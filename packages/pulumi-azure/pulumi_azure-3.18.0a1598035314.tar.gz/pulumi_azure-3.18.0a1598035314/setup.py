...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.18.0-alpha.1598035314+60f86e82'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.18.0-alpha.1598035314+60f86e82`
                """)
            else:
                raise
