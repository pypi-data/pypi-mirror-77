...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.18.0-alpha.1598271159+c11835ff'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.18.0-alpha.1598271159+c11835ff`
                """)
            else:
                raise
