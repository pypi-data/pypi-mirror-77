...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.19.0-alpha.1598623805+e42aba54'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.19.0-alpha.1598623805+e42aba54`
                """)
            else:
                raise
