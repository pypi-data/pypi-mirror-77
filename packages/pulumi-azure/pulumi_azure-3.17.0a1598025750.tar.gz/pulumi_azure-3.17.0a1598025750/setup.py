...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.17.0-alpha.1598025750+3fffd7a5'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.17.0-alpha.1598025750+3fffd7a5`
                """)
            else:
                raise
