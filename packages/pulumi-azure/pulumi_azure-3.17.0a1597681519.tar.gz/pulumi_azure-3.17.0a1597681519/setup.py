...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.17.0-alpha.1597681519+8b06fcfb'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.17.0-alpha.1597681519+8b06fcfb`
                """)
            else:
                raise
