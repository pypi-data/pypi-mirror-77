...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.19.0-alpha.1598308041+f4bd069e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.19.0-alpha.1598308041+f4bd069e`
                """)
            else:
                raise
