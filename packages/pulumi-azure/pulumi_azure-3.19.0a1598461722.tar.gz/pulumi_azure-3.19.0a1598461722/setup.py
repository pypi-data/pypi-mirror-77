...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.19.0-alpha.1598461722+ad86ae41'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.19.0-alpha.1598461722+ad86ae41`
                """)
            else:
                raise
