...
class ExcelWriter:
    ...
    designed to provide more flexible and ease of use excel writing experience.
    ...
    def __init__(self, filepath: str, sheet_name: Union[str, None] = '',
        ...
        if filepath.endswith('.xls'):
            lk.logt('[ExcelWriter][I2504]',
                    'ExcelWriter doesn\'t support xls format, will use xlsx '
                    'instead.', filepath, h='parent')
            filepath += 'x'
    ...
    def writeln(self, *row, auto_index=False, purify_values=False, fmt=None):
        ...
        if self.rowx == 0 or not auto_index:
            ...
            self.sheet.write(self.rowx, 0, index, fmt)
