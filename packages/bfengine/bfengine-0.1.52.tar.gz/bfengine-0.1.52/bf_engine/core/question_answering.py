...
class QuestionAnswering(Module):
    ...
    def train(self, data: str = None, question_path: str = None, corpus_path: str = None,append: bool = False,show_progress:bool=True,callback=None):
        """
        :param data:
        ...
        try:
            ...
            self._train(show_progress,callback)
    ...
    def _train(self,show_progress:bool=True,callback=None):
        ...
        with tqdm(total=100) as bar:
            ...
            while progress < 100:
                ...
                if callback:
                    callback(train_id, progress - old_progress)
                time.sleep(1)
            if show_progress:
                bar.set_description("qa train finished")
        if callback:
            callback(train_id, 100)
        time.sleep(5)
    def _pulish(self):
    ...
    def update_corpus(self, question_id, corpus_id):
        """
        更新语料
        :return:
        """
        return self.caller.update_corpus(question_id, corpus_id)
    ...
    def add_corpus(self, question_id, corpus):
        ...
        :return:
        """
        return self.caller.add_corpus(question_id, corpus)
