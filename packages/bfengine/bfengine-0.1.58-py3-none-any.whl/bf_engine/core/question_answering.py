...
class QuestionAnswering(Module):
    ...
    def _upload_question(self, question_path, is_log=True,append: bool = False):
        ...
        data_id = self.caller.upl(QuestionType.SQ_ANS, QuestionMode.INCRE if append else QuestionMode.FULL, question_path)
    ...
    def get_similar_qa_list(self,user_inputs:str,max_topn) -> str:
        return self.caller.get_similar_qa_list(user_inputs,max_topn)
