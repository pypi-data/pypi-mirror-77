...
class experiment:
    ...
    def publish_data(self, device_id, data, data_delimiter='null', timestamp = 0, auto_add_config=True):
        """
        ...
        auto_add_config : bool
            False if the device should not be automatically added to the experiment's configuration (default is True) 
        """
        ...
        if data_delimiter != 'null':
            payload['data_delimiter'] = data_delimiter
        if auto_add_config:
            payload['auto_add_config'] = auto_add_config
