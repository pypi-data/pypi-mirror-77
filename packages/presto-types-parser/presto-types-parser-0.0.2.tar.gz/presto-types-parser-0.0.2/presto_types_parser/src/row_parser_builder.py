import presto_types_parser.src.column_process.varbinary_processor as varbinary_processor
import presto_types_parser.src.complex_column_process.array_processor_builder as \
    array_processor_builder
import presto_types_parser.src.complex_column_process.map_processor_builder as \
    map_processor_builder
import presto_types_parser.src.complex_column_process.inner_row_processor_builder as \
    inner_row_processor_builder

from presto_types_parser.src.row_parser import PrestoRowParser
from presto_types_parser.src.column_process.default_cell_processor import process_raw_cell as \
...
def build_row_parser(columns):
    ...
    return PrestoRowParser(root_cell_processors)
