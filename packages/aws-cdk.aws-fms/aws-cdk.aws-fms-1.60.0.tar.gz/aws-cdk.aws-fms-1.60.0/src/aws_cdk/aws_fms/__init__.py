...
class CfnPolicy(
    ...
    def __init__(
        ...
        id: str,
        *,
        exclude_resource_tags: typing.Union[bool, aws_cdk.core.IResolvable],
        policy_name: str,
        remediation_enabled: typing.Union[bool, aws_cdk.core.IResolvable],
        resource_type: str,
        security_service_policy_data: typing.Any,
        delete_all_policy_resources: typing.Optional[
            typing.Union[bool, aws_cdk.core.IResolvable]
        ] = None,
        exclude_map: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "IEMapProperty"]
        ] = None,
        include_map: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "IEMapProperty"]
        ] = None,
        resource_tags: typing.Optional[
            typing.Union[
                aws_cdk.core.IResolvable,
                typing.List[
                    typing.Union[aws_cdk.core.IResolvable, "ResourceTagProperty"]
                ],
            ]
        ] = None,
    ...
    def exclude_map(
        self,
    ) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "IEMapProperty"]]:
    ...
    def exclude_map(
        self,
        value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "IEMapProperty"]],
    ) -> None:
    ...
    def resource_tags(
        ...
        typing.Union[
            aws_cdk.core.IResolvable,
            typing.List[typing.Union[aws_cdk.core.IResolvable, "ResourceTagProperty"]],
        ]
    ]:
...
class CfnPolicyProps:
    def __init__(
        ...
        *,
        ...
        exclude_map: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "CfnPolicy.IEMapProperty"]
        ] = None,
        include_map: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "CfnPolicy.IEMapProperty"]
        ] = None,
        resource_tags: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        aws_cdk.core.IResolvable, "CfnPolicy.ResourceTagProperty"
                    ]
                ],
            ]
        ] = None,
    ...
    def resource_tags(
        ...
        typing.Union[
            aws_cdk.core.IResolvable,
            typing.List[
                typing.Union[aws_cdk.core.IResolvable, "CfnPolicy.ResourceTagProperty"]
            ],
        ]
    ]:
        """``AWS::FMS::Policy.ResourceTags``.
