...
class Device(object):
    ...
    def __init__(self, id, zone, device_type, subtype,
...
class System(object):
    ...
    def __init__(self, hostname, user_code, user_id, user_email, user_password, panel_id, partition):
        """ Initiate the connection to the Visonic API """
        self.__api = API(hostname, user_code, user_id, user_email, user_password, panel_id, partition)
...
class API(object):
    ...
    def __init__(self, hostname, user_code, user_id, user_email, user_password, panel_id, partition):
        ...
        self.__url_general_panel_info = self.__url_base + '/panel_info'
    ...
    def login(self):
        ...
        # Setup authentication information (Used only in 8.0)
        login_info = {
