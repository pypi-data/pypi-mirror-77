...
class LidarCamera:
    ...
    def calibrate(self, position=None, rotation=None, pose=None, extrinsic_matrix=None, projection_matrix=None, K=None, D=None, model=None, scale_factor=None, skew=None, **kwargs):
        """
        ...
        :param scale_factor: image scale_factor
        :param skew: camera skew coefficient
        """
