...
gateway_base_aio.py
 ...
 Copyright (c) 2017-2019 All right reserved.
...
class GatewayBaseAIO(PanguBaseAIO):
    """
    ...
    def __init__(self, back_plane_ip_address=None, subscriber_port='16103',
                 publisher_port='16130', process_name='',
        ...
        :param publisher_port: pangu_base back plane publisher port.
                               This must match that of the pangu_base
                               backplane
    ...
    async def incoming_message_processing(self, topic, payload):
        ...
        if not content:
            await self.additional_pangu_messages(topic, payload)
            return
    ...
    async def additional_pangu_messages(self, topic, payload):
        """
