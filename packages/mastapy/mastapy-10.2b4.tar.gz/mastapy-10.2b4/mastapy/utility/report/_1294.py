...
from mastapy.utility.report import _1295, _1296
...
T = TypeVar('T', bound='_1296.CustomReportItemContainerCollectionItem')


class CustomReportItemContainerCollection(_1295.CustomReportItemContainerCollectionBase, Generic[T]):
    '''CustomReportItemContainerCollection
