...
from mastapy.utility.units_and_measurements.measurements import _1226
...
class DutyCyclePropertySummaryPercentage(_1355.DutyCyclePropertySummary['_1226.Percentage', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryPercentage
