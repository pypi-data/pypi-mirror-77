...
class ShavingDynamicsCalculationForHobbedGears(_551.ShavingDynamicsCalculation['T'], Generic[T]):
    ...
    def redressing_at_minimum_start_and_end_of_shaving_profile(self) -> '_549.ShaverRedressing[T]':
        ...
        if _549.ShaverRedressing[T].TYPE not in self.wrapped.RedressingAtMinimumStartAndEndOfShavingProfile.__class__.__mro__:
    ...
    def redressing_at_minimum_start_and_maximum_end_of_shaving_profile(self) -> '_549.ShaverRedressing[T]':
        ...
        if _549.ShaverRedressing[T].TYPE not in self.wrapped.RedressingAtMinimumStartAndMaximumEndOfShavingProfile.__class__.__mro__:
    ...
    def redressing_at_maximum_start_and_end_of_shaving_profile(self) -> '_549.ShaverRedressing[T]':
        ...
        if _549.ShaverRedressing[T].TYPE not in self.wrapped.RedressingAtMaximumStartAndEndOfShavingProfile.__class__.__mro__:
    ...
    def redressing_at_maximum_start_and_minimum_end_of_shaving_profile(self) -> '_549.ShaverRedressing[T]':
        ...
        if _549.ShaverRedressing[T].TYPE not in self.wrapped.RedressingAtMaximumStartAndMinimumEndOfShavingProfile.__class__.__mro__:
