...
class GearCutterSimulation(_0.APIBase):
    ...
    def minimum_thickness(self) -> '_488.CutterSimulationCalc':
        ...
        if _488.CutterSimulationCalc.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    def average_thickness(self) -> '_488.CutterSimulationCalc':
        ...
        if _488.CutterSimulationCalc.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    def maximum_thickness(self) -> '_488.CutterSimulationCalc':
        ...
        if _488.CutterSimulationCalc.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    def smallest_active_profile(self) -> '_488.CutterSimulationCalc':
        ...
        if _488.CutterSimulationCalc.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
