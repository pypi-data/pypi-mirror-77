...
class CylindricalGearRealCutterDesign(_509.CylindricalGearAbstractCutterDesign):
    ...
    @property
    def nominal_cutter_drawing(self) -> '_6532.SMTBitmap':
        ...
        return constructor.new(_6532.SMTBitmap)(self.wrapped.NominalCutterDrawing) if self.wrapped.NominalCutterDrawing else None
    ...
    def nominal_cutter_shape(self) -> '_526.CutterShapeDefinition':
        ...
        if _526.CutterShapeDefinition.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
