...
class GearRating(_156.AbstractGearRating):
    ...
    def bending_safety_factor_results(self) -> '_85.SafetyFactorItem':
        ...
        if _85.SafetyFactorItem.TYPE not in self.wrapped.BendingSafetyFactorResults.__class__.__mro__:
    ...
    def contact_safety_factor_results(self) -> '_85.SafetyFactorItem':
        ...
        if _85.SafetyFactorItem.TYPE not in self.wrapped.ContactSafetyFactorResults.__class__.__mro__:
