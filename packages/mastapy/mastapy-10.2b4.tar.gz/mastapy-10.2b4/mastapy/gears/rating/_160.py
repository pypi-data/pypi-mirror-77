...
from mastapy.gears.rating.cylindrical import _263, _255, _256
...
class GearDutyCycleRating(_156.AbstractGearRating):
    ...
    def gear_set_design_duty_cycle(self) -> '_164.GearSetDutyCycleRating':
        ...
        if _164.GearSetDutyCycleRating.TYPE not in self.wrapped.GearSetDesignDutyCycle.__class__.__mro__:
