...
class CylindricalGearMeshRating(_162.GearMeshRating):
    ...
    def cylindrical_mesh_single_flank_rating(self) -> '_267.CylindricalMeshSingleFlankRating':
        ...
        if _267.CylindricalMeshSingleFlankRating.TYPE not in self.wrapped.CylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    def isodin_cylindrical_mesh_single_flank_rating(self) -> '_313.ISO6336AbstractMetalMeshSingleFlankRating':
        ...
        if _313.ISO6336AbstractMetalMeshSingleFlankRating.TYPE not in self.wrapped.ISODINCylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    def mesh_single_flank_rating(self) -> '_267.CylindricalMeshSingleFlankRating':
        ...
        if _267.CylindricalMeshSingleFlankRating.TYPE not in self.wrapped.MeshSingleFlankRating.__class__.__mro__:
