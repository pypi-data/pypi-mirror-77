...
class GearMeshLoadDistributionAnalysis(_957.GearMeshImplementationAnalysis):
    ...
    @property
    def transmission_error_fourier_series(self) -> '_1080.FourierSeries':
        ...
        return constructor.new(_1080.FourierSeries)(self.wrapped.TransmissionErrorFourierSeries) if self.wrapped.TransmissionErrorFourierSeries else None
    ...
    def maximum_root_stress_with_flanks(self, gear: '_616.GearLoadDistributionAnalysis', flank: '_128.GearFlanks', stress_type: '_1397.StressResultsType') -> 'float':
        ...
        method_result = self.wrapped.MaximumRootStress.Overloads[_616.GearLoadDistributionAnalysis.TYPE, _128.GearFlanks.type_(), _1397.StressResultsType.type_()](gear.wrapped if gear else None, flank, stress_type)
        return method_result

    def maximum_root_stress(self, gear: '_616.GearLoadDistributionAnalysis', stress_type: '_1397.StressResultsType') -> 'float':
        ''' 'MaximumRootStress' is the original name of this method.
        ...
        stress_type = conversion.mp_to_pn_enum(stress_type)
        method_result = self.wrapped.MaximumRootStress.Overloads[_616.GearLoadDistributionAnalysis.TYPE, _1397.StressResultsType.type_()](gear.wrapped if gear else None, stress_type)
        return method_result
