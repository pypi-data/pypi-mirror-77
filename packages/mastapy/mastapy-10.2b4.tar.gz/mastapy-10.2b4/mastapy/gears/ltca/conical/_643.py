...
class ConicalMeshedGearLoadDistributionAnalysis(_0.APIBase):
    ...
    def contact_charts(self) -> '_948.GearLTCAContactCharts':
        ...
        if _948.GearLTCAContactCharts.TYPE not in self.wrapped.ContactCharts.__class__.__mro__:
    ...
    def contact_charts_as_text_file(self) -> '_947.GearLTCAContactChartDataAsTextFile':
        ...
        if _947.GearLTCAContactChartDataAsTextFile.TYPE not in self.wrapped.ContactChartsAsTextFile.__class__.__mro__:
