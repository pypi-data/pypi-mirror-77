...
class CylindricalGearDesign(_713.GearDesign):
    ...
    def iso6336_geometry(self) -> '_811.ISO6336GeometryBase':
        ...
        if _811.ISO6336GeometryBase.TYPE not in self.wrapped.ISO6336Geometry.__class__.__mro__:
    ...
    def material(self) -> '_379.GearMaterial':
        ...
        if _379.GearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
    ...
    def accuracy_grade_allowances_and_tolerances(self) -> '_876.CylindricalAccuracyGrader':
        ...
        if _876.CylindricalAccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
    ...
    def accuracy_grades_specified_accuracy(self) -> '_116.AccuracyGrades':
        ...
        if _116.AccuracyGrades.TYPE not in self.wrapped.AccuracyGradesSpecifiedAccuracy.__class__.__mro__:
    ...
    @property
    def micro_geometries(self) -> 'List[_849.CylindricalGearMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MicroGeometries, constructor.new(_849.CylindricalGearMicroGeometry))
        return value

    @property
    def manufacturing_configurations(self) -> 'List[_397.CylindricalGearManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ManufacturingConfigurations, constructor.new(_397.CylindricalGearManufacturingConfig))
        return value
