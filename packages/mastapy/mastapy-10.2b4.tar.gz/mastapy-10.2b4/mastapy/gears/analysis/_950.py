...
class AbstractGearMeshAnalysis(_0.APIBase):
    ...
    def gear_a(self) -> '_949.AbstractGearAnalysis':
        ...
        if _949.AbstractGearAnalysis.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    def gear_b(self) -> '_949.AbstractGearAnalysis':
        ...
        if _949.AbstractGearAnalysis.TYPE not in self.wrapped.GearB.__class__.__mro__:
