...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3573, _3571
...
class ParametricStudyTool(_6509.AnalysisCase):
    ...
    def load_case(self) -> '_6211.StaticLoadCase':
        ...
        if _6211.StaticLoadCase.TYPE not in self.wrapped.LoadCase.__class__.__mro__:
