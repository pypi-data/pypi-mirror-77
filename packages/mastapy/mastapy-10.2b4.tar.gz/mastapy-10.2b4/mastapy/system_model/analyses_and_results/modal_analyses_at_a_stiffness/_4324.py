...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4308, _4241
...
class RootAssemblyModalAnalysisAtAStiffness(_4241.AssemblyModalAnalysisAtAStiffness):
    ...
    @property
    def modal_analysis_at_a_stiffness_inputs(self) -> '_4308.ModalAnalysisAtAStiffness':
        ...
        return constructor.new(_4308.ModalAnalysisAtAStiffness)(self.wrapped.ModalAnalysisAtAStiffnessInputs) if self.wrapped.ModalAnalysisAtAStiffnessInputs else None
