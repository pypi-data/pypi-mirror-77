...
class HarmonicLoadDataBase(_0.APIBase):
    ...
    @property
    def excitations(self) -> 'List[_1080.FourierSeries]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Excitations, constructor.new(_1080.FourierSeries))
        return value
    ...
    def set_selected_harmonic_load_data(self, fourier_series_values: 'List[float]', fourier_series_name: 'str', fourier_series_measurement_type: '_6530.MeasurementType'):
        ...
        self.wrapped.SetSelectedHarmonicLoadData.Overloads[List[float], str, _6530.MeasurementType.type_()](fourier_series_values, fourier_series_name if fourier_series_name else None, fourier_series_measurement_type)

    def set_selected_harmonic_load_data_extended(self, amplitudes: 'List[float]', phases: 'List[float]', mean_value: 'float', fourier_series_name: 'str', fourier_series_measurement_type: '_6530.MeasurementType'):
        ''' 'SetSelectedHarmonicLoadData' is the original name of this method.
        ...
        fourier_series_name = str(fourier_series_name)
        fourier_series_measurement_type = conversion.mp_to_pn_enum(fourier_series_measurement_type)
        self.wrapped.SetSelectedHarmonicLoadData.Overloads[List[float], List[float], float, str, _6530.MeasurementType.type_()](amplitudes, phases, mean_value if mean_value else 0.0, fourier_series_name if fourier_series_name else None, fourier_series_measurement_type)

    def set_selected_harmonic_load_data_with_fourier_series(self, fourier_series: '_1080.FourierSeries'):
        ''' 'SetSelectedHarmonicLoadData' is the original name of this method.
        ...
        self.wrapped.SetSelectedHarmonicLoadData.Overloads[_1080.FourierSeries.TYPE](fourier_series.wrapped if fourier_series else None)
