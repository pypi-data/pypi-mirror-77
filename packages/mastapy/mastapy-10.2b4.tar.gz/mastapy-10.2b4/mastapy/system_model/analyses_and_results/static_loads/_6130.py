...
from mastapy.system_model.analyses_and_results.static_loads import _6230, _6159, _6204
...
class ElectricMachineHarmonicLoadData(_6204.SpeedDependentHarmonicLoadData):
    '''ElectricMachineHarmonicLoadData
    ...
    @property
    def force_distribution(self) -> '_6532.SMTBitmap':
        ...
        return constructor.new(_6532.SMTBitmap)(self.wrapped.ForceDistribution) if self.wrapped.ForceDistribution else None
