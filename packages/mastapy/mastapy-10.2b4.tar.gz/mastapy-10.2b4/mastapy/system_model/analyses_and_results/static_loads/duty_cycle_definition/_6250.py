...
from mastapy.utility.file_access_helpers import _1341
from mastapy.utility_gui import _1511
...
class MultiTimeSeriesDataInputFileOptions(_1511.DataInputFileOptions):
    '''MultiTimeSeriesDataInputFileOptions
    ...
    @property
    def delimiter_options(self) -> '_1341.TextFileDelimiterOptions':
        ...
        return constructor.new(_1341.TextFileDelimiterOptions)(self.wrapped.DelimiterOptions) if self.wrapped.DelimiterOptions else None
