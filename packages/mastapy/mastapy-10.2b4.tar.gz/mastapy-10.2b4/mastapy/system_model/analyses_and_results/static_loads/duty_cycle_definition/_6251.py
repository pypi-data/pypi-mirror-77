...
class PointLoadInputOptions(_1510.ColumnInputOptions):
    '''PointLoadInputOptions
    ...
    @property
    def conversion_to_load_case(self) -> '_6242.AdditionalForcesObtainedFrom':
        ...
        return constructor.new(_6242.AdditionalForcesObtainedFrom)(value) if value else None

    @conversion_to_load_case.setter
    def conversion_to_load_case(self, value: '_6242.AdditionalForcesObtainedFrom'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
