...
from mastapy.system_model.analyses_and_results.static_loads import _6179, _6155, _6135
...
class HarmonicLoadDataExcelImport(_6155.HarmonicLoadDataImportBase['_6135.ElectricMachineHarmonicLoadExcelImportOptions']):
    '''HarmonicLoadDataExcelImport
    ...
    @property
    def speeds(self) -> 'List[_6179.NamedSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Speeds, constructor.new(_6179.NamedSpeed))
        return value
