...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6297, _6323
...
class GearMeshAdvancedSystemDeflection(_6323.InterMountableComponentConnectionAdvancedSystemDeflection):
    '''GearMeshAdvancedSystemDeflection
    ...
    @property
    def misalignment_fourier_series_for_first_tooth_passing_period(self) -> '_1080.FourierSeries':
        ...
        return constructor.new(_1080.FourierSeries)(self.wrapped.MisalignmentFourierSeriesForFirstToothPassingPeriod) if self.wrapped.MisalignmentFourierSeriesForFirstToothPassingPeriod else None
    ...
    @property
    def max_pressure_contact_chart_for_each_tooth_pass_for_gear_a(self) -> 'List[_6297.ContactChartPerToothPass]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MaxPressureContactChartForEachToothPassForGearA, constructor.new(_6297.ContactChartPerToothPass))
        return value
