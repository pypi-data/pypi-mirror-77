...
class GearCompoundSystemDeflection(_2451.MountableComponentCompoundSystemDeflection):
    '''GearCompoundSystemDeflection
    ...
    def duty_cycle_rating(self) -> '_160.GearDutyCycleRating':
        ...
        if _160.GearDutyCycleRating.TYPE not in self.wrapped.DutyCycleRating.__class__.__mro__:
