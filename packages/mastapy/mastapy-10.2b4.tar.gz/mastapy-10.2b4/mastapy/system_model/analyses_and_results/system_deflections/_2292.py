...
class GearMeshSystemDeflection(_2300.InterMountableComponentConnectionSystemDeflection):
    ...
    def rating(self) -> '_162.GearMeshRating':
        ...
        if _162.GearMeshRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    def gear_a(self) -> '_2294.GearSystemDeflection':
        ...
        if _2294.GearSystemDeflection.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    def gear_b(self) -> '_2294.GearSystemDeflection':
        ...
        if _2294.GearSystemDeflection.TYPE not in self.wrapped.GearB.__class__.__mro__:
