...
from mastapy.system_model.analyses_and_results.system_deflections import _2309, _2307, _2302
...
class KlingelnbergCycloPalloidSpiralBevelGearSetSystemDeflection(_2302.KlingelnbergCycloPalloidConicalGearSetSystemDeflection):
    '''KlingelnbergCycloPalloidSpiralBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3310.KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_system_deflection(self) -> 'List[_2309.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelGearsSystemDeflection, constructor.new(_2309.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection))
        return value

    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_system_deflection(self) -> 'List[_2307.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelMeshesSystemDeflection, constructor.new(_2307.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection))
        return value
