...
class KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection(_2303.KlingelnbergCycloPalloidConicalGearSystemDeflection):
    '''KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3309.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow':
