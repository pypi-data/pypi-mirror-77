...
class SystemDeflection(_6518.FEAnalysis):
    '''SystemDeflection
    ...
    @property
    def analysis_options(self) -> '_2356.SystemDeflectionOptions':
        ...
        return constructor.new(_2356.SystemDeflectionOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions else None
