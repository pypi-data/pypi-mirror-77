...
from mastapy.system_model.analyses_and_results.system_deflections import _2255, _2317
...
class AbstractAssemblySystemDeflection(_2317.PartSystemDeflection):
    '''AbstractAssemblySystemDeflection
    ...
    @property
    def rigidly_connected_groups(self) -> 'List[_2377.RigidlyConnectedComponentGroupSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidlyConnectedGroups, constructor.new(_2377.RigidlyConnectedComponentGroupSystemDeflection))
        return value

    @property
    def components_with_unknown_mass_properties(self) -> 'List[_2255.ComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentsWithUnknownMassProperties, constructor.new(_2255.ComponentSystemDeflection))
        return value

    @property
    def components_with_zero_mass_properties(self) -> 'List[_2255.ComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentsWithZeroMassProperties, constructor.new(_2255.ComponentSystemDeflection))
        return value
