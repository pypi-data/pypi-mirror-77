...
from mastapy.system_model.analyses_and_results.system_deflections import _2306, _2304, _2302
...
class KlingelnbergCycloPalloidHypoidGearSetSystemDeflection(_2302.KlingelnbergCycloPalloidConicalGearSetSystemDeflection):
    '''KlingelnbergCycloPalloidHypoidGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3307.KlingelnbergCycloPalloidHypoidGearSetPowerFlow':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_system_deflection(self) -> 'List[_2306.KlingelnbergCycloPalloidHypoidGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidGearsSystemDeflection, constructor.new(_2306.KlingelnbergCycloPalloidHypoidGearSystemDeflection))
        return value

    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_system_deflection(self) -> 'List[_2304.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidMeshesSystemDeflection, constructor.new(_2304.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection))
        return value
