...
from mastapy.system_model.analyses_and_results.system_deflections import _2362, _2364
...
class PowerLoadSystemDeflection(_2364.VirtualComponentSystemDeflection):
    '''PowerLoadSystemDeflection
    ...
    @property
    def transmission_error_to_other_power_loads(self) -> 'List[_2362.TransmissionErrorResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TransmissionErrorToOtherPowerLoads, constructor.new(_2362.TransmissionErrorResult))
        return value
