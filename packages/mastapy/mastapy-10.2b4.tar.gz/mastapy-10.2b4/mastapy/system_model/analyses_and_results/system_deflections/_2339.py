...
class SpringDamperConnectionSystemDeflection(_2269.CouplingConnectionSystemDeflection):
    '''SpringDamperConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3338.SpringDamperConnectionPowerFlow':
