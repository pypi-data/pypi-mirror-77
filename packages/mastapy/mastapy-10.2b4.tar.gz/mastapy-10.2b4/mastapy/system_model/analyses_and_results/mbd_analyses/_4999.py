...
from mastapy.system_model.analyses_and_results.static_loads import _6082, _6115
...
class BeltConnectionMultiBodyDynamicsAnalysis(_5057.InterMountableComponentConnectionMultiBodyDynamicsAnalysis):
    '''BeltConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def loading_status(self) -> '_1387.LoadingStatus':
        ...
        return constructor.new(_1387.LoadingStatus)(value) if value else None
    ...
    def connection_load_case(self) -> '_6082.BeltConnectionLoadCase':
        ...
        if _6082.BeltConnectionLoadCase.TYPE not in self.wrapped.ConnectionLoadCase.__class__.__mro__:
