...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5118, _5028
...
class TorqueConverterConnectionMultiBodyDynamicsAnalysis(_5028.CouplingConnectionMultiBodyDynamicsAnalysis):
    '''TorqueConverterConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def locking_status(self) -> '_5118.TorqueConverterStatus':
        ...
        return constructor.new(_5118.TorqueConverterStatus)(value) if value else None
