...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3773, _3772, _3799
...
class ConceptGearSetModalAnalysesAtStiffnesses(_3799.GearSetModalAnalysesAtStiffnesses):
    '''ConceptGearSetModalAnalysesAtStiffnesses
    ...
    @property
    def concept_gears_modal_analyses_at_stiffnesses(self) -> 'List[_3773.ConceptGearModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsModalAnalysesAtStiffnesses, constructor.new(_3773.ConceptGearModalAnalysesAtStiffnesses))
        return value

    @property
    def concept_meshes_modal_analyses_at_stiffnesses(self) -> 'List[_3772.ConceptGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesModalAnalysesAtStiffnesses, constructor.new(_3772.ConceptGearMeshModalAnalysesAtStiffnesses))
        return value
