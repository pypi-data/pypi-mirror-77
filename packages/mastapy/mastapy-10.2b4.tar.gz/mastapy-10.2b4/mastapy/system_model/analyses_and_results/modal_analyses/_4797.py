...
from mastapy.nodal_analysis import _1369, _1368
...
class ModalAnalysisBarModelFEExportOptions(_0.APIBase):
    ...
    @property
    def analysis_type(self) -> '_1368.BarModelAnalysisType':
        ...
        return constructor.new(_1368.BarModelAnalysisType)(value) if value else None

    @analysis_type.setter
    def analysis_type(self, value: '_1368.BarModelAnalysisType'):
    ...
    @property
    def mode_options(self) -> '_1459.EigenvalueOptions':
        ...
        return constructor.new(_1459.EigenvalueOptions)(self.wrapped.ModeOptions) if self.wrapped.ModeOptions else None
