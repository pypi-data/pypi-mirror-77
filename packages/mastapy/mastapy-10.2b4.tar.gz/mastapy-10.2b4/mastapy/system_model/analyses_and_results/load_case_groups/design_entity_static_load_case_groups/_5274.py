...
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5271, _5272, _5275
from mastapy.system_model.part_model.gears import _2095, _2093
from mastapy.system_model.analyses_and_results.static_loads import _6145, _6147, _6150
...
TGearSet = TypeVar('TGearSet', bound='_2095.GearSet')
TGear = TypeVar('TGear', bound='_2093.Gear')
TGearStaticLoad = TypeVar('TGearStaticLoad', bound='_6145.GearLoadCase')
TGearMesh = TypeVar('TGearMesh', bound='_1895.GearMesh')
TGearMeshStaticLoad = TypeVar('TGearMeshStaticLoad', bound='_6147.GearMeshLoadCase')
TGearSetStaticLoad = TypeVar('TGearSetStaticLoad', bound='_6150.GearSetLoadCase')


class GearSetStaticLoadCaseGroup(_5275.PartStaticLoadCaseGroup, Generic[TGearSet, TGear, TGearStaticLoad, TGearMesh, TGearMeshStaticLoad, TGearSetStaticLoad]):
    '''GearSetStaticLoadCaseGroup
    ...
    @property
    def gears_load_cases(self) -> 'List[_5271.ComponentStaticLoadCaseGroup[TGear, TGearStaticLoad]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsLoadCases, constructor.new(_5271.ComponentStaticLoadCaseGroup)[TGear, TGearStaticLoad])
        return value

    @property
    def meshes_load_cases(self) -> 'List[_5272.ConnectionStaticLoadCaseGroup[TGearMesh, TGearMeshStaticLoad]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesLoadCases, constructor.new(_5272.ConnectionStaticLoadCaseGroup)[TGearMesh, TGearMeshStaticLoad])
        return value
