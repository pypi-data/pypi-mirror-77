...
TReal = TypeVar('TReal', bound='_2011.Component')
TComponentStaticLoad = TypeVar('TComponentStaticLoad', bound='_6098.ComponentLoadCase')


class ComponentStaticLoadCaseGroup(_5275.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]):
    '''ComponentStaticLoadCaseGroup
