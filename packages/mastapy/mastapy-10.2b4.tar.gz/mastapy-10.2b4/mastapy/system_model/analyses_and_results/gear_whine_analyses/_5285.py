...
from mastapy.system_model.analyses_and_results.static_loads import _6083, _6116
from mastapy.system_model.analyses_and_results.system_deflections import _2240, _2274
...
class BeltDriveGearWhineAnalysis(_5391.SpecialisedAssemblyGearWhineAnalysis):
    ...
    def assembly_load_case(self) -> '_6083.BeltDriveLoadCase':
        ...
        if _6083.BeltDriveLoadCase.TYPE not in self.wrapped.AssemblyLoadCase.__class__.__mro__:
