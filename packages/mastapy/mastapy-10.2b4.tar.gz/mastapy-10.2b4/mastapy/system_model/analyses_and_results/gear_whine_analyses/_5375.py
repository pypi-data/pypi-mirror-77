...
class PartToPartShearCouplingHalfGearWhineAnalysis(_5315.CouplingHalfGearWhineAnalysis):
    '''PartToPartShearCouplingHalfGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2319.PartToPartShearCouplingHalfSystemDeflection':
