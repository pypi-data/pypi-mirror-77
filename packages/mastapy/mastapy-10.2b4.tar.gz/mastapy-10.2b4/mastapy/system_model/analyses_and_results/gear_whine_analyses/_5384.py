...
class RollingRingConnectionGearWhineAnalysis(_5358.InterMountableComponentConnectionGearWhineAnalysis):
    '''RollingRingConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2327.RollingRingConnectionSystemDeflection':
