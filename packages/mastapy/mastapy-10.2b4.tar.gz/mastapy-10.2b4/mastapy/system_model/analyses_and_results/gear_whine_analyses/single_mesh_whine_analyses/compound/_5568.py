...
class BevelDifferentialGearMeshCompoundSingleMeshWhineAnalysis(_5573.BevelGearMeshCompoundSingleMeshWhineAnalysis):
    '''BevelDifferentialGearMeshCompoundSingleMeshWhineAnalysis
    ...
    @property
    def component_design(self) -> '_1883.BevelDifferentialGearMesh':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5444.BevelDifferentialGearMeshSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5444.BevelDifferentialGearMeshSingleMeshWhineAnalysis))
        return value

    @property
    def connection_single_mesh_whine_analysis_load_cases(self) -> 'List[_5444.BevelDifferentialGearMeshSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSingleMeshWhineAnalysisLoadCases, constructor.new(_5444.BevelDifferentialGearMeshSingleMeshWhineAnalysis))
        return value
