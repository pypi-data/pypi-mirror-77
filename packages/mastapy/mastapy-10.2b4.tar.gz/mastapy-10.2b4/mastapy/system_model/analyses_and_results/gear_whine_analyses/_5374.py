...
class PartToPartShearCouplingGearWhineAnalysis(_5314.CouplingGearWhineAnalysis):
    '''PartToPartShearCouplingGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2320.PartToPartShearCouplingSystemDeflection':
