...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses import _5526, _5440
...
class RootAssemblySingleMeshWhineAnalysis(_5440.AssemblySingleMeshWhineAnalysis):
    '''RootAssemblySingleMeshWhineAnalysis
    ...
    @property
    def single_mesh_whine_analysis_inputs(self) -> '_5526.SingleMeshWhineAnalysis':
        ...
        return constructor.new(_5526.SingleMeshWhineAnalysis)(self.wrapped.SingleMeshWhineAnalysisInputs) if self.wrapped.SingleMeshWhineAnalysisInputs else None
