...
class BevelDifferentialSunGearGearWhineAnalysis(_5286.BevelDifferentialGearGearWhineAnalysis):
    '''BevelDifferentialSunGearGearWhineAnalysis
    ...
    @property
    def component_design(self) -> '_2081.BevelDifferentialSunGear':
    ...
    @property
    def system_deflection_results(self) -> '_2245.BevelDifferentialSunGearSystemDeflection':
