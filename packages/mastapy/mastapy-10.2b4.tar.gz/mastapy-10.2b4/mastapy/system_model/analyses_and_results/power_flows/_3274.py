...
class ConnectionPowerFlow(_6515.ConnectionStaticLoadAnalysisCase):
    ...
    def component_design(self) -> '_1857.Connection':
        ...
        if _1857.Connection.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    def connection_design(self) -> '_1857.Connection':
        ...
        if _1857.Connection.TYPE not in self.wrapped.ConnectionDesign.__class__.__mro__:
    ...
    def torsional_system_deflection_analysis(self) -> '_2267.ConnectionSystemDeflection':
        ...
        if _2267.ConnectionSystemDeflection.TYPE not in self.wrapped.TorsionalSystemDeflectionAnalysis.__class__.__mro__:
