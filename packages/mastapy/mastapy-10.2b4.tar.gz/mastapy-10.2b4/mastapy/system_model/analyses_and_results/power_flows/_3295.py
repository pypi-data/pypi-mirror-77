...
from mastapy.system_model.analyses_and_results.power_flows import _3293, _3294, _3334
...
class GearSetPowerFlow(_3334.SpecialisedAssemblyPowerFlow):
    '''GearSetPowerFlow
    ...
    @property
    def meshes_power_flow(self) -> 'List[_3293.GearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3293.GearMeshPowerFlow))
        return value

    @property
    def gears_power_flow(self) -> 'List[_3294.GearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3294.GearPowerFlow))
        return value
