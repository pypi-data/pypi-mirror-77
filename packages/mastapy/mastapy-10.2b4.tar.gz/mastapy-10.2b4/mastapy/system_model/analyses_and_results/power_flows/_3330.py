...
from mastapy.system_model.analyses_and_results.power_flows import _3323, _3246
...
class RootAssemblyPowerFlow(_3246.AssemblyPowerFlow):
    '''RootAssemblyPowerFlow
    ...
    @property
    def power_flow_inputs(self) -> '_3323.PowerFlow':
        ...
        return constructor.new(_3323.PowerFlow)(self.wrapped.PowerFlowInputs) if self.wrapped.PowerFlowInputs else None
