...
class GearSetCompoundPowerFlow(_3456.SpecialisedAssemblyCompoundPowerFlow):
    '''GearSetCompoundPowerFlow
    ...
    def gear_set_duty_cycle_rating(self) -> '_164.GearSetDutyCycleRating':
        ...
        if _164.GearSetDutyCycleRating.TYPE not in self.wrapped.GearSetDutyCycleRating.__class__.__mro__:
