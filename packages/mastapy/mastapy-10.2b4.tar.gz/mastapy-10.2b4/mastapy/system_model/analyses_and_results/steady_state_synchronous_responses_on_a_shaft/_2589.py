...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _2600, _2508
...
class RootAssemblySteadyStateSynchronousResponseOnAShaft(_2508.AssemblySteadyStateSynchronousResponseOnAShaft):
    '''RootAssemblySteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def steady_state_synchronous_response_on_a_shaft_inputs(self) -> '_2600.SteadyStateSynchronousResponseOnAShaft':
        ...
        return constructor.new(_2600.SteadyStateSynchronousResponseOnAShaft)(self.wrapped.SteadyStateSynchronousResponseOnAShaftInputs) if self.wrapped.SteadyStateSynchronousResponseOnAShaftInputs else None
