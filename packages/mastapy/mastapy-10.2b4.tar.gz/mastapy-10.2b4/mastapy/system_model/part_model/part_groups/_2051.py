...
from mastapy.system_model.part_model.part_groups import _2052, _2050
...
class ConcentricPartGroup(_2050.ConcentricOrParallelPartGroup):
    '''ConcentricPartGroup
    ...
    @property
    def radial_position(self) -> '_1063.Vector2D':
        '''Vector2D: 'RadialPosition' is the original name of this property.'''

        return constructor.new(_1063.Vector2D)(self.wrapped.RadialPosition) if self.wrapped.RadialPosition else None

    @radial_position.setter
    def radial_position(self, value: '_1063.Vector2D'):
        value = value.wrapped if value else None
        self.wrapped.RadialPosition = value

    @property
    def parallel_groups(self) -> 'List[_2052.ConcentricPartGroupParallelToThis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelGroups, constructor.new(_2052.ConcentricPartGroupParallelToThis))
        return value
