...
from mastapy.system_model.part_model.projections import _2049
from mastapy.system_model.part_model.part_groups import _2054
...
class RootAssembly(_2002.Assembly):
    '''RootAssembly
    ...
    @property
    def parallel_part_groups_drawing_order(self) -> 'List[_2049.SpecifiedParallelPartGroupDrawingOrder]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelPartGroupsDrawingOrder, constructor.new(_2049.SpecifiedParallelPartGroupDrawingOrder))
        return value

    @property
    def parallel_part_groups(self) -> 'List[_2054.ParallelPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelPartGroups, constructor.new(_2054.ParallelPartGroup))
        return value
