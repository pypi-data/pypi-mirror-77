...
from mastapy.nodal_analysis.dev_tools_analyses import _1466
...
class ImportedFEWithSelectionForHarmonicAnalysis(_1971.ImportedFEWithSelection):
    '''ImportedFEWithSelectionForHarmonicAnalysis
    ...
    @property
    def harmonic_draw_style(self) -> '_1466.FEModelHarmonicAnalysisDrawStyle':
        ...
        return constructor.new(_1466.FEModelHarmonicAnalysisDrawStyle)(self.wrapped.HarmonicDrawStyle) if self.wrapped.HarmonicDrawStyle else None
