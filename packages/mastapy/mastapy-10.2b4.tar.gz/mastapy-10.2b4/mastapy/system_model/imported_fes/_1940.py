...
class ContactPairWithSelection(_0.APIBase):
    ...
    @property
    def contact_pair(self) -> '_1481.ContactPairReporting':
        ...
        return constructor.new(_1481.ContactPairReporting)(self.wrapped.ContactPair) if self.wrapped.ContactPair else None
