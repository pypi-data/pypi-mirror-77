...
from mastapy.system_model.imported_fes import _1931, _1937
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self) -> '_1931.AlignmentMethodForRaceBearing':
        ...
        return constructor.new(_1931.AlignmentMethodForRaceBearing)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_1931.AlignmentMethodForRaceBearing'):
    ...
    @property
    def links(self) -> 'List[_1937.BearingRaceNodeLink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1937.BearingRaceNodeLink))
        return value
