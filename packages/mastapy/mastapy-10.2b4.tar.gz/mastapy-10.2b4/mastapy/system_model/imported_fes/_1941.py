...
class CoordinateSystemWithSelection(_0.APIBase):
    ...
    @property
    def coordinate_system(self) -> '_1482.CoordinateSystemReporting':
        ...
        return constructor.new(_1482.CoordinateSystemReporting)(self.wrapped.CoordinateSystem) if self.wrapped.CoordinateSystem else None
