...
from mastapy.system_model.part_model.gears import _2089, _2105, _2088
...
class CylindricalGearMesh(_1895.GearMesh):
    ...
    def cylindrical_gear_set(self) -> '_2089.CylindricalGearSet':
        ...
        if _2089.CylindricalGearSet.TYPE not in self.wrapped.CylindricalGearSet.__class__.__mro__:
