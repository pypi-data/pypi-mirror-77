...
from mastapy.bearings.bearing_results.rolling.skf_module import _1717, _1721
...
class BearingRatingLife(_1721.SKFCalculationResult):
    '''BearingRatingLife
    ...
    @property
    def life_model(self) -> '_1717.LifeModel':
        ...
        return constructor.new(_1717.LifeModel)(self.wrapped.LifeModel) if self.wrapped.LifeModel else None
