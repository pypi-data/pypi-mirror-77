...
from mastapy.bearings.bearing_results.rolling import _1681, _1632
...
class LoadedThreePointContactBallBearingRow(_1632.LoadedBallBearingRow):
    '''LoadedThreePointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1681.LoadedThreePointContactBallBearingResults':
