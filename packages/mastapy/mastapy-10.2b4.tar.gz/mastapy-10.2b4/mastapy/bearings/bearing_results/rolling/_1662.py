...
class LoadedRollingBearingResults(_1590.LoadedDetailedBearingResults):
    ...
    def iso2812007(self) -> '_1728.ISO2812007Results':
        ...
        if _1728.ISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    def isots162812008(self) -> '_1731.ISOTS162812008Results':
        ...
        if _1731.ISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
