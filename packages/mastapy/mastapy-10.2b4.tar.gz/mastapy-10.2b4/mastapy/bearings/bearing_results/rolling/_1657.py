...
from mastapy.bearings.bearing_results.rolling import _1696, _1643
...
class LoadedRollerBearingElement(_1643.LoadedElement):
    '''LoadedRollerBearingElement
    ...
    @property
    def results_at_roller_offsets(self) -> 'List[_1696.ResultsAtRollerOffset]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsAtRollerOffsets, constructor.new(_1696.ResultsAtRollerOffset))
        return value
