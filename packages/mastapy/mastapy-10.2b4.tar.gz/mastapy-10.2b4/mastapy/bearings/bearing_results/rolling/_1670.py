...
from mastapy.bearings.bearing_results.rolling import _1669, _1659
...
class LoadedSphericalRollerRadialBearingRow(_1659.LoadedRollerBearingRow):
    '''LoadedSphericalRollerRadialBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1669.LoadedSphericalRollerRadialBearingResults':
