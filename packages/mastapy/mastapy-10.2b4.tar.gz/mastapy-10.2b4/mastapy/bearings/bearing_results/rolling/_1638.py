...
from mastapy.bearings.bearing_results.rolling import _1700, _1653
...
class LoadedCylindricalRollerBearingResults(_1653.LoadedNonBarrelRollerBearingResults):
    '''LoadedCylindricalRollerBearingResults
    ...
    @property
    def skf_maximal_constantly_acting_axial_load(self) -> '_1700.SKFMaximalConstantlyActingAxialLoadResults':
        ...
        return constructor.new(_1700.SKFMaximalConstantlyActingAxialLoadResults)(self.wrapped.SKFMaximalConstantlyActingAxialLoad) if self.wrapped.SKFMaximalConstantlyActingAxialLoad else None
