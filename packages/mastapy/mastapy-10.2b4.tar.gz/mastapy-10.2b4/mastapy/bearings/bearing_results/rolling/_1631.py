...
from mastapy.bearings.bearing_results.rolling import _1703, _1662
...
class LoadedBallBearingResults(_1662.LoadedRollingBearingResults):
    '''LoadedBallBearingResults
    ...
    @property
    def track_truncation(self) -> '_1703.TrackTruncationSafetyFactorResults':
        ...
        return constructor.new(_1703.TrackTruncationSafetyFactorResults)(self.wrapped.TrackTruncation) if self.wrapped.TrackTruncation else None
