...
from mastapy.bearings.bearing_results.rolling import _1634, _1659
...
class LoadedCrossedRollerBearingRow(_1659.LoadedRollerBearingRow):
    '''LoadedCrossedRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1634.LoadedCrossedRollerBearingResults':
