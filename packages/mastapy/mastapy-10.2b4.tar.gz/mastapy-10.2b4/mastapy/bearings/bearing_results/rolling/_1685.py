...
from mastapy.bearings.bearing_results.rolling import _1684, _1632
...
class LoadedThrustBallBearingRow(_1632.LoadedBallBearingRow):
    '''LoadedThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1684.LoadedThrustBallBearingResults':
