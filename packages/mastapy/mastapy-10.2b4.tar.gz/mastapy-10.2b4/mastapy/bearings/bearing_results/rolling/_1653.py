...
from mastapy.bearings.bearing_results.rolling import _1701, _1658
...
class LoadedNonBarrelRollerBearingResults(_1658.LoadedRollerBearingResults):
    '''LoadedNonBarrelRollerBearingResults
    ...
    @property
    def smt_rib_stress(self) -> '_1701.SMTRibStressResults':
        ...
        return constructor.new(_1701.SMTRibStressResults)(self.wrapped.SMTRibStress) if self.wrapped.SMTRibStress else None
