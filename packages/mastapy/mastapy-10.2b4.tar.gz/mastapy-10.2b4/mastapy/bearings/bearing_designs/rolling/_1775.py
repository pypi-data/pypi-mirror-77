...
from mastapy.bearings.bearing_designs.rolling import _1777, _1778, _1776
...
class NonBarrelRollerBearing(_1776.RollerBearing):
    '''NonBarrelRollerBearing
    ...
    @property
    def roller_end_shape(self) -> '_1777.RollerEndShape':
        ...
        return constructor.new(_1777.RollerEndShape)(value) if value else None

    @roller_end_shape.setter
    def roller_end_shape(self, value: '_1777.RollerEndShape'):
    ...
    @property
    def ribs(self) -> 'List[_1778.RollerRibDetail]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Ribs, constructor.new(_1778.RollerRibDetail))
        return value
