...
from mastapy.bearings.bearing_designs.rolling import _1761, _1779
...
class BallBearing(_1779.RollingBearing):
    '''BallBearing
    ...
    @property
    def shoulders(self) -> 'List[_1761.BallBearingShoulderDefinition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Shoulders, constructor.new(_1761.BallBearingShoulderDefinition))
        return value
