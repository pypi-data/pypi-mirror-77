...
from mastapy.bearings.bearing_designs.concept import _1809, _1811
...
class ConceptAxialClearanceBearing(_1811.ConceptClearanceBearing):
    '''ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_1809.BearingNodePosition':
        ...
        return constructor.new(_1809.BearingNodePosition)(value) if value else None

    @node_position.setter
    def node_position(self, value: '_1809.BearingNodePosition'):
