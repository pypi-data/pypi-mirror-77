...
from mastapy.detailed_rigid_connectors.interference_fits import _1031, _1030, _1035
...
class InterferenceFitDesign(_974.DetailedRigidConnectorDesign):
    '''InterferenceFitDesign
    ...
    @property
    def calculation_method(self) -> '_1031.CalculationMethods':
        ...
        return constructor.new(_1031.CalculationMethods)(value) if value else None

    @calculation_method.setter
    def calculation_method(self, value: '_1031.CalculationMethods'):
    ...
    @property
    def assembly_method(self) -> '_1030.AssemblyMethods':
        ...
        return constructor.new(_1030.AssemblyMethods)(value) if value else None

    @assembly_method.setter
    def assembly_method(self, value: '_1030.AssemblyMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
