...
class Bar(_1446.NodalComponent):
    '''Bar
    ...
    @property
    def bar_geometry(self) -> '_1367.BarGeometry':
        ...
        return constructor.new(_1367.BarGeometry)(self.wrapped.BarGeometry) if self.wrapped.BarGeometry else None
