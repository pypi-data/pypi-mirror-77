...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _1496, _1485
...
class ElementPropertiesRigid(_1485.ElementPropertiesBase):
    '''ElementPropertiesRigid
    ...
    @property
    def degrees_of_freedom_list(self) -> 'List[_1496.RigidElementNodeDegreesOfFreedom]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DegreesOfFreedomList, constructor.new(_1496.RigidElementNodeDegreesOfFreedom))
        return value
