...
class SplineJointDesign(_974.DetailedRigidConnectorDesign):
    ...
    def external_half(self) -> '_1001.SplineHalfDesign':
        ...
        if _1001.SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    def internal_half(self) -> '_1001.SplineHalfDesign':
        ...
        if _1001.SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
