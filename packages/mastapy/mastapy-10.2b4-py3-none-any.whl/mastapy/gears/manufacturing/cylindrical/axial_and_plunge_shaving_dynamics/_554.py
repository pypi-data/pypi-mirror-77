...
class ShavingDynamicsConfiguration(_0.APIBase):
    ...
    def conventional_shaving_dynamics(self) -> '_551.ShavingDynamicsCalculation[_536.ConventionalShavingDynamics]':
        ...
        if _551.ShavingDynamicsCalculation[_536.ConventionalShavingDynamics].TYPE not in self.wrapped.ConventionalShavingDynamics.__class__.__mro__:
    ...
    def plunge_shaving_dynamics(self) -> '_551.ShavingDynamicsCalculation[_540.PlungeShaverDynamics]':
        ...
        if _551.ShavingDynamicsCalculation[_540.PlungeShaverDynamics].TYPE not in self.wrapped.PlungeShavingDynamics.__class__.__mro__:
