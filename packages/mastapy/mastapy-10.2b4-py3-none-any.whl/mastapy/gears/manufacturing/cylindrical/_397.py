...
from mastapy.gears.gear_designs.cylindrical import _800, _776, _797
...
class CylindricalGearManufacturingConfig(_955.GearImplementationDetail):
    ...
    def rough_cutter(self) -> '_516.CylindricalGearRealCutterDesign':
        ...
        if _516.CylindricalGearRealCutterDesign.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    def finish_cutter(self) -> '_516.CylindricalGearRealCutterDesign':
        ...
        if _516.CylindricalGearRealCutterDesign.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    def rough_cutter_simulation(self) -> '_496.GearCutterSimulation':
        ...
        if _496.GearCutterSimulation.TYPE not in self.wrapped.RoughCutterSimulation.__class__.__mro__:
    ...
    def rough_process_simulation(self) -> '_424.CutterProcessSimulation':
        ...
        if _424.CutterProcessSimulation.TYPE not in self.wrapped.RoughProcessSimulation.__class__.__mro__:
    ...
    def finish_cutter_simulation(self) -> '_496.GearCutterSimulation':
        ...
        if _496.GearCutterSimulation.TYPE not in self.wrapped.FinishCutterSimulation.__class__.__mro__:
    ...
    def finish_process_simulation(self) -> '_424.CutterProcessSimulation':
        ...
        if _424.CutterProcessSimulation.TYPE not in self.wrapped.FinishProcessSimulation.__class__.__mro__:
    ...
    def design(self) -> '_776.CylindricalGearDesign':
        ...
        if _776.CylindricalGearDesign.TYPE not in self.wrapped.Design.__class__.__mro__:
