...
from mastapy.gears.rating.cylindrical import _255, _256
...
class ConicalGearDutyCycleRating(_160.GearDutyCycleRating):
    ...
    def left_flank_rating(self) -> '_161.GearFlankRating':
        ...
        if _161.GearFlankRating.TYPE not in self.wrapped.LeftFlankRating.__class__.__mro__:
    ...
    def concave_flank_rating(self) -> '_161.GearFlankRating':
        ...
        if _161.GearFlankRating.TYPE not in self.wrapped.ConcaveFlankRating.__class__.__mro__:
    ...
    def right_flank_rating(self) -> '_161.GearFlankRating':
        ...
        if _161.GearFlankRating.TYPE not in self.wrapped.RightFlankRating.__class__.__mro__:
    ...
    def convex_flank_rating(self) -> '_161.GearFlankRating':
        ...
        if _161.GearFlankRating.TYPE not in self.wrapped.ConvexFlankRating.__class__.__mro__:
