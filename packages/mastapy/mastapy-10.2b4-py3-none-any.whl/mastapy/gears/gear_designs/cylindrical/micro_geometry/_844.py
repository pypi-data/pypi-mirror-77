...
class CylindricalGearFlankMicroGeometry(_356.FlankMicroGeometry):
    ...
    def profile_relief(self) -> '_852.CylindricalGearProfileModification':
        ...
        if _852.CylindricalGearProfileModification.TYPE not in self.wrapped.ProfileRelief.__class__.__mro__:
    ...
    def lead_relief(self) -> '_845.CylindricalGearLeadModification':
        ...
        if _845.CylindricalGearLeadModification.TYPE not in self.wrapped.LeadRelief.__class__.__mro__:
