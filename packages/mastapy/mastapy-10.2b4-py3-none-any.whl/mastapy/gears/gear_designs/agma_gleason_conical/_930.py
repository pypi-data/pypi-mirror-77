...
class AGMAGleasonConicalGearDesign(_891.ConicalGearDesign):
    ...
    def accuracy_grades(self) -> '_116.AccuracyGrades':
        ...
        if _116.AccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
    ...
    def bevel_gear_material(self) -> '_379.GearMaterial':
        ...
        if _379.GearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
