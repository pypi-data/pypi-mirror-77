...
from mastapy.math_utility.optimisation import _1109, _1100, _1106
...
class DesignSpaceSearchBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def selected_design_space_search_strategy(self) -> '_1109.ParetoOptimisationStrategy':
        ...
        return constructor.new(_1109.ParetoOptimisationStrategy)(self.wrapped.SelectedDesignSpaceSearchStrategy) if self.wrapped.SelectedDesignSpaceSearchStrategy else None
    ...
    @property
    def input_setters(self) -> 'List[_1100.InputSetter[TAnalysis]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InputSetters, constructor.new(_1100.InputSetter)[TAnalysis])
        return value
    ...
    @property
    def filters(self) -> 'List[_1106.ParetoOptimisationFilter]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Filters, constructor.new(_1106.ParetoOptimisationFilter))
        return value
