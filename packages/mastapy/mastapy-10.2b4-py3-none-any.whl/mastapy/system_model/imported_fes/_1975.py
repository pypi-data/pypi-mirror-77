...
from mastapy.nodal_analysis.component_mode_synthesis import _1508
from mastapy.nodal_analysis.dev_tools_analyses import _1470
from mastapy.system_model.imported_fes import _1981, _1971
...
class ImportedFEWithSelectionStaticAnalysis(_1971.ImportedFEWithSelection):
    '''ImportedFEWithSelectionStaticAnalysis
    ...
    @property
    def full_fe_results(self) -> '_1508.StaticCMSResults':
        ...
        return constructor.new(_1508.StaticCMSResults)(self.wrapped.FullFEResults) if self.wrapped.FullFEResults else None

    @property
    def static_draw_style(self) -> '_1470.FEModelStaticAnalysisDrawStyle':
        ...
        return constructor.new(_1470.FEModelStaticAnalysisDrawStyle)(self.wrapped.StaticDrawStyle) if self.wrapped.StaticDrawStyle else None

    @property
    def boundary_conditions_selected_nodes(self) -> 'List[_1981.NodeBoundaryConditionStaticAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsSelectedNodes, constructor.new(_1981.NodeBoundaryConditionStaticAnalysis))
        return value

    @property
    def boundary_conditions_all_nodes(self) -> 'List[_1981.NodeBoundaryConditionStaticAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsAllNodes, constructor.new(_1981.NodeBoundaryConditionStaticAnalysis))
        return value

    @property
    def force_results(self) -> 'List[_1125.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceResults, constructor.new(_1125.VectorWithLinearAndAngularComponents))
        return value

    @property
    def displacement_results(self) -> 'List[_1125.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DisplacementResults, constructor.new(_1125.VectorWithLinearAndAngularComponents))
        return value
