...
from mastapy.system_model.imported_fes.version_comparer import _2001
...
class ImportedFEResults(_0.APIBase):
    ...
    @property
    def node_results(self) -> 'List[_2001.NodeComparisonResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeResults, constructor.new(_2001.NodeComparisonResult))
        return value
