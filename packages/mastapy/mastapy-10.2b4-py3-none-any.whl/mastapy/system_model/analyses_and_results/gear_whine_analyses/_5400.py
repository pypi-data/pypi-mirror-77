...
class StraightBevelDiffGearMeshGearWhineAnalysis(_5292.BevelGearMeshGearWhineAnalysis):
    '''StraightBevelDiffGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2342.StraightBevelDiffGearMeshSystemDeflection':
