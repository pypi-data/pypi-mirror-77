...
class CylindricalPlanetGearGearWhineAnalysis(_5319.CylindricalGearGearWhineAnalysis):
    '''CylindricalPlanetGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2284.CylindricalPlanetGearSystemDeflection':
