...
from mastapy.system_model.connections_and_sockets import _1858
...
class CVTBeltConnectionGearWhineAnalysis(_5284.BeltConnectionGearWhineAnalysis):
    '''CVTBeltConnectionGearWhineAnalysis
    ...
    @property
    def connection_design(self) -> '_1858.CVTBeltConnection':
    ...
    @property
    def system_deflection_results(self) -> '_2272.CVTBeltConnectionSystemDeflection':
