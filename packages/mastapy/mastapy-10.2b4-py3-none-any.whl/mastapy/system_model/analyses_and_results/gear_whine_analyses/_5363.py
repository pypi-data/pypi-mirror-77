...
class KlingelnbergCycloPalloidHypoidGearMeshGearWhineAnalysis(_5360.KlingelnbergCycloPalloidConicalGearMeshGearWhineAnalysis):
    '''KlingelnbergCycloPalloidHypoidGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2304.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection':
