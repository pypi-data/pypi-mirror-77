...
class AGMAGleasonConicalGearMeshGearWhineAnalysis(_5309.ConicalGearMeshGearWhineAnalysis):
    '''AGMAGleasonConicalGearMeshGearWhineAnalysis
    ...
    @property
    def connection_design(self) -> '_1881.AGMAGleasonConicalGearMesh':
    ...
    @property
    def system_deflection_results(self) -> '_2234.AGMAGleasonConicalGearMeshSystemDeflection':
