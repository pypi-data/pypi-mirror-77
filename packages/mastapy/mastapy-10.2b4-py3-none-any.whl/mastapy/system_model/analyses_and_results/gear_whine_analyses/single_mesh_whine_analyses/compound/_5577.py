...
class ClutchCompoundSingleMeshWhineAnalysis(_5593.CouplingCompoundSingleMeshWhineAnalysis):
    '''ClutchCompoundSingleMeshWhineAnalysis
    ...
    @property
    def component_design(self) -> '_2137.Clutch':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5456.ClutchSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5456.ClutchSingleMeshWhineAnalysis))
        return value

    @property
    def assembly_single_mesh_whine_analysis_load_cases(self) -> 'List[_5456.ClutchSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySingleMeshWhineAnalysisLoadCases, constructor.new(_5456.ClutchSingleMeshWhineAnalysis))
        return value
