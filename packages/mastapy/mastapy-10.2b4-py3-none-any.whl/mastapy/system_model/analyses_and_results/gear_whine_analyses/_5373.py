...
class PartToPartShearCouplingConnectionGearWhineAnalysis(_5313.CouplingConnectionGearWhineAnalysis):
    '''PartToPartShearCouplingConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2318.PartToPartShearCouplingConnectionSystemDeflection':
