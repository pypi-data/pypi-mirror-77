...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5392, _5341
...
class GearWhineAnalysisOptions(_0.APIBase):
    ...
    @property
    def excitation_selection(self) -> '_5428.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5428.ExcitationSourceSelectionGroup)(self.wrapped.ExcitationSelection) if self.wrapped.ExcitationSelection else None

    @property
    def modal_analysis_options(self) -> '_4799.ModalAnalysisOptions':
        ...
        return constructor.new(_4799.ModalAnalysisOptions)(self.wrapped.ModalAnalysisOptions) if self.wrapped.ModalAnalysisOptions else None
