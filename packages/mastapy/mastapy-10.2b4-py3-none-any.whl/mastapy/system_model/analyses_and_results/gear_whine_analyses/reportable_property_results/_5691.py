...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.reportable_property_results import _5687
...
class SingleWhineAnalysisResultsPropertyAccessor(_0.APIBase):
    ...
    @property
    def orders(self) -> 'List[_5687.ResultsForOrder]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Orders, constructor.new(_5687.ResultsForOrder))
        return value
