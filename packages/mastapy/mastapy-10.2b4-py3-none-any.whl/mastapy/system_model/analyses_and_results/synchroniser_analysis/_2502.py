...
from mastapy.system_model.part_model.couplings import _2161, _2163
...
class SynchroniserShift(_0.APIBase):
    ...
    @property
    def cone(self) -> '_2161.SynchroniserHalf':
        ...
        return constructor.new(_2161.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone else None

    @property
    def sleeve(self) -> '_2163.SynchroniserSleeve':
        ...
        return constructor.new(_2163.SynchroniserSleeve)(self.wrapped.Sleeve) if self.wrapped.Sleeve else None
