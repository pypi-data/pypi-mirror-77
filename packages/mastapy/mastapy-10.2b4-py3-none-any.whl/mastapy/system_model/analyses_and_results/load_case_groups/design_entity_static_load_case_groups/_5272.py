...
TConnection = TypeVar('TConnection', bound='_1857.Connection')
TConnectionStaticLoad = TypeVar('TConnectionStaticLoad', bound='_6110.ConnectionLoadCase')


class ConnectionStaticLoadCaseGroup(_5273.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]):
    '''ConnectionStaticLoadCaseGroup
