...
from mastapy.system_model.analyses_and_results.load_case_groups import (
    _5269, _5268, _5256, _5267,
    _5257
)
from mastapy.system_model.analyses_and_results.static_loads import (
    _6211, _6081, _6193, _6192,
    _6118, _6120, _6122, _6163
)
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5271, _5274, _5275
from mastapy.system_model.part_model import (
    _2007, _2037, _2036, _2023
)
from mastapy.system_model.part_model.gears import _2089, _2088
...
class AbstractStaticLoadCaseGroup(_5257.AbstractLoadCaseGroup):
    '''AbstractStaticLoadCaseGroup
    ...
    @property
    def optimum_tooth_numbers_target(self) -> '_5269.SystemOptimiserTargets':
        ...
        return constructor.new(_5269.SystemOptimiserTargets)(value) if value else None

    @optimum_tooth_numbers_target.setter
    def optimum_tooth_numbers_target(self, value: '_5269.SystemOptimiserTargets'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.OptimumToothNumbersTarget = value

    @property
    def gear_set_optimisation(self) -> '_5268.SystemOptimiserGearSetOptimisation':
        ...
        return constructor.new(_5268.SystemOptimiserGearSetOptimisation)(value) if value else None

    @gear_set_optimisation.setter
    def gear_set_optimisation(self, value: '_5268.SystemOptimiserGearSetOptimisation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def static_loads_limited_by_max_number_of_load_cases_to_display(self) -> 'List[_6211.StaticLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StaticLoadsLimitedByMaxNumberOfLoadCasesToDisplay, constructor.new(_6211.StaticLoadCase))
        return value

    @property
    def bearings(self) -> 'List[_5271.ComponentStaticLoadCaseGroup[_2007.Bearing, _6081.BearingLoadCase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Bearings, constructor.new(_5271.ComponentStaticLoadCaseGroup)[_2007.Bearing, _6081.BearingLoadCase])
        return value

    @property
    def power_loads(self) -> 'List[_5271.ComponentStaticLoadCaseGroup[_2037.PowerLoad, _6193.PowerLoadLoadCase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PowerLoads, constructor.new(_5271.ComponentStaticLoadCaseGroup)[_2037.PowerLoad, _6193.PowerLoadLoadCase])
        return value

    @property
    def point_loads(self) -> 'List[_5271.ComponentStaticLoadCaseGroup[_2036.PointLoad, _6192.PointLoadLoadCase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PointLoads, constructor.new(_5271.ComponentStaticLoadCaseGroup)[_2036.PointLoad, _6192.PointLoadLoadCase])
        return value

    @property
    def cylindrical_gear_sets(self) -> 'List[_5274.GearSetStaticLoadCaseGroup[_2089.CylindricalGearSet, _2088.CylindricalGear, _6118.CylindricalGearLoadCase, _1891.CylindricalGearMesh, _6120.CylindricalGearMeshLoadCase, _6122.CylindricalGearSetLoadCase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearSets, constructor.new(_5274.GearSetStaticLoadCaseGroup)[_2089.CylindricalGearSet, _2088.CylindricalGear, _6118.CylindricalGearLoadCase, _1891.CylindricalGearMesh, _6120.CylindricalGearMeshLoadCase, _6122.CylindricalGearSetLoadCase])
        return value

    @property
    def parts_with_excitations(self) -> 'List[_5275.PartStaticLoadCaseGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PartsWithExcitations, constructor.new(_5275.PartStaticLoadCaseGroup))
        return value

    @property
    def fe_components(self) -> 'List[_5271.ComponentStaticLoadCaseGroup[_2023.ImportedFEComponent, _6163.ImportedFEComponentLoadCase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEComponents, constructor.new(_5271.ComponentStaticLoadCaseGroup)[_2023.ImportedFEComponent, _6163.ImportedFEComponentLoadCase])
        return value

    @property
    def design_states(self) -> 'List[_5256.AbstractDesignStateLoadCaseGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStates, constructor.new(_5256.AbstractDesignStateLoadCaseGroup))
        return value
    ...
    @property
    def system_optimisation_gear_sets(self) -> 'List[_5267.SystemOptimisationGearSet]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SystemOptimisationGearSets, constructor.new(_5267.SystemOptimisationGearSet))
        return value
