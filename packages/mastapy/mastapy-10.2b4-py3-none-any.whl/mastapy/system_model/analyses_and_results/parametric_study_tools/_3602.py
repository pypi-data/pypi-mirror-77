...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3601, _3600, _3503
...
class StraightBevelDiffGearSetParametricStudyTool(_3503.BevelGearSetParametricStudyTool):
    ...
    @property
    def straight_bevel_diff_gears_parametric_study_tool(self) -> 'List[_3601.StraightBevelDiffGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsParametricStudyTool, constructor.new(_3601.StraightBevelDiffGearParametricStudyTool))
        return value

    @property
    def straight_bevel_diff_meshes_parametric_study_tool(self) -> 'List[_3600.StraightBevelDiffGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesParametricStudyTool, constructor.new(_3600.StraightBevelDiffGearMeshParametricStudyTool))
        return value
