...
class BevelDifferentialGearAdvancedSystemDeflection(_6276.BevelGearAdvancedSystemDeflection):
    '''BevelDifferentialGearAdvancedSystemDeflection
    ...
    def component_detailed_analysis(self) -> '_341.BevelGearRating':
        ...
        if _341.BevelGearRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
