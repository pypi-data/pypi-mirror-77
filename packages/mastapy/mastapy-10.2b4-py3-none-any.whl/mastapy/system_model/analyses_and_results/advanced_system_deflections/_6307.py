...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6304, _6308
...
class CylindricalMeshedGearAdvancedSystemDeflection(_0.APIBase):
    ...
    def cylindrical_gear_advanced_system_deflection(self) -> '_6304.CylindricalGearAdvancedSystemDeflection':
        ...
        if _6304.CylindricalGearAdvancedSystemDeflection.TYPE not in self.wrapped.CylindricalGearAdvancedSystemDeflection.__class__.__mro__:
    ...
    def other_cylindrical_gear_advanced_system_deflection(self) -> '_6304.CylindricalGearAdvancedSystemDeflection':
        ...
        if _6304.CylindricalGearAdvancedSystemDeflection.TYPE not in self.wrapped.OtherCylindricalGearAdvancedSystemDeflection.__class__.__mro__:
