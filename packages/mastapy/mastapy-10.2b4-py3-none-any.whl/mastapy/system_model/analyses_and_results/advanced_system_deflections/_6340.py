...
class PartToPartShearCouplingConnectionAdvancedSystemDeflection(_6299.CouplingConnectionAdvancedSystemDeflection):
    '''PartToPartShearCouplingConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6183.PartToPartShearCouplingConnectionLoadCase':
        ...
        return constructor.new(_6183.PartToPartShearCouplingConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2318.PartToPartShearCouplingConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2318.PartToPartShearCouplingConnectionSystemDeflection))
        return value
