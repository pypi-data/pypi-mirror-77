...
class AssemblyCompoundSystemDeflection(_2380.AbstractAssemblyCompoundSystemDeflection):
    '''AssemblyCompoundSystemDeflection
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2237.AssemblySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2237.AssemblySystemDeflection))
        return value

    @property
    def assembly_system_deflection_load_cases(self) -> 'List[_2237.AssemblySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionLoadCases, constructor.new(_2237.AssemblySystemDeflection))
        return value

    @property
    def bearings(self) -> 'List[_2386.BearingCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Bearings, constructor.new(_2386.BearingCompoundSystemDeflection))
        return value

    @property
    def belt_drives(self) -> 'List[_2388.BeltDriveCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BeltDrives, constructor.new(_2388.BeltDriveCompoundSystemDeflection))
        return value

    @property
    def bevel_differential_gear_sets(self) -> 'List[_2391.BevelDifferentialGearSetCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearSets, constructor.new(_2391.BevelDifferentialGearSetCompoundSystemDeflection))
        return value

    @property
    def bolts(self) -> 'List[_2397.BoltCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Bolts, constructor.new(_2397.BoltCompoundSystemDeflection))
        return value

    @property
    def bolted_joints(self) -> 'List[_2398.BoltedJointCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoltedJoints, constructor.new(_2398.BoltedJointCompoundSystemDeflection))
        return value

    @property
    def clutches(self) -> 'List[_2399.ClutchCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Clutches, constructor.new(_2399.ClutchCompoundSystemDeflection))
        return value

    @property
    def concept_couplings(self) -> 'List[_2404.ConceptCouplingCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptCouplings, constructor.new(_2404.ConceptCouplingCompoundSystemDeflection))
        return value

    @property
    def concept_gear_sets(self) -> 'List[_2409.ConceptGearSetCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearSets, constructor.new(_2409.ConceptGearSetCompoundSystemDeflection))
        return value

    @property
    def cv_ts(self) -> 'List[_2419.CVTCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CVTs, constructor.new(_2419.CVTCompoundSystemDeflection))
        return value

    @property
    def cylindrical_gear_sets(self) -> 'List[_2423.CylindricalGearSetCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearSets, constructor.new(_2423.CylindricalGearSetCompoundSystemDeflection))
        return value
    ...
    @property
    def rolling_bearings(self) -> 'List[_2386.BearingCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RollingBearings, constructor.new(_2386.BearingCompoundSystemDeflection))
        return value
