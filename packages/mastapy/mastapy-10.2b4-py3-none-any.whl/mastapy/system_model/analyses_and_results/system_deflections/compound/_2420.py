...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2462
...
class CVTPulleyCompoundSystemDeflection(_2462.PulleyCompoundSystemDeflection):
    '''CVTPulleyCompoundSystemDeflection
