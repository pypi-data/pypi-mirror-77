...
from mastapy.system_model.analyses_and_results.system_deflections import _2354, _2361
...
class ConnectionSystemDeflection(_6514.ConnectionFEAnalysis):
    ...
    def system_deflection(self) -> '_2354.SystemDeflection':
        ...
        if _2354.SystemDeflection.TYPE not in self.wrapped.SystemDeflection.__class__.__mro__:
    ...
    def power_loss(self) -> '_106.PowerLoss':
        ...
        if _106.PowerLoss.TYPE not in self.wrapped.PowerLoss.__class__.__mro__:
    ...
    def power_flow_results(self) -> '_3274.ConnectionPowerFlow':
        ...
        if _3274.ConnectionPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
