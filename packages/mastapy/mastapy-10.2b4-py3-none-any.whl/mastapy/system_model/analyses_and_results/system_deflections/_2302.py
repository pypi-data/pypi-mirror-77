...
from mastapy.system_model.analyses_and_results.power_flows import _3304, _3307, _3310
...
class KlingelnbergCycloPalloidConicalGearSetSystemDeflection(_2265.ConicalGearSetSystemDeflection):
    '''KlingelnbergCycloPalloidConicalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3304.KlingelnbergCycloPalloidConicalGearSetPowerFlow':
