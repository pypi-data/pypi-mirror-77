...
from mastapy.math_utility.measured_vectors import _1122, _1121
...
class ComponentSystemDeflection(_2317.PartSystemDeflection):
    '''ComponentSystemDeflection
    ...
    def resistive_torque(self) -> '_107.ResistiveTorque':
        ...
        if _107.ResistiveTorque.TYPE not in self.wrapped.ResistiveTorque.__class__.__mro__:
    ...
    @property
    def rigidly_connected_components(self) -> '_2377.RigidlyConnectedComponentGroupSystemDeflection':
        ...
        return constructor.new(_2377.RigidlyConnectedComponentGroupSystemDeflection)(self.wrapped.RigidlyConnectedComponents) if self.wrapped.RigidlyConnectedComponents else None

    @property
    def mass_properties_in_local_coordinate_system_from_node_model(self) -> '_1084.MassProperties':
        ...
        return constructor.new(_1084.MassProperties)(self.wrapped.MassPropertiesInLocalCoordinateSystemFromNodeModel) if self.wrapped.MassPropertiesInLocalCoordinateSystemFromNodeModel else None

    @property
    def node_results(self) -> 'List[_1122.NodeResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeResults, constructor.new(_1122.NodeResults))
        return value

    @property
    def connected_components_forces_in_lcs(self) -> 'List[_1121.ForceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectedComponentsForcesInLCS, constructor.new(_1121.ForceResults))
        return value

    @property
    def connected_components_forces_in_wcs(self) -> 'List[_1121.ForceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectedComponentsForcesInWCS, constructor.new(_1121.ForceResults))
        return value
