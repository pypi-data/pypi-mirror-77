...
from mastapy.gears.ltca.cylindrical import _634, _636
...
class CylindricalGearSetSystemDeflectionWithLTCAResults(_2278.CylindricalGearSetSystemDeflection):
    ...
    def basic_ltca_results(self) -> '_634.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _634.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.BasicLTCAResults.__class__.__mro__:
    ...
    def basic_ltca_results_only_first_planetary_mesh(self) -> '_634.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _634.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.BasicLTCAResultsOnlyFirstPlanetaryMesh.__class__.__mro__:
    ...
    def advanced_ltca_results(self) -> '_634.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _634.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.AdvancedLTCAResults.__class__.__mro__:
    ...
    def advanced_ltca_results_only_first_planetary_mesh(self) -> '_634.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _634.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.AdvancedLTCAResultsOnlyFirstPlanetaryMesh.__class__.__mro__:
