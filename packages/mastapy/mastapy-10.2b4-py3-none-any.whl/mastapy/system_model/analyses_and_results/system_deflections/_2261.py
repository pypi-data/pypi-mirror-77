...
from mastapy.system_model.analyses_and_results.system_deflections import _2262, _2260, _2293
...
class ConceptGearSetSystemDeflection(_2293.GearSetSystemDeflection):
    '''ConceptGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3270.ConceptGearSetPowerFlow':
    ...
    @property
    def concept_gears_system_deflection(self) -> 'List[_2262.ConceptGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsSystemDeflection, constructor.new(_2262.ConceptGearSystemDeflection))
        return value

    @property
    def concept_meshes_system_deflection(self) -> 'List[_2260.ConceptGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesSystemDeflection, constructor.new(_2260.ConceptGearMeshSystemDeflection))
        return value
