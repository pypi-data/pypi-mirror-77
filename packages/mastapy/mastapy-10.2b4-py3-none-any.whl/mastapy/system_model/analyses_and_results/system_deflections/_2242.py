...
from mastapy.system_model.analyses_and_results.system_deflections import _2243, _2241, _2247
...
class BevelDifferentialGearSetSystemDeflection(_2247.BevelGearSetSystemDeflection):
    '''BevelDifferentialGearSetSystemDeflection
    ...
    def component_detailed_analysis(self) -> '_342.BevelGearSetRating':
        ...
        if _342.BevelGearSetRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def bevel_differential_gears_system_deflection(self) -> 'List[_2243.BevelDifferentialGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsSystemDeflection, constructor.new(_2243.BevelDifferentialGearSystemDeflection))
        return value

    @property
    def bevel_differential_meshes_system_deflection(self) -> 'List[_2241.BevelDifferentialGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesSystemDeflection, constructor.new(_2241.BevelDifferentialGearMeshSystemDeflection))
        return value
