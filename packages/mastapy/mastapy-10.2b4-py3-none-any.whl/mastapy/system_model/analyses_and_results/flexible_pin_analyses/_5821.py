...
from mastapy.system_model.analyses_and_results.flexible_pin_analyses import _5813
...
class WindTurbineCertificationReport(_5813.CombinationAnalysis):
    '''WindTurbineCertificationReport
    ...
    @property
    def design(self) -> '_2039.RootAssembly':
        ...
        return constructor.new(_2039.RootAssembly)(self.wrapped.Design) if self.wrapped.Design else None
    ...
    @property
    def nominal_load_case_static_analysis(self) -> '_2329.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2329.RootAssemblySystemDeflection)(self.wrapped.NominalLoadCaseStaticAnalysis) if self.wrapped.NominalLoadCaseStaticAnalysis else None

    @property
    def extreme_load_case_static_analysis(self) -> '_2329.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2329.RootAssemblySystemDeflection)(self.wrapped.ExtremeLoadCaseStaticAnalysis) if self.wrapped.ExtremeLoadCaseStaticAnalysis else None
