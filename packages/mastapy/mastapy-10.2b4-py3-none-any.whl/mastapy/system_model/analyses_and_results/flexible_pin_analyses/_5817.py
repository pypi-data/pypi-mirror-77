...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2423, _2458, _2386
...
class FlexiblePinAnalysisGearAndBearingRating(_5814.FlexiblePinAnalysis):
    ...
    def gear_set_analysis(self) -> '_2423.CylindricalGearSetCompoundSystemDeflection':
        ...
        if _2423.CylindricalGearSetCompoundSystemDeflection.TYPE not in self.wrapped.GearSetAnalysis.__class__.__mro__:
