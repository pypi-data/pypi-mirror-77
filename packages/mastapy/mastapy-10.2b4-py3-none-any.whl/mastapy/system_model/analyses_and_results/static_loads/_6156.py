...
from mastapy.system_model.analyses_and_results.static_loads import _6159, _6155, _6136
...
class HarmonicLoadDataImportFromMotorPackages(_6155.HarmonicLoadDataImportBase['T'], Generic[T]):
    '''HarmonicLoadDataImportFromMotorPackages
