...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import (
    _6245, _6256, _6247, _6244,
    _6248, _6250, _6257, _6254,
    _6246, _6249, _6243
)
...
class TimeSeriesImporter(_0.APIBase):
    ...
    @property
    def import_type(self) -> '_6164.ImportType':
        '''ImportType: 'ImportType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ImportType)
        return constructor.new(_6164.ImportType)(value) if value else None

    @import_type.setter
    def import_type(self, value: '_6164.ImportType'):
    ...
    @property
    def time_step_input(self) -> '_6256.TimeStepInputOptions':
        ...
        return constructor.new(_6256.TimeStepInputOptions)(self.wrapped.TimeStepInput) if self.wrapped.TimeStepInput else None

    @property
    def gear_ratio_options(self) -> '_6247.GearRatioInputOptions':
        ...
        return constructor.new(_6247.GearRatioInputOptions)(self.wrapped.GearRatioOptions) if self.wrapped.GearRatioOptions else None

    @property
    def design_state_options(self) -> '_6244.DesignStateOptions':
        ...
        return constructor.new(_6244.DesignStateOptions)(self.wrapped.DesignStateOptions) if self.wrapped.DesignStateOptions else None

    @property
    def load_case_name_inputs(self) -> '_6248.LoadCaseNameOptions':
        ...
        return constructor.new(_6248.LoadCaseNameOptions)(self.wrapped.LoadCaseNameInputs) if self.wrapped.LoadCaseNameInputs else None

    @property
    def file_inputs(self) -> 'List[_6250.MultiTimeSeriesDataInputFileOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FileInputs, constructor.new(_6250.MultiTimeSeriesDataInputFileOptions))
        return value

    @property
    def torque_inputs(self) -> 'List[_6257.TorqueInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TorqueInputs, constructor.new(_6257.TorqueInputOptions))
        return value

    @property
    def speed_inputs(self) -> 'List[_6254.SpeedInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpeedInputs, constructor.new(_6254.SpeedInputOptions))
        return value

    @property
    def force_inputs(self) -> 'List[_6246.ForceInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceInputs, constructor.new(_6246.ForceInputOptions))
        return value

    @property
    def moment_inputs(self) -> 'List[_6249.MomentInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MomentInputs, constructor.new(_6249.MomentInputOptions))
        return value

    @property
    def boost_pressure_inputs(self) -> 'List[_6243.BoostPressureLoadCaseInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoostPressureInputs, constructor.new(_6243.BoostPressureLoadCaseInputOptions))
        return value

    @property
    def columns(self) -> 'List[_1340.ColumnTitle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Columns, constructor.new(_1340.ColumnTitle))
        return value
