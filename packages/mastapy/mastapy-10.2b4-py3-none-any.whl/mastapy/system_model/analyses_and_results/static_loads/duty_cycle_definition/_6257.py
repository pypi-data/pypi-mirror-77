...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6258, _6252
...
class TorqueInputOptions(_6252.PowerLoadInputOptions):
    '''TorqueInputOptions
    ...
    @property
    def conversion_to_load_case(self) -> '_6258.TorqueValuesObtainedFrom':
        ...
        return constructor.new(_6258.TorqueValuesObtainedFrom)(value) if value else None

    @conversion_to_load_case.setter
    def conversion_to_load_case(self, value: '_6258.TorqueValuesObtainedFrom'):
