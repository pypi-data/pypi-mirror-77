...
from mastapy.system_model.analyses_and_results.static_loads import _6130, _6136
...
T = TypeVar('T', bound='_6136.ElectricMachineHarmonicLoadImportOptionsBase')


class ElectricMachineHarmonicLoadDataFromMotorPackages(_6130.ElectricMachineHarmonicLoadData, Generic[T]):
    '''ElectricMachineHarmonicLoadDataFromMotorPackages
