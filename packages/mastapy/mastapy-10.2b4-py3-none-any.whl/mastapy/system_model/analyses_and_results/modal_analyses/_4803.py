...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4868, _4865, _4867
...
class PartModalAnalysis(_6522.PartStaticLoadAnalysisCase):
    '''PartModalAnalysis
    ...
    @property
    def results_for_modes(self) -> 'List[_4868.SingleModeResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsForModes, constructor.new(_4868.SingleModeResults))
        return value

    @property
    def shaft_excitation_details(self) -> 'List[_4865.RigidlyConnectedDesignEntityGroupModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftExcitationDetails, constructor.new(_4865.RigidlyConnectedDesignEntityGroupModalAnalysis))
        return value

    @property
    def gear_mesh_excitation_details(self) -> 'List[_4865.RigidlyConnectedDesignEntityGroupModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshExcitationDetails, constructor.new(_4865.RigidlyConnectedDesignEntityGroupModalAnalysis))
        return value
    ...
    def system_deflection_results(self) -> '_2317.PartSystemDeflection':
        ...
        if _2317.PartSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
