...
class ConnectionModalAnalysis(_6515.ConnectionStaticLoadAnalysisCase):
    ...
    def modal_analysis(self) -> '_4796.ModalAnalysis':
        ...
        if _4796.ModalAnalysis.TYPE not in self.wrapped.ModalAnalysis.__class__.__mro__:
    ...
    def system_deflection_results(self) -> '_2267.ConnectionSystemDeflection':
        ...
        if _2267.ConnectionSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
