...
from mastapy.utility.modal_analysis import _1321
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2206.DesignEntityGroupAnalysis):
    '''RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    @property
    def excitation_frequencies_at_reference_speed(self) -> 'List[_1321.DesignEntityExcitationDescription]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitationFrequenciesAtReferenceSpeed, constructor.new(_1321.DesignEntityExcitationDescription))
        return value
