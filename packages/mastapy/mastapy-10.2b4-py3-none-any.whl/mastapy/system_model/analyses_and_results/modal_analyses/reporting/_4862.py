...
class PerModeResultsReport(_1285.CustomReportChart):
    '''PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_1343.TableAndChartOptions':
    ...
    def display_option(self, value: '_1343.TableAndChartOptions'):
