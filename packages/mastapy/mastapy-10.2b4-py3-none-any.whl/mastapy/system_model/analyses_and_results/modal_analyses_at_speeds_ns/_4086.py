...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4085, _4084, _4006
...
class SpiralBevelGearSetModalAnalysesAtSpeeds(_4006.BevelGearSetModalAnalysesAtSpeeds):
    '''SpiralBevelGearSetModalAnalysesAtSpeeds
    ...
    @property
    def spiral_bevel_gears_modal_analyses_at_speeds(self) -> 'List[_4085.SpiralBevelGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsModalAnalysesAtSpeeds, constructor.new(_4085.SpiralBevelGearModalAnalysesAtSpeeds))
        return value

    @property
    def spiral_bevel_meshes_modal_analyses_at_speeds(self) -> 'List[_4084.SpiralBevelGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesModalAnalysesAtSpeeds, constructor.new(_4084.SpiralBevelGearMeshModalAnalysesAtSpeeds))
        return value
