...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4110, _4109, _4044
...
class WormGearSetModalAnalysesAtSpeeds(_4044.GearSetModalAnalysesAtSpeeds):
    '''WormGearSetModalAnalysesAtSpeeds
    ...
    @property
    def worm_gears_modal_analyses_at_speeds(self) -> 'List[_4110.WormGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsModalAnalysesAtSpeeds, constructor.new(_4110.WormGearModalAnalysesAtSpeeds))
        return value

    @property
    def worm_meshes_modal_analyses_at_speeds(self) -> 'List[_4109.WormGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesModalAnalysesAtSpeeds, constructor.new(_4109.WormGearMeshModalAnalysesAtSpeeds))
        return value
