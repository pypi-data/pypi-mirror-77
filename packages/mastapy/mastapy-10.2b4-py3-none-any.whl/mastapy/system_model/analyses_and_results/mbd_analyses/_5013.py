...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5011, _5030
...
class ClutchMultiBodyDynamicsAnalysis(_5030.CouplingMultiBodyDynamicsAnalysis):
    '''ClutchMultiBodyDynamicsAnalysis
    ...
    @property
    def clutch_connection(self) -> '_5011.ClutchConnectionMultiBodyDynamicsAnalysis':
        ...
        return constructor.new(_5011.ClutchConnectionMultiBodyDynamicsAnalysis)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
