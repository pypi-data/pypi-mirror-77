...
from mastapy.system_model.analyses_and_results.analysis_cases import _6520
...
class PartCompoundSteadyStateSynchronousResponseAtASpeed(_6520.PartCompoundAnalysis):
    '''PartCompoundSteadyStateSynchronousResponseAtASpeed
