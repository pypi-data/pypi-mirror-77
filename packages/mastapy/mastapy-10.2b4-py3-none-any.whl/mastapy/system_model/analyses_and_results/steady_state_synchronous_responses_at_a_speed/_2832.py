...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _2843, _2751
...
class RootAssemblySteadyStateSynchronousResponseAtASpeed(_2751.AssemblySteadyStateSynchronousResponseAtASpeed):
    '''RootAssemblySteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def steady_state_synchronous_response_at_a_speed_inputs(self) -> '_2843.SteadyStateSynchronousResponseAtASpeed':
        ...
        return constructor.new(_2843.SteadyStateSynchronousResponseAtASpeed)(self.wrapped.SteadyStateSynchronousResponseAtASpeedInputs) if self.wrapped.SteadyStateSynchronousResponseAtASpeedInputs else None
