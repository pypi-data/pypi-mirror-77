...
from mastapy.system_model.optimization import _1841
...
class OptimizationStep(_0.APIBase):
    ...
    @property
    def optimisation_target(self) -> '_1841.MicroGeometryOptimisationTarget':
        ...
        return constructor.new(_1841.MicroGeometryOptimisationTarget)(value) if value else None

    @optimisation_target.setter
    def optimisation_target(self, value: '_1841.MicroGeometryOptimisationTarget'):
