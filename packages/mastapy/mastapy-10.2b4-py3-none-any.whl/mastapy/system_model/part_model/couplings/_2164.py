...
from mastapy.system_model.part_model.couplings import _2165, _2167, _2142
...
class TorqueConverter(_2142.Coupling):
    '''TorqueConverter
    ...
    @property
    def pump(self) -> '_2165.TorqueConverterPump':
        ...
        return constructor.new(_2165.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump else None

    @property
    def turbine(self) -> '_2167.TorqueConverterTurbine':
        ...
        return constructor.new(_2167.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine else None
