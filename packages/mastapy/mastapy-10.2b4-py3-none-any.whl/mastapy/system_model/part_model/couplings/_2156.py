...
class ShaftHubConnection(_2014.Connector):
    ...
    def spline_joint_design(self) -> '_1002.SplineJointDesign':
        ...
        if _1002.SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    def interference_fit_design(self) -> '_1032.InterferenceFitDesign':
        ...
        if _1032.InterferenceFitDesign.TYPE not in self.wrapped.InterferenceFitDesign.__class__.__mro__:
