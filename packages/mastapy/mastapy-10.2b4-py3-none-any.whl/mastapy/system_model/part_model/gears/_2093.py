...
class Gear(_2029.MountableComponent):
    '''Gear
    ...
    def active_gear_design(self) -> '_713.GearDesign':
        ...
        if _713.GearDesign.TYPE not in self.wrapped.ActiveGearDesign.__class__.__mro__:
    ...
    def shaft(self) -> '_2046.Shaft':
        ...
        return constructor.new(_2046.Shaft)(self.wrapped.Shaft) if self.wrapped.Shaft else None
