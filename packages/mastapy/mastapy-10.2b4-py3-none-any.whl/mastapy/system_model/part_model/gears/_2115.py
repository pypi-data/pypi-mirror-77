...
from mastapy.system_model.part_model.gears import _2114, _2095
...
class WormGearSet(_2095.GearSet):
    '''WormGearSet
    ...
    @property
    def worm_gears(self) -> 'List[_2114.WormGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGears, constructor.new(_2114.WormGear))
        return value

    @property
    def worm_meshes(self) -> 'List[_1911.WormGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshes, constructor.new(_1911.WormGearMesh))
        return value
