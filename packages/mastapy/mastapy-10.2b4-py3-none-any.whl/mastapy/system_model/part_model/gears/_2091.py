...
class FaceGear(_2093.Gear):
    ...
    @property
    def orientation(self) -> '_2094.GearOrientations':
        ...
        return constructor.new(_2094.GearOrientations)(value) if value else None

    @orientation.setter
    def orientation(self, value: '_2094.GearOrientations'):
    ...
    def face_gear_design(self) -> '_755.FaceGearDesign':
        ...
        if _755.FaceGearDesign.TYPE not in self.wrapped.FaceGearDesign.__class__.__mro__:
