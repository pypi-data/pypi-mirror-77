...
class ConnectedSockets(_0.APIBase):
    ...
    def socket_a(self) -> '_1878.Socket':
        ...
        if _1878.Socket.TYPE not in self.wrapped.SocketA.__class__.__mro__:
    ...
    def socket_b(self) -> '_1878.Socket':
        ...
        if _1878.Socket.TYPE not in self.wrapped.SocketB.__class__.__mro__:
    ...
    def connection(self) -> '_1857.Connection':
        ...
        if _1857.Connection.TYPE not in self.wrapped.Connection.__class__.__mro__:
