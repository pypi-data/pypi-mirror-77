...
from mastapy.system_model.part_model import _2045, _2043
...
class PowerLoad(_2043.VirtualComponent):
    '''PowerLoad
    ...
    @property
    def single_blade_details(self) -> '_2045.WindTurbineSingleBladeDetails':
        ...
        return constructor.new(_2045.WindTurbineSingleBladeDetails)(self.wrapped.SingleBladeDetails) if self.wrapped.SingleBladeDetails else None

    @property
    def electric_machine_detail(self) -> '_6128.ElectricMachineDetail':
        ...
        return constructor.new(_6128.ElectricMachineDetail)(self.wrapped.ElectricMachineDetail) if self.wrapped.ElectricMachineDetail else None
