...
from mastapy.utility.units_and_measurements.measurements import _1166
...
class DutyCyclePropertySummarySmallAngle(_1355.DutyCyclePropertySummary['_1166.AngleSmall', 'T'], Generic[T]):
    '''DutyCyclePropertySummarySmallAngle
