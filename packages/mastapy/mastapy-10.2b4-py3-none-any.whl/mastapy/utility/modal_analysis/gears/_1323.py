...
from mastapy.utility.modal_analysis.gears import _1324, _1327, _1329
...
class GearOrderForTE(_1329.OrderWithRadius):
    '''GearOrderForTE
    ...
    @property
    def position(self) -> '_1324.GearPositions':
        ...
        return constructor.new(_1324.GearPositions)(value) if value else None

    @property
    def additional_orders_and_harmonics(self) -> 'List[_1327.OrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AdditionalOrdersAndHarmonics, constructor.new(_1327.OrderForTE))
        return value
