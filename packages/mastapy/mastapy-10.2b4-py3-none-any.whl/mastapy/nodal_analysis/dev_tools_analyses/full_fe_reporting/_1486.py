...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _968
...
class ElementPropertiesBeam(_1493.ElementPropertiesWithMaterial):
    '''ElementPropertiesBeam
    ...
    @property
    def section_type(self) -> '_968.BeamSectionType':
        ...
        return constructor.new(_968.BeamSectionType)(value) if value else None
