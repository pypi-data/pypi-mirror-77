...
from mastapy.bolts import _1058, _1039
...
class BoltMaterial(_1039.BoltedJointMaterial):
    '''BoltMaterial
    ...
    @property
    def strength_grade(self) -> '_1058.StrengthGrades':
        ...
        return constructor.new(_1058.StrengthGrades)(value) if value else None

    @strength_grade.setter
    def strength_grade(self, value: '_1058.StrengthGrades'):
