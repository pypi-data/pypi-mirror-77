...
class DetailedBoltDesign(_0.APIBase):
    ...
    def material_of_nut(self) -> '_1039.BoltedJointMaterial':
        ...
        if _1039.BoltedJointMaterial.TYPE not in self.wrapped.MaterialOfNut.__class__.__mro__:
    ...
    def material_of_tapped_thread(self) -> '_1039.BoltedJointMaterial':
        ...
        if _1039.BoltedJointMaterial.TYPE not in self.wrapped.MaterialOfTappedThread.__class__.__mro__:
