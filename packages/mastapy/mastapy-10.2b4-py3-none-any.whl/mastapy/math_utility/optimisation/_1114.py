...
from mastapy.math_utility.optimisation import _1115, _1113
...
class ParetoOptimistaionVariable(_1113.ParetoOptimisationVariableBase):
    '''ParetoOptimistaionVariable
    ...
    @property
    def property_target_for_dominant_candidate_search(self) -> '_1115.PropertyTargetForDominantCandidateSearch':
        ...
        return constructor.new(_1115.PropertyTargetForDominantCandidateSearch)(value) if value else None

    @property_target_for_dominant_candidate_search.setter
    def property_target_for_dominant_candidate_search(self, value: '_1115.PropertyTargetForDominantCandidateSearch'):
