...
from mastapy.bearings.bearing_results.rolling import _1611
...
class LoadedAngularContactThrustBallBearingElement(_1611.LoadedAngularContactBallBearingElement):
    '''LoadedAngularContactThrustBallBearingElement
