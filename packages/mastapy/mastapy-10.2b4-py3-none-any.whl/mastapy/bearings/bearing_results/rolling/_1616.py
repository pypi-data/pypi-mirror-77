...
from mastapy.bearings.bearing_results.rolling import _1615, _1613
...
class LoadedAngularContactThrustBallBearingRow(_1613.LoadedAngularContactBallBearingRow):
    '''LoadedAngularContactThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1615.LoadedAngularContactThrustBallBearingResults':
