...
from mastapy.bearings.bearing_results.rolling import _1650, _1639
...
class LoadedNeedleRollerBearingRow(_1639.LoadedCylindricalRollerBearingRow):
    '''LoadedNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1650.LoadedNeedleRollerBearingResults':
