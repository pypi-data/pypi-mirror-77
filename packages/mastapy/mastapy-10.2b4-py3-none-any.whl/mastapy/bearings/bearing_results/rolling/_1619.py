...
from mastapy.bearings.bearing_results.rolling import _1618, _1659
...
class LoadedAsymmetricSphericalRollerBearingRow(_1659.LoadedRollerBearingRow):
    '''LoadedAsymmetricSphericalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1618.LoadedAsymmetricSphericalRollerBearingResults':
