...
class ISO14179SettingsPerBearingType(_1140.IndependentReportablePropertiesBase['ISO14179SettingsPerBearingType']):
    '''ISO14179SettingsPerBearingType
    ...
    @property
    def rolling_bearing_type(self) -> '_1540.RollingBearingType':
        ...
        return constructor.new(_1540.RollingBearingType)(value) if value else None
