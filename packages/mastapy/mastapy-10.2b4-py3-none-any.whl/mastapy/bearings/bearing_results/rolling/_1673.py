...
from mastapy.bearings.bearing_results.rolling import _1672, _1659
...
class LoadedSphericalRollerThrustBearingRow(_1659.LoadedRollerBearingRow):
    '''LoadedSphericalRollerThrustBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1672.LoadedSphericalRollerThrustBearingResults':
