...
class LoadedNonBarrelRollerBearingRow(_1659.LoadedRollerBearingRow):
    '''LoadedNonBarrelRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1653.LoadedNonBarrelRollerBearingResults':
