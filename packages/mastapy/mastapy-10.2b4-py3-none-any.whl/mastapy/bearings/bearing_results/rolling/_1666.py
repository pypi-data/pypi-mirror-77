...
from mastapy.bearings.bearing_results.rolling import _1665, _1632
...
class LoadedSelfAligningBallBearingRow(_1632.LoadedBallBearingRow):
    '''LoadedSelfAligningBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1665.LoadedSelfAligningBallBearingResults':
