...
from mastapy.utility.property import (
    _1359, _1358, _1356, _1357
)
from mastapy.bearings.bearing_results.rolling import _1662, _1691
from mastapy.bearings import _1521
from mastapy.bearings.bearing_results import _1592
...
class LoadedRollingBearingDutyCycle(_1592.LoadedNonLinearBearingDutyCycleResults):
    '''LoadedRollingBearingDutyCycle
    ...
    @property
    def maximum_element_normal_stress_inner_summary(self) -> '_1359.DutyCyclePropertySummaryStress[_1662.LoadedRollingBearingResults]':
        ...
        return constructor.new(_1359.DutyCyclePropertySummaryStress)[_1662.LoadedRollingBearingResults](self.wrapped.MaximumElementNormalStressInnerSummary) if self.wrapped.MaximumElementNormalStressInnerSummary else None

    @property
    def maximum_element_normal_stress_outer_summary(self) -> '_1359.DutyCyclePropertySummaryStress[_1662.LoadedRollingBearingResults]':
        ...
        return constructor.new(_1359.DutyCyclePropertySummaryStress)[_1662.LoadedRollingBearingResults](self.wrapped.MaximumElementNormalStressOuterSummary) if self.wrapped.MaximumElementNormalStressOuterSummary else None

    @property
    def maximum_element_normal_stress_summary(self) -> '_1359.DutyCyclePropertySummaryStress[_1521.BearingLoadCaseResultsLightweight]':
        ...
        return constructor.new(_1359.DutyCyclePropertySummaryStress)[_1521.BearingLoadCaseResultsLightweight](self.wrapped.MaximumElementNormalStressSummary) if self.wrapped.MaximumElementNormalStressSummary else None

    @property
    def misalignment_summary(self) -> '_1358.DutyCyclePropertySummarySmallAngle[_1521.BearingLoadCaseResultsLightweight]':
        ...
        return constructor.new(_1358.DutyCyclePropertySummarySmallAngle)[_1521.BearingLoadCaseResultsLightweight](self.wrapped.MisalignmentSummary) if self.wrapped.MisalignmentSummary else None

    @property
    def iso2812007_dynamic_equivalent_load_summary(self) -> '_1356.DutyCyclePropertySummaryForce[_1521.BearingLoadCaseResultsLightweight]':
        ...
        return constructor.new(_1356.DutyCyclePropertySummaryForce)[_1521.BearingLoadCaseResultsLightweight](self.wrapped.ISO2812007DynamicEquivalentLoadSummary) if self.wrapped.ISO2812007DynamicEquivalentLoadSummary else None

    @property
    def isots162812008_dynamic_equivalent_load_summary(self) -> '_1356.DutyCyclePropertySummaryForce[_1521.BearingLoadCaseResultsLightweight]':
        ...
        return constructor.new(_1356.DutyCyclePropertySummaryForce)[_1521.BearingLoadCaseResultsLightweight](self.wrapped.ISOTS162812008DynamicEquivalentLoadSummary) if self.wrapped.ISOTS162812008DynamicEquivalentLoadSummary else None

    @property
    def maximum_truncation_summary(self) -> '_1357.DutyCyclePropertySummaryPercentage[_1521.BearingLoadCaseResultsLightweight]':
        ...
        return constructor.new(_1357.DutyCyclePropertySummaryPercentage)[_1521.BearingLoadCaseResultsLightweight](self.wrapped.MaximumTruncationSummary) if self.wrapped.MaximumTruncationSummary else None

    @property
    def maximum_static_contact_stress_duty_cycle(self) -> '_1691.MaximumStaticContactStressDutyCycle':
        ...
        return constructor.new(_1691.MaximumStaticContactStressDutyCycle)(self.wrapped.MaximumStaticContactStressDutyCycle) if self.wrapped.MaximumStaticContactStressDutyCycle else None
