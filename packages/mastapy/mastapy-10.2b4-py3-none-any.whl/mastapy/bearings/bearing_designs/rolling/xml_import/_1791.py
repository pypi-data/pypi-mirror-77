...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1792
...
class RollingBearingImporter(_0.APIBase):
    ...
    @property
    def mappings(self) -> 'List[_1792.XmlBearingTypeMapping]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Mappings, constructor.new(_1792.XmlBearingTypeMapping))
        return value
