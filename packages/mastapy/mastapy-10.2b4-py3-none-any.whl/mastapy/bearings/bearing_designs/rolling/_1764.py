...
from mastapy.bearings.bearing_designs.rolling import _1765
...
class BearingProtectionDetailsModifier(_0.APIBase):
    ...
    @property
    def current_protection_level(self) -> '_1765.BearingProtectionLevel':
        ...
        return constructor.new(_1765.BearingProtectionLevel)(value) if value else None

    @property
    def new_protection_level(self) -> '_1765.BearingProtectionLevel':
    ...
    def new_protection_level(self, value: '_1765.BearingProtectionLevel'):
