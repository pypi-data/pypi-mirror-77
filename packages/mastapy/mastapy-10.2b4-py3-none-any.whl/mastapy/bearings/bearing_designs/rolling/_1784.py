...
from mastapy.bearings.bearing_designs.rolling import _1778, _1775
...
class TaperRollerBearing(_1775.NonBarrelRollerBearing):
    '''TaperRollerBearing
    ...
    @property
    def bearing_measurement_type(self) -> '_1522.BearingMeasurementType':
        ...
        return constructor.new(_1522.BearingMeasurementType)(value) if value else None

    @bearing_measurement_type.setter
    def bearing_measurement_type(self, value: '_1522.BearingMeasurementType'):
    ...
    @property
    def major_rib_detail(self) -> '_1778.RollerRibDetail':
        ...
        return constructor.new(_1778.RollerRibDetail)(self.wrapped.MajorRibDetail) if self.wrapped.MajorRibDetail else None
