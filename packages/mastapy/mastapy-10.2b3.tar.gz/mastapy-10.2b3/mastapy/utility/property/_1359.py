...
from mastapy.utility.units_and_measurements.measurements import _1248
...
class DutyCyclePropertySummaryStress(_1355.DutyCyclePropertySummary['_1248.Stress', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryStress
