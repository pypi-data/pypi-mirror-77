...
from mastapy.utility.databases import _1349, _1351, _1350
...
TValue = TypeVar('TValue', bound='_1349.NamedDatabaseItem')


class NamedDatabase(_1351.SQLDatabase['_1350.NamedKey', 'TValue'], Generic[TValue]):
    '''NamedDatabase
    ...
    def rename(self, item: '_1349.NamedDatabaseItem', new_name: 'str') -> 'bool':
