...
from mastapy.utility.modal_analysis.gears import _1323, _1327
...
class GearMeshForTE(_1327.OrderForTE):
    '''GearMeshForTE
    ...
    @property
    def attached_gears(self) -> 'List[_1323.GearOrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AttachedGears, constructor.new(_1323.GearOrderForTE))
        return value
