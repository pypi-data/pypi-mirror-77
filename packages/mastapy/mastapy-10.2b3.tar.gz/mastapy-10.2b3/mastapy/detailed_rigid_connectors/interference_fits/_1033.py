...
from mastapy.bearings.tolerances import _1562, _1549, _1555
...
class InterferenceFitHalfDesign(_975.DetailedRigidConnectorHalfDesign):
    '''InterferenceFitHalfDesign
    ...
    @property
    def stress_region(self) -> '_1034.StressRegions':
        ...
        return constructor.new(_1034.StressRegions)(value) if value else None
    ...
    @property
    def tolerance(self) -> '_1562.SupportTolerance':
        ...
        return constructor.new(_1562.SupportTolerance)(self.wrapped.Tolerance) if self.wrapped.Tolerance else None

    @property
    def tolerance_of_type_inner_support_tolerance(self) -> '_1549.InnerSupportTolerance':
        ...
        if _1549.InnerSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
        ...
        return constructor.new(_1549.InnerSupportTolerance)(self.wrapped.Tolerance) if self.wrapped.Tolerance else None

    @property
    def tolerance_of_type_outer_support_tolerance(self) -> '_1555.OuterSupportTolerance':
        ...
        if _1555.OuterSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
        ...
        return constructor.new(_1555.OuterSupportTolerance)(self.wrapped.Tolerance) if self.wrapped.Tolerance else None
