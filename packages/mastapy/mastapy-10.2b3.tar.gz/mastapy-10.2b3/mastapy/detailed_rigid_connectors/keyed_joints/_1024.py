...
from mastapy.detailed_rigid_connectors.keyed_joints import _1027, _1025
...
class KeyedJointDesign(_1032.InterferenceFitDesign):
    '''KeyedJointDesign
