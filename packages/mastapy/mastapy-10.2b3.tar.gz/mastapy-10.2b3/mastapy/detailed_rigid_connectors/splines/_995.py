...
from mastapy.detailed_rigid_connectors.splines import _982, _1007
...
class SAESplineJointDesign(_1007.StandardSplineJointDesign):
    '''SAESplineJointDesign
    ...
    @property
    def fit_type(self) -> '_982.FitTypes':
        '''FitTypes: 'FitType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FitType)
        return constructor.new(_982.FitTypes)(value) if value else None

    @fit_type.setter
    def fit_type(self, value: '_982.FitTypes'):
