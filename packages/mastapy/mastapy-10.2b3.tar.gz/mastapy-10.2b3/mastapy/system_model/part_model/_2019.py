...
class FlexiblePinAssembly(_2041.SpecialisedAssembly):
    '''FlexiblePinAssembly
    ...
    @property
    def planet_gear(self) -> '_2088.CylindricalGear':
        ...
        return constructor.new(_2088.CylindricalGear)(self.wrapped.PlanetGear) if self.wrapped.PlanetGear else None
