...
from mastapy.bearings.tolerances import (
    _1545, _1546, _1548, _1558,
    _1554, _1561, _1549, _1562,
    _1555, _1564
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.bearings.bearing_results import _1596, _1597
from mastapy.bearings import (
    _1523, _1530, _1519, _1515
)
...
class Bearing(_2014.Connector):
    ...
    @property
    def bearing_tolerance_definition(self) -> '_1546.BearingToleranceDefinitionOptions':
        ...
        return constructor.new(_1546.BearingToleranceDefinitionOptions)(value) if value else None

    @bearing_tolerance_definition.setter
    def bearing_tolerance_definition(self, value: '_1546.BearingToleranceDefinitionOptions'):
    ...
    @property
    def journal_bearing_type(self) -> '_1530.JournalBearingType':
        ...
        return constructor.new(_1530.JournalBearingType)(value) if value else None

    @journal_bearing_type.setter
    def journal_bearing_type(self, value: '_1530.JournalBearingType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def damping_options(self) -> '_1519.BearingDampingMatrixOption':
        ...
        return constructor.new(_1519.BearingDampingMatrixOption)(value) if value else None

    @damping_options.setter
    def damping_options(self, value: '_1519.BearingDampingMatrixOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def ring_tolerance_inner(self) -> '_1548.InnerRingTolerance':
        ...
        return constructor.new(_1548.InnerRingTolerance)(self.wrapped.RingToleranceInner) if self.wrapped.RingToleranceInner else None

    @property
    def ring_tolerance_left(self) -> '_1558.RingTolerance':
        ...
        return constructor.new(_1558.RingTolerance)(self.wrapped.RingToleranceLeft) if self.wrapped.RingToleranceLeft else None

    @property
    def ring_tolerance_left_of_type_inner_ring_tolerance(self) -> '_1548.InnerRingTolerance':
        ...
        if _1548.InnerRingTolerance.TYPE not in self.wrapped.RingToleranceLeft.__class__.__mro__:
        ...
        return constructor.new(_1548.InnerRingTolerance)(self.wrapped.RingToleranceLeft) if self.wrapped.RingToleranceLeft else None

    @property
    def ring_tolerance_left_of_type_outer_ring_tolerance(self) -> '_1554.OuterRingTolerance':
        ...
        if _1554.OuterRingTolerance.TYPE not in self.wrapped.RingToleranceLeft.__class__.__mro__:
        ...
        return constructor.new(_1554.OuterRingTolerance)(self.wrapped.RingToleranceLeft) if self.wrapped.RingToleranceLeft else None

    @property
    def ring_tolerance_outer(self) -> '_1554.OuterRingTolerance':
        ...
        return constructor.new(_1554.OuterRingTolerance)(self.wrapped.RingToleranceOuter) if self.wrapped.RingToleranceOuter else None

    @property
    def ring_tolerance_right(self) -> '_1558.RingTolerance':
        ...
        return constructor.new(_1558.RingTolerance)(self.wrapped.RingToleranceRight) if self.wrapped.RingToleranceRight else None

    @property
    def ring_tolerance_right_of_type_inner_ring_tolerance(self) -> '_1548.InnerRingTolerance':
        ...
        if _1548.InnerRingTolerance.TYPE not in self.wrapped.RingToleranceRight.__class__.__mro__:
        ...
        return constructor.new(_1548.InnerRingTolerance)(self.wrapped.RingToleranceRight) if self.wrapped.RingToleranceRight else None

    @property
    def ring_tolerance_right_of_type_outer_ring_tolerance(self) -> '_1554.OuterRingTolerance':
        ...
        if _1554.OuterRingTolerance.TYPE not in self.wrapped.RingToleranceRight.__class__.__mro__:
        ...
        return constructor.new(_1554.OuterRingTolerance)(self.wrapped.RingToleranceRight) if self.wrapped.RingToleranceRight else None

    @property
    def inner_support_detail(self) -> '_1561.SupportDetail':
        ...
        return constructor.new(_1561.SupportDetail)(self.wrapped.InnerSupportDetail) if self.wrapped.InnerSupportDetail else None

    @property
    def left_support_detail(self) -> '_1561.SupportDetail':
        ...
        return constructor.new(_1561.SupportDetail)(self.wrapped.LeftSupportDetail) if self.wrapped.LeftSupportDetail else None

    @property
    def outer_support_detail(self) -> '_1561.SupportDetail':
        ...
        return constructor.new(_1561.SupportDetail)(self.wrapped.OuterSupportDetail) if self.wrapped.OuterSupportDetail else None

    @property
    def right_support_detail(self) -> '_1561.SupportDetail':
        ...
        return constructor.new(_1561.SupportDetail)(self.wrapped.RightSupportDetail) if self.wrapped.RightSupportDetail else None

    @property
    def support_tolerance_inner(self) -> '_1549.InnerSupportTolerance':
        ...
        return constructor.new(_1549.InnerSupportTolerance)(self.wrapped.SupportToleranceInner) if self.wrapped.SupportToleranceInner else None

    @property
    def support_tolerance_left(self) -> '_1562.SupportTolerance':
        ...
        return constructor.new(_1562.SupportTolerance)(self.wrapped.SupportToleranceLeft) if self.wrapped.SupportToleranceLeft else None

    @property
    def support_tolerance_left_of_type_inner_support_tolerance(self) -> '_1549.InnerSupportTolerance':
        ...
        if _1549.InnerSupportTolerance.TYPE not in self.wrapped.SupportToleranceLeft.__class__.__mro__:
        ...
        return constructor.new(_1549.InnerSupportTolerance)(self.wrapped.SupportToleranceLeft) if self.wrapped.SupportToleranceLeft else None

    @property
    def support_tolerance_left_of_type_outer_support_tolerance(self) -> '_1555.OuterSupportTolerance':
        ...
        if _1555.OuterSupportTolerance.TYPE not in self.wrapped.SupportToleranceLeft.__class__.__mro__:
        ...
        return constructor.new(_1555.OuterSupportTolerance)(self.wrapped.SupportToleranceLeft) if self.wrapped.SupportToleranceLeft else None

    @property
    def support_tolerance_outer(self) -> '_1555.OuterSupportTolerance':
        ...
        return constructor.new(_1555.OuterSupportTolerance)(self.wrapped.SupportToleranceOuter) if self.wrapped.SupportToleranceOuter else None

    @property
    def support_tolerance_right(self) -> '_1562.SupportTolerance':
        ...
        return constructor.new(_1562.SupportTolerance)(self.wrapped.SupportToleranceRight) if self.wrapped.SupportToleranceRight else None

    @property
    def support_tolerance_right_of_type_inner_support_tolerance(self) -> '_1549.InnerSupportTolerance':
        ...
        if _1549.InnerSupportTolerance.TYPE not in self.wrapped.SupportToleranceRight.__class__.__mro__:
        ...
        return constructor.new(_1549.InnerSupportTolerance)(self.wrapped.SupportToleranceRight) if self.wrapped.SupportToleranceRight else None

    @property
    def support_tolerance_right_of_type_outer_support_tolerance(self) -> '_1555.OuterSupportTolerance':
        ...
        if _1555.OuterSupportTolerance.TYPE not in self.wrapped.SupportToleranceRight.__class__.__mro__:
        ...
        return constructor.new(_1555.OuterSupportTolerance)(self.wrapped.SupportToleranceRight) if self.wrapped.SupportToleranceRight else None

    @property
    def inner_mounting_sleeve_bore_tolerance(self) -> '_1555.OuterSupportTolerance':
        ...
        return constructor.new(_1555.OuterSupportTolerance)(self.wrapped.InnerMountingSleeveBoreTolerance) if self.wrapped.InnerMountingSleeveBoreTolerance else None

    @property
    def inner_mounting_sleeve_outer_diameter_tolerance(self) -> '_1549.InnerSupportTolerance':
        ...
        return constructor.new(_1549.InnerSupportTolerance)(self.wrapped.InnerMountingSleeveOuterDiameterTolerance) if self.wrapped.InnerMountingSleeveOuterDiameterTolerance else None

    @property
    def outer_mounting_sleeve_bore_tolerance(self) -> '_1555.OuterSupportTolerance':
        ...
        return constructor.new(_1555.OuterSupportTolerance)(self.wrapped.OuterMountingSleeveBoreTolerance) if self.wrapped.OuterMountingSleeveBoreTolerance else None

    @property
    def outer_mounting_sleeve_outer_diameter_tolerance(self) -> '_1549.InnerSupportTolerance':
        ...
        return constructor.new(_1549.InnerSupportTolerance)(self.wrapped.OuterMountingSleeveOuterDiameterTolerance) if self.wrapped.OuterMountingSleeveOuterDiameterTolerance else None

    @property
    def simple_bearing_detail_property(self) -> '_1750.BearingDesign':
        ...
        return constructor.new(_1750.BearingDesign)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_detailed_bearing(self) -> '_1751.DetailedBearing':
        ...
        if _1751.DetailedBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1751.DetailedBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_dummy_rolling_bearing(self) -> '_1752.DummyRollingBearing':
        ...
        if _1752.DummyRollingBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1752.DummyRollingBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_linear_bearing(self) -> '_1753.LinearBearing':
        ...
        if _1753.LinearBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1753.LinearBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_non_linear_bearing(self) -> '_1754.NonLinearBearing':
        ...
        if _1754.NonLinearBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1754.NonLinearBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_angular_contact_ball_bearing(self) -> '_1755.AngularContactBallBearing':
        ...
        if _1755.AngularContactBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1755.AngularContactBallBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_angular_contact_thrust_ball_bearing(self) -> '_1756.AngularContactThrustBallBearing':
        ...
        if _1756.AngularContactThrustBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1756.AngularContactThrustBallBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_asymmetric_spherical_roller_bearing(self) -> '_1757.AsymmetricSphericalRollerBearing':
        ...
        if _1757.AsymmetricSphericalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1757.AsymmetricSphericalRollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_axial_thrust_cylindrical_roller_bearing(self) -> '_1758.AxialThrustCylindricalRollerBearing':
        ...
        if _1758.AxialThrustCylindricalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1758.AxialThrustCylindricalRollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_axial_thrust_needle_roller_bearing(self) -> '_1759.AxialThrustNeedleRollerBearing':
        ...
        if _1759.AxialThrustNeedleRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1759.AxialThrustNeedleRollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_ball_bearing(self) -> '_1760.BallBearing':
        ...
        if _1760.BallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1760.BallBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_barrel_roller_bearing(self) -> '_1762.BarrelRollerBearing':
        ...
        if _1762.BarrelRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1762.BarrelRollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_crossed_roller_bearing(self) -> '_1767.CrossedRollerBearing':
        ...
        if _1767.CrossedRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1767.CrossedRollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_cylindrical_roller_bearing(self) -> '_1768.CylindricalRollerBearing':
        ...
        if _1768.CylindricalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1768.CylindricalRollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_deep_groove_ball_bearing(self) -> '_1769.DeepGrooveBallBearing':
        ...
        if _1769.DeepGrooveBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1769.DeepGrooveBallBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_four_point_contact_ball_bearing(self) -> '_1771.FourPointContactBallBearing':
        ...
        if _1771.FourPointContactBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1771.FourPointContactBallBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_multi_point_contact_ball_bearing(self) -> '_1773.MultiPointContactBallBearing':
        ...
        if _1773.MultiPointContactBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1773.MultiPointContactBallBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_needle_roller_bearing(self) -> '_1774.NeedleRollerBearing':
        ...
        if _1774.NeedleRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1774.NeedleRollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_non_barrel_roller_bearing(self) -> '_1775.NonBarrelRollerBearing':
        ...
        if _1775.NonBarrelRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1775.NonBarrelRollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_roller_bearing(self) -> '_1776.RollerBearing':
        ...
        if _1776.RollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1776.RollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_rolling_bearing(self) -> '_1779.RollingBearing':
        ...
        if _1779.RollingBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1779.RollingBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_self_aligning_ball_bearing(self) -> '_1780.SelfAligningBallBearing':
        ...
        if _1780.SelfAligningBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1780.SelfAligningBallBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_spherical_roller_bearing(self) -> '_1782.SphericalRollerBearing':
        ...
        if _1782.SphericalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1782.SphericalRollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_spherical_roller_thrust_bearing(self) -> '_1783.SphericalRollerThrustBearing':
        ...
        if _1783.SphericalRollerThrustBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1783.SphericalRollerThrustBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_taper_roller_bearing(self) -> '_1784.TaperRollerBearing':
        ...
        if _1784.TaperRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1784.TaperRollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_three_point_contact_ball_bearing(self) -> '_1785.ThreePointContactBallBearing':
        ...
        if _1785.ThreePointContactBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1785.ThreePointContactBallBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_thrust_ball_bearing(self) -> '_1786.ThrustBallBearing':
        ...
        if _1786.ThrustBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1786.ThrustBallBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_toroidal_roller_bearing(self) -> '_1787.ToroidalRollerBearing':
        ...
        if _1787.ToroidalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1787.ToroidalRollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_pad_fluid_film_bearing(self) -> '_1800.PadFluidFilmBearing':
        ...
        if _1800.PadFluidFilmBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1800.PadFluidFilmBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_plain_grease_filled_journal_bearing(self) -> '_1802.PlainGreaseFilledJournalBearing':
        ...
        if _1802.PlainGreaseFilledJournalBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1802.PlainGreaseFilledJournalBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_plain_journal_bearing(self) -> '_1804.PlainJournalBearing':
        ...
        if _1804.PlainJournalBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1804.PlainJournalBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_plain_oil_fed_journal_bearing(self) -> '_1806.PlainOilFedJournalBearing':
        ...
        if _1806.PlainOilFedJournalBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1806.PlainOilFedJournalBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_tilting_pad_journal_bearing(self) -> '_1807.TiltingPadJournalBearing':
        ...
        if _1807.TiltingPadJournalBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1807.TiltingPadJournalBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_tilting_pad_thrust_bearing(self) -> '_1808.TiltingPadThrustBearing':
        ...
        if _1808.TiltingPadThrustBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1808.TiltingPadThrustBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_concept_axial_clearance_bearing(self) -> '_1810.ConceptAxialClearanceBearing':
        ...
        if _1810.ConceptAxialClearanceBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1810.ConceptAxialClearanceBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_concept_clearance_bearing(self) -> '_1811.ConceptClearanceBearing':
        ...
        if _1811.ConceptClearanceBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1811.ConceptClearanceBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_concept_radial_clearance_bearing(self) -> '_1812.ConceptRadialClearanceBearing':
        ...
        if _1812.ConceptRadialClearanceBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1812.ConceptRadialClearanceBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def detail(self) -> '_1750.BearingDesign':
        ...
        return constructor.new(_1750.BearingDesign)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_detailed_bearing(self) -> '_1751.DetailedBearing':
        ...
        if _1751.DetailedBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to DetailedBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new(_1751.DetailedBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_dummy_rolling_bearing(self) -> '_1752.DummyRollingBearing':
        ...
        if _1752.DummyRollingBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1752.DummyRollingBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_linear_bearing(self) -> '_1753.LinearBearing':
        ...
        if _1753.LinearBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to LinearBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new(_1753.LinearBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_non_linear_bearing(self) -> '_1754.NonLinearBearing':
        ...
        if _1754.NonLinearBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to NonLinearBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new(_1754.NonLinearBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_angular_contact_ball_bearing(self) -> '_1755.AngularContactBallBearing':
        ...
        if _1755.AngularContactBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1755.AngularContactBallBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_angular_contact_thrust_ball_bearing(self) -> '_1756.AngularContactThrustBallBearing':
        ...
        if _1756.AngularContactThrustBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1756.AngularContactThrustBallBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_asymmetric_spherical_roller_bearing(self) -> '_1757.AsymmetricSphericalRollerBearing':
        ...
        if _1757.AsymmetricSphericalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1757.AsymmetricSphericalRollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_axial_thrust_cylindrical_roller_bearing(self) -> '_1758.AxialThrustCylindricalRollerBearing':
        ...
        if _1758.AxialThrustCylindricalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1758.AxialThrustCylindricalRollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_axial_thrust_needle_roller_bearing(self) -> '_1759.AxialThrustNeedleRollerBearing':
        ...
        if _1759.AxialThrustNeedleRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1759.AxialThrustNeedleRollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_ball_bearing(self) -> '_1760.BallBearing':
        ...
        if _1760.BallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to BallBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new(_1760.BallBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_barrel_roller_bearing(self) -> '_1762.BarrelRollerBearing':
        ...
        if _1762.BarrelRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1762.BarrelRollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_crossed_roller_bearing(self) -> '_1767.CrossedRollerBearing':
        ...
        if _1767.CrossedRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1767.CrossedRollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_cylindrical_roller_bearing(self) -> '_1768.CylindricalRollerBearing':
        ...
        if _1768.CylindricalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1768.CylindricalRollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_deep_groove_ball_bearing(self) -> '_1769.DeepGrooveBallBearing':
        ...
        if _1769.DeepGrooveBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1769.DeepGrooveBallBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_four_point_contact_ball_bearing(self) -> '_1771.FourPointContactBallBearing':
        ...
        if _1771.FourPointContactBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1771.FourPointContactBallBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_multi_point_contact_ball_bearing(self) -> '_1773.MultiPointContactBallBearing':
        ...
        if _1773.MultiPointContactBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1773.MultiPointContactBallBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_needle_roller_bearing(self) -> '_1774.NeedleRollerBearing':
        ...
        if _1774.NeedleRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1774.NeedleRollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_non_barrel_roller_bearing(self) -> '_1775.NonBarrelRollerBearing':
        ...
        if _1775.NonBarrelRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1775.NonBarrelRollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_roller_bearing(self) -> '_1776.RollerBearing':
        ...
        if _1776.RollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to RollerBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new(_1776.RollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_rolling_bearing(self) -> '_1779.RollingBearing':
        ...
        if _1779.RollingBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to RollingBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new(_1779.RollingBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_self_aligning_ball_bearing(self) -> '_1780.SelfAligningBallBearing':
        ...
        if _1780.SelfAligningBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1780.SelfAligningBallBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_spherical_roller_bearing(self) -> '_1782.SphericalRollerBearing':
        ...
        if _1782.SphericalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1782.SphericalRollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_spherical_roller_thrust_bearing(self) -> '_1783.SphericalRollerThrustBearing':
        ...
        if _1783.SphericalRollerThrustBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1783.SphericalRollerThrustBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_taper_roller_bearing(self) -> '_1784.TaperRollerBearing':
        ...
        if _1784.TaperRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1784.TaperRollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_three_point_contact_ball_bearing(self) -> '_1785.ThreePointContactBallBearing':
        ...
        if _1785.ThreePointContactBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1785.ThreePointContactBallBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_thrust_ball_bearing(self) -> '_1786.ThrustBallBearing':
        ...
        if _1786.ThrustBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1786.ThrustBallBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_toroidal_roller_bearing(self) -> '_1787.ToroidalRollerBearing':
        ...
        if _1787.ToroidalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1787.ToroidalRollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_pad_fluid_film_bearing(self) -> '_1800.PadFluidFilmBearing':
        ...
        if _1800.PadFluidFilmBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1800.PadFluidFilmBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_plain_grease_filled_journal_bearing(self) -> '_1802.PlainGreaseFilledJournalBearing':
        ...
        if _1802.PlainGreaseFilledJournalBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1802.PlainGreaseFilledJournalBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_plain_journal_bearing(self) -> '_1804.PlainJournalBearing':
        ...
        if _1804.PlainJournalBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1804.PlainJournalBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_plain_oil_fed_journal_bearing(self) -> '_1806.PlainOilFedJournalBearing':
        ...
        if _1806.PlainOilFedJournalBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1806.PlainOilFedJournalBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_tilting_pad_journal_bearing(self) -> '_1807.TiltingPadJournalBearing':
        ...
        if _1807.TiltingPadJournalBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1807.TiltingPadJournalBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_tilting_pad_thrust_bearing(self) -> '_1808.TiltingPadThrustBearing':
        ...
        if _1808.TiltingPadThrustBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1808.TiltingPadThrustBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_concept_axial_clearance_bearing(self) -> '_1810.ConceptAxialClearanceBearing':
        ...
        if _1810.ConceptAxialClearanceBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1810.ConceptAxialClearanceBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_concept_clearance_bearing(self) -> '_1811.ConceptClearanceBearing':
        ...
        if _1811.ConceptClearanceBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1811.ConceptClearanceBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_concept_radial_clearance_bearing(self) -> '_1812.ConceptRadialClearanceBearing':
        ...
        if _1812.ConceptRadialClearanceBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1812.ConceptRadialClearanceBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def axial_internal_clearance_tolerance(self) -> '_2006.AxialInternalClearanceTolerance':
        ...
        return constructor.new(_2006.AxialInternalClearanceTolerance)(self.wrapped.AxialInternalClearanceTolerance) if self.wrapped.AxialInternalClearanceTolerance else None

    @property
    def radial_internal_clearance_tolerance(self) -> '_2038.RadialInternalClearanceTolerance':
        ...
        return constructor.new(_2038.RadialInternalClearanceTolerance)(self.wrapped.RadialInternalClearanceTolerance) if self.wrapped.RadialInternalClearanceTolerance else None
    ...
    @property
    def friction_coefficients(self) -> '_1698.RollingBearingFrictionCoefficients':
        ...
        return constructor.new(_1698.RollingBearingFrictionCoefficients)(self.wrapped.FrictionCoefficients) if self.wrapped.FrictionCoefficients else None

    @property
    def tolerance_combinations(self) -> 'List[_1564.ToleranceCombination]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToleranceCombinations, constructor.new(_1564.ToleranceCombination))
        return value

    @property
    def mounting(self) -> 'List[_2008.BearingRaceMountingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Mounting, constructor.new(_2008.BearingRaceMountingOptions))
        return value
    ...
    def set_detail_from_catalogue(self, catalogue: '_1515.BearingCatalog', designation: 'str'):
    ...
    def try_attach_left_side_to(self, shaft: '_2046.Shaft', offset: Optional['float'] = float('nan')) -> '_2012.ComponentsConnectedResult':
    ...
    def try_attach_right_side_to(self, shaft: '_2046.Shaft', offset: Optional['float'] = float('nan')) -> '_2012.ComponentsConnectedResult':
