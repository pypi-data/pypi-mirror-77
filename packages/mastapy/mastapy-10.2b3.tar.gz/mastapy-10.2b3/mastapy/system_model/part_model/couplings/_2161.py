...
from mastapy.system_model.part_model.couplings import _2160, _2162
...
class SynchroniserHalf(_2162.SynchroniserPart):
    '''SynchroniserHalf
    ...
    @property
    def cones(self) -> 'List[_2160.SynchroniserCone]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2160.SynchroniserCone))
        return value
