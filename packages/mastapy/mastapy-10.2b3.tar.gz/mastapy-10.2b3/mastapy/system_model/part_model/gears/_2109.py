...
from mastapy.system_model.part_model.gears import _2108, _2083
...
class StraightBevelDiffGearSet(_2083.BevelGearSet):
    '''StraightBevelDiffGearSet
    ...
    @property
    def straight_bevel_diff_gears(self) -> 'List[_2108.StraightBevelDiffGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGears, constructor.new(_2108.StraightBevelDiffGear))
        return value

    @property
    def straight_bevel_diff_meshes(self) -> 'List[_1907.StraightBevelDiffGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshes, constructor.new(_1907.StraightBevelDiffGearMesh))
        return value
