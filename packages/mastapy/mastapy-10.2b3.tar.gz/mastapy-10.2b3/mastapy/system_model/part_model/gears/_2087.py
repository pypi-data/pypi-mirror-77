...
from mastapy.system_model.part_model.gears import _2086, _2095
...
class ConicalGearSet(_2095.GearSet):
    '''ConicalGearSet
    ...
    @property
    def conical_gears(self) -> 'List[_2086.ConicalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalGears, constructor.new(_2086.ConicalGear))
        return value
