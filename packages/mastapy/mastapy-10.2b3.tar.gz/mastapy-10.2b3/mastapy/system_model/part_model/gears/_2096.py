...
class GearSetConfiguration(_0.APIBase):
    ...
    def implementation_detail_results_for(self, analysis_case: '_6211.StaticLoadCase', gear_set_mode: '_131.GearSetModes', run_all_planetary_meshes: 'bool') -> '_961.GearSetGroupDutyCycle':
        ...
        method_result = self.wrapped.ImplementationDetailResultsFor.Overloads[_6211.StaticLoadCase.TYPE, _131.GearSetModes.type_(), bool](analysis_case.wrapped if analysis_case else None, gear_set_mode, run_all_planetary_meshes if run_all_planetary_meshes else False)
        return constructor.new(_961.GearSetGroupDutyCycle)(method_result) if method_result else None

    def implementation_detail_results_for_group(self, analysis_case: '_5258.AbstractStaticLoadCaseGroup', gear_set_mode: '_131.GearSetModes', run_all_planetary_meshes: 'bool') -> '_961.GearSetGroupDutyCycle':
        ''' 'ImplementationDetailResultsFor' is the original name of this method.
        ...
        gear_set_mode = conversion.mp_to_pn_enum(gear_set_mode)
        run_all_planetary_meshes = bool(run_all_planetary_meshes)
        method_result = self.wrapped.ImplementationDetailResultsFor.Overloads[_5258.AbstractStaticLoadCaseGroup.TYPE, _131.GearSetModes.type_(), bool](analysis_case.wrapped if analysis_case else None, gear_set_mode, run_all_planetary_meshes if run_all_planetary_meshes else False)
        return constructor.new(_961.GearSetGroupDutyCycle)(method_result) if method_result else None

    def perform_implementation_detail_analysis(self, static_load: '_6211.StaticLoadCase', gear_set_mode: '_131.GearSetModes', run_all_planetary_meshes: Optional['bool'] = True, perform_system_analysis_if_not_ready: Optional['bool'] = True):
        ...
        self.wrapped.PerformImplementationDetailAnalysis.Overloads[_6211.StaticLoadCase.TYPE, _131.GearSetModes.type_(), bool, bool](static_load.wrapped if static_load else None, gear_set_mode, run_all_planetary_meshes if run_all_planetary_meshes else False, perform_system_analysis_if_not_ready if perform_system_analysis_if_not_ready else False)

    def perform_implementation_detail_analysis_group(self, static_load_case_group: '_5258.AbstractStaticLoadCaseGroup', gear_set_mode: '_131.GearSetModes', run_all_planetary_meshes: Optional['bool'] = True, perform_system_analysis_if_not_ready: Optional['bool'] = True):
        ''' 'PerformImplementationDetailAnalysis' is the original name of this method.
        ...
        run_all_planetary_meshes = bool(run_all_planetary_meshes)
        perform_system_analysis_if_not_ready = bool(perform_system_analysis_if_not_ready)
        self.wrapped.PerformImplementationDetailAnalysis.Overloads[_5258.AbstractStaticLoadCaseGroup.TYPE, _131.GearSetModes.type_(), bool, bool](static_load_case_group.wrapped if static_load_case_group else None, gear_set_mode, run_all_planetary_meshes if run_all_planetary_meshes else False, perform_system_analysis_if_not_ready if perform_system_analysis_if_not_ready else False)
