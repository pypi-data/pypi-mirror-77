...
from mastapy.math_utility import _1068, _1069
from mastapy.system_model.connections_and_sockets import _1855, _1872
...
class Component(_2033.Part):
    ...
    @property
    def twod_drawing_full_model(self) -> '_6532.SMTBitmap':
        ...
        return constructor.new(_6532.SMTBitmap)(self.wrapped.TwoDDrawingFullModel) if self.wrapped.TwoDDrawingFullModel else None
    ...
    @property
    def component_connections(self) -> 'List[_1855.ComponentConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentConnections, constructor.new(_1855.ComponentConnection))
        return value
    ...
    def set_position_and_rotation_of_component_and_connected_components(self, new_coordinate_system: '_1068.CoordinateSystem3D') -> '_1872.RealignmentResult':
        ...
        return constructor.new(_1872.RealignmentResult)(method_result) if method_result else None

    def set_position_of_component_and_connected_components(self, position: 'Vector3D') -> '_1872.RealignmentResult':
    ...
    def create_coordinate_system_editor(self) -> '_1069.CoordinateSystemEditor':
        ...
        return constructor.new(_1069.CoordinateSystemEditor)(method_result) if method_result else None
