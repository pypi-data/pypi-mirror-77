...
class PointLoad(_2043.VirtualComponent):
    '''PointLoad
    ...
    @property
    def offset(self) -> '_1124.Vector2DPolar':
        ...
        return constructor.new(_1124.Vector2DPolar)(self.wrapped.Offset) if self.wrapped.Offset else None
