...
from mastapy.system_model.drawing import _1849, _1848
...
class ContourDrawStyle(_112.DrawStyleBase):
    ...
    @property
    def contour(self) -> '_1344.ThreeDViewContourOption':
        '''ThreeDViewContourOption: 'Contour' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Contour)
        return constructor.new(_1344.ThreeDViewContourOption)(value) if value else None

    @contour.setter
    def contour(self, value: '_1344.ThreeDViewContourOption'):
    ...
    @property
    def deflection_scaling(self) -> '_1849.ScalingDrawStyle':
        ...
        return constructor.new(_1849.ScalingDrawStyle)(self.wrapped.DeflectionScaling) if self.wrapped.DeflectionScaling else None

    @property
    def model_view_options(self) -> '_1848.ModelViewOptionsDrawStyle':
        ...
        return constructor.new(_1848.ModelViewOptionsDrawStyle)(self.wrapped.ModelViewOptions) if self.wrapped.ModelViewOptions else None
