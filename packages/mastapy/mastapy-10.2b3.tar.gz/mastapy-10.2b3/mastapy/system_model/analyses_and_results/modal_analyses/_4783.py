...
from mastapy.nodal_analysis.component_mode_synthesis import _1506
...
class ImportedFEComponentModalAnalysis(_4724.AbstractShaftOrHousingModalAnalysis):
    '''ImportedFEComponentModalAnalysis
    ...
    @property
    def modal_full_fe_results(self) -> 'List[_1506.ModalCMSResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ModalFullFEResults, constructor.new(_1506.ModalCMSResults))
        return value
