...
class RigidlyConnectedDesignEntityGroupForSingleModeModalAnalysis(_0.APIBase):
    ...
    @property
    def component_results(self) -> 'List[_4859.ComponentPerModeResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentResults, constructor.new(_4859.ComponentPerModeResult))
        return value
