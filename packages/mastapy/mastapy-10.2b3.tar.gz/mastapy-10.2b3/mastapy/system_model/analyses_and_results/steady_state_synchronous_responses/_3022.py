...
class ConnectionSteadyStateSynchronousResponse(_6515.ConnectionStaticLoadAnalysisCase):
    '''ConnectionSteadyStateSynchronousResponse
    ...
    @property
    def steady_state_synchronous_response(self) -> '_3087.SteadyStateSynchronousResponse':
        ...
        return constructor.new(_3087.SteadyStateSynchronousResponse)(self.wrapped.SteadyStateSynchronousResponse) if self.wrapped.SteadyStateSynchronousResponse else None
