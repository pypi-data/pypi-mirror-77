...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4047, _4046, _3994
...
class HypoidGearSetModalAnalysesAtSpeeds(_3994.AGMAGleasonConicalGearSetModalAnalysesAtSpeeds):
    '''HypoidGearSetModalAnalysesAtSpeeds
    ...
    @property
    def hypoid_gears_modal_analyses_at_speeds(self) -> 'List[_4047.HypoidGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsModalAnalysesAtSpeeds, constructor.new(_4047.HypoidGearModalAnalysesAtSpeeds))
        return value

    @property
    def hypoid_meshes_modal_analyses_at_speeds(self) -> 'List[_4046.HypoidGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesModalAnalysesAtSpeeds, constructor.new(_4046.HypoidGearMeshModalAnalysesAtSpeeds))
        return value
