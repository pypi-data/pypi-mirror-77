...
from mastapy.system_model.analyses_and_results.power_flows import _3350, _3349, _3352
...
class SynchroniserPartSystemDeflection(_2270.CouplingHalfSystemDeflection):
    '''SynchroniserPartSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3350.SynchroniserPartPowerFlow':
