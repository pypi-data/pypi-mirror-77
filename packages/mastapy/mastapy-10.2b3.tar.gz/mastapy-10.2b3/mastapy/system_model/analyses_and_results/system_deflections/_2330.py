...
from mastapy.detailed_rigid_connectors.splines.ratings import (
    _1011, _1013, _1015, _1017,
    _1019
)
from mastapy._internal.cast_exception import CastException
from mastapy.detailed_rigid_connectors.keyed_joints.rating import _1029
from mastapy.detailed_rigid_connectors.interference_fits.rating import _1036
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2379
...
class ShaftHubConnectionSystemDeflection(_2268.ConnectorSystemDeflection):
    '''ShaftHubConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3331.ShaftHubConnectionPowerFlow':
    ...
    @property
    def component_detailed_analysis(self) -> '_1023.ShaftHubConnectionRating':
        ...
        return constructor.new(_1023.ShaftHubConnectionRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def component_detailed_analysis_of_type_agma6123_spline_joint_rating(self) -> '_1011.AGMA6123SplineJointRating':
        ...
        if _1011.AGMA6123SplineJointRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
        ...
        return constructor.new(_1011.AGMA6123SplineJointRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def component_detailed_analysis_of_type_din5466_spline_rating(self) -> '_1013.DIN5466SplineRating':
        ...
        if _1013.DIN5466SplineRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
        ...
        return constructor.new(_1013.DIN5466SplineRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def component_detailed_analysis_of_type_gbt17855_spline_joint_rating(self) -> '_1015.GBT17855SplineJointRating':
        ...
        if _1015.GBT17855SplineJointRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
        ...
        return constructor.new(_1015.GBT17855SplineJointRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def component_detailed_analysis_of_type_sae_spline_joint_rating(self) -> '_1017.SAESplineJointRating':
        ...
        if _1017.SAESplineJointRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
        ...
        return constructor.new(_1017.SAESplineJointRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def component_detailed_analysis_of_type_spline_joint_rating(self) -> '_1019.SplineJointRating':
        ...
        if _1019.SplineJointRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
        ...
        return constructor.new(_1019.SplineJointRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def component_detailed_analysis_of_type_keyway_rating(self) -> '_1029.KeywayRating':
        ...
        if _1029.KeywayRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
        ...
        return constructor.new(_1029.KeywayRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def component_detailed_analysis_of_type_interference_fit_rating(self) -> '_1036.InterferenceFitRating':
        ...
        if _1036.InterferenceFitRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
        ...
        return constructor.new(_1036.InterferenceFitRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None
    ...
    @property
    def left_flank_contacts(self) -> 'List[_2379.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LeftFlankContacts, constructor.new(_2379.SplineFlankContactReporting))
        return value

    @property
    def right_flank_contacts(self) -> 'List[_2379.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RightFlankContacts, constructor.new(_2379.SplineFlankContactReporting))
        return value

    @property
    def tip_contacts(self) -> 'List[_2379.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TipContacts, constructor.new(_2379.SplineFlankContactReporting))
        return value
