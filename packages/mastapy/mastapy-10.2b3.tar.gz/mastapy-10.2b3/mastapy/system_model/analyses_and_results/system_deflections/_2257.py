...
class ConceptCouplingConnectionSystemDeflection(_2269.CouplingConnectionSystemDeflection):
    '''ConceptCouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3265.ConceptCouplingConnectionPowerFlow':
