...
class CylindricalGearMeshSystemDeflection(_2292.GearMeshSystemDeflection):
    '''CylindricalGearMeshSystemDeflection
    ...
    @property
    def chart_of_effective_change_in_operating_centre_distance(self) -> '_6532.SMTBitmap':
        ...
        return constructor.new(_6532.SMTBitmap)(self.wrapped.ChartOfEffectiveChangeInOperatingCentreDistance) if self.wrapped.ChartOfEffectiveChangeInOperatingCentreDistance else None
    ...
    @property
    def power_flow_results(self) -> '_3283.CylindricalGearMeshPowerFlow':
    ...
    @property
    def gear_a(self) -> '_2281.CylindricalGearSystemDeflection':
    ...
    @property
    def gear_b(self) -> '_2281.CylindricalGearSystemDeflection':
    ...
    @property
    def misalignment_data(self) -> '_1371.CylindricalMisalignmentCalculator':
        ...
        return constructor.new(_1371.CylindricalMisalignmentCalculator)(self.wrapped.MisalignmentData) if self.wrapped.MisalignmentData else None

    @property
    def misalignment_data_left_flank(self) -> '_1371.CylindricalMisalignmentCalculator':
        ...
        return constructor.new(_1371.CylindricalMisalignmentCalculator)(self.wrapped.MisalignmentDataLeftFlank) if self.wrapped.MisalignmentDataLeftFlank else None

    @property
    def misalignment_data_right_flank(self) -> '_1371.CylindricalMisalignmentCalculator':
        ...
        return constructor.new(_1371.CylindricalMisalignmentCalculator)(self.wrapped.MisalignmentDataRightFlank) if self.wrapped.MisalignmentDataRightFlank else None
    ...
    @property
    def cylindrical_gears(self) -> 'List[_2281.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_2281.CylindricalGearSystemDeflection))
        return value

    @property
    def mesh_deflections_left_flank(self) -> 'List[_2374.MeshDeflectionResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshDeflectionsLeftFlank, constructor.new(_2374.MeshDeflectionResults))
        return value

    @property
    def mesh_deflections_right_flank(self) -> 'List[_2374.MeshDeflectionResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshDeflectionsRightFlank, constructor.new(_2374.MeshDeflectionResults))
        return value
