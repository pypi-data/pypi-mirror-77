...
class StraightBevelDiffGearMeshSystemDeflection(_2246.BevelGearMeshSystemDeflection):
    '''StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3341.StraightBevelDiffGearMeshPowerFlow':
