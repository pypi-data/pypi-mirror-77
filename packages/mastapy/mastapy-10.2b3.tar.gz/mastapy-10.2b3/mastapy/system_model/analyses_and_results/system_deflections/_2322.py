...
class PlanetCarrierSystemDeflection(_2314.MountableComponentSystemDeflection):
    '''PlanetCarrierSystemDeflection
    ...
    @property
    def windup(self) -> 'List[_2375.PlanetCarrierWindup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Windup, constructor.new(_2375.PlanetCarrierWindup))
        return value
