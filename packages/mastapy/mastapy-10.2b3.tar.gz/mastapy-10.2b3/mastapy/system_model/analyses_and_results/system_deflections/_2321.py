...
class PlanetaryConnectionSystemDeflection(_2334.ShaftToMountableComponentConnectionSystemDeflection):
    '''PlanetaryConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3319.PlanetaryConnectionPowerFlow':
