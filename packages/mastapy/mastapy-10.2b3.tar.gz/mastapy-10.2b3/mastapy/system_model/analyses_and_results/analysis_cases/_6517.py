...
from mastapy.system_model.analyses_and_results import _2207, _2205
...
class DesignEntityCompoundAnalysis(_2205.DesignEntityAnalysis):
    '''DesignEntityCompoundAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2207.DesignEntitySingleContextAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2207.DesignEntitySingleContextAnalysis))
        return value
