...
class TimeSeriesLoadAnalysisCase(_6509.AnalysisCase):
    '''TimeSeriesLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_6225.TimeSeriesLoadCase':
        ...
        return constructor.new(_6225.TimeSeriesLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None
