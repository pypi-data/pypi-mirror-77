...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3864, _3863, _3799
...
class WormGearSetModalAnalysesAtStiffnesses(_3799.GearSetModalAnalysesAtStiffnesses):
    '''WormGearSetModalAnalysesAtStiffnesses
    ...
    @property
    def worm_gears_modal_analyses_at_stiffnesses(self) -> 'List[_3864.WormGearModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsModalAnalysesAtStiffnesses, constructor.new(_3864.WormGearModalAnalysesAtStiffnesses))
        return value

    @property
    def worm_meshes_modal_analyses_at_stiffnesses(self) -> 'List[_3863.WormGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesModalAnalysesAtStiffnesses, constructor.new(_3863.WormGearMeshModalAnalysesAtStiffnesses))
        return value
