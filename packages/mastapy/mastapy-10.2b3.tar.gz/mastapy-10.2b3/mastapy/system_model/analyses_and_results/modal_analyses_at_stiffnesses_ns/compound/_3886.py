...
class BoltCompoundModalAnalysesAtStiffnesses(_3892.ComponentCompoundModalAnalysesAtStiffnesses):
    '''BoltCompoundModalAnalysesAtStiffnesses
    ...
    @property
    def component_design(self) -> '_2009.Bolt':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3763.BoltModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3763.BoltModalAnalysesAtStiffnesses))
        return value

    @property
    def component_modal_analyses_at_stiffnesses_load_cases(self) -> 'List[_3763.BoltModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysesAtStiffnessesLoadCases, constructor.new(_3763.BoltModalAnalysesAtStiffnesses))
        return value
