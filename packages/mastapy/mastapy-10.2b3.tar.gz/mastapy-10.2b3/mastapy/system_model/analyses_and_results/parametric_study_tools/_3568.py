...
class ParametricStudyDOEResultVariable(_1113.ParetoOptimisationVariableBase):
    '''ParametricStudyDOEResultVariable
    ...
    @property
    def target(self) -> '_1115.PropertyTargetForDominantCandidateSearch':
    ...
    @target.setter
    def target(self, value: '_1115.PropertyTargetForDominantCandidateSearch'):
