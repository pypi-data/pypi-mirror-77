...
class AGMAGleasonConicalGearSetGearWhineAnalysis(_5310.ConicalGearSetGearWhineAnalysis):
    '''AGMAGleasonConicalGearSetGearWhineAnalysis
    ...
    @property
    def assembly_design(self) -> '_2077.AGMAGleasonConicalGearSet':
    ...
    @property
    def system_deflection_results(self) -> '_2235.AGMAGleasonConicalGearSetSystemDeflection':
