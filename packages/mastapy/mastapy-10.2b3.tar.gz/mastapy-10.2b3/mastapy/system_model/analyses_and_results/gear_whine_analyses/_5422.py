...
class ZerolBevelGearMeshGearWhineAnalysis(_5292.BevelGearMeshGearWhineAnalysis):
    '''ZerolBevelGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2368.ZerolBevelGearMeshSystemDeflection':
