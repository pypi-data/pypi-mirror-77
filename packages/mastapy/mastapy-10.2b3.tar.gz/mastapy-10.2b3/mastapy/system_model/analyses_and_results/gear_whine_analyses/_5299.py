...
class CoaxialConnectionGearWhineAnalysis(_5389.ShaftToMountableComponentConnectionGearWhineAnalysis):
    '''CoaxialConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2254.CoaxialConnectionSystemDeflection':
