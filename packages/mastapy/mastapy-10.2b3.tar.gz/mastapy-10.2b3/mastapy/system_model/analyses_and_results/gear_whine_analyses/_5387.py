...
class ShaftGearWhineAnalysis(_5278.AbstractShaftOrHousingGearWhineAnalysis):
    '''ShaftGearWhineAnalysis
    ...
    @property
    def coupled_modal_analysis(self) -> '_4818.ShaftModalAnalysis':
    ...
    @property
    def system_deflection_results(self) -> '_2333.ShaftSystemDeflection':
