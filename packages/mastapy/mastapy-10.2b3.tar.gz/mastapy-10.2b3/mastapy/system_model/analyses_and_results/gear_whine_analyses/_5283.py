...
class BearingGearWhineAnalysis(_5312.ConnectorGearWhineAnalysis):
    '''BearingGearWhineAnalysis
    ...
    @property
    def rolling_bearing_speed_results(self) -> '_1699.RollingBearingSpeedResults':
        ...
        return constructor.new(_1699.RollingBearingSpeedResults)(self.wrapped.RollingBearingSpeedResults) if self.wrapped.RollingBearingSpeedResults else None
    ...
    @property
    def system_deflection_results(self) -> '_2238.BearingSystemDeflection':
