...
class FlexiblePinAssemblyGearWhineAnalysis(_5391.SpecialisedAssemblyGearWhineAnalysis):
    '''FlexiblePinAssemblyGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2291.FlexiblePinAssemblySystemDeflection':
