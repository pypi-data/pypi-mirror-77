...
class StraightBevelSunGearGearWhineAnalysis(_5399.StraightBevelDiffGearGearWhineAnalysis):
    '''StraightBevelSunGearGearWhineAnalysis
    ...
    @property
    def component_design(self) -> '_2113.StraightBevelSunGear':
    ...
    @property
    def system_deflection_results(self) -> '_2349.StraightBevelSunGearSystemDeflection':
