...
class RollingRingAssemblyGearWhineAnalysis(_5391.SpecialisedAssemblyGearWhineAnalysis):
    '''RollingRingAssemblyGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2326.RollingRingAssemblySystemDeflection':
