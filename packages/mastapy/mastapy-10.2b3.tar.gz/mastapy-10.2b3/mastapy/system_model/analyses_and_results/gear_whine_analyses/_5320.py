...
class CylindricalGearMeshGearWhineAnalysis(_5344.GearMeshGearWhineAnalysis):
    '''CylindricalGearMeshGearWhineAnalysis
    ...
    @property
    def advanced_system_deflection_results(self) -> '_6305.CylindricalGearMeshAdvancedSystemDeflection':
        ...
        return constructor.new(_6305.CylindricalGearMeshAdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionResults) if self.wrapped.AdvancedSystemDeflectionResults else None
