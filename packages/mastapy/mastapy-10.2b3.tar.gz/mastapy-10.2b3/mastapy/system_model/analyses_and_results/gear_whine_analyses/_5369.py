...
class MeasurementComponentGearWhineAnalysis(_5417.VirtualComponentGearWhineAnalysis):
    '''MeasurementComponentGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2312.MeasurementComponentSystemDeflection':
