...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5789
...
class StraightBevelPlanetGearCompoundGearWhineAnalysis(_5789.StraightBevelDiffGearCompoundGearWhineAnalysis):
    '''StraightBevelPlanetGearCompoundGearWhineAnalysis
