...
class SynchroniserSleeveGearWhineAnalysis(_5409.SynchroniserPartGearWhineAnalysis):
    '''SynchroniserSleeveGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2352.SynchroniserSleeveSystemDeflection':
