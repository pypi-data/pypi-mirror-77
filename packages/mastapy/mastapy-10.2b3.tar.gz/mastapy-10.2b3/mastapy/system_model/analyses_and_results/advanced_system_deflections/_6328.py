...
class KlingelnbergCycloPalloidHypoidGearMeshAdvancedSystemDeflection(_6325.KlingelnbergCycloPalloidConicalGearMeshAdvancedSystemDeflection):
    '''KlingelnbergCycloPalloidHypoidGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6170.KlingelnbergCycloPalloidHypoidGearMeshLoadCase':
        ...
        return constructor.new(_6170.KlingelnbergCycloPalloidHypoidGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2304.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2304.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection))
        return value
