...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5056, _5094, _5089
...
class MBDRunUpAnalysisOptions(_6510.AbstractAnalysisOptions['_6225.TimeSeriesLoadCase']):
    '''MBDRunUpAnalysisOptions
    ...
    @property
    def input_velocity_processing_type(self) -> '_5056.InputVelocityForRunUpProcessingType':
        ...
        return constructor.new(_5056.InputVelocityForRunUpProcessingType)(value) if value else None

    @input_velocity_processing_type.setter
    def input_velocity_processing_type(self, value: '_5056.InputVelocityForRunUpProcessingType'):
    ...
    @property
    def shape_of_initial_acceleration_period(self) -> '_5094.ShapeOfInitialAccelerationPeriodForRunUp':
        ...
        return constructor.new(_5094.ShapeOfInitialAccelerationPeriodForRunUp)(value) if value else None

    @shape_of_initial_acceleration_period.setter
    def shape_of_initial_acceleration_period(self, value: '_5094.ShapeOfInitialAccelerationPeriodForRunUp'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ShapeOfInitialAccelerationPeriod = value

    @property
    def run_up_driving_mode(self) -> '_5089.RunUpDrivingMode':
        ...
        return constructor.new(_5089.RunUpDrivingMode)(value) if value else None

    @run_up_driving_mode.setter
    def run_up_driving_mode(self, value: '_5089.RunUpDrivingMode'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
