...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5073, _4996
...
class RootAssemblyMultiBodyDynamicsAnalysis(_4996.AssemblyMultiBodyDynamicsAnalysis):
    '''RootAssemblyMultiBodyDynamicsAnalysis
    ...
    @property
    def multi_body_dynamics_analysis_inputs(self) -> '_5073.MultiBodyDynamicsAnalysis':
        ...
        return constructor.new(_5073.MultiBodyDynamicsAnalysis)(self.wrapped.MultiBodyDynamicsAnalysisInputs) if self.wrapped.MultiBodyDynamicsAnalysisInputs else None
