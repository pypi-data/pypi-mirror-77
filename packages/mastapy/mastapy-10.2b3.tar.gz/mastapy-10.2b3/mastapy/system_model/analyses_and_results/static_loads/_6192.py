...
from mastapy.nodal_analysis.varying_input_components import _1405, _1406
from mastapy.system_model.analyses_and_results.static_loads import _6191, _6235
...
class PointLoadLoadCase(_6235.VirtualComponentLoadCase):
    '''PointLoadLoadCase
    ...
    @property
    def force_x(self) -> '_1405.ForceInputComponent':
        ...
        return constructor.new(_1405.ForceInputComponent)(self.wrapped.ForceX) if self.wrapped.ForceX else None

    @property
    def force_y(self) -> '_1405.ForceInputComponent':
        ...
        return constructor.new(_1405.ForceInputComponent)(self.wrapped.ForceY) if self.wrapped.ForceY else None

    @property
    def axial_load(self) -> '_1405.ForceInputComponent':
        ...
        return constructor.new(_1405.ForceInputComponent)(self.wrapped.AxialLoad) if self.wrapped.AxialLoad else None

    @property
    def moment_x(self) -> '_1406.MomentInputComponent':
        ...
        return constructor.new(_1406.MomentInputComponent)(self.wrapped.MomentX) if self.wrapped.MomentX else None

    @property
    def moment_y(self) -> '_1406.MomentInputComponent':
        ...
        return constructor.new(_1406.MomentInputComponent)(self.wrapped.MomentY) if self.wrapped.MomentY else None

    @property
    def moment_z(self) -> '_1406.MomentInputComponent':
        ...
        return constructor.new(_1406.MomentInputComponent)(self.wrapped.MomentZ) if self.wrapped.MomentZ else None

    def get_harmonic_load_data_for_import(self) -> '_6191.PointLoadHarmonicLoadData':
        ...
        return constructor.new(_6191.PointLoadHarmonicLoadData)(method_result) if method_result else None
