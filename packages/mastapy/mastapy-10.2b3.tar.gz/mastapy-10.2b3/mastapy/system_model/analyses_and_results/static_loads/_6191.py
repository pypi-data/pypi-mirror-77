...
from mastapy.math_utility import _1073, _1080
...
class PointLoadHarmonicLoadData(_6204.SpeedDependentHarmonicLoadData):
    '''PointLoadHarmonicLoadData
    ...
    @property
    def degree_of_freedom(self) -> '_1073.DegreesOfFreedom':
        ...
        return constructor.new(_1073.DegreesOfFreedom)(value) if value else None

    @degree_of_freedom.setter
    def degree_of_freedom(self, value: '_1073.DegreesOfFreedom'):
