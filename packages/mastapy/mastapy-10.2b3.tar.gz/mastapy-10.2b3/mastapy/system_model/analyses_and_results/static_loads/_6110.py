...
from mastapy.system_model.analyses_and_results.static_loads import _6211, _6225
...
class ConnectionLoadCase(_2203.ConnectionAnalysis):
    '''ConnectionLoadCase
    ...
    @property
    def static_load_case(self) -> '_6211.StaticLoadCase':
        ...
        return constructor.new(_6211.StaticLoadCase)(self.wrapped.StaticLoadCase) if self.wrapped.StaticLoadCase else None
