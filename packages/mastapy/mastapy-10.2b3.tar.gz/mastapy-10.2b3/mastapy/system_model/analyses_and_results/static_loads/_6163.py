...
from mastapy.system_model.imported_fes import _1933, _1957
...
class ImportedFEComponentLoadCase(_6074.AbstractShaftOrHousingLoadCase):
    '''ImportedFEComponentLoadCase
    ...
    @property
    def angle_source(self) -> '_1933.AngleSource':
        ...
        return constructor.new(_1933.AngleSource)(value) if value else None
