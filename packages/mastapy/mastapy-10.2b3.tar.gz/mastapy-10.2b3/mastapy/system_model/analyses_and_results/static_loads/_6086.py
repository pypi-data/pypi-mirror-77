...
from mastapy.system_model.analyses_and_results.static_loads import _6084, _6085, _6091
...
class BevelDifferentialGearSetLoadCase(_6091.BevelGearSetLoadCase):
    '''BevelDifferentialGearSetLoadCase
    ...
    @property
    def bevel_differential_gears_load_case(self) -> 'List[_6084.BevelDifferentialGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsLoadCase, constructor.new(_6084.BevelDifferentialGearLoadCase))
        return value

    @property
    def bevel_differential_meshes_load_case(self) -> 'List[_6085.BevelDifferentialGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesLoadCase, constructor.new(_6085.BevelDifferentialGearMeshLoadCase))
        return value
