...
class RollingRingConnectionCompoundSteadyStateSynchronousResponseAtASpeed(_2927.InterMountableComponentConnectionCompoundSteadyStateSynchronousResponseAtASpeed):
    '''RollingRingConnectionCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_design(self) -> '_1873.RollingRingConnection':
    ...
    @property
    def connection_design(self) -> '_1873.RollingRingConnection':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2830.RollingRingConnectionSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2830.RollingRingConnectionSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def connection_steady_state_synchronous_response_at_a_speed_load_cases(self) -> 'List[_2830.RollingRingConnectionSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSteadyStateSynchronousResponseAtASpeedLoadCases, constructor.new(_2830.RollingRingConnectionSteadyStateSynchronousResponseAtASpeed))
        return value
