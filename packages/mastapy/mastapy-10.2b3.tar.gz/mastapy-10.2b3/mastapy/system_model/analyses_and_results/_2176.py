...
class CompoundAnalysis:
    ...
    def perform_analysis_with_progress(self, progress: '_6529.TaskProgress'):
        ''' 'PerformAnalysis' is the original name of this method.
        ...
        self.wrapped.PerformAnalysis.Overloads[_6529.TaskProgress.TYPE](progress.wrapped if progress else None)

    def results_for(self, design_entity: '_1816.DesignEntity') -> 'Iterable[_6517.DesignEntityCompoundAnalysis]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.ResultsFor(design_entity.wrapped if design_entity else None), constructor.new(_6517.DesignEntityCompoundAnalysis))
