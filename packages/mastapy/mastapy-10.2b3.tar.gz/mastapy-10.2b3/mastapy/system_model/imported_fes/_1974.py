...
from mastapy.nodal_analysis.dev_tools_analyses import _1468, _1459
...
class ImportedFEWithSelectionModalAnalysis(_1971.ImportedFEWithSelection):
    '''ImportedFEWithSelectionModalAnalysis
    ...
    @property
    def modal_draw_style(self) -> '_1468.FEModelModalAnalysisDrawStyle':
        ...
        return constructor.new(_1468.FEModelModalAnalysisDrawStyle)(self.wrapped.ModalDrawStyle) if self.wrapped.ModalDrawStyle else None
    ...
    @property
    def fe_modal_frequencies(self) -> 'List[_1377.FEModalFrequencyComparison]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEModalFrequencies, constructor.new(_1377.FEModalFrequencyComparison))
        return value
