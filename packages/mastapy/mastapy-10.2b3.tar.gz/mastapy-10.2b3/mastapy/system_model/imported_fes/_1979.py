...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _1494
...
class MaterialPropertiesWithSelection(_0.APIBase):
    ...
    @property
    def material_properties(self) -> '_1494.MaterialPropertiesReporting':
        ...
        return constructor.new(_1494.MaterialPropertiesReporting)(self.wrapped.MaterialProperties) if self.wrapped.MaterialProperties else None
