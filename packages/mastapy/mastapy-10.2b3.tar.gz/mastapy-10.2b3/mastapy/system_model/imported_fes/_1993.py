...
from mastapy.system_model.imported_fes import _1986, _1985
...
class SystemDeflectionFEExportOptions(_0.APIBase):
    ...
    @property
    def nodes(self) -> 'List[_1986.PerNodeExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Nodes, constructor.new(_1986.PerNodeExportOptions))
        return value

    @property
    def links(self) -> 'List[_1985.PerLinkExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1985.PerLinkExportOptions))
        return value
