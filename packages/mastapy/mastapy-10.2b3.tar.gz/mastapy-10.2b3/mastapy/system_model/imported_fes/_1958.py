...
from mastapy.system_model.imported_fes import _1947, _1963
...
class ImportedFEElectricMachineStatorLink(_1963.ImportedFEMultiNodeLink):
    '''ImportedFEElectricMachineStatorLink
    ...
    @property
    def electric_machine_dynamic_load_data(self) -> '_1947.ElectricMachineDynamicLoadData':
        ...
        return constructor.new(_1947.ElectricMachineDynamicLoadData)(self.wrapped.ElectricMachineDynamicLoadData) if self.wrapped.ElectricMachineDynamicLoadData else None
