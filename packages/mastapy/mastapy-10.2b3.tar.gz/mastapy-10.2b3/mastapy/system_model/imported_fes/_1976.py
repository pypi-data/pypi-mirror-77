...
class IndependentMastaCreatedCondensationNode(_0.APIBase):
    ...
    @property
    def rigid_coupling_type(self) -> '_1480.RigidCouplingType':
        ...
        return constructor.new(_1480.RigidCouplingType)(value) if value else None

    @rigid_coupling_type.setter
    def rigid_coupling_type(self, value: '_1480.RigidCouplingType'):
    ...
    @property
    def imported_fe_node(self) -> '_1969.ImportedFEStiffnessNode':
        ...
        return constructor.new(_1969.ImportedFEStiffnessNode)(self.wrapped.ImportedFENode) if self.wrapped.ImportedFENode else None
