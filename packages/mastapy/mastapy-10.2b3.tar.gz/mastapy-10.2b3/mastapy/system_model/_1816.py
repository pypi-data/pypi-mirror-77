...
from mastapy.utility.scripting import _1272
...
class DesignEntity(_0.APIBase):
    ...
    @property
    def design_properties(self) -> '_1813.Design':
        ...
        return constructor.new(_1813.Design)(self.wrapped.DesignProperties) if self.wrapped.DesignProperties else None

    @property
    def user_specified_data(self) -> '_1272.UserSpecifiedData':
        ...
        return constructor.new(_1272.UserSpecifiedData)(self.wrapped.UserSpecifiedData) if self.wrapped.UserSpecifiedData else None
