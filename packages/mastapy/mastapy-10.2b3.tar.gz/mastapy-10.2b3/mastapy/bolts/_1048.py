...
from mastapy.bolts import _1039
...
class ClampedSection(_0.APIBase):
    ...
    @property
    def material(self) -> '_1039.BoltedJointMaterial':
        ...
        return constructor.new(_1039.BoltedJointMaterial)(self.wrapped.Material) if self.wrapped.Material else None
