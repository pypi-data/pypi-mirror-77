...
class ParetoOptimisationStrategyChartInformation(_0.APIBase):
    ...
    @property
    def bars(self) -> 'List[_1110.ParetoOptimisationStrategyBars]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Bars, constructor.new(_1110.ParetoOptimisationStrategyBars))
        return value
