...
from mastapy.math_utility.stiffness_calculators import _1097
...
class SurfaceToSurfaceContactStiffnessEntity(_1430.ArbitraryNodalComponent):
    '''SurfaceToSurfaceContactStiffnessEntity
    ...
    @property
    def contact(self) -> '_1097.SurfaceToSurfaceContact':
        ...
        return constructor.new(_1097.SurfaceToSurfaceContact)(self.wrapped.Contact) if self.wrapped.Contact else None
