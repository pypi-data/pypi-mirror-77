...
class CylindricalMeshedGearLoadDistributionAnalysis(_0.APIBase):
    ...
    def contact_patch_detailed(self, result_type: '_610.ContactResultType', number_of_face_width_steps: 'int', number_of_roll_distance_steps: 'int') -> '_1081.GriddedSurface':
        ...
        method_result = self.wrapped.ContactPatch.Overloads[_610.ContactResultType.type_(), int, int](result_type, number_of_face_width_steps if number_of_face_width_steps else 0, number_of_roll_distance_steps if number_of_roll_distance_steps else 0)
        return constructor.new(_1081.GriddedSurface)(method_result) if method_result else None

    def contact_patch(self, result_type: '_610.ContactResultType', include_tip_contact: 'bool') -> '_1081.GriddedSurface':
        ''' 'ContactPatch' is the original name of this method.
        ...
        method_result = self.wrapped.ContactPatch.Overloads[_610.ContactResultType.type_(), bool](result_type, include_tip_contact if include_tip_contact else False)
        return constructor.new(_1081.GriddedSurface)(method_result) if method_result else None
