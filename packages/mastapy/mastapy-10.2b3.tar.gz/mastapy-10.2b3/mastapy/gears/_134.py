...
class GearSetOptimiser(_0.APIBase):
    ...
    def perform_strength_optimisation(self, number_of_results: 'int', use_current_design_as_starting_point: Optional['bool'] = False) -> '_133.GearSetOptimisationResults':
        ...
        method_result = self.wrapped.PerformStrengthOptimisation.Overloads[int, bool](number_of_results if number_of_results else 0, use_current_design_as_starting_point if use_current_design_as_starting_point else False)
        return constructor.new(_133.GearSetOptimisationResults)(method_result) if method_result else None

    def perform_strength_optimisation_with_progress(self, number_of_results: 'int', progress: '_6529.TaskProgress', use_current_design_as_starting_point: Optional['bool'] = False) -> '_133.GearSetOptimisationResults':
        ''' 'PerformStrengthOptimisation' is the original name of this method.
        ...
        number_of_results = int(number_of_results)
        use_current_design_as_starting_point = bool(use_current_design_as_starting_point)
        method_result = self.wrapped.PerformStrengthOptimisation.Overloads[int, _6529.TaskProgress.TYPE, bool](number_of_results if number_of_results else 0, progress.wrapped if progress else None, use_current_design_as_starting_point if use_current_design_as_starting_point else False)
        return constructor.new(_133.GearSetOptimisationResults)(method_result) if method_result else None
