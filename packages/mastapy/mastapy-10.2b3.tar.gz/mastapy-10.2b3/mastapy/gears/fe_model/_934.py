...
class GearFEModel(_955.GearImplementationDetail):
    ...
    def calculate_stiffness_from_fe_with_progress(self, progress: '_6529.TaskProgress'):
        ''' 'CalculateStiffnessFromFE' is the original name of this method.
        ...
        self.wrapped.CalculateStiffnessFromFE.Overloads[_6529.TaskProgress.TYPE](progress.wrapped if progress else None)
    ...
    def get_stress_influence_coefficients_from_fe(self, flank: '_128.GearFlanks'):
        ...
        self.wrapped.GetStressInfluenceCoefficientsFromFE.Overloads[_128.GearFlanks.type_()](flank)

    def get_stress_influence_coefficients_from_fe_with_progress(self, flank: '_128.GearFlanks', progress: '_6529.TaskProgress'):
        ''' 'GetStressInfluenceCoefficientsFromFE' is the original name of this method.
        ...
        flank = conversion.mp_to_pn_enum(flank)
        self.wrapped.GetStressInfluenceCoefficientsFromFE.Overloads[_128.GearFlanks.type_(), _6529.TaskProgress.TYPE](flank, progress.wrapped if progress else None)
