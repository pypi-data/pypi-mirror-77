...
class RollingBearing(_1751.DetailedBearing):
    '''RollingBearing
    ...
    @property
    def catalogue(self) -> '_1515.BearingCatalog':
        ...
        return constructor.new(_1515.BearingCatalog)(value) if value else None
    ...
    @property
    def type_information(self) -> '_1766.BearingTypeExtraInformation':
        ...
        return constructor.new(_1766.BearingTypeExtraInformation)(value) if value else None
    ...
    @property
    def cage_material(self) -> '_1518.BearingCageMaterial':
        ...
        return constructor.new(_1518.BearingCageMaterial)(value) if value else None

    @cage_material.setter
    def cage_material(self, value: '_1518.BearingCageMaterial'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CageMaterial = value

    @property
    def sleeve_type(self) -> '_1781.SleeveType':
        ...
        return constructor.new(_1781.SleeveType)(value) if value else None
    ...
    @property
    def protection(self) -> '_1763.BearingProtection':
        ...
        return constructor.new(_1763.BearingProtection)(self.wrapped.Protection) if self.wrapped.Protection else None
