...
class LoadedPlainJournalBearingRow(_0.APIBase):
    ...
    def row(self) -> '_1524.BearingRow':
        ...
        return constructor.new(_1524.BearingRow)(value) if value else None
    ...
    @property
    def journal_bearing_loading_chart(self) -> '_6532.SMTBitmap':
        ...
        return constructor.new(_6532.SMTBitmap)(self.wrapped.JournalBearingLoadingChart) if self.wrapped.JournalBearingLoadingChart else None
