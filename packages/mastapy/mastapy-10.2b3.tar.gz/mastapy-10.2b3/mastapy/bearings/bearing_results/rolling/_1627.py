...
from mastapy.bearings.bearing_results.rolling import _1626, _1624
...
class LoadedAxialThrustNeedleRollerBearingRow(_1624.LoadedAxialThrustCylindricalRollerBearingRow):
    '''LoadedAxialThrustNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1626.LoadedAxialThrustNeedleRollerBearingResults':
