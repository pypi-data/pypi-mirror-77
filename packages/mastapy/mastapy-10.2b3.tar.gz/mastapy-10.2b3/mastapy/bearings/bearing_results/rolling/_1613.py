...
from mastapy.bearings.bearing_results.rolling import _1612, _1632
...
class LoadedAngularContactBallBearingRow(_1632.LoadedBallBearingRow):
    '''LoadedAngularContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1612.LoadedAngularContactBallBearingResults':
