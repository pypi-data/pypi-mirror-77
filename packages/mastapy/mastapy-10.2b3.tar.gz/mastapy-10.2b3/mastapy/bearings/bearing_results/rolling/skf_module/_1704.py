...
from mastapy.bearings.bearing_results.rolling.skf_module import _1705, _1721
...
class AdjustedSpeed(_1721.SKFCalculationResult):
    '''AdjustedSpeed
    ...
    @property
    def adjustment_factors(self) -> '_1705.AdjustmentFactors':
        ...
        return constructor.new(_1705.AdjustmentFactors)(self.wrapped.AdjustmentFactors) if self.wrapped.AdjustmentFactors else None
