...
class GreaseLifeAndRelubricationInterval(_1721.SKFCalculationResult):
    '''GreaseLifeAndRelubricationInterval
    ...
    def grease(self) -> '_1713.Grease':
        ...
        return constructor.new(_1713.Grease)(self.wrapped.Grease) if self.wrapped.Grease else None

    @property
    def initial_fill(self) -> '_1716.InitialFill':
        ...
        return constructor.new(_1716.InitialFill)(self.wrapped.InitialFill) if self.wrapped.InitialFill else None

    @property
    def grease_quantity(self) -> '_1715.GreaseQuantity':
        ...
        return constructor.new(_1715.GreaseQuantity)(self.wrapped.GreaseQuantity) if self.wrapped.GreaseQuantity else None
