...
from mastapy.bearings.bearing_results.rolling import _1612
...
class LoadedAngularContactThrustBallBearingResults(_1612.LoadedAngularContactBallBearingResults):
    '''LoadedAngularContactThrustBallBearingResults
