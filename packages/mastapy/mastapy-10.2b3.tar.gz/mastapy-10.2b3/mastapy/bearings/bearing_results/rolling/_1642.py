...
from mastapy.bearings.bearing_results.rolling import _1641, _1632
...
class LoadedDeepGrooveBallBearingRow(_1632.LoadedBallBearingRow):
    '''LoadedDeepGrooveBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1641.LoadedDeepGrooveBallBearingResults':
