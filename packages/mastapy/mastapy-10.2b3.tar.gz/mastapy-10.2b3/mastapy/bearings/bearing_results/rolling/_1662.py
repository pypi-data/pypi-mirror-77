...
from mastapy.bearings.bearing_results.rolling.fitting import _1737, _1735, _1738
from mastapy.bearings.bearing_results.rolling import (
    _1606, _1603, _1690, _1663
)
from mastapy.bearings.bearing_results.rolling.iso_rating_results import (
    _1728, _1726, _1732, _1731,
    _1727, _1733, _1729
)
from mastapy._internal.cast_exception import CastException
from mastapy.bearings.bearing_results.rolling.skf_module import _1723
...
class LoadedRollingBearingResults(_1590.LoadedDetailedBearingResults):
    '''LoadedRollingBearingResults
    ...
    @property
    def fluid_film_temperature_source(self) -> '_1528.FluidFilmTemperatureOptions':
        ...
        return constructor.new(_1528.FluidFilmTemperatureOptions)(value) if value else None
    ...
    @property
    def outer_ring_fitting_at_assembly(self) -> '_1737.OuterRingFittingThermalResults':
        ...
        return constructor.new(_1737.OuterRingFittingThermalResults)(self.wrapped.OuterRingFittingAtAssembly) if self.wrapped.OuterRingFittingAtAssembly else None

    @property
    def outer_ring_fitting_at_operating_conditions(self) -> '_1737.OuterRingFittingThermalResults':
        ...
        return constructor.new(_1737.OuterRingFittingThermalResults)(self.wrapped.OuterRingFittingAtOperatingConditions) if self.wrapped.OuterRingFittingAtOperatingConditions else None

    @property
    def inner_ring_fitting_at_assembly(self) -> '_1735.InnerRingFittingThermalResults':
        ...
        return constructor.new(_1735.InnerRingFittingThermalResults)(self.wrapped.InnerRingFittingAtAssembly) if self.wrapped.InnerRingFittingAtAssembly else None

    @property
    def inner_ring_fitting_at_operating_conditions(self) -> '_1735.InnerRingFittingThermalResults':
        ...
        return constructor.new(_1735.InnerRingFittingThermalResults)(self.wrapped.InnerRingFittingAtOperatingConditions) if self.wrapped.InnerRingFittingAtOperatingConditions else None
    ...
    @property
    def din732(self) -> '_1603.DIN732Results':
        ...
        return constructor.new(_1603.DIN732Results)(self.wrapped.DIN732) if self.wrapped.DIN732 else None

    @property
    def iso2812007(self) -> '_1728.ISO2812007Results':
        ...
        return constructor.new(_1728.ISO2812007Results)(self.wrapped.ISO2812007) if self.wrapped.ISO2812007 else None

    @property
    def iso2812007_of_type_ball_iso2812007_results(self) -> '_1726.BallISO2812007Results':
        ...
        if _1726.BallISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
        ...
        return constructor.new(_1726.BallISO2812007Results)(self.wrapped.ISO2812007) if self.wrapped.ISO2812007 else None

    @property
    def iso2812007_of_type_roller_iso2812007_results(self) -> '_1732.RollerISO2812007Results':
        ...
        if _1732.RollerISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
        ...
        return constructor.new(_1732.RollerISO2812007Results)(self.wrapped.ISO2812007) if self.wrapped.ISO2812007 else None

    @property
    def isots162812008(self) -> '_1731.ISOTS162812008Results':
        ...
        return constructor.new(_1731.ISOTS162812008Results)(self.wrapped.ISOTS162812008) if self.wrapped.ISOTS162812008 else None

    @property
    def isots162812008_of_type_ball_isots162812008_results(self) -> '_1727.BallISOTS162812008Results':
        ...
        if _1727.BallISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
        ...
        return constructor.new(_1727.BallISOTS162812008Results)(self.wrapped.ISOTS162812008) if self.wrapped.ISOTS162812008 else None

    @property
    def isots162812008_of_type_roller_isots162812008_results(self) -> '_1733.RollerISOTS162812008Results':
        ...
        if _1733.RollerISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
        ...
        return constructor.new(_1733.RollerISOTS162812008Results)(self.wrapped.ISOTS162812008) if self.wrapped.ISOTS162812008 else None

    @property
    def iso762006(self) -> '_1729.ISO762006Results':
        ...
        return constructor.new(_1729.ISO762006Results)(self.wrapped.ISO762006) if self.wrapped.ISO762006 else None

    @property
    def maximum_static_contact_stress(self) -> '_1690.MaximumStaticContactStress':
        ...
        return constructor.new(_1690.MaximumStaticContactStress)(self.wrapped.MaximumStaticContactStress) if self.wrapped.MaximumStaticContactStress else None

    @property
    def skf_module_results(self) -> '_1723.SKFModuleResults':
        ...
        return constructor.new(_1723.SKFModuleResults)(self.wrapped.SKFModuleResults) if self.wrapped.SKFModuleResults else None

    @property
    def rows(self) -> 'List[_1663.LoadedRollingBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Rows, constructor.new(_1663.LoadedRollingBearingRow))
        return value

    @property
    def all_mounting_results(self) -> 'List[_1738.RingFittingThermalResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllMountingResults, constructor.new(_1738.RingFittingThermalResults))
        return value
