...
from mastapy.bearings.bearing_results.rolling import _1648
...
class LoadedThreePointContactBallBearingElement(_1648.LoadedMultiPointContactBallBearingElement):
    '''LoadedThreePointContactBallBearingElement
