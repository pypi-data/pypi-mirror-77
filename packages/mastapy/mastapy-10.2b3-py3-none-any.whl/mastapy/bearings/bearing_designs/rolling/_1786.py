...
from mastapy.bearings.bearing_designs.rolling import _1760
...
class ThrustBallBearing(_1760.BallBearing):
    '''ThrustBallBearing
    ...
    @property
    def outer_ring_mounting(self) -> '_1533.OuterRingMounting':
        ...
        return constructor.new(_1533.OuterRingMounting)(value) if value else None

    @outer_ring_mounting.setter
    def outer_ring_mounting(self, value: '_1533.OuterRingMounting'):
