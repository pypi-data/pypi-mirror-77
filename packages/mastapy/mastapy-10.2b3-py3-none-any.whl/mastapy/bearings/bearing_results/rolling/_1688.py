...
from mastapy.bearings.bearing_results.rolling import _1687, _1659
...
class LoadedToroidalRollerBearingRow(_1659.LoadedRollerBearingRow):
    '''LoadedToroidalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1687.LoadedToroidalRollerBearingResults':
