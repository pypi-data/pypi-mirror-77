...
from mastapy.bearings.bearing_results.fluid_film import _1743
...
class LoadedPlainJournalBearingResults(_1590.LoadedDetailedBearingResults):
    '''LoadedPlainJournalBearingResults
    ...
    @property
    def journal_bearing_rows(self) -> 'List[_1743.LoadedPlainJournalBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.JournalBearingRows, constructor.new(_1743.LoadedPlainJournalBearingRow))
        return value
