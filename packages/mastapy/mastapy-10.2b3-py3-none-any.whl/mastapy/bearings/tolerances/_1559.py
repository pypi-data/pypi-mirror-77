...
from mastapy.bearings.tolerances import _1560, _1557
...
class RoundnessSpecification(_1140.IndependentReportablePropertiesBase['RoundnessSpecification']):
    '''RoundnessSpecification
    ...
    @property
    def specification_type(self) -> '_1560.RoundnessSpecificationType':
        ...
        return constructor.new(_1560.RoundnessSpecificationType)(value) if value else None

    @specification_type.setter
    def specification_type(self, value: '_1560.RoundnessSpecificationType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.SpecificationType = value

    @property
    def roundness_distribution(self) -> 'List[_1557.RaceRoundnessAtAngle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RoundnessDistribution, constructor.new(_1557.RaceRoundnessAtAngle))
        return value
