...
from mastapy.utility.units_and_measurements.measurements import _1186
...
class DutyCyclePropertySummaryForce(_1355.DutyCyclePropertySummary['_1186.Force', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryForce
