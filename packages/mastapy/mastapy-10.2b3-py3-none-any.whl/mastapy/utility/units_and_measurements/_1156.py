...
class MeasurementBase(_0.APIBase):
    ...
    @property
    def rounding_method(self) -> '_1149.RoundingMethods':
        ...
        return constructor.new(_1149.RoundingMethods)(value) if value else None

    @rounding_method.setter
    def rounding_method(self, value: '_1149.RoundingMethods'):
    ...
    @property
    def current_unit(self) -> '_1161.Unit':
        ...
        return constructor.new(_1161.Unit)(self.wrapped.CurrentUnit) if self.wrapped.CurrentUnit else None
