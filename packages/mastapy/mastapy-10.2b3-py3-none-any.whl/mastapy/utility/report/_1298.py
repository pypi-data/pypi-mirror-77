...
from mastapy.utility.report import _1299, _1302
...
TItem = TypeVar('TItem', bound='_1302.CustomReportPropertyItem')


class CustomReportMultiPropertyItem(_1299.CustomReportMultiPropertyItemBase, Generic[TItem]):
    '''CustomReportMultiPropertyItem
