...
from mastapy.utility.report import _1313, _1312
...
class CustomReportPropertyItem(_0.APIBase):
    ...
    @property
    def font_weight(self) -> '_1313.FontWeight':
        '''FontWeight: 'FontWeight' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FontWeight)
        return constructor.new(_1313.FontWeight)(value) if value else None

    @font_weight.setter
    def font_weight(self, value: '_1313.FontWeight'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FontWeight = value

    @property
    def font_style(self) -> '_1312.FontStyle':
        '''FontStyle: 'FontStyle' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FontStyle)
        return constructor.new(_1312.FontStyle)(value) if value else None

    @font_style.setter
    def font_style(self, value: '_1312.FontStyle'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FontStyle = value

    @property
    def horizontal_position(self) -> '_1273.CellValuePosition':
        ...
        return constructor.new(_1273.CellValuePosition)(value) if value else None

    @horizontal_position.setter
    def horizontal_position(self, value: '_1273.CellValuePosition'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
