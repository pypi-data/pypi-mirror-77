...
from mastapy.detailed_rigid_connectors.splines import _989, _998, _1006
...
class DIN5480SplineHalfDesign(_1006.StandardSplineHalfDesign):
    '''DIN5480SplineHalfDesign
    ...
    @property
    def manufacturing_type(self) -> '_989.ManufacturingTypes':
        ...
        return constructor.new(_989.ManufacturingTypes)(value) if value else None

    @manufacturing_type.setter
    def manufacturing_type(self, value: '_989.ManufacturingTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ManufacturingType = value

    @property
    def finishing_method(self) -> '_998.FinishingMethods':
        ...
        return constructor.new(_998.FinishingMethods)(value) if value else None

    @finishing_method.setter
    def finishing_method(self, value: '_998.FinishingMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
