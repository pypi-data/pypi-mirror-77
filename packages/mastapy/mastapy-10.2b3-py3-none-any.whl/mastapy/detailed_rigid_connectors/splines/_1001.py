...
class SplineHalfDesign(_975.DetailedRigidConnectorHalfDesign):
    '''SplineHalfDesign
    ...
    @property
    def heat_treatment(self) -> '_985.HeatTreatmentTypes':
        ...
        return constructor.new(_985.HeatTreatmentTypes)(value) if value else None

    @heat_treatment.setter
    def heat_treatment(self, value: '_985.HeatTreatmentTypes'):
    ...
    @property
    def fit_and_tolerance(self) -> '_1008.FitAndTolerance':
        ...
        return constructor.new(_1008.FitAndTolerance)(self.wrapped.FitAndTolerance) if self.wrapped.FitAndTolerance else None
