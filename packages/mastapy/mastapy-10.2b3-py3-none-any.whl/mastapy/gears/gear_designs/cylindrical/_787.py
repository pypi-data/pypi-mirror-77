...
class CylindricalGearSetDesign(_716.GearSetDesign):
    ...
    @property
    def micro_geometries(self) -> 'List[_854.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MicroGeometries, constructor.new(_854.CylindricalGearSetMicroGeometry))
        return value

    @property
    def manufacturing_configurations(self) -> 'List[_410.CylindricalSetManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ManufacturingConfigurations, constructor.new(_410.CylindricalSetManufacturingConfig))
        return value
    ...
    def set_active_manufacturing_configuration(self, value: '_410.CylindricalSetManufacturingConfig'):
    ...
    def add_new_manufacturing_configuration(self, new_config_name: Optional['str'] = 'None') -> '_410.CylindricalSetManufacturingConfig':
        ...
        return constructor.new(_410.CylindricalSetManufacturingConfig)(method_result) if method_result else None
    ...
    def delete_manufacturing_configuration(self, config: '_410.CylindricalSetManufacturingConfig'):
    ...
    def add_new_micro_geometry(self) -> '_854.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_854.CylindricalGearSetMicroGeometry)(method_result) if method_result else None

    def delete_micro_geometry(self, micro_geometry: '_854.CylindricalGearSetMicroGeometry'):
    ...
    def set_active_micro_geometry(self, value: '_854.CylindricalGearSetMicroGeometry'):
    ...
    def micro_geometry_named(self, micro_geometry_name: 'str') -> '_854.CylindricalGearSetMicroGeometry':
