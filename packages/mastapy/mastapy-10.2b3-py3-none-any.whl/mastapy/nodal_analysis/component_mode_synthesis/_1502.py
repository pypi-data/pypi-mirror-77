...
class CMSOptions(_0.APIBase):
    ...
    @property
    def precision_when_saving_expansion_vectors(self) -> '_1072.DataPrecision':
        ...
        return constructor.new(_1072.DataPrecision)(value) if value else None

    @precision_when_saving_expansion_vectors.setter
    def precision_when_saving_expansion_vectors(self, value: '_1072.DataPrecision'):
    ...
    @property
    def internal_mode_options(self) -> '_1459.EigenvalueOptions':
        ...
        return constructor.new(_1459.EigenvalueOptions)(self.wrapped.InternalModeOptions) if self.wrapped.InternalModeOptions else None
