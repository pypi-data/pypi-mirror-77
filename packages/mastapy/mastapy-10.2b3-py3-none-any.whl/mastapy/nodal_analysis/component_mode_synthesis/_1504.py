...
from mastapy.nodal_analysis.dev_tools_analyses import _1464
from mastapy.nodal_analysis.component_mode_synthesis import _1502, _1499
...
class FullFEModel(_0.APIBase):
    ...
    @property
    def fe_model(self) -> '_1464.FEModel':
        ...
        return constructor.new(_1464.FEModel)(self.wrapped.FEModel) if self.wrapped.FEModel else None

    @property
    def reduction_options(self) -> '_1502.CMSOptions':
        ...
        return constructor.new(_1502.CMSOptions)(self.wrapped.ReductionOptions) if self.wrapped.ReductionOptions else None

    @property
    def element_face_groups(self) -> 'List[_1499.CMSElementFaceGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElementFaceGroups, constructor.new(_1499.CMSElementFaceGroup))
        return value
