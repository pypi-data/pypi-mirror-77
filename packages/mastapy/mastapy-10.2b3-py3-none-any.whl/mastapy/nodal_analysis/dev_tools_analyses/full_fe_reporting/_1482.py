...
from mastapy.fe_tools.vis_tools_visualisation.enums import _966
...
class CoordinateSystemReporting(_0.APIBase):
    ...
    @property
    def type_(self) -> '_966.CoordinateSystemType':
        ...
        return constructor.new(_966.CoordinateSystemType)(value) if value else None
