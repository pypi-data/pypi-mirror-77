...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _1485
...
class ElementPropertiesMass(_1485.ElementPropertiesBase):
    '''ElementPropertiesMass
    ...
    @property
    def inertia(self) -> '_1083.InertiaTensor':
        ...
        return constructor.new(_1083.InertiaTensor)(self.wrapped.Inertia) if self.wrapped.Inertia else None
