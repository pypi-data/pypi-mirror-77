...
class FEModel(_0.APIBase):
    ...
    @property
    def rigid_element_properties(self) -> 'List[_1489.ElementPropertiesRigid]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidElementProperties, constructor.new(_1489.ElementPropertiesRigid))
        return value

    @property
    def solid_element_properties(self) -> 'List[_1491.ElementPropertiesSolid]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SolidElementProperties, constructor.new(_1491.ElementPropertiesSolid))
        return value

    @property
    def shell_element_properties(self) -> 'List[_1490.ElementPropertiesShell]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShellElementProperties, constructor.new(_1490.ElementPropertiesShell))
        return value

    @property
    def beam_element_properties(self) -> 'List[_1486.ElementPropertiesBeam]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BeamElementProperties, constructor.new(_1486.ElementPropertiesBeam))
        return value

    @property
    def spring_dashpot_element_properties(self) -> 'List[_1492.ElementPropertiesSpringDashpot]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpringDashpotElementProperties, constructor.new(_1492.ElementPropertiesSpringDashpot))
        return value

    @property
    def mass_element_properties(self) -> 'List[_1488.ElementPropertiesMass]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MassElementProperties, constructor.new(_1488.ElementPropertiesMass))
        return value

    @property
    def interface_element_properties(self) -> 'List[_1487.ElementPropertiesInterface]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InterfaceElementProperties, constructor.new(_1487.ElementPropertiesInterface))
        return value

    @property
    def other_element_properties(self) -> 'List[_1485.ElementPropertiesBase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OtherElementProperties, constructor.new(_1485.ElementPropertiesBase))
        return value

    @property
    def materials(self) -> 'List[_1494.MaterialPropertiesReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Materials, constructor.new(_1494.MaterialPropertiesReporting))
        return value

    @property
    def coordinate_systems(self) -> 'List[_1482.CoordinateSystemReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CoordinateSystems, constructor.new(_1482.CoordinateSystemReporting))
        return value

    @property
    def contact_pairs(self) -> 'List[_1481.ContactPairReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ContactPairs, constructor.new(_1481.ContactPairReporting))
        return value
