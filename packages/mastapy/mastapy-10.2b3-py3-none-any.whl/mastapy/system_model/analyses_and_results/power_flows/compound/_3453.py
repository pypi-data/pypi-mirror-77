...
class ShaftCompoundPowerFlow(_3367.AbstractShaftOrHousingCompoundPowerFlow):
    '''ShaftCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3332.ShaftPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3332.ShaftPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_3332.ShaftPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_3332.ShaftPowerFlow))
        return value
