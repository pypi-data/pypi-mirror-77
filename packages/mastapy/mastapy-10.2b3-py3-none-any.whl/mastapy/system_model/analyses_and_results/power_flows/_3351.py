...
from mastapy.system_model.analyses_and_results.power_flows import _3349, _3334
...
class SynchroniserPowerFlow(_3334.SpecialisedAssemblyPowerFlow):
    '''SynchroniserPowerFlow
    ...
    @property
    def cones(self) -> 'List[_3349.SynchroniserHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_3349.SynchroniserHalfPowerFlow))
        return value
