...
from mastapy.system_model.analyses_and_results.static_loads import _6125, _6156, _6137
...
class HarmonicLoadDataJMAGImport(_6156.HarmonicLoadDataImportFromMotorPackages['_6137.ElectricMachineHarmonicLoadJMAGImportOptions']):
    '''HarmonicLoadDataJMAGImport
    ...
    @property
    def electric_machine_data_per_speed(self) -> 'List[_6125.DataFromJMAGPerSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElectricMachineDataPerSpeed, constructor.new(_6125.DataFromJMAGPerSpeed))
        return value
