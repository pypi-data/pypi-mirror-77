...
class PlanetaryGearSetLoadCase(_6122.CylindricalGearSetLoadCase):
    '''PlanetaryGearSetLoadCase
    ...
    @property
    def include_gear_blank_elastic_distortion(self) -> '_1143.LoadCaseOverrideOption':
    ...
    def include_gear_blank_elastic_distortion(self, value: '_1143.LoadCaseOverrideOption'):
    ...
    @property
    def assembly_design(self) -> '_2105.PlanetaryGearSet':
