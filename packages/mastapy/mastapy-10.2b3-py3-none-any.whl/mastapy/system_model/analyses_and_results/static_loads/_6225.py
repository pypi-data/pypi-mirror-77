...
class TimeSeriesLoadCase(_6072.LoadCase):
    '''TimeSeriesLoadCase
    ...
    @property
    def driva_analysis_options(self) -> '_5069.MBDAnalysisOptions':
        ...
        return constructor.new(_5069.MBDAnalysisOptions)(self.wrapped.DRIVAAnalysisOptions) if self.wrapped.DRIVAAnalysisOptions else None
