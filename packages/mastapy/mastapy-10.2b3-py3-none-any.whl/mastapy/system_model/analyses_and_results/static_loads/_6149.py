...
from mastapy.system_model.analyses_and_results.static_loads import _6148, _6153
...
class GearSetHarmonicLoadData(_6153.HarmonicLoadDataBase):
    '''GearSetHarmonicLoadData
    ...
    @property
    def gear_mesh_te_order_type(self) -> '_6148.GearMeshTEOrderType':
        ...
        return constructor.new(_6148.GearMeshTEOrderType)(value) if value else None

    @gear_mesh_te_order_type.setter
    def gear_mesh_te_order_type(self, value: '_6148.GearMeshTEOrderType'):
