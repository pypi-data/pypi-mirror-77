...
from mastapy.system_model import _1825, _1826, _1827
from mastapy.system_model.analyses_and_results.mbd_analyses import _5122
from mastapy.system_model.analyses_and_results.static_loads import _6231, _6130, _6235
from mastapy.system_model.imported_fes import _1946
...
class PowerLoadLoadCase(_6235.VirtualComponentLoadCase):
    '''PowerLoadLoadCase
    ...
    @property
    def drag_torque_specification_method(self) -> '_1825.PowerLoadDragTorqueSpecificationMethod':
        ...
        return constructor.new(_1825.PowerLoadDragTorqueSpecificationMethod)(value) if value else None

    @drag_torque_specification_method.setter
    def drag_torque_specification_method(self, value: '_1825.PowerLoadDragTorqueSpecificationMethod'):
    ...
    @property
    def wheel_slip_model(self) -> '_5122.WheelSlipType':
        ...
        return constructor.new(_5122.WheelSlipType)(value) if value else None

    @wheel_slip_model.setter
    def wheel_slip_model(self, value: '_5122.WheelSlipType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def target_speed_input_type(self) -> '_1827.PowerLoadPIDControlSpeedInputType':
        ...
        return constructor.new(_1827.PowerLoadPIDControlSpeedInputType)(value) if value else None

    @target_speed_input_type.setter
    def target_speed_input_type(self, value: '_1827.PowerLoadPIDControlSpeedInputType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def component_design(self) -> '_2037.PowerLoad':
    ...
    @property
    def engine_idle_speed_control_pid_settings(self) -> '_1131.PIDControlSettings':
        ...
        return constructor.new(_1131.PIDControlSettings)(self.wrapped.EngineIdleSpeedControlPIDSettings) if self.wrapped.EngineIdleSpeedControlPIDSettings else None

    @property
    def coefficient_of_friction_with_ground(self) -> '_1407.NonDimensionalInputComponent':
        ...
        return constructor.new(_1407.NonDimensionalInputComponent)(self.wrapped.CoefficientOfFrictionWithGround) if self.wrapped.CoefficientOfFrictionWithGround else None

    @property
    def pid_control_settings(self) -> '_1131.PIDControlSettings':
        ...
        return constructor.new(_1131.PIDControlSettings)(self.wrapped.PIDControlSettings) if self.wrapped.PIDControlSettings else None

    def get_harmonic_load_data_for_import(self) -> '_6130.ElectricMachineHarmonicLoadData':
        ...
        return constructor.new(_6130.ElectricMachineHarmonicLoadData)(method_result) if method_result else None
