...
from mastapy.system_model.analyses_and_results.static_loads import _6117, _6083
...
class CVTLoadCase(_6083.BeltDriveLoadCase):
    '''CVTLoadCase
    ...
    @property
    def assembly_design(self) -> '_2144.CVT':
    ...
    @property
    def pulleys(self) -> 'List[_6117.CVTPulleyLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_6117.CVTPulleyLoadCase))
        return value
