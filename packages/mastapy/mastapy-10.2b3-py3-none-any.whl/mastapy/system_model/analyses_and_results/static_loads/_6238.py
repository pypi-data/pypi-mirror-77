...
from mastapy.system_model.analyses_and_results.static_loads import _6236, _6237, _6150
...
class WormGearSetLoadCase(_6150.GearSetLoadCase):
    '''WormGearSetLoadCase
    ...
    @property
    def worm_gears_load_case(self) -> 'List[_6236.WormGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsLoadCase, constructor.new(_6236.WormGearLoadCase))
        return value

    @property
    def worm_meshes_load_case(self) -> 'List[_6237.WormGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesLoadCase, constructor.new(_6237.WormGearMeshLoadCase))
        return value
