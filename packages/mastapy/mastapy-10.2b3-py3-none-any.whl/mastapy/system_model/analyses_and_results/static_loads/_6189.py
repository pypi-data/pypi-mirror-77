...
from mastapy.system_model.analyses_and_results.static_loads import _6188, _6178
...
class PlanetCarrierLoadCase(_6178.MountableComponentLoadCase):
    '''PlanetCarrierLoadCase
    ...
    @property
    def planet_manufacture_errors(self) -> 'List[_6188.PlanetarySocketManufactureError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetManufactureErrors, constructor.new(_6188.PlanetarySocketManufactureError))
        return value
