...
from mastapy.system_model.analyses_and_results import _2208
...
class PartLoadCase(_2208.PartAnalysis):
    '''PartLoadCase
    ...
    def get_harmonic_load_data_for_import(self) -> '_6153.HarmonicLoadDataBase':
        ...
        return constructor.new(_6153.HarmonicLoadDataBase)(method_result) if method_result else None
