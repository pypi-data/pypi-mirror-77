...
from mastapy.system_model.analyses_and_results import _2231
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5350
from mastapy.system_model.analyses_and_results.load_case_groups import _5259, _5260, _5261
...
class StaticLoadCase(_6072.LoadCase):
    '''StaticLoadCase
    ...
    @property
    def advanced_system_deflection_options(self) -> '_6262.AdvancedSystemDeflectionOptions':
        ...
        return constructor.new(_6262.AdvancedSystemDeflectionOptions)(self.wrapped.AdvancedSystemDeflectionOptions) if self.wrapped.AdvancedSystemDeflectionOptions else None

    @property
    def te_set_up_for_dynamic_analyses_options(self) -> '_2231.TESetUpForDynamicAnalysisOptions':
        ...
        return constructor.new(_2231.TESetUpForDynamicAnalysisOptions)(self.wrapped.TESetUpForDynamicAnalysesOptions) if self.wrapped.TESetUpForDynamicAnalysesOptions else None

    @property
    def gear_whine_harmonic_excitation_analysis_options(self) -> '_5350.GearWhineAnalysisOptions':
        ...
        return constructor.new(_5350.GearWhineAnalysisOptions)(self.wrapped.GearWhineHarmonicExcitationAnalysisOptions) if self.wrapped.GearWhineHarmonicExcitationAnalysisOptions else None

    @property
    def clutch_engagements(self) -> 'List[_5259.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClutchEngagements, constructor.new(_5259.ClutchEngagementStatus))
        return value

    @property
    def concept_clutch_engagements(self) -> 'List[_5260.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptClutchEngagements, constructor.new(_5260.ConceptSynchroGearEngagementStatus))
        return value

    def duplicate(self, new_design_state_group: '_5261.DesignState', name: Optional['str'] = 'None') -> 'StaticLoadCase':
