...
from mastapy.system_model.analyses_and_results.load_case_groups import _5259, _5260, _5256
...
class DesignState(_5256.AbstractDesignStateLoadCaseGroup):
    '''DesignState
    ...
    @property
    def clutches(self) -> 'List[_5259.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Clutches, constructor.new(_5259.ClutchEngagementStatus))
        return value

    @property
    def concept_synchro_mounted_gears(self) -> 'List[_5260.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptSynchroMountedGears, constructor.new(_5260.ConceptSynchroGearEngagementStatus))
        return value

    def clutch_engagement_status_for(self, clutch_connection: '_1915.ClutchConnection') -> '_5259.ClutchEngagementStatus':
        ...
        return constructor.new(_5259.ClutchEngagementStatus)(method_result) if method_result else None

    def concept_synchro_gear_engagement_status_for(self, gear: '_2088.CylindricalGear') -> '_5260.ConceptSynchroGearEngagementStatus':
        ...
        return constructor.new(_5260.ConceptSynchroGearEngagementStatus)(method_result) if method_result else None
    ...
    def create_load_case(self, name: Optional['str'] = 'New Static Load') -> '_6211.StaticLoadCase':
        ...
        return constructor.new(_6211.StaticLoadCase)(method_result) if method_result else None
