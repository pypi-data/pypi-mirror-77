...
from mastapy.math_utility import (
    _1076, _1094, _1067, _1086,
    _1075, _1064, _1074, _1089
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy._internal import enum_with_selected_value_runtime, conversion, constructor
from mastapy.system_model.analyses_and_results.modal_analyses import (
    _4758, _4847, _4846, _4802,
    _4848
)
from mastapy.system_model.analyses_and_results.gear_whine_analyses.whine_analyses_results import (
    _5425, _5428, _5433, _5434
)
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5341, _5392
from mastapy.utility.units_and_measurements.measurements import (
    _1212, _1166, _1264, _1172,
    _1163, _1168, _1186, _1259,
    _1180, _1230, _1231, _1234
)
from mastapy.utility.property import _1360
...
class WhineWaterfallSettings(_0.APIBase):
    ...
    @property
    def translation_or_rotation(self) -> '_1094.TranslationRotation':
        ...
        return constructor.new(_1094.TranslationRotation)(value) if value else None

    @translation_or_rotation.setter
    def translation_or_rotation(self, value: '_1094.TranslationRotation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TranslationOrRotation = value

    @property
    def coordinate_system(self) -> '_4758.CoordinateSystemForWhine':
        ...
        return constructor.new(_4758.CoordinateSystemForWhine)(value) if value else None

    @coordinate_system.setter
    def coordinate_system(self, value: '_4758.CoordinateSystemForWhine'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CoordinateSystem = value

    @property
    def complex_component(self) -> '_1067.ComplexPartDisplayOption':
        ...
        return constructor.new(_1067.ComplexPartDisplayOption)(value) if value else None

    @complex_component.setter
    def complex_component(self, value: '_1067.ComplexPartDisplayOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ComplexComponent = value

    @property
    def magnitude_method_for_complex_vectors(self) -> '_1086.ComplexMagnitudeMethod':
        ...
        return constructor.new(_1086.ComplexMagnitudeMethod)(value) if value else None

    @magnitude_method_for_complex_vectors.setter
    def magnitude_method_for_complex_vectors(self, value: '_1086.ComplexMagnitudeMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def chart_type(self) -> '_1074.DynamicsResponse3DChartType':
        ...
        return constructor.new(_1074.DynamicsResponse3DChartType)(value) if value else None

    @chart_type.setter
    def chart_type(self, value: '_1074.DynamicsResponse3DChartType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def connected_component_type(self) -> '_5425.ConnectedComponentType':
        ...
        return constructor.new(_5425.ConnectedComponentType)(value) if value else None

    @connected_component_type.setter
    def connected_component_type(self, value: '_5425.ConnectedComponentType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ConnectedComponentType = value

    @property
    def whine_waterfall_export_option(self) -> '_4847.WhineWaterfallExportOption':
        ...
        return constructor.new(_4847.WhineWaterfallExportOption)(value) if value else None

    @whine_waterfall_export_option.setter
    def whine_waterfall_export_option(self, value: '_4847.WhineWaterfallExportOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def selected_excitations(self) -> '_5428.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5428.ExcitationSourceSelectionGroup)(self.wrapped.SelectedExcitations) if self.wrapped.SelectedExcitations else None

    @property
    def waterfall_chart_settings(self) -> '_4846.WaterfallChartSettings':
        ...
        return constructor.new(_4846.WaterfallChartSettings)(self.wrapped.WaterfallChartSettings) if self.wrapped.WaterfallChartSettings else None
    ...
    @property
    def frequency_options(self) -> '_5341.FrequencyOptionsForGearWhineAnalysisResults':
        ...
        return constructor.new(_5341.FrequencyOptionsForGearWhineAnalysisResults)(self.wrapped.FrequencyOptions) if self.wrapped.FrequencyOptions else None

    @property
    def reference_speed_options(self) -> '_5392.SpeedOptionsForGearWhineAnalysisResults':
        ...
        return constructor.new(_5392.SpeedOptionsForGearWhineAnalysisResults)(self.wrapped.ReferenceSpeedOptions) if self.wrapped.ReferenceSpeedOptions else None

    @property
    def very_short_length_reference_values(self) -> '_4848.WhineWaterfallReferenceValues[_1212.LengthVeryShort]':
        ...
        return constructor.new(_4848.WhineWaterfallReferenceValues)[_1212.LengthVeryShort](self.wrapped.VeryShortLengthReferenceValues) if self.wrapped.VeryShortLengthReferenceValues else None

    @property
    def small_angle_reference_values(self) -> '_4848.WhineWaterfallReferenceValues[_1166.AngleSmall]':
        ...
        return constructor.new(_4848.WhineWaterfallReferenceValues)[_1166.AngleSmall](self.wrapped.SmallAngleReferenceValues) if self.wrapped.SmallAngleReferenceValues else None

    @property
    def small_velocity_reference_values(self) -> '_4848.WhineWaterfallReferenceValues[_1264.VelocitySmall]':
        ...
        return constructor.new(_4848.WhineWaterfallReferenceValues)[_1264.VelocitySmall](self.wrapped.SmallVelocityReferenceValues) if self.wrapped.SmallVelocityReferenceValues else None

    @property
    def angular_velocity_reference_values(self) -> '_4848.WhineWaterfallReferenceValues[_1172.AngularVelocity]':
        ...
        return constructor.new(_4848.WhineWaterfallReferenceValues)[_1172.AngularVelocity](self.wrapped.AngularVelocityReferenceValues) if self.wrapped.AngularVelocityReferenceValues else None

    @property
    def acceleration_reference_values(self) -> '_4848.WhineWaterfallReferenceValues[_1163.Acceleration]':
        ...
        return constructor.new(_4848.WhineWaterfallReferenceValues)[_1163.Acceleration](self.wrapped.AccelerationReferenceValues) if self.wrapped.AccelerationReferenceValues else None

    @property
    def angular_acceleration_reference_values(self) -> '_4848.WhineWaterfallReferenceValues[_1168.AngularAcceleration]':
        ...
        return constructor.new(_4848.WhineWaterfallReferenceValues)[_1168.AngularAcceleration](self.wrapped.AngularAccelerationReferenceValues) if self.wrapped.AngularAccelerationReferenceValues else None

    @property
    def force_reference_values(self) -> '_4848.WhineWaterfallReferenceValues[_1186.Force]':
        ...
        return constructor.new(_4848.WhineWaterfallReferenceValues)[_1186.Force](self.wrapped.ForceReferenceValues) if self.wrapped.ForceReferenceValues else None

    @property
    def torque_reference_values(self) -> '_4848.WhineWaterfallReferenceValues[_1259.Torque]':
        ...
        return constructor.new(_4848.WhineWaterfallReferenceValues)[_1259.Torque](self.wrapped.TorqueReferenceValues) if self.wrapped.TorqueReferenceValues else None

    @property
    def energy_reference_values(self) -> '_4848.WhineWaterfallReferenceValues[_1180.Energy]':
        ...
        return constructor.new(_4848.WhineWaterfallReferenceValues)[_1180.Energy](self.wrapped.EnergyReferenceValues) if self.wrapped.EnergyReferenceValues else None

    @property
    def power_small_reference_values(self) -> '_4848.WhineWaterfallReferenceValues[_1230.PowerSmall]':
        ...
        return constructor.new(_4848.WhineWaterfallReferenceValues)[_1230.PowerSmall](self.wrapped.PowerSmallReferenceValues) if self.wrapped.PowerSmallReferenceValues else None

    @property
    def power_small_per_unit_area_reference_values(self) -> '_4848.WhineWaterfallReferenceValues[_1231.PowerSmallPerArea]':
        ...
        return constructor.new(_4848.WhineWaterfallReferenceValues)[_1231.PowerSmallPerArea](self.wrapped.PowerSmallPerUnitAreaReferenceValues) if self.wrapped.PowerSmallPerUnitAreaReferenceValues else None

    @property
    def pressure_reference_values(self) -> '_4848.WhineWaterfallReferenceValues[_1234.Pressure]':
        ...
        return constructor.new(_4848.WhineWaterfallReferenceValues)[_1234.Pressure](self.wrapped.PressureReferenceValues) if self.wrapped.PressureReferenceValues else None

    @property
    def result_location_selection_groups(self) -> '_5433.ResultLocationSelectionGroups':
        ...
        return constructor.new(_5433.ResultLocationSelectionGroups)(self.wrapped.ResultLocationSelectionGroups) if self.wrapped.ResultLocationSelectionGroups else None

    @property
    def active_result_locations(self) -> 'List[_5434.ResultNodeSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ActiveResultLocations, constructor.new(_5434.ResultNodeSelection))
        return value

    @property
    def degrees_of_freedom(self) -> 'List[_1360.EnumWithBool[_1089.ResultOptionsFor3DVector]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DegreesOfFreedom, constructor.new(_1360.EnumWithBool)[_1089.ResultOptionsFor3DVector])
        return value
