...
from mastapy.system_model.analyses_and_results.modal_analyses import _4746, _4776, _4803
...
class AbstractAssemblyModalAnalysis(_4803.PartModalAnalysis):
    ...
    def assembly_design(self) -> '_2003.AbstractAssembly':
        ...
        return constructor.new(_2003.AbstractAssembly)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None
    ...
    def assembly_design_of_type_specialised_assembly(self) -> '_2041.SpecialisedAssembly':
        ...
        return constructor.new(_2041.SpecialisedAssembly)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None
    ...
    def assembly_design_of_type_cvt(self) -> '_2144.CVT':
        ...
        return constructor.new(_2144.CVT)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None
    ...
    @property
    def rigidly_connected_groups(self) -> 'List[_4746.ComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidlyConnectedGroups, constructor.new(_4746.ComponentModalAnalysis))
        return value

    @property
    def gear_meshes(self) -> 'List[_4776.GearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshes, constructor.new(_4776.GearMeshModalAnalysis))
        return value
