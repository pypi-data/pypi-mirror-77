...
class CouplingConnectionModalAnalysis(_4784.InterMountableComponentConnectionModalAnalysis):
    '''CouplingConnectionModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2269.CouplingConnectionSystemDeflection':
