...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6378, _6381
...
class PowerLoadAdvancedSystemDeflection(_6381.VirtualComponentAdvancedSystemDeflection):
    '''PowerLoadAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6193.PowerLoadLoadCase':
        ...
        return constructor.new(_6193.PowerLoadLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def transmission_error_to_other_power_loads(self) -> 'List[_6378.TransmissionErrorToOtherPowerLoad]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TransmissionErrorToOtherPowerLoads, constructor.new(_6378.TransmissionErrorToOtherPowerLoad))
        return value

    @property
    def component_system_deflection_results(self) -> 'List[_2324.PowerLoadSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2324.PowerLoadSystemDeflection))
        return value
