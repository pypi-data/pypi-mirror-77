...
class ConceptCouplingAdvancedSystemDeflection(_6298.CouplingAdvancedSystemDeflection):
    '''ConceptCouplingAdvancedSystemDeflection
    ...
    @property
    def assembly_load_case(self) -> '_6101.ConceptCouplingLoadCase':
        ...
        return constructor.new(_6101.ConceptCouplingLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None

    @property
    def assembly_system_deflection_results(self) -> 'List[_2259.ConceptCouplingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2259.ConceptCouplingSystemDeflection))
        return value
