...
class BevelDifferentialPlanetGearGearWhineAnalysis(_5286.BevelDifferentialGearGearWhineAnalysis):
    '''BevelDifferentialPlanetGearGearWhineAnalysis
    ...
    @property
    def component_design(self) -> '_2080.BevelDifferentialPlanetGear':
    ...
    @property
    def system_deflection_results(self) -> '_2244.BevelDifferentialPlanetGearSystemDeflection':
