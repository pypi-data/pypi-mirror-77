...
class BevelDifferentialGearMeshGearWhineAnalysis(_5292.BevelGearMeshGearWhineAnalysis):
    '''BevelDifferentialGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2241.BevelDifferentialGearMeshSystemDeflection':
