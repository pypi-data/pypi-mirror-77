...
class BevelGearMeshGearWhineAnalysis(_5280.AGMAGleasonConicalGearMeshGearWhineAnalysis):
    '''BevelGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2246.BevelGearMeshSystemDeflection':
