...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4406, _4407, _4412
...
class FaceGearSetCompoundModalAnalysisAtAStiffness(_4412.GearSetCompoundModalAnalysisAtAStiffness):
    '''FaceGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def face_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4406.FaceGearCompoundModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsCompoundModalAnalysisAtAStiffness, constructor.new(_4406.FaceGearCompoundModalAnalysisAtAStiffness))
        return value

    @property
    def face_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4407.FaceGearMeshCompoundModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesCompoundModalAnalysisAtAStiffness, constructor.new(_4407.FaceGearMeshCompoundModalAnalysisAtAStiffness))
        return value
