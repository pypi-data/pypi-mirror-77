...
class BoltedJointCompoundModalAnalysesAtStiffnesses(_3959.SpecialisedAssemblyCompoundModalAnalysesAtStiffnesses):
    '''BoltedJointCompoundModalAnalysesAtStiffnesses
    ...
    @property
    def component_design(self) -> '_2010.BoltedJoint':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3762.BoltedJointModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3762.BoltedJointModalAnalysesAtStiffnesses))
        return value

    @property
    def assembly_modal_analyses_at_stiffnesses_load_cases(self) -> 'List[_3762.BoltedJointModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysesAtStiffnessesLoadCases, constructor.new(_3762.BoltedJointModalAnalysesAtStiffnesses))
        return value
