...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4092, _4091, _4006
...
class StraightBevelDiffGearSetModalAnalysesAtSpeeds(_4006.BevelGearSetModalAnalysesAtSpeeds):
    '''StraightBevelDiffGearSetModalAnalysesAtSpeeds
    ...
    @property
    def straight_bevel_diff_gears_modal_analyses_at_speeds(self) -> 'List[_4092.StraightBevelDiffGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsModalAnalysesAtSpeeds, constructor.new(_4092.StraightBevelDiffGearModalAnalysesAtSpeeds))
        return value

    @property
    def straight_bevel_diff_meshes_modal_analyses_at_speeds(self) -> 'List[_4091.StraightBevelDiffGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesModalAnalysesAtSpeeds, constructor.new(_4091.StraightBevelDiffGearMeshModalAnalysesAtSpeeds))
        return value
