...
from mastapy.system_model.analyses_and_results.system_deflections import _2370, _2368, _2247
...
class ZerolBevelGearSetSystemDeflection(_2247.BevelGearSetSystemDeflection):
    '''ZerolBevelGearSetSystemDeflection
    ...
    @property
    def zerol_bevel_gears_system_deflection(self) -> 'List[_2370.ZerolBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsSystemDeflection, constructor.new(_2370.ZerolBevelGearSystemDeflection))
        return value

    @property
    def zerol_bevel_meshes_system_deflection(self) -> 'List[_2368.ZerolBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesSystemDeflection, constructor.new(_2368.ZerolBevelGearMeshSystemDeflection))
        return value
