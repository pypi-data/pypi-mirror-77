...
from mastapy.system_model.analyses_and_results.system_deflections import _2350, _2335
...
class SynchroniserSystemDeflection(_2335.SpecialisedAssemblySystemDeflection):
    '''SynchroniserSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3351.SynchroniserPowerFlow':
    ...
    @property
    def cones(self) -> 'List[_2350.SynchroniserHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2350.SynchroniserHalfSystemDeflection))
        return value
