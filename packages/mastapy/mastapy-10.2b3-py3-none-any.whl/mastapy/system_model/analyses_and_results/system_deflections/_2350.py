...
from mastapy.system_model.analyses_and_results.system_deflections import _2251, _2351
...
class SynchroniserHalfSystemDeflection(_2351.SynchroniserPartSystemDeflection):
    '''SynchroniserHalfSystemDeflection
    ...
    @property
    def clutch_connection(self) -> '_2251.ClutchConnectionSystemDeflection':
        ...
        return constructor.new(_2251.ClutchConnectionSystemDeflection)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
