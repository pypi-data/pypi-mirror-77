...
from mastapy.system_model.drawing import _1849, _1847
...
class SystemDeflectionDrawStyle(_1847.ContourDrawStyle):
    '''SystemDeflectionDrawStyle
    ...
    @property
    def force_arrow_scaling(self) -> '_1849.ScalingDrawStyle':
        ...
        return constructor.new(_1849.ScalingDrawStyle)(self.wrapped.ForceArrowScaling) if self.wrapped.ForceArrowScaling else None
