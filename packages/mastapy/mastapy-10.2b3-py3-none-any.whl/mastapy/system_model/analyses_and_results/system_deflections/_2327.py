...
class RollingRingConnectionSystemDeflection(_2300.InterMountableComponentConnectionSystemDeflection):
    '''RollingRingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3328.RollingRingConnectionPowerFlow':
