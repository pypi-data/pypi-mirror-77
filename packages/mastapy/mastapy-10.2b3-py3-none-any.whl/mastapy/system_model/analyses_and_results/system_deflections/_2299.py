...
from mastapy.math_utility.measured_vectors import _1125, _1120
...
class ImportedFEComponentSystemDeflection(_2233.AbstractShaftOrHousingSystemDeflection):
    '''ImportedFEComponentSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3300.ImportedFEComponentPowerFlow':
    ...
    @property
    def stiffness_in_world_coordinate_system_mn_rad(self) -> '_1391.NodalMatrix':
        ...
        return constructor.new(_1391.NodalMatrix)(self.wrapped.StiffnessInWorldCoordinateSystemMNRad) if self.wrapped.StiffnessInWorldCoordinateSystemMNRad else None

    @property
    def mass_in_world_coordinate_system_mn_rad_s_kg(self) -> '_1391.NodalMatrix':
        ...
        return constructor.new(_1391.NodalMatrix)(self.wrapped.MassInWorldCoordinateSystemMNRadSKg) if self.wrapped.MassInWorldCoordinateSystemMNRadSKg else None
    ...
    @property
    def applied_internal_forces_in_world_coordinate_system(self) -> 'List[_1125.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AppliedInternalForcesInWorldCoordinateSystem, constructor.new(_1125.VectorWithLinearAndAngularComponents))
        return value

    @property
    def node_results_in_shaft_coordinate_system(self) -> 'List[_1120.ForceAndDisplacementResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeResultsInShaftCoordinateSystem, constructor.new(_1120.ForceAndDisplacementResults))
        return value
