...
class SteadyStateSynchronousResponseOnAShaft(_6524.StaticLoadAnalysisCase):
    '''SteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def options(self) -> '_3089.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3089.SteadyStateSynchronousResponseOptions)(self.wrapped.Options) if self.wrapped.Options else None
