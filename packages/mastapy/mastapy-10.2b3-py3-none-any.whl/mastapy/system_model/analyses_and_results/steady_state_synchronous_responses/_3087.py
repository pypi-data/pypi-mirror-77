...
class SteadyStateSynchronousResponse(_6511.CompoundAnalysisCase):
    '''SteadyStateSynchronousResponse
    ...
    @property
    def steady_state_analysis_options(self) -> '_3089.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3089.SteadyStateSynchronousResponseOptions)(self.wrapped.SteadyStateAnalysisOptions) if self.wrapped.SteadyStateAnalysisOptions else None
