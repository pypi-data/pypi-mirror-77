...
class ConnectionDynamicAnalysis(_6514.ConnectionFEAnalysis):
    '''ConnectionDynamicAnalysis
    ...
    @property
    def dynamic_analysis(self) -> '_5868.DynamicAnalysis':
        ...
        return constructor.new(_5868.DynamicAnalysis)(self.wrapped.DynamicAnalysis) if self.wrapped.DynamicAnalysis else None
