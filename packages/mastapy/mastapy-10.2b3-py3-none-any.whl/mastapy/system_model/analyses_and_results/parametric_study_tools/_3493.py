...
class BearingParametricStudyTool(_3521.ConnectorParametricStudyTool):
    ...
    @property
    def bearing_duty_cycle_results(self) -> 'List[_1584.LoadedBearingDutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingDutyCycleResults, constructor.new(_1584.LoadedBearingDutyCycle))
        return value
