...
class ConnectionParametricStudyTool(_6512.ConnectionAnalysisCase):
    '''ConnectionParametricStudyTool
    ...
    @property
    def parametric_study_tool(self) -> '_3572.ParametricStudyTool':
        ...
        return constructor.new(_3572.ParametricStudyTool)(self.wrapped.ParametricStudyTool) if self.wrapped.ParametricStudyTool else None
