...
from mastapy import _3, _6529, _0
...
from mastapy.system_model.part_model.configurations import _2171, _2169, _2172
...
from mastapy.system_model.database_access import _1852
...
class Design(_0.APIBase):
    ...
    @property
    def masta_gui(self) -> '_1509.MASTAGUI':
        ...
        return constructor.new(_1509.MASTAGUI)(self.wrapped.MastaGUI) if self.wrapped.MastaGUI else None
    ...
    @property
    def file_save_details_most_recent(self) -> '_1138.FileHistoryItem':
        ...
        return constructor.new(_1138.FileHistoryItem)(self.wrapped.FileSaveDetailsMostRecent) if self.wrapped.FileSaveDetailsMostRecent else None

    @property
    def default_system_temperatures(self) -> '_1832.TransmissionTemperatureSet':
        ...
        return constructor.new(_1832.TransmissionTemperatureSet)(self.wrapped.DefaultSystemTemperatures) if self.wrapped.DefaultSystemTemperatures else None
    ...
    @property
    def detailed_spline_settings(self) -> '_978.DetailedSplineJointSettings':
        ...
        return constructor.new(_978.DetailedSplineJointSettings)(self.wrapped.DetailedSplineSettings) if self.wrapped.DetailedSplineSettings else None
    ...
    @property
    def file_save_details_all(self) -> '_1137.FileHistory':
        ...
        return constructor.new(_1137.FileHistory)(self.wrapped.FileSaveDetailsAll) if self.wrapped.FileSaveDetailsAll else None
    ...
    @property
    def selected_gear_set_selection_group(self) -> '_2075.ActiveGearSetDesignSelectionGroup':
        ...
        return constructor.new(_2075.ActiveGearSetDesignSelectionGroup)(self.wrapped.SelectedGearSetSelectionGroup) if self.wrapped.SelectedGearSetSelectionGroup else None

    @property
    def system(self) -> '_1831.SystemReporting':
        ...
        return constructor.new(_1831.SystemReporting)(self.wrapped.System) if self.wrapped.System else None

    @property
    def fe_batch_operations(self) -> '_1935.BatchOperations':
        ...
        return constructor.new(_1935.BatchOperations)(self.wrapped.FEBatchOperations) if self.wrapped.FEBatchOperations else None

    @property
    def iso14179_settings_per_bearing_type(self) -> 'List[_1609.ISO14179SettingsPerBearingType]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISO14179SettingsPerBearingType, constructor.new(_1609.ISO14179SettingsPerBearingType))
        return value

    @property
    def gear_set_configurations(self) -> 'List[_2075.ActiveGearSetDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetConfigurations, constructor.new(_2075.ActiveGearSetDesignSelectionGroup))
        return value

    @property
    def shaft_detail_configurations(self) -> 'List[_2171.ActiveShaftDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftDetailConfigurations, constructor.new(_2171.ActiveShaftDesignSelectionGroup))
        return value

    @property
    def imported_fe_configurations(self) -> 'List[_2169.ActiveImportedFESelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ImportedFEConfigurations, constructor.new(_2169.ActiveImportedFESelectionGroup))
        return value

    @property
    def bearing_detail_configurations(self) -> 'List[_2172.BearingDetailConfiguration]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingDetailConfigurations, constructor.new(_2172.BearingDetailConfiguration))
        return value

    @property
    def design_states(self) -> 'List[_5261.DesignState]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStates, constructor.new(_5261.DesignState))
        return value

    @property
    def static_loads(self) -> 'List[_6211.StaticLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StaticLoads, constructor.new(_6211.StaticLoadCase))
        return value

    @property
    def duty_cycles(self) -> 'List[_5262.DutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DutyCycles, constructor.new(_5262.DutyCycle))
        return value

    @property
    def root_assembly(self) -> '_2039.RootAssembly':
        ...
        return constructor.new(_2039.RootAssembly)(self.wrapped.RootAssembly) if self.wrapped.RootAssembly else None

    @property
    def gear_set_config(self) -> '_2096.GearSetConfiguration':
        '''GearSetConfiguration: 'GearSetConfig' is the original name of this property.'''

        return constructor.new(_2096.GearSetConfiguration)(self.wrapped.GearSetConfig) if self.wrapped.GearSetConfig else None

    @gear_set_config.setter
    def gear_set_config(self, value: '_2096.GearSetConfiguration'):
    ...
    @property
    def databases(self) -> '_1852.Databases':
        ...
        return constructor.new(_1852.Databases)(self.wrapped.Databases) if self.wrapped.Databases else None
    ...
    def remove_bearing_from_database(self, rolling_bearing: '_1779.RollingBearing'):
    ...
    def design_state_named(self, name: 'str') -> '_5261.DesignState':
        ...
        return constructor.new(_5261.DesignState)(method_result) if method_result else None

    def duty_cycle_named(self, name: 'str') -> '_5262.DutyCycle':
        ...
        return constructor.new(_5262.DutyCycle)(method_result) if method_result else None
    ...
    def save(self, file_name: 'str', save_results: 'bool') -> '_1318.Status':
        ...
        method_result = self.wrapped.Save.Overloads[str, bool](file_name if file_name else None, save_results if save_results else False)
        return constructor.new(_1318.Status)(method_result) if method_result else None

    def save_with_progess(self, file_name: 'str', save_results: 'bool', progress: '_6529.TaskProgress') -> '_1318.Status':
        ''' 'Save' is the original name of this method.
        ...
        file_name = str(file_name)
        save_results = bool(save_results)
        method_result = self.wrapped.Save.Overloads[str, bool, _6529.TaskProgress.TYPE](file_name if file_name else None, save_results if save_results else False, progress.wrapped if progress else None)
        return constructor.new(_1318.Status)(method_result) if method_result else None
    ...
    def add_synchroniser_shift(self, name: 'str') -> '_2502.SynchroniserShift':
        ...
        name = str(name)
        method_result = self.wrapped.AddSynchroniserShift.Overloads[str](name if name else None)
        return constructor.new(_2502.SynchroniserShift)(method_result) if method_result else None
    ...
    def add_design_state(self, name: Optional['str'] = 'New Design State') -> '_5261.DesignState':
    ...
    def add_duty_cycle(self, name: Optional['str'] = 'New Duty Cycle') -> '_5262.DutyCycle':
    ...
    def all_parts_of_type_assembly(self) -> 'List[_2002.Assembly]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2002.Assembly.TYPE](), constructor.new(_2002.Assembly))
    ...
    @staticmethod
    def load(file_path: 'str', load_full_fe_option: Optional['_1136.ExternalFullFEFileOption'] = _1136.ExternalFullFEFileOption.MESH_AND_EXPANSION_VECTORS) -> 'Design':
    ...
    def new_belt_creation_options(self, centre_distance: Optional['float'] = 0.1, pulley_a_diameter: Optional['float'] = 0.1, pulley_b_diameter: Optional['float'] = 0.1, name: Optional['str'] = 'Belt Drive') -> '_2131.BeltCreationOptions':
        ...
        return constructor.new(_2131.BeltCreationOptions)(method_result) if method_result else None

    def new_planet_carrier_creation_options(self, number_of_planets: Optional['int'] = 3, diameter: Optional['float'] = 0.1) -> '_2133.PlanetCarrierCreationOptions':
        ...
        return constructor.new(_2133.PlanetCarrierCreationOptions)(method_result) if method_result else None

    def new_shaft_creation_options(self, length: Optional['float'] = 0.1, outer_diameter: Optional['float'] = 0.0, bore: Optional['float'] = 0.0, name: Optional['str'] = 'Shaft') -> '_2134.ShaftCreationOptions':
        ...
        return constructor.new(_2134.ShaftCreationOptions)(method_result) if method_result else None
    ...
    def new_cylindrical_gear_linear_train_creation_options(self, number_of_gears: Optional['int'] = 3, name: Optional['str'] = 'Gear Train') -> '_2132.CylindricalGearLinearTrainCreationOptions':
        ...
        return constructor.new(_2132.CylindricalGearLinearTrainCreationOptions)(method_result) if method_result else None
    ...
    def new_nodal_matrix(self, dense_matrix: 'List[List[float]]') -> '_1391.NodalMatrix':
        ...
        return constructor.new(_1391.NodalMatrix)(method_result) if method_result else None
