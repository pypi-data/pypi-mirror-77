...
from mastapy.system_model.part_model import _2012, _2029
...
class Connector(_2029.MountableComponent):
    '''Connector
    ...
    def house_in(self, shaft: '_2046.Shaft', offset: Optional['float'] = float('nan')) -> '_1857.Connection':
        ...
        return constructor.new(_1857.Connection)(method_result) if method_result else None

    def try_house_in(self, shaft: '_2046.Shaft', offset: Optional['float'] = float('nan')) -> '_2012.ComponentsConnectedResult':
