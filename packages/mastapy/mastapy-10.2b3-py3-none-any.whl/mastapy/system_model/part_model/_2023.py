...
class ImportedFEComponent(_2004.AbstractShaftOrHousing):
    '''ImportedFEComponent
    ...
    @property
    def default_active_imported_fe(self) -> '_1957.ImportedFE':
        ...
        return constructor.new(_1957.ImportedFE)(self.wrapped.DefaultActiveImportedFE) if self.wrapped.DefaultActiveImportedFE else None
    ...
    def add_imported_fe(self) -> '_1957.ImportedFE':
        ...
        return constructor.new(_1957.ImportedFE)(method_result) if method_result else None

    def add_imported_fe_with_name(self, name: 'str') -> '_1957.ImportedFE':
        ''' 'AddImportedFE' is the original name of this method.
        ...
        name = str(name)
        method_result = self.wrapped.AddImportedFE.Overloads[str](name if name else None)
        return constructor.new(_1957.ImportedFE)(method_result) if method_result else None

    def select_imported_fe(self, imported_fe: '_1957.ImportedFE'):
    ...
    def remove_imported_fe(self, imported_fe: '_1957.ImportedFE') -> 'bool':
