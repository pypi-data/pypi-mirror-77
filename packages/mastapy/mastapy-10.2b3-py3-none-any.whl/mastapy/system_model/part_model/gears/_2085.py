...
from mastapy.system_model.part_model.gears import _2084, _2095
...
class ConceptGearSet(_2095.GearSet):
    '''ConceptGearSet
    ...
    @property
    def concept_gears(self) -> 'List[_2084.ConceptGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGears, constructor.new(_2084.ConceptGear))
        return value

    @property
    def concept_meshes(self) -> 'List[_1887.ConceptGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshes, constructor.new(_1887.ConceptGearMesh))
        return value
