...
from mastapy.system_model.part_model.gears import _2082, _2083
...
class BevelDifferentialGearSet(_2083.BevelGearSet):
    '''BevelDifferentialGearSet
    ...
    @property
    def bevel_gears(self) -> 'List[_2082.BevelGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelGears, constructor.new(_2082.BevelGear))
        return value

    @property
    def bevel_meshes(self) -> 'List[_1885.BevelGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelMeshes, constructor.new(_1885.BevelGearMesh))
        return value
