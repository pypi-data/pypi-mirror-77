...
from mastapy.system_model.part_model.gears import _2088, _2095
...
class CylindricalGearSet(_2095.GearSet):
    '''CylindricalGearSet
    ...
    @property
    def supercharger_rotor_set(self) -> '_2126.SuperchargerRotorSet':
        ...
        return constructor.new(_2126.SuperchargerRotorSet)(self.wrapped.SuperchargerRotorSet) if self.wrapped.SuperchargerRotorSet else None

    @property
    def cylindrical_gears(self) -> 'List[_2088.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_2088.CylindricalGear))
        return value

    @property
    def cylindrical_meshes(self) -> 'List[_1891.CylindricalGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_1891.CylindricalGearMesh))
        return value
