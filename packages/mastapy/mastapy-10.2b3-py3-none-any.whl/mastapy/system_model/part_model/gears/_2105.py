...
from mastapy.system_model.part_model.gears import _2088, _2090, _2089
...
class PlanetaryGearSet(_2089.CylindricalGearSet):
    '''PlanetaryGearSet
    ...
    @property
    def suns(self) -> 'List[_2088.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Suns, constructor.new(_2088.CylindricalGear))
        return value

    @property
    def planets(self) -> 'List[_2090.CylindricalPlanetGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planets, constructor.new(_2090.CylindricalPlanetGear))
        return value

    @property
    def annuluses(self) -> 'List[_2088.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Annuluses, constructor.new(_2088.CylindricalGear))
        return value

    def add_sun(self) -> '_2088.CylindricalGear':
    ...
    def add_planet(self) -> '_2088.CylindricalGear':
