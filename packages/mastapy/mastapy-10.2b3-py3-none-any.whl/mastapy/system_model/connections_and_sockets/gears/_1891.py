...
class CylindricalGearMesh(_1895.GearMesh):
    '''CylindricalGearMesh
    ...
    @property
    def cylindrical_gear_set(self) -> '_2089.CylindricalGearSet':
        ...
        return constructor.new(_2089.CylindricalGearSet)(self.wrapped.CylindricalGearSet) if self.wrapped.CylindricalGearSet else None

    @property
    def centre_distance_range(self) -> '_1126.ShortLengthRange':
        ...
        return constructor.new(_1126.ShortLengthRange)(self.wrapped.CentreDistanceRange) if self.wrapped.CentreDistanceRange else None
