...
class SpringDamperConnection(_1919.CouplingConnection):
    '''SpringDamperConnection
    ...
    @property
    def damping_option(self) -> '_1814.ComponentDampingOption':
        ...
        return constructor.new(_1814.ComponentDampingOption)(value) if value else None

    @damping_option.setter
    def damping_option(self, value: '_1814.ComponentDampingOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.DampingOption = value

    @property
    def damping(self) -> '_1385.LinearDampingConnectionProperties':
        ...
        return constructor.new(_1385.LinearDampingConnectionProperties)(self.wrapped.Damping) if self.wrapped.Damping else None
