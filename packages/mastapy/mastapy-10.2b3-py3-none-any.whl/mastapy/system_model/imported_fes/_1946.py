...
from mastapy.system_model.analyses_and_results.static_loads import _6230, _6159
...
class ElectricMachineDataSet(_0.APIBase):
    ...
    @property
    def torque_ripple_input_type(self) -> '_6230.TorqueRippleInputType':
        ...
        return constructor.new(_6230.TorqueRippleInputType)(value) if value else None

    @torque_ripple_input_type.setter
    def torque_ripple_input_type(self, value: '_6230.TorqueRippleInputType'):
    ...
    def multiple_fourier_series_interpolator_for(self, harmonic_load_data_type: '_6159.HarmonicLoadDataType') -> '_1087.MultipleFourierSeriesInterpolator':
        ...
        method_result = self.wrapped.MultipleFourierSeriesInterpolatorFor.Overloads[_6159.HarmonicLoadDataType.type_()](harmonic_load_data_type)
        return constructor.new(_1087.MultipleFourierSeriesInterpolator)(method_result) if method_result else None

    def add_or_replace_excitation_data(self, harmonic_load_data_type: '_6159.HarmonicLoadDataType', speed: 'float', fourier_series_values: 'List[float]', fourier_series_name: 'str', fourier_series_measurement_type: '_6530.MeasurementType'):
        ...
        self.wrapped.AddOrReplaceExcitationData.Overloads[_6159.HarmonicLoadDataType.type_(), float, List[float], str, _6530.MeasurementType.type_()](harmonic_load_data_type, speed if speed else 0.0, fourier_series_values, fourier_series_name if fourier_series_name else None, fourier_series_measurement_type)

    def add_or_replace_excitation_data_with_amplitudes_and_phases(self, harmonic_load_data_type: '_6159.HarmonicLoadDataType', speed: 'float', fourier_series_amplitudes: 'List[float]', fourier_series_phases: 'List[float]', fourier_series_mean_value: 'float', fourier_series_name: 'str', fourier_series_measurement_type: '_6530.MeasurementType'):
        ''' 'AddOrReplaceExcitationData' is the original name of this method.
        ...
        fourier_series_name = str(fourier_series_name)
        fourier_series_measurement_type = conversion.mp_to_pn_enum(fourier_series_measurement_type)
        self.wrapped.AddOrReplaceExcitationData.Overloads[_6159.HarmonicLoadDataType.type_(), float, List[float], List[float], float, str, _6530.MeasurementType.type_()](harmonic_load_data_type, speed if speed else 0.0, fourier_series_amplitudes, fourier_series_phases, fourier_series_mean_value if fourier_series_mean_value else 0.0, fourier_series_name if fourier_series_name else None, fourier_series_measurement_type)

    def multiple_fourier_series_interpolator_for_with_stiffness_node(self, harmonic_load_data_type: '_6159.HarmonicLoadDataType', node: '_1969.ImportedFEStiffnessNode') -> '_1087.MultipleFourierSeriesInterpolator':
        ''' 'MultipleFourierSeriesInterpolatorFor' is the original name of this method.
        ...
        harmonic_load_data_type = conversion.mp_to_pn_enum(harmonic_load_data_type)
        method_result = self.wrapped.MultipleFourierSeriesInterpolatorFor.Overloads[_6159.HarmonicLoadDataType.type_(), _1969.ImportedFEStiffnessNode.TYPE](harmonic_load_data_type, node.wrapped if node else None)
        return constructor.new(_1087.MultipleFourierSeriesInterpolator)(method_result) if method_result else None

    def add_or_replace_excitation_data_with_stiffness_node(self, harmonic_load_data_type: '_6159.HarmonicLoadDataType', node: '_1969.ImportedFEStiffnessNode', speed: 'float', fourier_series_values: 'List[float]', fourier_series_name: 'str', fourier_series_measurement_type: '_6530.MeasurementType'):
        ''' 'AddOrReplaceExcitationData' is the original name of this method.
        ...
        fourier_series_name = str(fourier_series_name)
        fourier_series_measurement_type = conversion.mp_to_pn_enum(fourier_series_measurement_type)
        self.wrapped.AddOrReplaceExcitationData.Overloads[_6159.HarmonicLoadDataType.type_(), _1969.ImportedFEStiffnessNode.TYPE, float, List[float], str, _6530.MeasurementType.type_()](harmonic_load_data_type, node.wrapped if node else None, speed if speed else 0.0, fourier_series_values, fourier_series_name if fourier_series_name else None, fourier_series_measurement_type)

    def add_or_replace_excitation_data_with_amplitudes_phases_and_stiffness_node(self, harmonic_load_data_type: '_6159.HarmonicLoadDataType', node: '_1969.ImportedFEStiffnessNode', speed: 'float', fourier_series_amplitudes: 'List[float]', fourier_series_phases: 'List[float]', fourier_series_mean_value: 'float', fourier_series_name: 'str', fourier_series_measurement_type: '_6530.MeasurementType'):
        ''' 'AddOrReplaceExcitationData' is the original name of this method.
        ...
        fourier_series_name = str(fourier_series_name)
        fourier_series_measurement_type = conversion.mp_to_pn_enum(fourier_series_measurement_type)
        self.wrapped.AddOrReplaceExcitationData.Overloads[_6159.HarmonicLoadDataType.type_(), _1969.ImportedFEStiffnessNode.TYPE, float, List[float], List[float], float, str, _6530.MeasurementType.type_()](harmonic_load_data_type, node.wrapped if node else None, speed if speed else 0.0, fourier_series_amplitudes, fourier_series_phases, fourier_series_mean_value if fourier_series_mean_value else 0.0, fourier_series_name if fourier_series_name else None, fourier_series_measurement_type)
