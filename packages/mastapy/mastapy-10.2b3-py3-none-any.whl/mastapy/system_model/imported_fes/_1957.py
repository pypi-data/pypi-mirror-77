...
from mastapy.system_model.imported_fes import (
    _1936, _1970, _1994, _1930,
    _1932, _1995, _1990, _1969,
    _1928, _1953, _1956, _1976,
    _1975, _1972, _1973, _1974
)
from mastapy._internal.python_net import python_net_import
from mastapy.system_model.part_model import _2015, _2011, _2023
from mastapy.nodal_analysis import _1383, _1376, _1379
from mastapy.nodal_analysis.component_mode_synthesis import _1504
from mastapy.system_model import _1829
...
class ImportedFE(_1379.FEStiffness):
    '''ImportedFE
    ...
    @property
    def bearing_node_alignment(self) -> '_1936.BearingNodeAlignmentOption':
        ...
        return constructor.new(_1936.BearingNodeAlignmentOption)(value) if value else None

    @bearing_node_alignment.setter
    def bearing_node_alignment(self, value: '_1936.BearingNodeAlignmentOption'):
    ...
    @property
    def alignment_method(self) -> '_1930.AlignmentMethod':
        ...
        return constructor.new(_1930.AlignmentMethod)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_1930.AlignmentMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def gravity_force_source(self) -> '_1383.GravityForceSource':
        ...
        return constructor.new(_1383.GravityForceSource)(value) if value else None
    ...
    @property
    def fe_meshing_options(self) -> '_1376.FEMeshingOptions':
        ...
        return constructor.new(_1376.FEMeshingOptions)(self.wrapped.FEMeshingOptions) if self.wrapped.FEMeshingOptions else None

    @property
    def cms_model(self) -> '_1504.FullFEModel':
        ...
        return constructor.new(_1504.FullFEModel)(self.wrapped.CMSModel) if self.wrapped.CMSModel else None

    @property
    def alignment_to_component(self) -> '_1829.RelativeComponentAlignment[_2011.Component]':
        ...
        return constructor.new(_1829.RelativeComponentAlignment)[_2011.Component](self.wrapped.AlignmentToComponent) if self.wrapped.AlignmentToComponent else None

    @property
    def alignment_using_axial_node_positions(self) -> '_1932.AlignmentUsingAxialNodePositions':
        ...
        return constructor.new(_1932.AlignmentUsingAxialNodePositions)(self.wrapped.AlignmentUsingAxialNodePositions) if self.wrapped.AlignmentUsingAxialNodePositions else None

    @property
    def coordinate_system(self) -> '_1068.CoordinateSystem3D':
        ...
        return constructor.new(_1068.CoordinateSystem3D)(self.wrapped.CoordinateSystem) if self.wrapped.CoordinateSystem else None

    @property
    def export(self) -> '_1995.UsedForExportingAnImportedFEsSetupOrSubstructuringStepToAnFEFile':
        ...
        return constructor.new(_1995.UsedForExportingAnImportedFEsSetupOrSubstructuringStepToAnFEFile)(self.wrapped.Export) if self.wrapped.Export else None
    ...
    @property
    def shafts_that_can_be_replaced(self) -> 'List[_1990.ReplacedShaftSelectionHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftsThatCanBeReplaced, constructor.new(_1990.ReplacedShaftSelectionHelper))
        return value
    ...
    @property
    def replaced_shafts(self) -> 'List[_2046.Shaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReplacedShafts, constructor.new(_2046.Shaft))
        return value

    @property
    def links(self) -> 'List[_1928.ImportedFELink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1928.ImportedFELink))
        return value

    @property
    def thermal_expansion_forces(self) -> 'List[_1125.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionForces, constructor.new(_1125.VectorWithLinearAndAngularComponents))
        return value

    @property
    def thermal_expansion_displacements(self) -> 'List[_1125.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionDisplacements, constructor.new(_1125.VectorWithLinearAndAngularComponents))
        return value

    @property
    def geometries(self) -> 'List[_1953.FEStiffnessGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Geometries, constructor.new(_1953.FEStiffnessGeometry))
        return value

    @property
    def gear_meshing_options(self) -> 'List[_1956.GearMeshingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshingOptions, constructor.new(_1956.GearMeshingOptions))
        return value

    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_1976.IndependentMastaCreatedCondensationNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.IndependentMastaCreatedCondensationNodes, constructor.new(_1976.IndependentMastaCreatedCondensationNode))
        return value

    @property
    def imported_fe_component(self) -> '_2023.ImportedFEComponent':
        ...
        return constructor.new(_2023.ImportedFEComponent)(self.wrapped.ImportedFEComponent) if self.wrapped.ImportedFEComponent else None
    ...
    def load_existing_masta_fe_file(self, file_name: 'str'):
        ...
        self.wrapped.LoadExistingMastaFEFile.Overloads[str](file_name if file_name else None)

    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_6529.TaskProgress'):
        ''' 'LoadExistingMastaFEFile' is the original name of this method.
        ...
        file_name = str(file_name)
        self.wrapped.LoadExistingMastaFEFile.Overloads[str, _6529.TaskProgress.TYPE](file_name if file_name else None, progress.wrapped if progress else None)

    def create_imported_fe_with_selection_static_analysis(self) -> '_1975.ImportedFEWithSelectionStaticAnalysis':
        ...
        return constructor.new(_1975.ImportedFEWithSelectionStaticAnalysis)(method_result) if method_result else None

    def create_imported_fe_with_selection_components(self) -> '_1972.ImportedFEWithSelectionComponents':
        ...
        return constructor.new(_1972.ImportedFEWithSelectionComponents)(method_result) if method_result else None

    def create_imported_fe_with_selection_for_harmonic_analysis(self) -> '_1973.ImportedFEWithSelectionForHarmonicAnalysis':
        ...
        return constructor.new(_1973.ImportedFEWithSelectionForHarmonicAnalysis)(method_result) if method_result else None

    def create_imported_fe_with_selection_modal_analysis(self) -> '_1974.ImportedFEWithSelectionModalAnalysis':
        ...
        return constructor.new(_1974.ImportedFEWithSelectionModalAnalysis)(method_result) if method_result else None
    ...
    def links_for(self, node: '_1969.ImportedFEStiffnessNode') -> 'List[_1928.ImportedFELink]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.LinksFor(node.wrapped if node else None), constructor.new(_1928.ImportedFELink))
