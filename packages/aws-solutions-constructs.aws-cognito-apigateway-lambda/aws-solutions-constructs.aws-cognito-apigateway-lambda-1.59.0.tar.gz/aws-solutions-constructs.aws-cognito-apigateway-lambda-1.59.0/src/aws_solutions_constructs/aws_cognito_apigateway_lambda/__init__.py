...
class CognitoToApiGatewayToLambda(
    ...
    def __init__(
        ...
        *,
        ...
        cognito_user_pool_client_props: typing.Optional[aws_cdk.aws_cognito.UserPoolClientProps] = None,
    ...
    def api_gateway_authorizer(self) -> aws_cdk.aws_apigateway.CfnAuthorizer:
        return jsii.get(self, "apiGatewayAuthorizer")
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(cognito_user_pool_client_props, dict):
            cognito_user_pool_client_props = aws_cdk.aws_cognito.UserPoolClientProps(**cognito_user_pool_client_props)
