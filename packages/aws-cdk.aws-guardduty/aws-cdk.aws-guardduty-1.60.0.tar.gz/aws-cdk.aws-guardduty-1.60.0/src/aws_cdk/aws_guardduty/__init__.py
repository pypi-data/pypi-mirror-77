...
class CfnDetector(
    ...
    @enable.setter
    def enable(self, value: typing.Union[bool, aws_cdk.core.IResolvable]) -> None:
...
class CfnFilter(
    ...
    def __init__(
        ...
        *,
        ...
        finding_criteria: typing.Union[
            aws_cdk.core.IResolvable, "FindingCriteriaProperty"
        ],
        name: str,
        rank: jsii.Number,
    ) -> None:
    ...
    def finding_criteria(
        self,
    ) -> typing.Union[aws_cdk.core.IResolvable, "FindingCriteriaProperty"]:
    ...
    def finding_criteria(
        self, value: typing.Union[aws_cdk.core.IResolvable, "FindingCriteriaProperty"]
    ) -> None:
    ...
    @jsii.data_type(
        ...
        jsii_struct_bases=[],
        name_mapping={"eq": "eq", "gte": "gte", "lt": "lt", "lte": "lte", "neq": "neq"},
    )
        ...
        def __init__(
            ...
            *,
            ...
            item_type: typing.Optional[
                typing.Union[aws_cdk.core.IResolvable, "CfnFilter.ConditionProperty"]
            ] = None,
        ) -> None:
            """
...
class CfnFilterProps:
    def __init__(
        ...
        *,
        ...
        detector_id: str,
        finding_criteria: typing.Union[
            aws_cdk.core.IResolvable, "CfnFilter.FindingCriteriaProperty"
        ],
        name: str,
        rank: jsii.Number,
    ) -> None:
...
class CfnIPSet(
    ...
    @activate.setter
    def activate(self, value: typing.Union[bool, aws_cdk.core.IResolvable]) -> None:
...
class CfnMember(
    ...
    def __init__(
        ...
        *,
        ...
        email: str,
        member_id: str,
        disable_email_notification: typing.Optional[
