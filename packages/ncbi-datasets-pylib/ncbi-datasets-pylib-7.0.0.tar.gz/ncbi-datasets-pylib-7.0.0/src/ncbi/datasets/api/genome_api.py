...
class GenomeApi(object):
    ...
    def check_assembly_availability(self, accessions, **kwargs):  # noqa: E501
        ...
        This 'GET' version of check is limited by the size of the GET URL (2KB, which works out to about 140 genomic accessions).  The POST operation is provided to allow users to supply a much larger number of accessions in a single request.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def check_assembly_availability_post(self, body, **kwargs):  # noqa: E501
        ...
        The 'GET' version of check is limited by the size of the GET URL (2KB, which works out to about 140 genomic accessions).  The POST operation is provided to allow users to supply a much larger number of accessions in a single request.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def download_assembly_package(self, accessions, **kwargs):  # noqa: E501
        ...
        :param bool include_sequence: Set to false to omit the genomic sequence.
    ...
    def download_assembly_package_post(self, body, **kwargs):  # noqa: E501
        ...
        This 'GET' version of download is limited by the size of the GET URL (2KB, which works out to about 140 genomic accessions).  The POST operation is provided to allow users to supply a much larger number of accessions in a single request.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def genome_tax_name_query(self, organism_query, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str organism_query: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def genome_tax_name_query_with_http_info(self, organism_query, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/genome/taxon_suggest/{organism_query}/names', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
