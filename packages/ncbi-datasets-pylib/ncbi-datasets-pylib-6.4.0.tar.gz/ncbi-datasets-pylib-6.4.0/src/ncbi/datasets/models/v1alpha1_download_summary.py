...
class V1alpha1DownloadSummary(object):
    ...
    def __init__(self, assembly_count=None, dehydrated=None, errors=None, hydrated=None, record_count=None, resource_updated_on=None, local_vars_configuration=None):  # noqa: E501
