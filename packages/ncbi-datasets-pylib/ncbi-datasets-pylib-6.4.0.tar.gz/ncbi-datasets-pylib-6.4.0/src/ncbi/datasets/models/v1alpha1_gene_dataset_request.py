...
class V1alpha1GeneDatasetRequest(object):
    ...
    openapi_types = {
        'accessions': 'list[str]',
        'gene_ids': 'list[int]',
        'include_annotation_type': 'list[GeneDatasetRequestFasta]',
    ...
    def __init__(self, accessions=None, gene_ids=None, include_annotation_type=None, returned_content=None, sort_schema=None, symbol=None, tax_token=None, local_vars_configuration=None):  # noqa: E501
    ...
    def include_annotation_type(self):
        ...
        :rtype: list[GeneDatasetRequestFasta]
        """
    ...
    def include_annotation_type(self, include_annotation_type):
        ...
        :type: list[GeneDatasetRequestFasta]
        """
