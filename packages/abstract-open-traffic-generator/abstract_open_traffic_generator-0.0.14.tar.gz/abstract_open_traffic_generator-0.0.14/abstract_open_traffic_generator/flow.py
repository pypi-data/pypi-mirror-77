...
class Flow(object):
    ...
    A high level data plane traffic flow. Acts as a container for endpoints, frame size, frame rate, duration and packet headers.
    ...
    - duration (Union[Duration, type(None)]): A container for different transmit durations. 
    """
...
class Endpoint(object):
    ...
    A container for different types of endpoints. The endpoint choice dictates the type of flow.
...
class DeviceEndpoint(object):
    ...
    Args
    ----
    - tx_devices (Union[list[Union[str, type(None)]], type(None)]): The unique names of emulated devices that will be transmitting. The devices names can be 1..n of  DeviceGroup, Device, Ethernet, Vlan, Ipv4 etc
    - rx_devices (Union[list[Union[str, type(None)]], type(None)]): The unique names of emulated devices that will be receiving. The devices names can be 1..n of  DeviceGroup, Device, Ethernet, Vlan, Ipv4 etc
    - packet_encap (Union[str, type(None)]): The encapsulation determines what packet headers will be  auto generated by the traffic generator.
...
class PortPattern(object):
    ...
    A pattern that is applied to a test port. The name of the pattern will be reflected in the port results.
...
class Pattern(object):
    ...
    A container for packet header field patterns. Possible patterns are fixed, list, increment, decrement, random.
...
class PfcPause(object):
    ...
    - class_enable_vector (Union[Pattern, type(None)]): A container for packet header field patterns. Possible patterns are fixed, list, increment, decrement, random.
    - pause_class_0 (Union[Pattern, type(None)]): A container for packet header field patterns. Possible patterns are fixed, list, increment, decrement, random.
    - pause_class_1 (Union[Pattern, type(None)]): A container for packet header field patterns. Possible patterns are fixed, list, increment, decrement, random.
    - pause_class_2 (Union[Pattern, type(None)]): A container for packet header field patterns. Possible patterns are fixed, list, increment, decrement, random.
    - pause_class_3 (Union[Pattern, type(None)]): A container for packet header field patterns. Possible patterns are fixed, list, increment, decrement, random.
    - pause_class_4 (Union[Pattern, type(None)]): A container for packet header field patterns. Possible patterns are fixed, list, increment, decrement, random.
    - pause_class_5 (Union[Pattern, type(None)]): A container for packet header field patterns. Possible patterns are fixed, list, increment, decrement, random.
    - pause_class_6 (Union[Pattern, type(None)]): A container for packet header field patterns. Possible patterns are fixed, list, increment, decrement, random.
    - pause_class_7 (Union[Pattern, type(None)]): A container for packet header field patterns. Possible patterns are fixed, list, increment, decrement, random.
    """
...
class Rate(object):
    ...
    - gap (Union[float, int, type(None)]): The minimum gap in bytes between packets.
    """
...
class Fixed(object):
    ...
    A fixed number of packets will be transmitted after which the flow will stop. If the number of packets is set to 0 the flow will not stop.

    Args
    ----
    - delay (Union[float, int, type(None)]): Start transmit of the flow after a delay of this number of bytes.
    - packets (Union[float, int, type(None)]): Stop transmit of the flow after this number of packets. A value of 0 means that the flow will not stop transmitting.
    """
...
class Burst(object):
    ...
    Args
    ----
    - gap (Union[float, int, type(None)]): The gap between each burst as a number of bytes.
    - packets (Union[float, int, type(None)]): The number of packets transmitted per burst.
    """
