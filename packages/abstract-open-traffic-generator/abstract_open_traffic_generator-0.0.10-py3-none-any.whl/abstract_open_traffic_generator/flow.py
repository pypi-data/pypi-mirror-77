...
class Duration(object):
    ...
    ----
    - choice (Union[str, type(None)]): TBD
    - fixed (Union[Fixed, type(None)]): A fixed number of packets will be transmitted after which the flow will stop. If the number of packets is set to 0 the flow will not stop.
    - burst (Union[Burst, type(None)]): A continuous burst of packets that will not automatically stop.
    """
    _CHOICE_MAP = {
        'Fixed': 'fixed',
        'Burst': 'burst',
