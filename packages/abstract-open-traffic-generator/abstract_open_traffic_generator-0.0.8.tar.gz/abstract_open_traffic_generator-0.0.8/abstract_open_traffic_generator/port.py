...
class Port(object):
	...
	- location (Union[Location, type(None)]): TBD
	"""
...
class Location(object):
	...
	- physical (Union[Physical, type(None)]): TBD
	- interface (Union[Interface, type(None)]): TBD
	- virtual (Union[Virtual, type(None)]): TBD
	- container (Union[Container, type(None)]): TBD
	"""
	_CHOICE_MAP = {
		'Physical': 'physical',
		'Interface': 'interface',
