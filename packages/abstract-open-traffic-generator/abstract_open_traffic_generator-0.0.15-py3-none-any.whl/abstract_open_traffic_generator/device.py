...
class DeviceGroup(object):
    ...
    - ports (Union[list[Union[str, None]], None]): One or more port names that the emulated device containers will share
    - devices (Union[list[Union[Device]], None]): One or more emulated device containers
    """
...
class Device(object):
    ...
    ----
    - name (Union[str, None]): Unique name of an object that is the primary key for objects found in arrays
    - devices_per_port (Union[float, int, None]): The number of emulated devices that will be created on each port
    - parent (Union[str, None]): The name of a device container or network container that is the parent of this container
        Use this property to establish a hierarchical relationship between device containers
        A non
        existent value indicates the device container is the root of the hierarchy
    - protocols (Union[list[Union[Protocol]], None]): The emulated protocols in this device container
    """
...
class Protocol(object):
    """Generated from OpenAPI #/components/schemas/Device.Protocol model
    ...
    Args
    ----
    - parent (Union[str, None]): The name of a device/protocol/network container that is the parent of another container
        Use this property to establish a parent/child or sibling relationship between device containers and protocol containers
        An empty value indicates the container is the root of the hierarchy
    - choice (Union[Ethernet, Vlan, Ipv4, Bgpv4]): TBD
    """
    _CHOICE_MAP = {
        'Ethernet': 'ethernet',
        'Vlan': 'vlan',
    ...
    def __init__(self, parent=None, choice=None):
        ...
        from abstract_open_traffic_generator.device import Vlan
...
class Ethernet(object):
    ...
    ----
    - name (Union[str, None]): Unique name of an object that is the primary key for objects found in arrays
    - mac (Union[Pattern]): A container for emulated device property patterns
    - mtu (Union[Pattern]): A container for emulated device property patterns
    """
...
class Vlan(object):
    ...
    ----
    - name (Union[str, None]): Unique name of an object that is the primary key for objects found in arrays
    - tpid (Union[Pattern]): A container for emulated device property patterns
    - priority (Union[Pattern]): A container for emulated device property patterns
    - id (Union[Pattern]): A container for emulated device property patterns
    """
...
class Ipv4(object):
    ...
    ----
    - name (Union[str, None]): Unique name of an object that is the primary key for objects found in arrays
    - address (Union[Pattern]): A container for emulated device property patterns
    - gateway (Union[Pattern]): A container for emulated device property patterns
    - prefix (Union[Pattern]): A container for emulated device property patterns
    """
...
class Bgpv4(object):
    ...
    ----
    - name (Union[str, None]): Unique name of an object that is the primary key for objects found in arrays
    - as_number_2_byte (Union[Pattern]): A container for emulated device property patterns
    - dut_as_number_2_byte (Union[Pattern]): A container for emulated device property patterns
    - as_number_4_byte (Union[Pattern]): A container for emulated device property patterns
    - as_number_set_mode (Union[Pattern]): A container for emulated device property patterns
    - type (Union[IBGP, EBGP, None]): The type of BGP topology
    ...
    - hold_time_interval (Union[Pattern]): A container for emulated device property patterns
    - keep_alive_interval (Union[Pattern]): A container for emulated device property patterns
    - graceful_restart (Union[Pattern]): A container for emulated device property patterns
    - authentication (Union[Pattern]): A container for emulated device property patterns
    - ttl (Union[Pattern]): A container for emulated device property patterns
    - dut_ipv4_address (Union[Pattern]): A container for emulated device property patterns
    """
