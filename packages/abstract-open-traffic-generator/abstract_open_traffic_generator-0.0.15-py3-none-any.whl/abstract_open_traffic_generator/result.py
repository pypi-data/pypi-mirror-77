...
class Request(object):
    ...
    Args
    ----
    - result_type (Union[state, location, ports, flows, None]): TBD
    """
...
class Response(object):
    ...
    Args
    ----
    - state (Union[State]): TBD
    - location (Union[Location]): Location result
    ...
    - ports (Union[Port]): TBD
    - flows (Union[Flow]): TBD
    """
...
class State(object):
    ...
    Args
    ----
    - state_transitions (Union[success, errored, transitioning, None]): TBD
    - transitions (Union[float, int, None]): Indicates the current total number of state transitions
    - errors (Union[float, int, None]): Indicates the current total number of state errors
    - details (Union[list[Union[StateDetail]], None]): TBD
    """
...
class StateDetail(object):
    ...
    Args
    ----
    - name (Union[str, None]): The unique name of an object in the configuration
    - configured (Union[str, None]): The configured state of the named object
    - current (Union[str, None]): The current state of the named object
    - message (Union[str, None]): Detailed transition or error information
    """
...
class Location(object):
    ...
    Args
    ----
    - description (Union[str, None]): The description of the location format
    - format (Union[str, None]): The regex format of the location
    """
...
class Port(object):
    ...
    Args
    ----
    - name (Union[str, None]): The name of a configured port
    - frames_tx (Union[float, int, None]): The current total number of frames transmitted
    - frames_rx (Union[float, int, None]): The current total number of valid frames received
    - bytes_tx (Union[float, int, None]): The current total number of bytes transmitted
    - bytes_rx (Union[float, int, None]): The current total number of valid bytes received
    - frames_tx_rate (Union[float, int, None]): The current rate of frames transmitted
    - frames_rx_rate (Union[float, int, None]): The current rate of valid frames received
    - data_integrity_errors (Union[float, int, None]): The current total number of data integrity errors
    - counters (Union[list[None], None]): A map of unique names of PortCounter objects added to Port objects and the corresponding count values
    """
...
class Flow(object):
    ...
    Args
    ----
    - name (Union[str, None]): The name of a configured flow
    - port_tx (Union[str, None]): The name of a configured port
    - port_rx (Union[str, None]): The name of a configured port
    - frames_tx (Union[float, int, None]): The current total number of frames transmitted
    - frames_rx (Union[float, int, None]): The current total number of valid frames received
    - bytes_tx (Union[float, int, None]): The current total number of bytes transmitted
    - bytes_rx (Union[float, int, None]): The current total number of valid bytes received
    - frames_tx_rate (Union[float, int, None]): The current rate of frames transmitted
    - frames_rx_rate (Union[float, int, None]): The current rate of valid frames received
    - loss (Union[float, int, None]): The percentage of lost frames
    - group_by (None): A runtime map of field name to result value The name comes from the flow
        packet
        header
        group_by property
    """
