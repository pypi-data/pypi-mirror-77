...
class Flow(object):
    ...
    A high level data plane traffic flo  
    ...
    """
    def __init__(self, name=None, endpoint=None, packet=None, size=None, rate=None, duration=None, state=None):
...
class Endpoint(object):
    ...
    A container for different types of endpoint  
    The endpoint choice dictates the type of flow  
...
class PortPattern(object):
    ...
    A pattern that is applied to a test por  
...
class Header(object):
    ...
    Container for all traffic packet header  
...
class Pattern(object):
    ...
    A container for packet header field pattern  
    Possible patterns are fixed, list, counter, random  
...
class PfcPause(object):
    ...
    IEEE 802.1Qbb PFC Pause packet heade  
    - dst: 01:80:C2:00:00:01 48bits - src: 48bits - ether_type: 0x8808 16bits - control_op_code: 0x0101 16bits - class_enable_vector: 16bits - pause_class_0: 0x0000 16bits - pause_class_1: 0x0000 16bits - pause_class_2: 0x0000 16bits - pause_class_3: 0x0000 16bits - pause_class_4: 0x0000 16bits - pause_class_5: 0x0000 16bits - pause_class_6: 0x0000 16bits - pause_class_7: 0x0000 16bit  
...
class Size(object):
    ...
    The frame size which overrides the total length of the packe  
...
class Rate(object):
    ...
    The rate of packet transmissio  
...
class Duration(object):
    ...
    A container for different transmit duration  
...
class Fixed(object):
    ...
    A fixed number of packets will be transmitted after which the flow will sto  
