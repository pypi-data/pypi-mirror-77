...
class Ipv4(object):
    ...
    """
    def __init__(self, name=None, parent=None, address=None, gateway=None, prefix=None):
        from abstract_open_traffic_generator.emulated import Pattern
        if isinstance(name, (str, type(None))) is True:
            self.name = name
        else:
...
class Bgpv4(object):
    ...
    """
    def __init__(self, name=None, parent=None, as_number_2_byte=None, dut_as_number_2_byte=None, as_number_4_byte=None, as_number_set_mode=None, type=None, hold_time_interval=None, keep_alive_interval=None, graceful_restart=None, authentication=None, ttl=None, dut_ipv4_address=None):
        from abstract_open_traffic_generator.emulated import Pattern
        if isinstance(name, (str, type(None))) is True:
            self.name = name
        else:
