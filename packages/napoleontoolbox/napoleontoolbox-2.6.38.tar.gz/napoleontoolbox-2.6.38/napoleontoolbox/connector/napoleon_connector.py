...
def fetch_equity_daily_data(ticker=None, provider = 'yahoo', starting_date=None,running_date=None,local_root_directory=None):
    ...
    try:
        ...
        log.info('No yahoo ticker equivalent for this ticker. Check dictionary of yahoo tickers equivalents')

    if provider == 'yahoo':
        data_df = data.DataReader(yahoo_ticker, provider, starting_date, running_date)
        ...
        log.info('This provider has not been set up yet.')
        return
