...
class AndroidChannel(betterproto.Message):
    ...
    # 相关风格
    style: List["StyleList"] = betterproto.message_field(7)
    # 推荐池漫画ID(上限50)
...
class GetUserInfoResponse(betterproto.Message):
    code: int = betterproto.int32_field(1)
    msg: str = betterproto.string_field(2)
    data: "User" = betterproto.message_field(3)
...
class ListUsersInfo(betterproto.Message):
    ...
    list: List["User"] = betterproto.message_field(2)
...
class UpdateOperateBannerReq(betterproto.Message):
    ...
    # 跳转类型 0-领取礼包 1-漫画详情 2-跳转单话 3-活动页面 4-跳转 app
...
class ComicWiki(betterproto.Message):
    ...
    producers: List["AuthorList"] = betterproto.message_field(13)
    # 主角
    ...
    horizontal_cover2: List[str] = betterproto.string_field(23)
    # 一句话简介
    introduction: str = betterproto.string_field(24)
    # 经典台词
    classic_lines: str = betterproto.string_field(25)
    # 作者列表
    authors: List["AuthorList"] = betterproto.message_field(26)
    # 风格列表
    styles: List["StyleList"] = betterproto.message_field(27)
    # 地区
    area: "AreaList" = betterproto.message_field(28)
    # 开启预约追漫 0-不开启 1-开启
...
@dataclass
class AuthorList(betterproto.Message):
    # 作者ID
    id: int = betterproto.int32_field(1)
    # 中文名
    cname: str = betterproto.string_field(2)
...
@dataclass
class StyleList(betterproto.Message):
    # 风格标签ID
    id: int = betterproto.int32_field(1)
    # 风格名
    name: str = betterproto.string_field(2)
...
@dataclass
class AreaList(betterproto.Message):
    # 地区ID
    id: int = betterproto.int32_field(1)
    # 地区名
    name: str = betterproto.string_field(2)
...
class Comic(betterproto.Message):
    ...
    # 禁止主站搜索
    no_master_search: bool = betterproto.bool_field(28)
    # 相关漫画ids
    relation_ids: List[int] = betterproto.int32_field(29)
    # 是否禁止打赏(为true时则禁止打赏)
    no_reward: bool = betterproto.bool_field(30)
    # 作者列表
    authors: List["AuthorList"] = betterproto.message_field(31)
    # 风格列表
    styles: List["StyleList"] = betterproto.message_field(32)
    # 地区列表
    area: "AreaList" = betterproto.message_field(33)
    # 允许使用道具
    items: bool = betterproto.bool_field(34)
    # 禁止算法推荐 0-允许推荐 1-禁止推荐
    no_recommend: bool = betterproto.bool_field(35)
    # 禁止月票
    ...
    # 禁止更多推荐
    no_more_recommend: bool = betterproto.bool_field(45)
...
@dataclass
class BannerListReq(betterproto.Message):
    # 页码
    page_num: int = betterproto.int32_field(1)
    # 分页条目数
    page_size: int = betterproto.int32_field(2)
...
class CommonBannerListReq(betterproto.Message):
    ...
    # 11-卡券包漫读卡推广banner 12-应援月票入口资源位,暂时是无跳转模式，所以 jump_type=0 13-单话评论区公告
    banner_type: int = betterproto.int32_field(6)


@dataclass
class BannerListResp(betterproto.Message):
    code: int = betterproto.int32_field(1)
    msg: str = betterproto.string_field(2)
    data: "BannerList" = betterproto.message_field(3)


@dataclass
class BannerList(betterproto.Message):
    list: List["BannerShort"] = betterproto.message_field(1)
    total: int = betterproto.int32_field(2)


@dataclass
class BannerShort(betterproto.Message):
    # ID
    id: int = betterproto.int32_field(1)
    # 标题
    title: str = betterproto.string_field(2)
    ...
    # 修改时间
    mtime: str = betterproto.string_field(6)
    # 上线时间 格式: "2006-01-02T15:04:05+07:00"
    active_time: str = betterproto.string_field(7)
    # 下线时间 格式: "2006-01-02T15:04:05+07:00"
    offline_time: str = betterproto.string_field(8)
...
class CommonBannerShort(betterproto.Message):
    ...
    # 漫画标题
    comic_title: str = betterproto.string_field(14)
    # 单话标题
    episode_title: str = betterproto.string_field(15)
...
class BannerInfo(betterproto.Message):
    ...
    # 新增字段，如果勾选了 pc 端，此处需要传值 banner 类型 2-pc
...
class CommonBannerInfo(betterproto.Message):
    ...
    # 文案
    content: str = betterproto.string_field(3)
    # 跳转类型 0-不跳转 1-漫画详情 2-漫画单话 3-活动专题页地址 4-app内部跳转
    jump_type: int = betterproto.int32_field(4)
    # 漫画id
    comic_id: int = betterproto.int32_field(5)
...
@dataclass
class BannerDetailReq(betterproto.Message):
    # ID
    id: int = betterproto.int32_field(1)
...
@dataclass
class DelBannerReq(betterproto.Message):
    # ID
    id: int = betterproto.int32_field(1)
...
@dataclass
class BannerDetailResp(betterproto.Message):
    code: int = betterproto.int32_field(1)
    msg: str = betterproto.string_field(2)
    data: "BannerInfo" = betterproto.message_field(3)
...
class FlashInfo(betterproto.Message):
    ...
    # 图片 url
    img: str = betterproto.string_field(3)
    # 跳转类型 0-不跳转 1-漫画详情 2-漫画单话 3-活动专题页地址 4-跳转app内部
    jump_type: int = betterproto.int32_field(4)
    # 跳转漫画ID
    jump_comic: int = betterproto.int32_field(5)
    # 跳转话ID
...
class GetExpenseHistoryReq(betterproto.Message):
    ...
    platform: int = betterproto.int32_field(7)
    # 消费方式 3: 漫币 2: 阅读券 4: 限免卡 后端同学注意， 非订单范畴从 10000 开始 月票 10001
...
class EditTokenTempReq(betterproto.Message):
    ...
    # 卡券配置 eg:[{coupon_count: 1, coupon_id: 12}]
...
class TokenTemp(betterproto.Message):
    ...
    # 跳转地址
    jump_value: str = betterproto.string_field(6)
    # 卡券配置 eg:[{gift_count: 1, gift_id: 12}]
    gift_settings: List["TokenGiftSetting"] = betterproto.message_field(7)
    # 创建时间
    ctime: str = betterproto.string_field(8)
    # 创造人
...
class ManageStub(betterproto.ServiceStub):
    ...
    @allure.step("""更新使用用户""")
    def update_user(self, request: User) -> DefaultResponse:
        """更新使用用户"""
        logging.getLogger(__name__).info(
    ...
    def add_comic_wiki(self, request: ComicWiki) -> DefaultResponse:
        """新增漫画百科"""
        logging.getLogger(__name__).info(
            "start call " + "[add_comic_wiki]" + " api" + "=>" + """新增漫画百科"""
        )
        response = DefaultResponse()
    ...
    def edit_comic_wiki(self, request: ComicWiki) -> DefaultResponse:
        """修改漫画百科"""
        logging.getLogger(__name__).info(
            "start call " + "[edit_comic_wiki]" + " api" + "=>" + """修改漫画百科"""
        )
        response = DefaultResponse()
    ...
    @allure.step("""Banner列表""")
    def banner_list(self, request: BannerListReq) -> BannerListResp:
        """Banner列表"""
        logging.getLogger(__name__).info(
            "start call " + "[banner_list]" + " api" + "=>" + """Banner列表"""
        )
        response = BannerListResp()
        self._do_twirp_rpc("/manage.v0.Manage/BannerList", request, response)
        logging.getLogger(__name__).info("call " + "[banner_list]" + " api success!")
        return response

    @allure.step("""Banner详情""")
    def banner_detail(self, request: BannerDetailReq) -> BannerDetailResp:
        """Banner详情"""
        logging.getLogger(__name__).info(
            "start call " + "[banner_detail]" + " api" + "=>" + """Banner详情"""
        )
        response = BannerDetailResp()
        self._do_twirp_rpc("/manage.v0.Manage/BannerDetail", request, response)
        logging.getLogger(__name__).info("call " + "[banner_detail]" + " api success!")
        return response

    @allure.step("""新增Banner""")
    def add_banner(self, request: BannerInfo) -> DefaultResponse:
        """新增Banner"""
        logging.getLogger(__name__).info(
            "start call " + "[add_banner]" + " api" + "=>" + """新增Banner"""
        )
        response = DefaultResponse()
        self._do_twirp_rpc("/manage.v0.Manage/AddBanner", request, response)
        logging.getLogger(__name__).info("call " + "[add_banner]" + " api success!")
        return response

    @allure.step("""删除Banner""")
    def del_banner(self, request: DelBannerReq) -> DefaultResponse:
        """删除Banner"""
        logging.getLogger(__name__).info(
            "start call " + "[del_banner]" + " api" + "=>" + """删除Banner"""
        )
        response = DefaultResponse()
        self._do_twirp_rpc("/manage.v0.Manage/DelBanner", request, response)
        logging.getLogger(__name__).info("call " + "[del_banner]" + " api success!")
        return response

    @allure.step("""修改Banner""")
    def edit_banner(self, request: BannerInfo) -> DefaultResponse:
        """修改Banner"""
        logging.getLogger(__name__).info(
            "start call " + "[edit_banner]" + " api" + "=>" + """修改Banner"""
        )
        response = DefaultResponse()
        self._do_twirp_rpc("/manage.v0.Manage/EditBanner", request, response)
        logging.getLogger(__name__).info("call " + "[edit_banner]" + " api success!")
        return response
