    ...
    def __init__(
        ...
        *,
        ...
        targets: typing.Union[
            ...
            typing.List[typing.Union["TargetProperty", aws_cdk.core.IResolvable]],
        ],
...
class CfnNotificationRuleProps:
    def __init__(
        ...
        *,
        ...
        targets: typing.Union[
            ...
            typing.List[
                typing.Union[
                    "CfnNotificationRule.TargetProperty", aws_cdk.core.IResolvable
                ]
            ],
        ],
        status: typing.Optional[str] = None,
    ...
    def targets(
        ...
        aws_cdk.core.IResolvable,
        typing.List[
            typing.Union["CfnNotificationRule.TargetProperty", aws_cdk.core.IResolvable]
        ],
    ]:
        """``AWS::CodeStarNotifications::NotificationRule.Targets``.
