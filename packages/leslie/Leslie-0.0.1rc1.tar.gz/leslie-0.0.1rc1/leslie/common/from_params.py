...
from leslie.common.lazy import Lazy
...
def is_base_registrable(cls) -> bool:
    ...
    a class.
    """
    from leslie.common.registrable import Registrable  # import here to avoid circular imports
...
def pop_and_construct_arg(
    ...
    """
    from leslie.models.archival import load_archive  # import here to avoid circular imports
