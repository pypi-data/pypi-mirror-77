...
# @Last Modified time: 2020-08-19 14:14:19
...
class Common(object):
	...
	def __sendCodeV3(self,mobilePhone,env="fat"):
		if env == "uat":
	...
	def login_auth_app(self,mobilePhone,env="fat"):
		"""
			app登陆认证
			返回token,guid
		"""
		self.__sendCodeV3(mobilePhone)
		if env == "uat":
