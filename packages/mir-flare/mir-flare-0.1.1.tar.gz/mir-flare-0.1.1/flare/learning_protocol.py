...
class LearningProtocol(object):
    ...
    def __init__(self, model: Union[GaussianProcess,MappedGaussianProcess],
                    n_cpus : int = 0,
        ...
        self.model = model
        self.output = Output(basename=protocol_name,
                             always_flush=True)
    ...
    def augment_training_set(self, structure: Structure,
        ...
        if isinstance(self.model,GaussianProcess):
            ...
            self.model.update_db(structure=structure,
    ...
    def run_passive_learning(self,
        ...
        if not isinstance(self.model, GaussianProcess):
            raise NotImplementedError("Passive learning not"
        ...
        for frame in frames:
            ...
            self.model.update_db(struc=frame,
        ...
        if n_atoms_added:
            logger.info(f"Added {n_atoms_added} atoms to "
                        f"pretrain.\n"
...
class LearningProtocol:
    ...
    def __init__(self, gp: Union[GaussianProcess, MappedGaussianProcess],
        ...
        self.seed_envs = [] if passive_envs is None else \
            passive_envs
        self.seed_frames = [] if passive_frames is None \
            else passive_frames
    ...
    def active_run(self):
        ...
        while cur_frame is not None:
            ...
            self.output.write_gp_dft_comparison(
                ...
                frame=dummy_frame, start_time=time.time(),
