...
class AccountServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetAccountAssociations = channel.unary_stream(
                ...
                request_serializer=account__pb2.GetAccountAssociationsRequest.SerializeToString,
        ...
        self.SaveOpportunity = channel.unary_unary(
                '/calixa.domain.account.AccountService/SaveOpportunity',
                request_serializer=account__pb2.SaveOpportunityRequest.SerializeToString,
                response_deserializer=account__pb2.Opportunity.FromString,
                )
        self.GetOpportunities = channel.unary_stream(
                '/calixa.domain.account.AccountService/GetOpportunities',
                request_serializer=account__pb2.GetOpportunitiesRequest.SerializeToString,
                response_deserializer=account__pb2.Opportunity.FromString,
                )
...
class AccountServiceServicer(object):
    ...
    def SaveOpportunity(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')

    def GetOpportunities(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_AccountServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetAccountAssociations': grpc.unary_stream_rpc_method_handler(
                    ...
                    request_deserializer=account__pb2.GetAccountAssociationsRequest.FromString,
            ...
            'SaveOpportunity': grpc.unary_unary_rpc_method_handler(
                    servicer.SaveOpportunity,
                    request_deserializer=account__pb2.SaveOpportunityRequest.FromString,
                    response_serializer=account__pb2.Opportunity.SerializeToString,
            ),
            'GetOpportunities': grpc.unary_stream_rpc_method_handler(
                    servicer.GetOpportunities,
                    request_deserializer=account__pb2.GetOpportunitiesRequest.FromString,
                    response_serializer=account__pb2.Opportunity.SerializeToString,
            ),
    }
...
class AccountService(object):
    ...
    def GetAccountAssociations(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/calixa.domain.account.AccountService/GetAccountAssociations',
            account__pb2.GetAccountAssociationsRequest.SerializeToString,
    ...
    def SaveOpportunity(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/calixa.domain.account.AccountService/SaveOpportunity',
            account__pb2.SaveOpportunityRequest.SerializeToString,
            account__pb2.Opportunity.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetOpportunities(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/calixa.domain.account.AccountService/GetOpportunities',
            account__pb2.GetOpportunitiesRequest.SerializeToString,
            account__pb2.Opportunity.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
