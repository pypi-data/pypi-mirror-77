...
class NoteServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SaveThread = channel.unary_unary(
                ...
                response_deserializer=collaboration__pb2.Thread.FromString,
                )
        ...
        self.SaveMessage = channel.unary_unary(
                ...
                response_deserializer=collaboration__pb2.Message.FromString,
                )
        ...
        self.DeleteThread = channel.unary_unary(
                '/calixa.domain.collaboration.NoteService/DeleteThread',
                request_serializer=collaboration__pb2.ThreadReference.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                )
        self.DeleteMessage = channel.unary_unary(
                '/calixa.domain.collaboration.NoteService/DeleteMessage',
                request_serializer=collaboration__pb2.MessageReference.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                )
        self.AddOrganizationUserNotification = channel.unary_unary(
                ...
                response_deserializer=collaboration__pb2.OrganizationUserNotification.FromString,
                )
...
def add_NoteServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SaveThread': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=collaboration__pb2.Thread.SerializeToString,
            ),
            ...
            'SaveMessage': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=collaboration__pb2.Message.SerializeToString,
            ),
            ...
            'DeleteMessage': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=collaboration__pb2.MessageReference.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            'AddOrganizationUserNotification': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=collaboration__pb2.OrganizationUserNotification.SerializeToString,
            ),
...
class NoteService(object):
    ...
    def SaveThread(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/calixa.domain.collaboration.NoteService/SaveThread',
            ...
            collaboration__pb2.Thread.FromString,
    ...
    def SaveMessage(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/calixa.domain.collaboration.NoteService/SaveMessage',
            ...
            collaboration__pb2.Message.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def DeleteThread(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/calixa.domain.collaboration.NoteService/DeleteThread',
            collaboration__pb2.ThreadReference.SerializeToString,
    ...
    def DeleteMessage(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/calixa.domain.collaboration.NoteService/DeleteMessage',
            collaboration__pb2.MessageReference.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def AddOrganizationUserNotification(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/calixa.domain.collaboration.NoteService/AddOrganizationUserNotification',
            ...
            collaboration__pb2.OrganizationUserNotification.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
