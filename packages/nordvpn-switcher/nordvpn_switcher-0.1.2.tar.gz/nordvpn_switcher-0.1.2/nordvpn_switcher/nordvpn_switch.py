...
from nordvpn_switcher import NordVPN_options  # relative-import the *package* containing the templates

template = pkg_resources.open_text(NordVPN_options, 'countrylist.txt').read().split('\n')
