...
def sample_final_states(circuit, samples=1, data=None):
    ...
    the symbol values in the range (0, 2pi) will be assigned to the gate operation.
...
def circuit_fidelity_pdf(circuit, samples=3000, bins=100, data=None):
    ...
    Args: 
        ...
        data: real numbers with shape
            ...
            into the circuits, following the ordering dictated by `symbol_names`.
        bins: int
            Number of bins in the probability density function
    Returns:
...
def get_data_Haar(n_qubit, samples=3000, bins=100):
    ...
    Args:
        ...
        samples: int
            Number of samples
        bins: int
            Number of bins of the Haar distribution
    Returns:
...
def circuit_expressibility_measure(circuit, samples = 3000, bins=100, data=None, relative=False, epsilon=1e-10):
    ...
    The expressibility measure is the KL-divergence between the sampled fidelity distribution of the parameterised circuit and the Haar distribution. Reference: https://arxiv.org/pdf/1905.10876.pdf
