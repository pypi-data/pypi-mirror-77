...
class CloudFrontToApiGatewayToLambda(
    ...
    def __init__(
        ...
        id: str,
        *,
        api_gateway_props: typing.Optional[aws_cdk.aws_apigateway.LambdaRestApiProps] = None,
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(api_gateway_props, dict):
            api_gateway_props = aws_cdk.aws_apigateway.LambdaRestApiProps(**api_gateway_props)
