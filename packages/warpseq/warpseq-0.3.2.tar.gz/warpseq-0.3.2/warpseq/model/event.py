...
class Event(object):
    ...
    __slots__ = [ 'type', 'note', 'time', 'on_event', 'scale', 'from_context' ]

    from . note import Note

    def __init__(self, type=None, note=None, time=None, on_event=None, scale=None, from_context=None):
        self.type = type
        self.note = note
        self.time = time
