...
class Song(NewReferenceObject):
    ...
    __slots__ = [ 'name', 'clips', 'scale', 'tempo', 'devices', 'instruments', 'scales', 'scenes', 'tracks',
                  'transforms', 'patterns', 'data_pools', 'obj_id' ]

    def __init__(self, name=None, clips = None, scale=None, tempo=120, devices=None, instruments=None, scales=None,
                 scenes=None, tracks=None, transforms=None, patterns=None, data_pools=None, obj_id=None):
    ...
    def to_dict(self):
        ...
        result = dict(
            ...
            data_pools = {str(k): v.to_dict() for (k, v) in self.data_pools.items()},
