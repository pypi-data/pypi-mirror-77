...
def get_version():
    ...
    version_py = Path(__file__).parent / "traktor_server" / "version.py"
...
setup(
    ...
    description="Sever for traktor app.",
    long_description=io.open("README.md", "r", encoding="utf-8").read(),
    long_description_content_type="text/markdown",
    url="https://github.com/alefnula/traktor-server",
    ...
    entry_points="""
        [console_scripts]
        traktor-server=traktor_server.__main__:main
    """,
)
