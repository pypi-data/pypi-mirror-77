...
class AddProxyMethodToApiResourceInputParams:
    def __init__(
        self,
        *,
        api_gateway_role: aws_cdk.aws_iam.Role,
        api_method: str,
    ...
    def api_gateway_role(self) -> aws_cdk.aws_iam.Role:
        return self._values.get("api_gateway_role")

    @builtins.property
    def api_method(self) -> str:
        return self._values.get("api_method")

    @builtins.property
    def api_resource(self) -> aws_cdk.aws_apigateway.IResource:
        return self._values.get("api_resource")
...
class BuildEncryptionKeyProps:
    def __init__(
        self, *, encryption_key_props: typing.Optional[aws_cdk.aws_kms.KeyProps] = None
    ) -> None:
        """
...
class BuildS3BucketProps:
    def __init__(
        self, *, bucket_props: typing.Optional[aws_cdk.aws_s3.BucketProps] = None
    ) -> None:
        """
