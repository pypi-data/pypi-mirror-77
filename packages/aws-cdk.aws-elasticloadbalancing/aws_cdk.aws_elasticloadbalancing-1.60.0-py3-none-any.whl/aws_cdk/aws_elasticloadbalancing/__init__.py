...
class CfnLoadBalancer(
    ...
    def __init__(
        ...
        *,
        listeners: typing.Union[
            ...
            typing.List[typing.Union["ListenersProperty", aws_cdk.core.IResolvable]],
        ],
        access_logging_policy: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "AccessLoggingPolicyProperty"]
        ] = None,
        ...
        connection_draining_policy: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "ConnectionDrainingPolicyProperty"]
        ] = None,
        connection_settings: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "ConnectionSettingsProperty"]
        ] = None,
        cross_zone: typing.Optional[
            typing.Union[bool, aws_cdk.core.IResolvable]
        ] = None,
        health_check: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "HealthCheckProperty"]
        ] = None,
        ...
        lb_cookie_stickiness_policy: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        aws_cdk.core.IResolvable, "LBCookieStickinessPolicyProperty"
                    ]
                ],
            ]
        ] = None,
        ...
        policies: typing.Optional[
            typing.Union[
                aws_cdk.core.IResolvable,
                typing.List[typing.Union[aws_cdk.core.IResolvable, "PoliciesProperty"]],
            ]
        ] = None,
    ...
    def health_check(
        self,
    ) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "HealthCheckProperty"]]:
...
class CfnLoadBalancerProps:
    def __init__(
        ...
        *,
        listeners: typing.Union[
            ...
            typing.List[
                typing.Union[
                    "CfnLoadBalancer.ListenersProperty", aws_cdk.core.IResolvable
                ]
            ],
        ],
        access_logging_policy: typing.Optional[
            typing.Union[
                aws_cdk.core.IResolvable, "CfnLoadBalancer.AccessLoggingPolicyProperty"
            ]
        ] = None,
        app_cookie_stickiness_policy: typing.Optional[
            typing.Union[
        ...
        connection_settings: typing.Optional[
            typing.Union[
                aws_cdk.core.IResolvable, "CfnLoadBalancer.ConnectionSettingsProperty"
            ]
        ] = None,
        cross_zone: typing.Optional[
            typing.Union[bool, aws_cdk.core.IResolvable]
        ...
        health_check: typing.Optional[
            typing.Union[
                aws_cdk.core.IResolvable, "CfnLoadBalancer.HealthCheckProperty"
            ]
        ] = None,
        instances: typing.Optional[typing.List[str]] = None,
        lb_cookie_stickiness_policy: typing.Optional[
        ...
        policies: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        aws_cdk.core.IResolvable, "CfnLoadBalancer.PoliciesProperty"
                    ]
                ],
            ]
        ] = None,
    ...
    def listeners(
        ...
        aws_cdk.core.IResolvable,
        typing.List[
            typing.Union["CfnLoadBalancer.ListenersProperty", aws_cdk.core.IResolvable]
        ],
    ]:
        """``AWS::ElasticLoadBalancing::LoadBalancer.Listeners``.
    ...
    def connection_draining_policy(
        ...
        typing.Union[
            aws_cdk.core.IResolvable, "CfnLoadBalancer.ConnectionDrainingPolicyProperty"
        ]
    ]:
        """``AWS::ElasticLoadBalancing::LoadBalancer.ConnectionDrainingPolicy``.
    ...
    def health_check(
        ...
        typing.Union[aws_cdk.core.IResolvable, "CfnLoadBalancer.HealthCheckProperty"]
    ]:
        """``AWS::ElasticLoadBalancing::LoadBalancer.HealthCheck``.
...
class ListenerPort(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-elasticloadbalancing.ListenerPort"
):
    ...
    def add_listener(
        ...
        *,
        ...
        allow_connections_from: typing.Optional[
            typing.List[aws_cdk.aws_ec2.IConnectable]
        ] = None,
