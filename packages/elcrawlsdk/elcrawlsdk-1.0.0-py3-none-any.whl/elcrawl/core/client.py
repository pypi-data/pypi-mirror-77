...
from elcrawl.core import ELCRAWL_TMP
from elcrawl.core.config import config
from elcrawl.core.request import Request
from elcrawl.utils.scrapy import get_scrapy_cfg, get_items_fields, get_pipelines, get_spider_filepath
...
def get_ignore_matches():
    ...
    ignore_file = os.path.join(os.path.abspath(os.curdir), '.elcrawlignore')
...
class Client(object):
    ...
    def upload_customized_spider(directory=None, name=None, col=None, display_name=None, command=None, id=None):
        ...
        target_path = os.path.join(ELCRAWL_TMP, name or os.path.basename(directory)) + '.zip'
