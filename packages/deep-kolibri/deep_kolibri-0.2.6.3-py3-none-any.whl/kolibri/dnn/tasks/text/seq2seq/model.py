...
import kolibri.dnn
from kolibri.data.corpus.generators import DataGenerator, Seq2SeqDataSet
from kolibri.dnn.autoencoder.decoder import AttGRUDecoder
from kolibri.dnn.autoencoder.encoder import GRUEncoder
...
class Seq2Seq:
    ...
    def __init__(self,
        ...
        self.encoder_processor = TextIndexer(min_count=1)
        self.decoder_processor = TextIndexer(build_vocab_from_labels=True, min_count=1)
