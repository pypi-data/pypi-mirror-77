...
class Ad(object):
    ...
    def __init__(self, audio_device=None, sampling_rate=16000):
        ...
        _ad_openal.Ad_swiginit(self, _ad_openal.new_Ad(audio_device, sampling_rate))
    __swig_destroy__ = _ad_openal.delete_Ad

    def __enter__(self):
        r"""__enter__(Ad self) -> Ad"""
        return _ad_openal.Ad___enter__(self)

    def __exit__(self, exception_type, exception_value, exception_traceback):
        r"""__exit__(Ad self, PyObject * exception_type, PyObject * exception_value, PyObject * exception_traceback)"""
        return _ad_openal.Ad___exit__(self, exception_type, exception_value, exception_traceback)

    def start_recording(self):
        r"""start_recording(Ad self) -> int"""
        return _ad_openal.Ad_start_recording(self)

    def stop_recording(self):
        r"""stop_recording(Ad self) -> int"""
        return _ad_openal.Ad_stop_recording(self)

    def readinto(self, DATA):
        r"""readinto(Ad self, char * DATA) -> int"""
        return _ad_openal.Ad_readinto(self, DATA)

# Register Ad in _ad_openal:
_ad_openal.Ad_swigregister(Ad)
