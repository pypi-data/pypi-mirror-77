...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'mongodbatlas', '1.2.0-alpha.1598307836+9e5f95c8'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource mongodbatlas 1.2.0-alpha.1598307836+9e5f95c8`
                """)
            else:
                raise
