...
def replace(df1,df,name,n,method:None):
    ...
    Returns:
       drop_row_missing(df1,df,name,n,method) : The data frame with replaced NaN values with specified method and required columns
...
def swapmissing_subset(df,name,method):
    ...
    Returns:
       replace_missing(df,name,method) : The data frame with replaced NaN values with specified method and required columns
...
def dropmissing_subset(df,name):
    ...
    Returns:
       drop_selected(df,name) : The DataFrame which is to be clean by dropping missing and NaN values
...
def dropmissing(df):
    ...
    Returns:
       drop_all_missing(df) : The DataFrame which is to be clean by dropping missing and NaN values
...
def dropmissing_rows(df):
    ...
    Returns:
       drop_row_missing(df) : The DataFrame which is to be clean by dropping missing and NaN values
