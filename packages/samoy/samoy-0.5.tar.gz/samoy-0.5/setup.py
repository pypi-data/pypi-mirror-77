...
long_description= color.BOLD+"Auto Data cleaner - samoy"+color.END,      # Type in your E-Mail
...
'https://github.com/samoy-pckg/samoy/archive/v_05.zip',    # I explain this later on
