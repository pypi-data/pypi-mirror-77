    ...
    def __init__(
        ...
        *,
        ...
        endpoint_details: typing.Optional[
            typing.Union["EndpointDetailsProperty", aws_cdk.core.IResolvable]
        ] = None,
        endpoint_type: typing.Optional[str] = None,
        identity_provider_details: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "IdentityProviderDetailsProperty"]
        ] = None,
...
class CfnServerProps:
    def __init__(
        ...
        *,
        certificate: typing.Optional[str] = None,
        endpoint_details: typing.Optional[
            typing.Union["CfnServer.EndpointDetailsProperty", aws_cdk.core.IResolvable]
        ] = None,
        endpoint_type: typing.Optional[str] = None,
        identity_provider_details: typing.Optional[
            typing.Union[
                aws_cdk.core.IResolvable, "CfnServer.IdentityProviderDetailsProperty"
            ]
        ] = None,
        identity_provider_type: typing.Optional[str] = None,
        logging_role: typing.Optional[str] = None,
...
class CfnUser(
        ...
        *,
        ...
        home_directory_mappings: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        aws_cdk.core.IResolvable, "HomeDirectoryMapEntryProperty"
                    ]
                ],
            ]
        ] = None,
    ...
    def home_directory_mappings(
        ...
        typing.Union[
            aws_cdk.core.IResolvable,
            typing.List[
                typing.Union[aws_cdk.core.IResolvable, "HomeDirectoryMapEntryProperty"]
            ],
        ]
    ]:
...
class CfnUserProps:
    ...
    def home_directory_mappings(
        ...
        typing.Union[
            ...
            typing.List[
                typing.Union[
                    aws_cdk.core.IResolvable, "CfnUser.HomeDirectoryMapEntryProperty"
                ]
            ],
        ]
    ]:
