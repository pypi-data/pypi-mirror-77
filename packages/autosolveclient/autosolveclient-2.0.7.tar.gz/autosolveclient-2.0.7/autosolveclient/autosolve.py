...
class InternalAutoSolve:
    ...
    def begin_connection(self):
        self.executor.submit(self.process_begin_connection)
    ...
    def handle_success(self):
        ...
        self.delay = 0
        self.ready = True
        self.executor.submit(self.attempt_message_backlog_send)
    ...
    def send_token_request(self, message):
        self.executor.submit(self.process_send_token_request, message)

    def cancel_token_request(self, taskId):
        self.executor.submit(self.process_cancel_token_request, taskId)

    def cancel_all_requests(self):
        self.executor.submit(self.process_cancel_all_requests)
    ...
    def process_send_token_request(self, message):
        ...
        try:
            ...
            self.executor.submit(self.resend, message, self.token_send_routing_key, self.directExchangeName)
    ...
    def process_cancel_token_request(self, taskId):
        ...
        try:
            ...
            self.log(e, self.autosolve_constants.WARNING)
            self.executor.submit(self.resend, message, self.cancel_send_routing_key, self.fanoutExchangeName)
