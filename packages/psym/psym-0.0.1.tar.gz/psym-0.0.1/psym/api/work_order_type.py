...
class WorkOrderTypesSearch:
    def __init__(self, client: SymphonyClient):
        self.client = client

    def all_entities(self) -> Iterator[WorkOrderType]:
        """Get the iterator of work order types
            ...
            **Example**
            ...
            .. code-block:: python
                ...
                work_order_types = client.get_work_order_types.all_entities()
                for work_order_type in work_order_types:
                    print(work_order_type.name, work_order_type.description)
        """
        result = WorkOrderTypesQuery.execute(self.client)
        if result is None:
            return
    ...
    def by_name(self, name: str) -> WorkOrderType:
        """This function gets existing WorkOrderType by its name.
            ...
            **Example**
            ...
            .. code-block:: python
                ...
                client.get_work_order_types.by_name(name="WorkOrderType Name")
        """
        work_order_types = get_work_order_types(client=self.client).all_entities()
        for work_order_type in work_order_types:
            if work_order_type.name == name:
                return work_order_type
        raise EntityNotFoundError(entity=Entity.WorkOrderType, entity_name=name)

    def by_id(self, id: str) -> WorkOrderType:
        """This function gets existing WorkOrderType by its ID.
            ...
            **Example**
            ...
            .. code-block:: python
                ...
                client.get_work_order_types.by_id(id="12345678")
        """
        result = WorkOrderTypeDetailsQuery.execute(self.client, id=id)
...
def get_work_order_types(client: SymphonyClient) -> WorkOrderTypesSearch:
    """This function gets WorkOrderTypesSearch object.

        :py:meth:`WorkOrderTypesSearch.all_entities()`
        :py:meth:`WorkOrderTypesSearch.by_name()`
        :py:meth:`WorkOrderTypesSearch.by_id()`

        **Example 1**

        .. code-block:: python

            client.get_work_order_types.all_entities()
        ...
        **Example 3**
        ...
        .. code-block:: python
            ...
            client.get_work_order_types.by_name(name="WorkOrderType Name")
    """
    return WorkOrderTypesSearch(client=client)
...
def edit_work_order_type(
    ...
    """
    search = WorkOrderTypesSearch(client=client)
    work_order_type = search.by_id(id=work_order_type_id)
