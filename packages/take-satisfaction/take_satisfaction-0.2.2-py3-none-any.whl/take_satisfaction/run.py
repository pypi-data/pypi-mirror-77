...
def run(sql_context: CONTEXT, start_date: str, end_date: str, bot_identity: str, category: str,
        threshold: int) -> tp.Dict[str, tp.Any]:
    ...
    preprocessed_df = remove_manual(scale_raw_df, scale_manual, threshold, bot_events_answer_column)
    
    scale_translations = params['scale_translations']
    converted_df = convert_scale(preprocessed_df, scale_translations, threshold,
