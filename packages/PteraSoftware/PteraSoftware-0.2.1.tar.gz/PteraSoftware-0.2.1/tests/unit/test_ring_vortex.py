...
class TestRingVortex(unittest.TestCase):
    ...
    def test_class(self):
        ...
        self.assertIsInstance(self.ring_vortex_fixture, main.aerodynamics.RingVortex)
        self.assertIsInstance(
            self.ring_vortex_fixture.front_leg, main.aerodynamics.LineVortex
        )
        self.assertIsInstance(
            self.ring_vortex_fixture.left_leg, main.aerodynamics.LineVortex
        )
        self.assertIsInstance(
            self.ring_vortex_fixture.back_leg, main.aerodynamics.LineVortex
        )
        self.assertIsInstance(
            self.ring_vortex_fixture.right_leg, main.aerodynamics.LineVortex
        )
