...
def make_line_vortex_fixture():
    ...
    line_vortex_fixture = main.aerodynamics.LineVortex(
...
def make_horseshoe_vortex_fixture():
    ...
    horseshoe_vortex_fixture = main.aerodynamics.HorseshoeVortex(
...
def make_ring_vortex_fixture():
    ...
    ring_vortex_fixture = main.aerodynamics.RingVortex(
