...
class SoldProperty(Model):
    ...
    def __init__(self, id: str=None, address: str=None, postal_code: str=None, community: str=None, properly_city_code: str=None, zone: str=None, yr_built: int=None, living_space_square_footage_ag: int=None, lot_size: float=None, lot_depth: float=None, lot_frontage: float=None, land_use_code: str=None, assessed_value: float=None, tax_amount: float=None, building_type: str=None, style: str=None, basement_development: str=None, basement_percent_development: float=None, basement: List[str]=None, bedrooms_total: float=None, bedrooms_standard: float=None, bedrooms_extra: float=None, bedrooms_ag: float=None, bedrooms_with_closet: float=None, master_walk_in: bool=None, master_ensuite: bool=None, bathrooms_total: float=None, bathrooms_full: float=None, bathrooms_half: float=None, bathrooms_main: float=None, bathrooms_basement: float=None, room_number: float=None, kitchen_countertops: List[str]=None, kitchen_island: bool=None, kitchen_appliances: List[str]=None, kitchen_layout: str=None, flooring: List[str]=None, fireplace: List[str]=None, heating_type: List[str]=None, backyard_details: str=None, exterior: List[str]=None, parking: List[str]=None, total_parking: float=None, enclosed_parking: float=None, roof_type: str=None, roof_age_years: int=None, is_renovated: bool=None, renovations_or_upgrades: str=None, property_photos_user_submitted: str=None, latitude: float=None, longitude: float=None, google_place_id: str=None, building_place_id: str=None, geo_hash5: str=None, geo_hash12: str=None, custom_annotations: List[CustomAnnotation]=None, images: List[Image]=None, rooms: List[List[str]]=None, property_rooms: List[Room]=None, tax_assessment_roll_number: str=None, assessed_year: int=None, air_conditioning: str=None, approx_sqft: str=None, elevator: bool=None, direction_faces: str=None, basement_ensuite: bool=None, is_ph: bool=None, entry_level: float=None, unit_number: str=None, share_percentage: str=None, patio_and_porch_features: str=None, association_amenities: List[str]=None, locker: str=None, condo_corp_number: str=None, condo_corp: str=None, laundry_features: List[str]=None, association_fee: float=None, parking_fee: float=None, parking_included: bool=None, pets_allowed: str=None, city: str=None, province: str=None, stories: int=None, properly_municipality_code: str=None, building_name: str=None, association_fee_frequency: str=None, list_agent_phone: str=None, list_agent_email: str=None, list_agent_full_name: str=None, list_agent_mls_id: str=None, sold_price: float=None, list_price: float=None, sold_date: str=None, list_date: str=None, dom: float=None, mls_id: str=None, lease: bool=None):  # noqa: E501
        ...
        :param building_place_id: The building_place_id of this SoldProperty.  # noqa: E501
        ...
        :param is_ph: The is_ph of this SoldProperty.  # noqa: E501
        :type is_ph: bool
        :param entry_level: The entry_level of this SoldProperty.  # noqa: E501
        ...
        :param locker: The locker of this SoldProperty.  # noqa: E501
        :type locker: str
    ...
    def building_place_id(self) -> str:
        """Gets the building_place_id of this SoldProperty.

        The google place id for the whole building  # noqa: E501

        :return: The building_place_id of this SoldProperty.
        :rtype: str
        """
    ...
    def building_place_id(self, building_place_id: str):
        """Sets the building_place_id of this SoldProperty.

        The google place id for the whole building  # noqa: E501

        :param building_place_id: The building_place_id of this SoldProperty.
        :type building_place_id: str
        """
    ...
    @property
    def is_ph(self) -> bool:
        """Gets the is_ph of this SoldProperty.

        Is your unit a penthouse unit?  # noqa: E501

        :return: The is_ph of this SoldProperty.
        :rtype: bool
        """
        return self._is_ph
    ...
    def is_ph(self, is_ph: bool):
        """Sets the is_ph of this SoldProperty.

        Is your unit a penthouse unit?  # noqa: E501

        :param is_ph: The is_ph of this SoldProperty.
        :type is_ph: bool
        """
    ...
    def entry_level(self) -> float:
        """Gets the entry_level of this SoldProperty.
        ...
        :return: The entry_level of this SoldProperty.
        :rtype: float
        """
    ...
    def entry_level(self, entry_level: float):
        """Sets the entry_level of this SoldProperty.

        The entryLevel of a condo/apartment. Equivalent to the floor number minus any missing floors (e.g. floor 13 doesn't exist for some buildings)  # noqa: E501

        :param entry_level: The entry_level of this SoldProperty.
        :type entry_level: float
        """
    ...
    @property
    def locker(self) -> str:
        """Gets the locker of this SoldProperty.

        Type of locker that comes with this property  # noqa: E501

        :return: The locker of this SoldProperty.
        :rtype: str
        """
        return self._locker
    ...
    def locker(self, locker: str):
        """Sets the locker of this SoldProperty.

        Type of locker that comes with this property  # noqa: E501

        :param locker: The locker of this SoldProperty.
        :type locker: str
        """
