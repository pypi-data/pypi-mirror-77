...
model_with_custom_staging_schema = Sqlpie(models=['model_2']).models['model_2']
all_models = Sqlpie()
...
class TestClient(unittest.TestCase):
  ...
  def test_all_leaves(self):
  	self.assertEqual(example_model.dag.all_leaves(),  ['example_model.example_2', 'example_model.example_3'])
  
  def test_model_key_names(self):
  	self.assertEqual(list(example_model.rendered_model.keys()), ['example_model_staging.example_1', 'example_model.example_2', 'example_model.example_3'])
  ...
  def test_all_models_edges(self):
    ...
    edges = sorted([['example_model.example_3', 'model_2.example_1'], ['custom_staging_schema.enrich_example_1', 'model_2.example_1'], ['example_model_staging.example_1', 'model_2.example_1'], ['example_source_schema.table_3', 'custom_staging_schema.enrich_example_1'], ['example_model.example_2', 'custom_staging_schema.enrich_example_1'], ['example_source_schema.table_1', 'model_with_empty_config.query_1'], ['example_model_staging.example_1', 'example_model.example_3'], ['example_model_staging.example_1', 'example_model.example_2'], ['example_source_schema.table_1', 'example_model_staging.example_1'], ['example_source_schema.table_2', 'example_model_staging.example_1'], ['example_source_schema.table_3', 'example_model_staging.example_1']])
  ...
  def test_table_index_output(self):
    table_index = {'custom_staging_schema.enrich_example_1': {'file_path': './models/model_2/enrich_example_1.sql', 'source_name': 'model_2', 'schema': 'custom_staging_schema', 'table_name': 'custom_staging_schema.enrich_example_1', 'table_short_name': 'enrich_example_1', 'update_method': 'append', 'source_type': 'staging', 'included_in': ['model_2']}, 'model_2.example_1': {'file_path': './models/model_2/example_1.sql', 'source_name': 'model_2', 'schema': 'model_2', 'table_name': 'model_2.example_1', 'table_short_name': 'example_1', 'update_method': 'append', 'source_type': 'model'}, 'model_with_empty_config.query_1': {'file_path': './models/model_with_empty_config/query_1.sql', 'source_name': 'model_with_empty_config', 'schema': 'model_with_empty_config', 'table_name': 'model_with_empty_config.query_1', 'table_short_name': 'query_1', 'update_method': 'append', 'source_type': 'model'}, 'example_model_staging.example_1': {'file_path': './models/example_model/example_1.sql', 'source_name': 'example_model', 'schema': 'example_model_staging', 'table_name': 'example_model_staging.example_1', 'table_short_name': 'example_1', 'update_method': 'append', 'description': 'reads data from sources and performs some processing and enrichment', 'source_type': 'staging', 'included_in': ['example_model']}, 'example_model.example_2': {'file_path': './models/example_model/example_2.sql', 'source_name': 'example_model', 'schema': 'example_model', 'table_name': 'example_model.example_2', 'table_short_name': 'example_2', 'update_method': 'append', 'description': 'daily aggregation view', 'source_type': 'model', 'included_in': ['model_2']}, 'example_model.example_3': {'file_path': './models/example_model/example_3.sql', 'source_name': 'example_model', 'schema': 'example_model', 'table_name': 'example_model.example_3', 'table_short_name': 'example_3', 'update_method': 'append', 'description': 'monthly aggregation view', 'source_type': 'model', 'included_in': ['model_2']}, 'example_source_schema.table_3': {'source_type': 'source', 'source_name': 'example_source_schema', 'schema': 'example_source_schema_public', 'table_name': 'example_source_schema.table_3', 'table_short_name': 'table_3', 'destination_table': 'custom_staging_schema.enrich_example_1', 'included_in': ['model_2', 'example_model'], 'description': 'bing ads daily aggregated metrics'}, 'example_source_schema.table_1': {'source_type': 'source', 'source_name': 'example_source_schema', 'schema': 'example_source_schema_public', 'table_name': 'example_source_schema.table_1', 'table_short_name': 'table_1', 'destination_table': 'model_with_empty_config.query_1', 'included_in': ['model_with_empty_config', 'example_model'], 'description': 'facebook advertsing daily aggregated metrics'}, 'example_source_schema.table_2': {'source_type': 'source', 'source_name': 'example_source_schema', 'schema': 'example_source_schema_public', 'table_name': 'example_source_schema.table_2', 'table_short_name': 'table_2', 'destination_table': 'example_model_staging.example_1', 'included_in': ['example_model'], 'description': 'google adwords daily aggregated metrics'}}
  ...
  def test_table_index_model_description(self):
    description_output = all_models.api_data['table_index']['example_model_staging.example_1']['description']
  ...
  def test_staging_source_type(self):
    staging_source_type = all_models.api_data['table_index']['example_model_staging.example_1']['source_type']
    self.assertEqual(staging_source_type, 'staging')

  def test_staging_model_inclusion(self):
    included_in_output = all_models.api_data['table_index']['example_model_staging.example_1']['included_in']
    included_in = ['example_model']
    self.assertEqual(included_in_output, included_in)

  def test_file_path_index(self):
    file_path_index = {'./models/model_2/enrich_example_1.sql': 'custom_staging_schema.enrich_example_1', './models/model_2/example_1.sql': 'model_2.example_1', './models/model_with_empty_config/query_1.sql': 'model_with_empty_config.query_1', './models/example_model/example_1.sql': 'example_model_staging.example_1', './models/example_model/example_2.sql': 'example_model.example_2', './models/example_model/example_3.sql': 'example_model.example_3'}
    file_path_index_output = all_models.file_path_index
