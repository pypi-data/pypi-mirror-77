...
class CfnScalingPlan(
    ...
    def __init__(
        ...
        *,
        application_source: typing.Union[
            "ApplicationSourceProperty", aws_cdk.core.IResolvable
        ],
        scaling_instructions: typing.Union[
            aws_cdk.core.IResolvable,
            typing.List[
                typing.Union[aws_cdk.core.IResolvable, "ScalingInstructionProperty"]
            ],
        ],
    ) -> None:
    ...
    def application_source(
        self,
    ) -> typing.Union["ApplicationSourceProperty", aws_cdk.core.IResolvable]:
    ...
    def application_source(
        self, value: typing.Union["ApplicationSourceProperty", aws_cdk.core.IResolvable]
    ) -> None:
            ...
            *,
            ...
            tag_filters: typing.Optional[
                typing.Union[
                    ...
                    typing.List[
                        typing.Union[
                            aws_cdk.core.IResolvable, "CfnScalingPlan.TagFilterProperty"
                        ]
                    ],
                ]
            ] = None,
    ...
    class ScalingInstructionProperty:
        def __init__(
            ...
            *,
            ...
            target_tracking_configurations: typing.Union[
                aws_cdk.core.IResolvable,
                typing.List[
                    typing.Union[
                        aws_cdk.core.IResolvable,
            ...
            customized_load_metric_specification: typing.Optional[
                typing.Union[
                    aws_cdk.core.IResolvable,
                    "CfnScalingPlan.CustomizedLoadMetricSpecificationProperty",
                ]
            ] = None,
            disable_dynamic_scaling: typing.Optional[
                typing.Union[bool, aws_cdk.core.IResolvable]
            ] = None,
            predefined_load_metric_specification: typing.Optional[
                typing.Union[
                    aws_cdk.core.IResolvable,
    ...
    class TargetTrackingConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            customized_scaling_metric_specification: typing.Optional[
                typing.Union[
                    aws_cdk.core.IResolvable,
            ...
            predefined_scaling_metric_specification: typing.Optional[
                typing.Union[
                    aws_cdk.core.IResolvable,
...
class CfnScalingPlanProps:
    def __init__(
        ...
        *,
        application_source: typing.Union[
            "CfnScalingPlan.ApplicationSourceProperty", aws_cdk.core.IResolvable
        ],
        scaling_instructions: typing.Union[
            aws_cdk.core.IResolvable,
            typing.List[
    ...
    def scaling_instructions(
        ...
        typing.List[
            typing.Union[
                aws_cdk.core.IResolvable, "CfnScalingPlan.ScalingInstructionProperty"
            ]
        ],
    ]:
        """``AWS::AutoScalingPlans::ScalingPlan.ScalingInstructions``.
