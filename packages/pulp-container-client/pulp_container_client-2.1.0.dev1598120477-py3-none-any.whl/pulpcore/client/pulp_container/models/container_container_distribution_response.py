...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, base_path=None, content_guard=None, repository_version=None, pulp_href=None, name=None, pulp_created=None, repository=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
