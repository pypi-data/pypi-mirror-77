...
import panviva
from panviva.models.resource_search_result import ResourceSearchResult  # noqa: E501
...
class TestResourceSearchResult(unittest.TestCase):
    ...
    def testResourceSearchResult(self):
        ...
        # model = panviva.models.resource_search_result.ResourceSearchResult()  # noqa: E501
        pass
