...
class EvaluationStack():
    ...
    def insert(self, index: int, item: StackItem) -> None: 
        """
        Add an intem at a specific index
        """
    ...
    def remove(self, index: int) -> StackItem: 
        ...
        """
    @property
    def _items(self) -> List[StackItem]:
        """
        :type: List[StackItem]
        """
    pass
...
class ExceptionHandlingState():
    ...
    __entries: dict # value = {'TRY': (ExceptionHandlingState.TRY, None), 'CATCH': (ExceptionHandlingState.CATCH, None), 'FINALLY': (ExceptionHandlingState.FINALLY, None)}
...
class ExecutionContext():
    def __init__(self, script: Script, reference_counter: ReferenceCounter) -> None: ...
    ...
    def static_fields(self) -> Slot:
        ...
        """
    @property
    def try_stack(self) -> List[ExceptionHandlingContext]:
        """
        :type: List[ExceptionHandlingContext]
        """
    pass
class ExecutionEngine():
    ...
    def load_script(self, script: Script, initial_position: int = 0) -> ExecutionContext: 
        """
    ...
    def pop(self) -> StackItem: 
        """
        Pop the top item from the evaluation stack.
        """
    ...
    def exception_message(self) -> str:
        ...
        """
    @property
    def invocation_stack(self) -> List[ExecutionContext]:
        """
...
class MapStackItem(CompoundType, StackItem):
    ...
    def clear(self) -> None: 
        ...
        Remove all internal items.
        """
    def keys(self) -> List[StackItem]: ...
    def remove(self, key: PrimitiveType) -> None: 
        """
        Remove pair by key
        """
    def values(self) -> List[StackItem]: ...
    pass
...
class OpCode():
    ...
    __entries: dict # value = {'PUSHDATA1': (OpCode.PUSHDATA1, None), 'PUSHDATA2': (OpCode.PUSHDATA2, None), 'PUSHDATA4': (OpCode.PUSHDATA4, None), 'PUSHINT8': (OpCode.PUSHINT8, None), 'PUSHINT16': (OpCode.PUSHINT16, None), 'PUSHINT32': (OpCode.PUSHINT32, None), 'PUSHINT64': (OpCode.PUSHINT64, None), 'PUSHINT128': (OpCode.PUSHINT128, None), 'PUSHINT256': (OpCode.PUSHINT256, None), 'INITSSLOT': (OpCode.INITSSLOT, None), 'INITSLOT': (OpCode.INITSLOT, None), 'RET': (OpCode.RET, None), 'NOP': (OpCode.NOP, None), 'PUSHM1': (OpCode.PUSHM1, None), 'PUSH0': (OpCode.PUSH0, None), 'PUSH1': (OpCode.PUSH1, None), 'PUSH2': (OpCode.PUSH2, None), 'PUSH3': (OpCode.PUSH3, None), 'PUSH4': (OpCode.PUSH4, None), 'PUSH5': (OpCode.PUSH5, None), 'PUSH6': (OpCode.PUSH6, None), 'PUSH7': (OpCode.PUSH7, None), 'PUSH8': (OpCode.PUSH8, None), 'PUSH9': (OpCode.PUSH9, None), 'PUSH10': (OpCode.PUSH10, None), 'PUSH11': (OpCode.PUSH11, None), 'PUSH12': (OpCode.PUSH12, None), 'PUSH13': (OpCode.PUSH13, None), 'PUSH14': (OpCode.PUSH14, None), 'PUSH15': (OpCode.PUSH15, None), 'PUSH16': (OpCode.PUSH16, None), 'PUSHNULL': (OpCode.PUSHNULL, None), 'PUSHA': (OpCode.PUSHA, None), 'THROW': (OpCode.THROW, None), 'TRY': (OpCode.TRY, None), 'TRY_L': (OpCode.TRY_L, None), 'ENDTRY': (OpCode.ENDTRY, None), 'ENDTRY_L': (OpCode.ENDTRY_L, None), 'ENDFINALLY': (OpCode.ENDFINALLY, None), 'ASSERT': (OpCode.ASSERT, None), 'ABORT': (OpCode.ABORT, None), 'JMP': (OpCode.JMP, None), 'JMP_L': (OpCode.JMP_L, None), 'JMPIF': (OpCode.JMPIF, None), 'JMPIF_L': (OpCode.JMPIF_L, None), 'JMPIFNOT': (OpCode.JMPIFNOT, None), 'JMPIFNOT_L': (OpCode.JMPIFNOT_L, None), 'JMPEQ': (OpCode.JMPEQ, None), 'JMPEQ_L': (OpCode.JMPEQ_L, None), 'JMPNE': (OpCode.JMPNE, None), 'JMPNE_L': (OpCode.JMPNE_L, None), 'JMPGT': (OpCode.JMPGT, None), 'JMPGT_L': (OpCode.JMPGT_L, None), 'JMPGE': (OpCode.JMPGE, None), 'JMPGE_L': (OpCode.JMPGE_L, None), 'JMPLT': (OpCode.JMPLT, None), 'JMPLT_L': (OpCode.JMPLT_L, None), 'JMPLE': (OpCode.JMPLE, None), 'JMPLE_L': (OpCode.JMPLE_L, None), 'CALL': (OpCode.CALL, None), 'CALL_L': (OpCode.CALL_L, None), 'CALLA': (OpCode.CALLA, None), 'DEPTH': (OpCode.DEPTH, None), 'DROP': (OpCode.DROP, None), 'NIP': (OpCode.NIP, None), 'XDROP': (OpCode.XDROP, None), 'CLEAR': (OpCode.CLEAR, None), 'DUP': (OpCode.DUP, None), 'OVER': (OpCode.OVER, None), 'PICK': (OpCode.PICK, None), 'TUCK': (OpCode.TUCK, None), 'SWAP': (OpCode.SWAP, None), 'ROT': (OpCode.ROT, None), 'ROLL': (OpCode.ROLL, None), 'NEWMAP': (OpCode.NEWMAP, None), 'REVERSE3': (OpCode.REVERSE3, None), 'REVERSE4': (OpCode.REVERSE4, None), 'REVERSEN': (OpCode.REVERSEN, None), 'STSFLD0': (OpCode.STSFLD0, None), 'STSFLD1': (OpCode.STSFLD1, None), 'STSFLD2': (OpCode.STSFLD2, None), 'STSFLD3': (OpCode.STSFLD3, None), 'STSFLD4': (OpCode.STSFLD4, None), 'STSFLD5': (OpCode.STSFLD5, None), 'STSFLD6': (OpCode.STSFLD6, None), 'STSFLD': (OpCode.STSFLD, None), 'LDSFLD0': (OpCode.LDSFLD0, None), 'LDSFLD1': (OpCode.LDSFLD1, None), 'LDSFLD2': (OpCode.LDSFLD2, None), 'LDSFLD3': (OpCode.LDSFLD3, None), 'LDSFLD4': (OpCode.LDSFLD4, None), 'LDSFLD5': (OpCode.LDSFLD5, None), 'LDSFLD6': (OpCode.LDSFLD6, None), 'LDSFLD': (OpCode.LDSFLD, None), 'STLOC0': (OpCode.STLOC0, None), 'STLOC1': (OpCode.STLOC1, None), 'STLOC2': (OpCode.STLOC2, None), 'STLOC3': (OpCode.STLOC3, None), 'STLOC4': (OpCode.STLOC4, None), 'STLOC5': (OpCode.STLOC5, None), 'STLOC6': (OpCode.STLOC6, None), 'STLOC': (OpCode.STLOC, None), 'LDLOC0': (OpCode.LDLOC0, None), 'LDLOC1': (OpCode.LDLOC1, None), 'LDLOC2': (OpCode.LDLOC2, None), 'LDLOC3': (OpCode.LDLOC3, None), 'LDLOC4': (OpCode.LDLOC4, None), 'LDLOC5': (OpCode.LDLOC5, None), 'LDLOC6': (OpCode.LDLOC6, None), 'LDLOC': (OpCode.LDLOC, None), 'STARG0': (OpCode.STARG0, None), 'STARG1': (OpCode.STARG1, None), 'STARG2': (OpCode.STARG2, None), 'STARG3': (OpCode.STARG3, None), 'STARG4': (OpCode.STARG4, None), 'STARG5': (OpCode.STARG5, None), 'STARG6': (OpCode.STARG6, None), 'STARG': (OpCode.STARG, None), 'LDARG0': (OpCode.LDARG0, None), 'LDARG1': (OpCode.LDARG1, None), 'LDARG2': (OpCode.LDARG2, None), 'LDARG3': (OpCode.LDARG3, None), 'LDARG4': (OpCode.LDARG4, None), 'LDARG5': (OpCode.LDARG5, None), 'LDARG6': (OpCode.LDARG6, None), 'LDARG': (OpCode.LDARG, None), 'NEWBUFFER': (OpCode.NEWBUFFER, None), 'NEWARRAY': (OpCode.NEWARRAY, None), 'MEMCPY': (OpCode.MEMCPY, None), 'CAT': (OpCode.CAT, None), 'DEC': (OpCode.DEC, None), 'CONVERT': (OpCode.CONVERT, None), 'SUBSTR': (OpCode.SUBSTR, None), 'LEFT': (OpCode.LEFT, None), 'RIGHT': (OpCode.RIGHT, None), 'INVERT': (OpCode.INVERT, None), 'NEWSTRUCT': (OpCode.NEWSTRUCT, None), 'AND': (OpCode.AND, None), 'OR': (OpCode.OR, None), 'XOR': (OpCode.XOR, None), 'EQUAL': (OpCode.EQUAL, None), 'NOTEQUAL': (OpCode.NOTEQUAL, None), 'SIGN': (OpCode.SIGN, None), 'ABS': (OpCode.ABS, None), 'NEGATE': (OpCode.NEGATE, None), 'INC': (OpCode.INC, None), 'ADD': (OpCode.ADD, None), 'SUB': (OpCode.SUB, None), 'MUL': (OpCode.MUL, None), 'MOD': (OpCode.MOD, None), 'SHL': (OpCode.SHL, None), 'SHR': (OpCode.SHR, None), 'NOT': (OpCode.NOT, None), 'BOOLAND': (OpCode.BOOLAND, None), 'BOOLOR': (OpCode.BOOLOR, None), 'NZ': (OpCode.NZ, None), 'NUMEQUAL': (OpCode.NUMEQUAL, None), 'NUMNOTEQUAL': (OpCode.NUMNOTEQUAL, None), 'LT': (OpCode.LT, None), 'LE': (OpCode.LE, None), 'GT': (OpCode.GT, None), 'GE': (OpCode.GE, None), 'MIN': (OpCode.MIN, None), 'MAX': (OpCode.MAX, None), 'WITHIN': (OpCode.WITHIN, None), 'PACK': (OpCode.PACK, None), 'UNPACK': (OpCode.UNPACK, None), 'NEWARRAY0': (OpCode.NEWARRAY0, None), 'NEWARRAY_T': (OpCode.NEWARRAY_T, None), 'SETITEM': (OpCode.SETITEM, None), 'NEWSTRUCT0': (OpCode.NEWSTRUCT0, None), 'SIZE': (OpCode.SIZE, None), 'HASKEY': (OpCode.HASKEY, None), 'KEYS': (OpCode.KEYS, None), 'VALUES': (OpCode.VALUES, None), 'PICKITEM': (OpCode.PICKITEM, None), 'APPEND': (OpCode.APPEND, None), 'REVERSEITEMS': (OpCode.REVERSEITEMS, None), 'REMOVE': (OpCode.REMOVE, None), 'CLEARITEMS': (OpCode.CLEARITEMS, None), 'ISNULL': (OpCode.ISNULL, None), 'ISTYPE': (OpCode.ISTYPE, None), 'SYSCALL': (OpCode.SYSCALL, None)}
    __members__: dict # value = {'PUSHDATA1': OpCode.PUSHDATA1, 'PUSHDATA2': OpCode.PUSHDATA2, 'PUSHDATA4': OpCode.PUSHDATA4, 'PUSHINT8': OpCode.PUSHINT8, 'PUSHINT16': OpCode.PUSHINT16, 'PUSHINT32': OpCode.PUSHINT32, 'PUSHINT64': OpCode.PUSHINT64, 'PUSHINT128': OpCode.PUSHINT128, 'PUSHINT256': OpCode.PUSHINT256, 'INITSSLOT': OpCode.INITSSLOT, 'INITSLOT': OpCode.INITSLOT, 'RET': OpCode.RET, 'NOP': OpCode.NOP, 'PUSHM1': OpCode.PUSHM1, 'PUSH0': OpCode.PUSH0, 'PUSH1': OpCode.PUSH1, 'PUSH2': OpCode.PUSH2, 'PUSH3': OpCode.PUSH3, 'PUSH4': OpCode.PUSH4, 'PUSH5': OpCode.PUSH5, 'PUSH6': OpCode.PUSH6, 'PUSH7': OpCode.PUSH7, 'PUSH8': OpCode.PUSH8, 'PUSH9': OpCode.PUSH9, 'PUSH10': OpCode.PUSH10, 'PUSH11': OpCode.PUSH11, 'PUSH12': OpCode.PUSH12, 'PUSH13': OpCode.PUSH13, 'PUSH14': OpCode.PUSH14, 'PUSH15': OpCode.PUSH15, 'PUSH16': OpCode.PUSH16, 'PUSHNULL': OpCode.PUSHNULL, 'PUSHA': OpCode.PUSHA, 'THROW': OpCode.THROW, 'TRY': OpCode.TRY, 'TRY_L': OpCode.TRY_L, 'ENDTRY': OpCode.ENDTRY, 'ENDTRY_L': OpCode.ENDTRY_L, 'ENDFINALLY': OpCode.ENDFINALLY, 'ASSERT': OpCode.ASSERT, 'ABORT': OpCode.ABORT, 'JMP': OpCode.JMP, 'JMP_L': OpCode.JMP_L, 'JMPIF': OpCode.JMPIF, 'JMPIF_L': OpCode.JMPIF_L, 'JMPIFNOT': OpCode.JMPIFNOT, 'JMPIFNOT_L': OpCode.JMPIFNOT_L, 'JMPEQ': OpCode.JMPEQ, 'JMPEQ_L': OpCode.JMPEQ_L, 'JMPNE': OpCode.JMPNE, 'JMPNE_L': OpCode.JMPNE_L, 'JMPGT': OpCode.JMPGT, 'JMPGT_L': OpCode.JMPGT_L, 'JMPGE': OpCode.JMPGE, 'JMPGE_L': OpCode.JMPGE_L, 'JMPLT': OpCode.JMPLT, 'JMPLT_L': OpCode.JMPLT_L, 'JMPLE': OpCode.JMPLE, 'JMPLE_L': OpCode.JMPLE_L, 'CALL': OpCode.CALL, 'CALL_L': OpCode.CALL_L, 'CALLA': OpCode.CALLA, 'DEPTH': OpCode.DEPTH, 'DROP': OpCode.DROP, 'NIP': OpCode.NIP, 'XDROP': OpCode.XDROP, 'CLEAR': OpCode.CLEAR, 'DUP': OpCode.DUP, 'OVER': OpCode.OVER, 'PICK': OpCode.PICK, 'TUCK': OpCode.TUCK, 'SWAP': OpCode.SWAP, 'ROT': OpCode.ROT, 'ROLL': OpCode.ROLL, 'NEWMAP': OpCode.NEWMAP, 'REVERSE3': OpCode.REVERSE3, 'REVERSE4': OpCode.REVERSE4, 'REVERSEN': OpCode.REVERSEN, 'STSFLD0': OpCode.STSFLD0, 'STSFLD1': OpCode.STSFLD1, 'STSFLD2': OpCode.STSFLD2, 'STSFLD3': OpCode.STSFLD3, 'STSFLD4': OpCode.STSFLD4, 'STSFLD5': OpCode.STSFLD5, 'STSFLD6': OpCode.STSFLD6, 'STSFLD': OpCode.STSFLD, 'LDSFLD0': OpCode.LDSFLD0, 'LDSFLD1': OpCode.LDSFLD1, 'LDSFLD2': OpCode.LDSFLD2, 'LDSFLD3': OpCode.LDSFLD3, 'LDSFLD4': OpCode.LDSFLD4, 'LDSFLD5': OpCode.LDSFLD5, 'LDSFLD6': OpCode.LDSFLD6, 'LDSFLD': OpCode.LDSFLD, 'STLOC0': OpCode.STLOC0, 'STLOC1': OpCode.STLOC1, 'STLOC2': OpCode.STLOC2, 'STLOC3': OpCode.STLOC3, 'STLOC4': OpCode.STLOC4, 'STLOC5': OpCode.STLOC5, 'STLOC6': OpCode.STLOC6, 'STLOC': OpCode.STLOC, 'LDLOC0': OpCode.LDLOC0, 'LDLOC1': OpCode.LDLOC1, 'LDLOC2': OpCode.LDLOC2, 'LDLOC3': OpCode.LDLOC3, 'LDLOC4': OpCode.LDLOC4, 'LDLOC5': OpCode.LDLOC5, 'LDLOC6': OpCode.LDLOC6, 'LDLOC': OpCode.LDLOC, 'STARG0': OpCode.STARG0, 'STARG1': OpCode.STARG1, 'STARG2': OpCode.STARG2, 'STARG3': OpCode.STARG3, 'STARG4': OpCode.STARG4, 'STARG5': OpCode.STARG5, 'STARG6': OpCode.STARG6, 'STARG': OpCode.STARG, 'LDARG0': OpCode.LDARG0, 'LDARG1': OpCode.LDARG1, 'LDARG2': OpCode.LDARG2, 'LDARG3': OpCode.LDARG3, 'LDARG4': OpCode.LDARG4, 'LDARG5': OpCode.LDARG5, 'LDARG6': OpCode.LDARG6, 'LDARG': OpCode.LDARG, 'NEWBUFFER': OpCode.NEWBUFFER, 'NEWARRAY': OpCode.NEWARRAY, 'MEMCPY': OpCode.MEMCPY, 'CAT': OpCode.CAT, 'DEC': OpCode.DEC, 'CONVERT': OpCode.CONVERT, 'SUBSTR': OpCode.SUBSTR, 'LEFT': OpCode.LEFT, 'RIGHT': OpCode.RIGHT, 'INVERT': OpCode.INVERT, 'NEWSTRUCT': OpCode.NEWSTRUCT, 'AND': OpCode.AND, 'OR': OpCode.OR, 'XOR': OpCode.XOR, 'EQUAL': OpCode.EQUAL, 'NOTEQUAL': OpCode.NOTEQUAL, 'SIGN': OpCode.SIGN, 'ABS': OpCode.ABS, 'NEGATE': OpCode.NEGATE, 'INC': OpCode.INC, 'ADD': OpCode.ADD, 'SUB': OpCode.SUB, 'MUL': OpCode.MUL, 'MOD': OpCode.MOD, 'SHL': OpCode.SHL, 'SHR': OpCode.SHR, 'NOT': OpCode.NOT, 'BOOLAND': OpCode.BOOLAND, 'BOOLOR': OpCode.BOOLOR, 'NZ': OpCode.NZ, 'NUMEQUAL': OpCode.NUMEQUAL, 'NUMNOTEQUAL': OpCode.NUMNOTEQUAL, 'LT': OpCode.LT, 'LE': OpCode.LE, 'GT': OpCode.GT, 'GE': OpCode.GE, 'MIN': OpCode.MIN, 'MAX': OpCode.MAX, 'WITHIN': OpCode.WITHIN, 'PACK': OpCode.PACK, 'UNPACK': OpCode.UNPACK, 'NEWARRAY0': OpCode.NEWARRAY0, 'NEWARRAY_T': OpCode.NEWARRAY_T, 'SETITEM': OpCode.SETITEM, 'NEWSTRUCT0': OpCode.NEWSTRUCT0, 'SIZE': OpCode.SIZE, 'HASKEY': OpCode.HASKEY, 'KEYS': OpCode.KEYS, 'VALUES': OpCode.VALUES, 'PICKITEM': OpCode.PICKITEM, 'APPEND': OpCode.APPEND, 'REVERSEITEMS': OpCode.REVERSEITEMS, 'REMOVE': OpCode.REMOVE, 'CLEARITEMS': OpCode.CLEARITEMS, 'ISNULL': OpCode.ISNULL, 'ISTYPE': OpCode.ISTYPE, 'SYSCALL': OpCode.SYSCALL}
    pass
...
class Slot():
    ...
    @overload
    def __init__(self, items: List[StackItem], reference_counter: ReferenceCounter) -> None: ...
    @overload
...
class ArrayStackItem(CompoundType, StackItem):
    ...
    @overload
    def append(self, stack_items: List[StackItem]) -> None: ...
    def clear(self) -> None: 
        """
        Remove all internal items.
        """
    ...
    def _items(self) -> List[StackItem]:
        ...
        """
    @property
    def _sub_items(self) -> List[StackItem]:
        """
        :type: List[StackItem]
        """
    pass
class StackItemType():
    ...
    __entries: dict # value = {'ANY': (StackItemType.ANY, None), 'POINTER': (StackItemType.POINTER, None), 'BOOLEAN': (StackItemType.BOOLEAN, None), 'INTEGER': (StackItemType.INTEGER, None), 'BYTESTRING': (StackItemType.BYTESTRING, None), 'BUFFER': (StackItemType.BUFFER, None), 'ARRAY': (StackItemType.ARRAY, None), 'STRUCT': (StackItemType.STRUCT, None), 'MAP': (StackItemType.MAP, None), 'INTEROP': (StackItemType.INTEROP, None)}
...
class VMState():
    ...
    __entries: dict # value = {'NONE': (VMState.NONE, None), 'HALT': (VMState.HALT, None), 'FAULT': (VMState.FAULT, None), 'BREAK': (VMState.BREAK, None)}
