...
[boto3.MarketplaceEntitlementService 1.14.49](https://boto3.amazonaws.com/v1/documentation/api/1.14.49/reference/services/marketplace-entitlement.html#MarketplaceEntitlementService) service
