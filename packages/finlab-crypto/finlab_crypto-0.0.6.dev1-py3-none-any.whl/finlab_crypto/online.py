...
class TradingPortfolio():
  ...
  def calculate_transaction(self, signals, fixed_position, quote_asset_list, threshold_to_rebalance):
    ...
    signals['base_value_btc'] = signals.latest_signal * signals.weight_btc
    ...
    diff_value_btc = pd.DataFrame({
      ...
      'threshold_to_rebalance': (max_algo_value + fixed_position * asset_price_in_btc) * threshold_to_rebalance,
    })
