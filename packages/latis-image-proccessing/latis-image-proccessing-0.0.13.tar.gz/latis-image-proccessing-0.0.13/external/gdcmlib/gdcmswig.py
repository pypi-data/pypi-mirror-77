...
class Testing(object):
    ...
    @staticmethod
    def ComputeMD5(buffer: "char const *", buf_len: "size_t", digest_str: "char [33]") -> "bool":
    ...
    @staticmethod
    def GetFileNames() -> "char const *const *":
        return _gdcmswig.Testing_GetFileNames()

    @staticmethod
    def GetNumberOfFileNames() -> "unsigned int":
        return _gdcmswig.Testing_GetNumberOfFileNames()

    @staticmethod
    def GetFileName(file: "unsigned int") -> "char const *":
        return _gdcmswig.Testing_GetFileName(file)

    @staticmethod
    def GetMediaStorageDataFiles() -> "gdcm::Testing::MediaStorageDataFilesType":
        return _gdcmswig.Testing_GetMediaStorageDataFiles()

    @staticmethod
    def GetNumberOfMediaStorageDataFiles() -> "unsigned int":
        return _gdcmswig.Testing_GetNumberOfMediaStorageDataFiles()

    @staticmethod
    def GetMediaStorageDataFile(file: "unsigned int") -> "char const *const *":
        return _gdcmswig.Testing_GetMediaStorageDataFile(file)

    @staticmethod
    def GetMediaStorageFromFile(filepath: "char const *") -> "char const *":
        return _gdcmswig.Testing_GetMediaStorageFromFile(filepath)

    @staticmethod
    def GetMD5DataImages() -> "gdcm::Testing::MD5DataImagesType":
        return _gdcmswig.Testing_GetMD5DataImages()

    @staticmethod
    def GetNumberOfMD5DataImages() -> "unsigned int":
        return _gdcmswig.Testing_GetNumberOfMD5DataImages()

    @staticmethod
    def GetMD5DataImage(file: "unsigned int") -> "char const *const *":
        return _gdcmswig.Testing_GetMD5DataImage(file)

    @staticmethod
    def GetMD5FromFile(filepath: "char const *") -> "char const *":
        return _gdcmswig.Testing_GetMD5FromFile(filepath)

    @staticmethod
    def GetMD5FromBrokenFile(filepath: "char const *") -> "char const *":
        return _gdcmswig.Testing_GetMD5FromBrokenFile(filepath)

    @staticmethod
    def GetStreamOffsetFromFile(filepath: "char const *") -> "std::streamoff":
        return _gdcmswig.Testing_GetStreamOffsetFromFile(filepath)

    @staticmethod
    def GetSelectedTagsOffsetFromFile(filepath: "char const *") -> "std::streamoff":
        return _gdcmswig.Testing_GetSelectedTagsOffsetFromFile(filepath)

    @staticmethod
    def GetSelectedPrivateGroupOffsetFromFile(filepath: "char const *") -> "std::streamoff":
        return _gdcmswig.Testing_GetSelectedPrivateGroupOffsetFromFile(filepath)

    @staticmethod
    def GetLossyFlagFromFile(filepath: "char const *") -> "int":
        return _gdcmswig.Testing_GetLossyFlagFromFile(filepath)

    @staticmethod
    def GetDataRoot() -> "char const *":
        return _gdcmswig.Testing_GetDataRoot()

    @staticmethod
    def GetDataExtraRoot() -> "char const *":
        return _gdcmswig.Testing_GetDataExtraRoot()

    @staticmethod
    def GetPixelSpacingDataRoot() -> "char const *":
        return _gdcmswig.Testing_GetPixelSpacingDataRoot()

    @staticmethod
    def GetTempDirectory(subdir: "char const *"=None) -> "char const *":
        return _gdcmswig.Testing_GetTempDirectory(subdir)

    @staticmethod
    def GetTempDirectoryW(subdir: "wchar_t const *"=None) -> "wchar_t const *":
        return _gdcmswig.Testing_GetTempDirectoryW(subdir)

    @staticmethod
    def GetTempFilename(filename: "char const *", subdir: "char const *"=None) -> "char const *":
        return _gdcmswig.Testing_GetTempFilename(filename, subdir)

    @staticmethod
    def GetTempFilenameW(filename: "wchar_t const *", subdir: "wchar_t const *"=None) -> "wchar_t const *":
        return _gdcmswig.Testing_GetTempFilenameW(filename, subdir)

    @staticmethod
    def GetSourceDirectory() -> "char const *":
        return _gdcmswig.Testing_GetSourceDirectory()

    @staticmethod
    def ComputeFileMD5(*args) -> "char const *":
