...
def concatenate_activities(
    ...
    activities_clean_df.loc[:, "created_at"] = pd.to_datetime(activities_clean_df["created_at"])
...
def calculate_shipments_treatment_steps_time(
    ...
    activities_clean_df = activities_clean_df.dropna(subset=["shipment_id"])[["created_at", "header", "shipment_id"]]
    ...
    return calculate_steps_time(activities_df=activities_clean_df)
