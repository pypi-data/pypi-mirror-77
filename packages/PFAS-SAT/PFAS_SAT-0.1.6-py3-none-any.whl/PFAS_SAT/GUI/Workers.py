...
class Worker_MC(QtCore.QThread):
    ...
    def __init__(self, parent, project, InputFlow_object, n, seed):
    ...
    def run(self):
        ...
        MC_results_raw = self.project.MC_Run(n=self.n, signal=self.UpdatePBr_Opt)
        MC_results = self.project.MC_Result_DF(MC_results_raw)
        Time_finish = time()
