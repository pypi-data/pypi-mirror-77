...
class AdvWWT(ProcessModel):
    ...
    def calc(self, Inc_flow=None):
        ...
        # add to Inventory
        self.Inventory.add('Leachate', 'AdvWWT', 'Water', self.RO_effluent)
        self.Inventory.add('Storage', 'AdvWWT', 'Water', self.GAC_effluent)

    def products(self):
        Products = {}
        Products['ROConc'] = self.RO_concentrate
    ...
    def report(self, normalized=False):
        ...
        if not normalized:
            ...
            report['ROConc'] = self.RO_concentrate.PFAS
            ...
            report['ROConc'] = self.RO_concentrate.PFAS / self.Inc_flow.PFAS
