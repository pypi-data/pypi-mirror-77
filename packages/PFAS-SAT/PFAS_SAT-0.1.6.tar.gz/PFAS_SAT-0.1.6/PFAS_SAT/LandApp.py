...
class LandApp(ProcessModel):
    ...
    def calc(self, Inc_flow=None):
        ...
        soil_mass_mix = self.InputData.LandApp['depth_mix']['amount'] * self.Inc_flow.mass \
        ...
        Percip_Vol = self.Inc_flow.mass / self.InputData.LandApp['appl_dens']['amount'] * self.InputData.Percip['ann_precip']['amount'] * 1000  # L/yr
        ...
        # add to Inventory
        self.Inventory.add('Leachate', 'LandApp', 'Water', self.Leachate)
        self.Inventory.add('RunOff', 'LandApp', 'Water', self.RunOff)
        self.Inventory.add('Remaining', 'LandApp', 'Soil', self.Remaining)
