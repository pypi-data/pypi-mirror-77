...
class SampleTest(unittest.TestCase):
    ...
    def test_calc1(self):
        ...
        for tmethod,ta in test_patterns:
            with self.subTest(method=tmethod,alpha=ta,fterm="Mismatch repair"):
                self.assertTrue(self._df_checker(self.smpl.calc(method=tmethod,alpha=ta,fterm="Mismatch repair")))
    ...
    def test_calc2(self):
        ...
        for tmethod,ta in test_patterns:
            with self.subTest(method=tmethod,alpha=ta,fterm=None):
                self.assertTrue(self._df_checker(self.smpl.calc(method=tmethod,alpha=ta,fterm=None)))
