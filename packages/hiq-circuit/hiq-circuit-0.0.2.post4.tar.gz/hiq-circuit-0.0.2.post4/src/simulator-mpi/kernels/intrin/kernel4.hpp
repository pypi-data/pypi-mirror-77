                    ...
                    for (std::size_t i2 = 0; i2 < dsorted[1];
                         ...
                         for (std::size_t i3 = 0; i3 < dsorted[2];
                              ...
                              for (std::size_t i4 = 0; i4 < dsorted[3]; ++i4) {
                                   kernel_compute(psi, i0 + i1 + i2 + i3 + i4,
                                                  d0, d1, d2, d3, mm, mmt);
                              }
                         }
                    }
