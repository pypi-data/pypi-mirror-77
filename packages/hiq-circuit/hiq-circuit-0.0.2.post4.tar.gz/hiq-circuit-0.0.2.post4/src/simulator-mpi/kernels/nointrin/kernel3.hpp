               ...
               for (std::size_t i1 = 0; i1 < dsorted[0]; i1 += 2 * dsorted[1]) {
                    for (std::size_t i2 = 0; i2 < dsorted[1];
                         ...
                         for (std::size_t i3 = 0; i3 < dsorted[2]; ++i3) {
                              kernel_core(psi, i0 + i1 + i2 + i3, d0, d1, d2,
                                          m);
                         }
                    }
               }
                    ...
                    for (std::size_t i2 = 0; i2 < dsorted[1];
                         ...
                         for (std::size_t i3 = 0; i3 < dsorted[2]; ++i3) {
                              if (((i0 + i1 + i2 + i3) & ctrlmask) == ctrlmask)
                                   kernel_core(psi, i0 + i1 + i2 + i3, d0, d1,
                                               d2, m);
                         }
                    }
               }
...
template <class V, class M,
          void K(V&, std::size_t, std::size_t, std::size_t, std::size_t,
                 M const&)>
void kernelK(V& psi, unsigned id2, unsigned id1, unsigned id0, M const& m,
             std::size_t ctrlmask)
{
     std::size_t n = psi.size();
     std::size_t d0 = 1UL << id0;
