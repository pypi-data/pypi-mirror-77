...
# Create color pickers based on number of groups
                    ...
                    html.Div(className='twelve columns', id='graph_settings', children=[
                        ...
                        html.Div(className='twelve columns',
                                 ...
                                 children=[
                                     ...
                                     html.Label('Standard Mean Error Type:'),
                                     dcc.RadioItems(
                                         id='error_type',
...
@app.callback(
    ...
    [Input(component_id='video_numbers', component_property='value'),
     ...
     Input(component_id='set_ind_title', component_property='n_clicks'),
     Input(component_id='fonts', component_property='value'),
     Input(component_id='font_size', component_property='value'),
     Input(component_id='show_bg', component_property='value'),
    ...
    [State(component_id='behaviors', component_property='value'),
     ...
     State(component_id='ind_graph_title', component_property='value')])
def update_ind_graph(select_vids, feature_name, group_name, show_mean, update_colors,
    ...
    fig = go.Figure()
    graph_title = group_name + ' ' + feature_name
...
@app.callback(
    ...
    [Input(component_id='multi_group_selector', component_property='value'),
     ...
     Input(component_id='graph_seconds', component_property='value'),
     Input(component_id='show_grid', component_property='value'),
     Input(component_id='set_multi_title', component_property='n_clicks'),
     Input(component_id='fonts', component_property='value'),
     Input(component_id='font_size', component_property='value'),
     Input(component_id='show_bg', component_property='value'),
    ...
    [State(component_id='behaviors', component_property='value'),
     ...
     State(component_id='mean_graph_title', component_property='value')])
def update_multi_graph(list_groups, feature_name, show_group_mean, update_colors, colors, seconds,
                       showgrid, update_title, font, fontsize, showbg, update_multi_range, error,
