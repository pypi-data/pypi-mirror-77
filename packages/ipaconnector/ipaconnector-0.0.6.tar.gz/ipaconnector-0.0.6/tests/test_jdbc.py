...
class TestHive(TestCase):
    ...
    def test_create_database_without_uri(self):
        _db_name, _uri = self.ut.create_database("prv_moa_zi43_usr")
        self.jdbc.query.assert_called_once_with("CREATE DATABASE `prv_moa_zi43_usr` COMMENT `DB created automatically`"
                                                " LOCATION '/data/prv_moa/zi43/usr'")
        self.assertEqual(_db_name, 'prv_moa_zi43_usr')
        self.assertEqual(_uri, '/data/prv_moa/zi43/usr')

    def test_create_database_with_uri(self):
        _db_name, _uri = self.ut.create_database("prv_moa_zi43_usr", uri="/some/path/to/db")
        self.jdbc.query.assert_called_once_with("CREATE DATABASE `prv_moa_zi43_usr` COMMENT `DB created automatically`"
                                                " LOCATION '/some/path/to/db'")
        self.assertEqual(_db_name, 'prv_moa_zi43_usr')
        self.assertEqual(_uri, '/some/path/to/db')

    def test_create_database_with_comment(self):
        _db_name, _uri = self.ut.create_database("prv_moa_zi43_usr", description="This is database description")
        self.jdbc.query.assert_called_once_with("CREATE DATABASE `prv_moa_zi43_usr` COMMENT `This is database "
                                                "description`"
                                                " LOCATION '/data/prv_moa/zi43/usr'")
        self.assertEqual(_db_name, 'prv_moa_zi43_usr')
        self.assertEqual(_uri, '/data/prv_moa/zi43/usr')
    ...
    def test_grant_access_to_db(self):
        self.ut.grant_access_to_db("prv_moa_zi43_usr", "hdfs://elara-ha/data/prv_moa/zi43/usr", 'usr_role_name')
    ...
    def test_grant_access_to_db_create_select(self):
        self.ut.grant_access_to_db("prv_moa_zi43_usr",
                                   "hdfs://elara-ha/data/prv_moa/zi43/usr",
                                   'usr_role_name',
                                   'CREATE,SELECT')
    ...
    def test_revoke_old_role_should_not_reovke(self):
        self.ut.revoke_old_role("some_old_role")
        self.jdbc.query.assert_called_once_with("REVOKE ROLE `some_old_role`")
