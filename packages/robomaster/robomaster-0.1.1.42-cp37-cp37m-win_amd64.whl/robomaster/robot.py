...
class TelloDroneInfoSubject(dds.Subject):
    ...
    def decode(self, buf):
        ...
        found_info_num = 0
        for info in push_info:
            # TODO DDS_HIGH_FLAG is too short, and insufficient identification info available.
