...
class Flight:
    ...
    def up(self, distance=0):
        """ 向上飞distance厘米，指相对距离

        :param distance: float:[20, 500]向上飞行的相对距离，单位 cm
        :return: action对象
        """
        return self.fly(UP, distance)

    def down(self, distance=0):
        """ 向下飞distance厘米，指相对距离

        :param distance: float:[20, 500]向下飞行的相对距离，单位 cm
        :return: action对象
        """
        return self.fly(DOWN, distance)
    ...
    def forward(self, distance=0):
        ...
        :return: action对象
        """
        return self.fly(FORWARD, distance)
    ...
    def backward(self, distance=0):
        ...
        :return: action对象
        """
        return self.fly(BACKWARD, distance)

    def left(self, distance=0):
        """ 向左飞行distance厘米， 指相对距离

        :param distance: float:[20, 500]向左飞行的相对距离，单位 cm
        :return: action对象
        """
        return self.fly(LEFT, distance)

    def right(self, distance=0):
        """ 向右飞行distance厘米， 指相对距离

        :param distance: float:[20, 500]向右飞行的相对距离，单位 cm
        :return: action对象
        """
        return self.fly(RIGHT, distance)

    def fly(self, direction=FORWARD, distance=0):
        """ 控制飞机向指定方向飞行指定距离。
    ...
    def move(self, x=0, y=0, z=0, speed=10, mid=None):
        """ 飞机相对位置的控制
        ...
        if mid:
            ...
            y = pad_pos_y + y
            z = pad_pos_z + z
            return self.go(x, y, z, speed, mid)
        else:
            logger.error("Flight: move, mid is None")
            return None

    def moveto(self, yaw=0):
    ...
    def curve(self, x1=0, y1=0, z1=0, x2=0, y2=0, z2=0, speed=20, mid=None):
    ...
    def jump(self, x=0, y=0, z=0, speed=20, yaw=0, mid1='m-1', mid2='m-1'):
