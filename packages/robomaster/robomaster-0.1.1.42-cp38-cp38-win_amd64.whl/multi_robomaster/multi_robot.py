...
class MultiRobotBase(object):
    ...
    def __init__(self):
        ...
        # self._robots_sn_dict = {} # key:SN,  value: robot obj
    ...
    def set_all_robots_mode(self, mode=1):
        pass

    def _number_prompt(self, robot_id, robot_obj):
        pass
    ...
    def _get_numbered_robot(self):
        """get the robot being numbered

        :return: the robot_obj being numbered
        """
        # TODO get which robot is numbered
        robot_obj = None
        return robot_obj
    ...
    def remove_group(self, group_list):
        ...
        :return:
        """
        # Todo delete the group obj which is removed
    ...
    def run(self, *exec_list):
        ...
        :param exec_list: [robot_group, action]...
        :return:
        """
...
class MultiEP(MultiRobotBase):
    ...
    def _number_prompt(self, robot_id, robot_obj):
        """robot uses light/sound to respond to the user
        ...
        """
        # TODO
        # blaster = robot_obj.blaster
        logger.info(
            "Multi_Robot number_id, id {0} : number successfully".format(robot_id))
        '''if blaster:
            #blaster.fire(blaster.INFRARED_FIRE, robot_id + 1)
            time.sleep(1)
        else:
            # TODO Deal with there is no reponse-module
            #  while number id processing
            pass'''
...
class MultiDrone(MultiRobotBase):
    ...
    def _scan_multi_robot(self, num=0):
        ...
        for ip in ip_list:
            # 将client的目标地址设置为搜索到的ip地址，本机地址设置为对应的本机地址
