...
class CfnDevice(
    ...
    @enabled.setter
    def enabled(self, value: typing.Union[bool, aws_cdk.core.IResolvable]) -> None:
...
class CfnDeviceProps:
    def __init__(
        self, *, device_id: str, enabled: typing.Union[bool, aws_cdk.core.IResolvable]
    ) -> None:
...
class CfnProject(
    ...
    def __init__(
        ...
        *,
        placement_template: typing.Union[
            "PlacementTemplateProperty", aws_cdk.core.IResolvable
        ],
    ...
    def placement_template(
        self,
    ) -> typing.Union["PlacementTemplateProperty", aws_cdk.core.IResolvable]:
    ...
    def placement_template(
        self, value: typing.Union["PlacementTemplateProperty", aws_cdk.core.IResolvable]
    ) -> None:
        ...
        def device_templates(
            ...
            typing.Union[
                ...
                typing.Mapping[
                    str,
                    typing.Union[
                        aws_cdk.core.IResolvable, "CfnProject.DeviceTemplateProperty"
                    ],
                ],
            ]
        ]:
...
class CfnProjectProps:
    def __init__(
        ...
        *,
        placement_template: typing.Union[
            "CfnProject.PlacementTemplateProperty", aws_cdk.core.IResolvable
        ],
        description: typing.Optional[str] = None,
        project_name: typing.Optional[str] = None,
    ) -> None:
