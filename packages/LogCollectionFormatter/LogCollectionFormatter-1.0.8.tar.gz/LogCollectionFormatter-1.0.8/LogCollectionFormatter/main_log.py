                ...
                try:
                    ...
                    try:
                        ...
                        message = {u'actionCode': action_code,
                                   u'requestTime': request_time.strftime("%Y-%m-%d %H:%M:%S.%f")[:-3],
                                   u'responseTime': response_time.strftime("%Y-%m-%d %H:%M:%S")[:-3],
                        ...
                        if response_data:
                            if str(response_data.get('code')) or str(response_data.get(u'code')):
                                response_code = str(response_data.get('code') or response_data.get(u'code'))
