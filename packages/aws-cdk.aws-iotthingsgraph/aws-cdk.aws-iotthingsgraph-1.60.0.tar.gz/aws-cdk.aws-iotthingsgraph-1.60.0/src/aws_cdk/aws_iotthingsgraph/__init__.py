...
class CfnFlowTemplate(
    ...
    def __init__(
        ...
        *,
        definition: typing.Union[
            "DefinitionDocumentProperty", aws_cdk.core.IResolvable
        ],
    ...
    def definition(
        self,
    ) -> typing.Union["DefinitionDocumentProperty", aws_cdk.core.IResolvable]:
    ...
    def definition(
        self,
        value: typing.Union["DefinitionDocumentProperty", aws_cdk.core.IResolvable],
    ) -> None:
...
class CfnFlowTemplateProps:
    def __init__(
        ...
        *,
        definition: typing.Union[
            "CfnFlowTemplate.DefinitionDocumentProperty", aws_cdk.core.IResolvable
        ],
        compatible_namespace_version: typing.Optional[jsii.Number] = None,
    ) -> None:
