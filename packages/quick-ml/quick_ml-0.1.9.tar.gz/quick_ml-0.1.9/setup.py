...
setup(
  ...
  description = 'quick_ml : ML For Everyone. Making Deep Learning through TPUs accessible to everyone. Lesser Code, faster computation, better modelling.',   # Give a short description about your library
  ...
  download_url = 'https://gitlab.com/antoreep_jana/quick_ml/-/archive/v0.1.9/quick_ml-v0.1.9.tar.gz',    # I explain this later on
