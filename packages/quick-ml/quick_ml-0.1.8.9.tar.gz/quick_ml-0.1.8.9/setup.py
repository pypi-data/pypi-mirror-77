...
setup(
  ...
  version = '0.1.8.9',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://gitlab.com/antoreep_jana/quick_ml/-/archive/v0.1.8.9/quick_ml-v0.1.8.9.tar.gz',    # I explain this later on
