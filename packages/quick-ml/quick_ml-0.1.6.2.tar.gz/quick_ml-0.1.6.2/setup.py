...
setup(
  ...
  version = '0.1.6.2',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://gitlab.com/antoreep_jana/quick_ml/-/archive/v0.1.6.2/quick_ml-v0.1.6.2.tar.gz',    # I explain this later on
