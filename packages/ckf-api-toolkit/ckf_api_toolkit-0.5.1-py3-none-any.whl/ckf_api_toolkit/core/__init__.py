"""Generics to be extended for connecting to remote datastores and services
...
class Instruction:
    ...
    Attributes:
        ...
        parser (Callable): Parser function will be used to parse return values to the actor. Use for additional logic and formatting.
    """
...
class Actor:
    ...
    Attributes:
        repository (Repostory): The repository this actor will interact with
