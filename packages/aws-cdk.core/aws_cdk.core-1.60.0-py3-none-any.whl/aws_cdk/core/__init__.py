...
class LegacyStackSynthesizer(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.LegacyStackSynthesizer"
):
...
class NestedStackSynthesizer(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.NestedStackSynthesizer"
):
...
class DefaultStackSynthesizer(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.DefaultStackSynthesizer"
):
...
class CustomResourceProvider(
    Construct, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.CustomResourceProvider"
):
