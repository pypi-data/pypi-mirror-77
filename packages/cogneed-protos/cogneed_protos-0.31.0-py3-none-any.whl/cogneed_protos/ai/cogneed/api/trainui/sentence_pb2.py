...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n4cogneed-protos/ai/cogneed/api/trainui/sentence.proto\x12\x1f\x61i.cogneed.api.trainui.sentence\"9\n\x06\x43reate\x12\x10\n\x08use_case\x18\x01 \x01(\t\x12\x0f\n\x07keyword\x18\x02 \x01(\t\x12\x0c\n\x04text\x18\x03 \x01(\t\"\x14\n\x04Read\x12\x0c\n\x04uuid\x18\x01 \x01(\t\"=\n\x04List\x12\x10\n\x08use_case\x18\x01 \x01(\t\x12\x0c\n\x04page\x18\x02 \x01(\x05\x12\x15\n\rrows_per_page\x18\x03 \x01(\x05\"\x16\n\x06\x44\x65lete\x12\x0c\n\x04uuid\x18\x01 \x01(\t\"I\n\x08Sentence\x12\x0c\n\x04uuid\x18\x01 \x01(\t\x12\x10\n\x08use_case\x18\x02 \x01(\t\x12\x0f\n\x07keyword\x18\x03 \x01(\t\x12\x0c\n\x04text\x18\x04 \x01(\t\"Y\n\x0cListResponse\x12\r\n\x05\x63ount\x18\x01 \x01(\x05\x12:\n\x07results\x18\x02 \x03(\x0b\x32).ai.cogneed.api.trainui.sentence.Sentence\"\x0c\n\nResponseOk2\xeb\x03\n\x0fSentenceService\x12^\n\x06\x63reate\x12\'.ai.cogneed.api.trainui.sentence.Create\x1a+.ai.cogneed.api.trainui.sentence.ResponseOk\x12X\n\x04read\x12%.ai.cogneed.api.trainui.sentence.Read\x1a).ai.cogneed.api.trainui.sentence.Sentence\x12\\\n\x04list\x12%.ai.cogneed.api.trainui.sentence.List\x1a-.ai.cogneed.api.trainui.sentence.ListResponse\x12`\n\x06update\x12).ai.cogneed.api.trainui.sentence.Sentence\x1a+.ai.cogneed.api.trainui.sentence.ResponseOk\x12^\n\x06\x64\x65lete\x12\'.ai.cogneed.api.trainui.sentence.Delete\x1a+.ai.cogneed.api.trainui.sentence.ResponseOkB#\n\x1f\x61i.cogneed.api.trainui.sentenceP\x01\x62\x06proto3')
)
...
_CREATE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='keyword', full_name='ai.cogneed.api.trainui.sentence.Create.keyword', index=1,
...
_LIST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='page', full_name='ai.cogneed.api.trainui.sentence.List.page', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='rows_per_page', full_name='ai.cogneed.api.trainui.sentence.List.rows_per_page', index=2,
...
_SENTENCE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='keyword', full_name='ai.cogneed.api.trainui.sentence.Sentence.keyword', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RESPONSEOK = _descriptor.Descriptor(
  name='ResponseOk',
  full_name='ai.cogneed.api.trainui.sentence.ResponseOk',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
ResponseOk = _reflection.GeneratedProtocolMessageType('ResponseOk', (_message.Message,), dict(
  ...
  __module__ = 'cogneed_protos.ai.cogneed.api.trainui.sentence_pb2'
  # @@protoc_insertion_point(class_scope:ai.cogneed.api.trainui.sentence.ResponseOk)
  ))
