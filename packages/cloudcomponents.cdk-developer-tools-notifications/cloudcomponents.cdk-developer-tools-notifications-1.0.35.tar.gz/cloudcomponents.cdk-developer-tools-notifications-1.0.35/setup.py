    ...
    """
{
    ...
    "package_data": {
        "cloudcomponents.cdk_developer_tools_notifications._jsii": [
            "cdk-developer-tools-notifications@1.0.35.jsii.tgz"
        ],
        "cloudcomponents.cdk_developer_tools_notifications": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-codecommit>=1.61.0, <2.0.0",
        "aws-cdk.aws-codedeploy>=1.61.0, <2.0.0",
        "aws-cdk.aws-codepipeline>=1.61.0, <2.0.0",
        "aws-cdk.aws-codestarnotifications>=1.61.0, <2.0.0",
        ...
        "cloudcomponents.cdk-chatops>=1.0.31, <2.0.0",
