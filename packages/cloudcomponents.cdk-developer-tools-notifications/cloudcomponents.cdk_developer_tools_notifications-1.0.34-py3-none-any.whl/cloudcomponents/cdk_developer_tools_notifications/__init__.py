...
class _INotificationRuleProxy:
    __jsii_type__ = "@cloudcomponents/cdk-developer-tools-notifications.INotificationRule"
...
class _INotificationTargetProxy:
    __jsii_type__ = "@cloudcomponents/cdk-developer-tools-notifications.INotificationTarget"
