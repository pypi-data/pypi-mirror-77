...
@LastEditTime: 2020-08-17 12:42:28
...
class ThemeUpdate(SevenBaseHandler):
    ...
    def get_async(self):
        ...
        skin_info = skin_info_model.get_entity("theme_id=%s", params=theme_id)
        if not skin_info:
        ...
        machine_info_model.update_table("skin_id=%s", "act_id=%s", [skin_info.id, act_id])
