...
@LastEditTime: 2020-08-13 17:34:06
...
from models.db_models.base.base_info_model import *
from models.db_models.login.login_log_model import *
...
class BaseInfoHandler(SevenBaseHandler):
    ...
    def post_async(self):
        ...
        base_info = base_info_model.get_entity_by_id(1)
    ...
    def get_async(self):
        ...
        info = {}
        info["company"] = "天志互联"
        info["miniappName"] = "在线拆盲盒"
        info["logo"] = "https://isv.alibabausercontent.com/010229100714/imgextra/i2/2206353354303/O1CN01GByNR91heosQQfU0Z_!!2206353354303-2-isvtu-010229100714.png"
