...
@LastEditTime: 2020-08-13 18:10:30
...
from models.db_models.act.act_type_model import *
from models.db_models.app.app_info_model import *
from models.db_models.theme.theme_info_model import *
from models.db_models.skin.skin_info_model import *
...
class ActCreateHandler(TopBaseHandler):
    ...
    def get_async(self):
        ...
        if not act_id:
            ...
            self.save_orm(orm_infos, act_id)
        ...
        # self.logger_info.info(str(act_id))
    ...
    def save_orm(self, orm_infos, act_id):
        ...
        for behavior_orm_item in behavior_orm_list:
            if behavior_orm_item.key_name.find(orm_infos[0].key_name) != -1:
                delete_orm_ids.append(behavior_orm_item.id)
