...
@LastEditTime: 2020-08-13 15:47:03
...
from models.taobao_model import *
from models.db_models.operation.operation_log_model import *
...
class SevenBaseHandler(BaseApiHandler):
    ...
    def create_order_id(self, ran=0):
        """
        @description: 生成订单号
        @param ran：随机数位数（0-5）
        @return: 25位的订单号
