...
id = "8418d87759d6582109be63a1b510dd22ad0733c4"
date = "2020-08-27 13:10:13 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "8418d87759d6582109be63a1b510dd22ad0733c4":
        return
    msg = "Program id (8418d87759d6582109be63a1b510dd22ad0733c4) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
