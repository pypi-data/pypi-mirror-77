...
id = "2b4ab4bafe5b246abdd72ed0ad454d509b633eda"
date = "2020-08-10 17:26:21 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "2b4ab4bafe5b246abdd72ed0ad454d509b633eda":
        return
    msg = "Program id (2b4ab4bafe5b246abdd72ed0ad454d509b633eda) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
