...
function GetOciCommandsToLongParams_lb() {
    $ociCommandsToLongParams = @{
        ...
        'lb listener create' = 'connection-configuration-backend-tcp-proxy-protocol-version connection-configuration-idle-timeout default-backend-set-name from-json help hostname-names load-balancer-id max-wait-seconds name path-route-set-name port protocol rule-set-names ssl-certificate-name ssl-verify-depth ssl-verify-peer-certificate wait-for-state wait-interval-seconds'
        ...
        'lb listener update' = 'connection-configuration-backend-tcp-proxy-protocol-version connection-configuration-idle-timeout default-backend-set-name force from-json help hostname-names listener-name load-balancer-id max-wait-seconds path-route-set-name port protocol rule-set-names ssl-certificate-name ssl-verify-depth ssl-verify-peer-certificate wait-for-state wait-interval-seconds'
