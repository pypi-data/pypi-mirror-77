...
function GetOciCommandsToLongParams_db() {
    $ociCommandsToLongParams = @{
        ...
        'db autonomous-database update' = 'admin-password autonomous-database-id cpu-core-count data-storage-size-in-tbs db-name db-version db-workload defined-tags display-name force freeform-tags from-json help if-match is-auto-scaling-enabled is-data-guard-enabled is-free-tier license-model max-wait-seconds nsg-ids private-endpoint-label subnet-id wait-for-state wait-interval-seconds whitelisted-ips'
