...
class connect_logger_Logger(connect_Base):
    ...
    __slots__ = ("path", "level", "handlers", "sections", "maskedFields", "regexMaskingList", "compact", "defaultFilename")
    _hx_fields = ["path", "level", "handlers", "sections", "maskedFields", "regexMaskingList", "compact", "defaultFilename"]
    ...
    def getFilename(self):
        ...
        if (firstWriter is not None):
            ...
            if (filename is not None):
                ...
                fixedFilename = False
            fixedFilename1 = (HxString.substr(filename,len(self.path),None) if fixedFilename else filename)
...
class connect_util_Util:
    ...
    __slots__ = ()
    _hx_statics = ["replaceStrSensitiveData", "beautify", "beautifyObject", "maskFields", "isJson", "isJsonObject", "isJsonArray", "isArray", "isStruct", "createObjectDiff", "getLines", "boolToInt", "addIdsToObject", "compactArray"]
            ...
            while (_g < len(_g1)):
                ...
                if (maskedFields.indexOf(fieldName) != -1):
                    if (Type.typeof(Reflect.field(obj,fieldName)) == ValueType.TObject):
                        ...
                        value1 = Reflect.field(obj,fieldName)
                        value2 = StringTools.lpad("","*",HxOverrides.length(value1))
                    ...
                    value3 = connect_util_Util.maskFields(Reflect.field(obj,fieldName))
