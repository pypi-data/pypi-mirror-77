...
PyObject* effekseer_Shoot(effekseer_obj* self, PyObject* args)
{
	...
	PyObject* mat_proj;
	PyObject* mat_view;
	if (!PyArg_ParseTuple(args, "OOf|i", &mat_proj, &mat_view, &dt, &clear))
		return NULL;
...
PyObject* effekseer_Add(effekseer_obj* self, PyObject* args, PyObject* kwargs)
{
	...
	float* rot = pyObjToFloat((PyObject*)position, rot_buff, d1);

	float scale_buff[3] = { 1.0, 1.0, 1.0 };
	float* scl = pyObjToFloat((PyObject*)position, scale_buff, d1);
