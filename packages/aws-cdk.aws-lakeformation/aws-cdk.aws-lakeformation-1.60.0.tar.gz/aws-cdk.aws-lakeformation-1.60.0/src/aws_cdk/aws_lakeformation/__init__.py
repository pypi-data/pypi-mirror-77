        ...
        *,
        admins: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union["DataLakePrincipalProperty", aws_cdk.core.IResolvable]
                ],
            ]
        ] = None,
    ) -> None:
...
class CfnPermissions(
    ...
    def __init__(
        ...
        *,
        data_lake_principal: typing.Union[
            aws_cdk.core.IResolvable, "DataLakePrincipalProperty"
        ],
    ...
    def data_lake_principal(
        self, value: typing.Union[aws_cdk.core.IResolvable, "DataLakePrincipalProperty"]
    ) -> None:
    ...
    class ResourceProperty:
        def __init__(
            ...
            *,
            database_resource: typing.Optional[
                typing.Union[
                    aws_cdk.core.IResolvable, "CfnPermissions.DatabaseResourceProperty"
                ]
            ] = None,
            ...
            table_resource: typing.Optional[
                typing.Union[
                    aws_cdk.core.IResolvable, "CfnPermissions.TableResourceProperty"
                ]
            ] = None,
        ...
        def data_location_resource(
            ...
            typing.Union[
                aws_cdk.core.IResolvable, "CfnPermissions.DataLocationResourceProperty"
            ]
        ]:
        ...
        def __init__(
            ...
            *,
            ...
            column_wildcard: typing.Optional[
                typing.Union[
                    aws_cdk.core.IResolvable, "CfnPermissions.ColumnWildcardProperty"
                ]
            ] = None,
            database_name: typing.Optional[str] = None,
            name: typing.Optional[str] = None,
    ...
    def __init__(
        ...
        *,
        ...
        resource: typing.Union[
            aws_cdk.core.IResolvable, "CfnPermissions.ResourceProperty"
        ],
        permissions: typing.Optional[typing.List[str]] = None,
        permissions_with_grant_option: typing.Optional[typing.List[str]] = None,
    ) -> None:
