...
class Deployment():
    ...
    def batch_predict(self, input_location=None, output_location=None, name=None, refresh_schedule=None, global_prediction_args=None):
        return self.client.batch_predict(self.deployment_id, input_location, output_location, name, refresh_schedule, global_prediction_args)

    def batch_prediction_from_upload(self, name=None, global_prediction_args=None):
        return self.client.batch_prediction_from_upload(self.deployment_id, name, global_prediction_args)
