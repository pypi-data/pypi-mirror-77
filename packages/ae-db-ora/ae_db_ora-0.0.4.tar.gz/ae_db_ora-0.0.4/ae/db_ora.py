...
.. hint::
  This namespace portion is using the
  `cx_Oracle package <https://cx-oracle.readthedocs.io/en/7.2/module.html>`_
...
application instance (of the class :class:`~ae.console.ConsoleApp`
