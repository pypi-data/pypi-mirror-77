            ...
            try:
                ...
                if out != self._prev_output:
                    ...
                    if "msg=" in out:
                        ...
                        if data.get("obj", "") == "tunnels" and \
                                "started tunnel" in data.get("msg", ""):
                            self.handle_status_change(NgrokStatus.FORWARDING)
                            self.handle_open(data)
                        elif data.get("obj", "") == "join" and \
                                "join connections" in data.get("msg", ""):
                            self.handle_status_change(NgrokStatus.CONNECTED)
                            self.handle_connected(data)
                        elif "session closing" in data.get("msg", ""):
