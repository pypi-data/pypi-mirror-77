...
class QueuesV1Api(object):
    ...
    def patch_queue_with_http_info(
        self, owner, agent, queue_uuid, body, **kwargs
    ):  # noqa: E501
        """Patch queue  # noqa: E501
        ...
        all_params = ["owner", "agent", "queue_uuid", "body"]
        all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `agent` when calling `patch_queue`"
            )  # noqa: E501
    ...
    def update_queue_with_http_info(
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `agent` when calling `update_queue`"
            )  # noqa: E501
        # verify the required parameter 'queue_uuid' is set
        if self.api_client.client_side_validation and (
            "queue_uuid" not in local_var_params
