...
def load_bitmap_from_file(file_name:str, transparent_color:Optional[int]=0, is_mask:Optional[bool]=False) -> int: ...
def load_bitmap_from_string(bmp_string:str, transparent_color:Optional[int]=0, is_mask:Optional[bool]=False) -> int: ...
def load_font_from_bitmap(bmp_id:int, characters:str, transparent_color:Optional[int]=0) -> int: ...
def load_mask_from_bytes(byte_array:bytes, transparent_color:Optional[int]=0, is_mask:Optional[bool]=0, strip_alpha:Optional[bool]=False) -> int: ...
