...
class CfnBudget(
    ...
    def __init__(
        ...
        id: str,
        *,
        budget: typing.Union["BudgetDataProperty", aws_cdk.core.IResolvable],
        notifications_with_subscribers: typing.Optional[
            typing.Union[
                aws_cdk.core.IResolvable,
                typing.List[
                    typing.Union[
                        aws_cdk.core.IResolvable, "NotificationWithSubscribersProperty"
                    ]
                ],
            ]
        ] = None,
        ...
        props = CfnBudgetProps(
            budget=budget, notifications_with_subscribers=notifications_with_subscribers
        )
    ...
    @budget.setter
    def budget(
        self, value: typing.Union["BudgetDataProperty", aws_cdk.core.IResolvable]
    ) -> None:
    ...
    class BudgetDataProperty:
        def __init__(
            ...
            *,
            budget_type: str,
            time_unit: str,
            budget_limit: typing.Optional[
                typing.Union[aws_cdk.core.IResolvable, "CfnBudget.SpendProperty"]
            ] = None,
            budget_name: typing.Optional[str] = None,
            cost_filters: typing.Any = None,
            cost_types: typing.Optional[
                typing.Union[aws_cdk.core.IResolvable, "CfnBudget.CostTypesProperty"]
            ] = None,
            planned_budget_limits: typing.Any = None,
            time_period: typing.Optional[
                typing.Union[aws_cdk.core.IResolvable, "CfnBudget.TimePeriodProperty"]
            ] = None,
        ) -> None:
            """
    ...
    class CostTypesProperty:
        def __init__(
            self,
            *,
            include_credit: typing.Optional[
                typing.Union[bool, aws_cdk.core.IResolvable]
            ] = None,
            include_discount: typing.Optional[
                typing.Union[bool, aws_cdk.core.IResolvable]
            ] = None,
            include_other_subscription: typing.Optional[
                typing.Union[bool, aws_cdk.core.IResolvable]
            ] = None,
            include_recurring: typing.Optional[
                typing.Union[bool, aws_cdk.core.IResolvable]
            ] = None,
            include_refund: typing.Optional[
                typing.Union[bool, aws_cdk.core.IResolvable]
            ] = None,
            include_subscription: typing.Optional[
                typing.Union[bool, aws_cdk.core.IResolvable]
            ] = None,
            include_support: typing.Optional[
                typing.Union[bool, aws_cdk.core.IResolvable]
            ] = None,
            include_tax: typing.Optional[
                typing.Union[bool, aws_cdk.core.IResolvable]
            ] = None,
            include_upfront: typing.Optional[
                typing.Union[bool, aws_cdk.core.IResolvable]
            ] = None,
            use_amortized: typing.Optional[
                typing.Union[bool, aws_cdk.core.IResolvable]
            ] = None,
            use_blended: typing.Optional[
                typing.Union[bool, aws_cdk.core.IResolvable]
            ] = None,
        ) -> None:
            """
    ...
    class NotificationWithSubscribersProperty:
        def __init__(
            ...
            *,
            notification: typing.Union[
                aws_cdk.core.IResolvable, "CfnBudget.NotificationProperty"
            ],
            subscribers: typing.Union[
                aws_cdk.core.IResolvable,
                typing.List[
                    typing.Union[
                        aws_cdk.core.IResolvable, "CfnBudget.SubscriberProperty"
                    ]
                ],
            ],
        ) -> None:
        ...
        def subscribers(
            ...
            aws_cdk.core.IResolvable,
            typing.List[
                typing.Union[aws_cdk.core.IResolvable, "CfnBudget.SubscriberProperty"]
            ],
        ]:
