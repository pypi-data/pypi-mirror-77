    ...
    def __init__(self, param):
        ...
        with conn:
            ...
            if len(results)>0:
                ...
                print("For Israel run, no stocks were found with stocks under israeli index")
            ...
            if len(resultsb)>0:
                ...
                print("For Israel run, no benchmarks were found with benchmarks under israeli index")
