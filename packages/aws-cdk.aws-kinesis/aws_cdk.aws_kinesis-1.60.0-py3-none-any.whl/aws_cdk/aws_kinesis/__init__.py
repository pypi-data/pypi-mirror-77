    ...
    def __init__(
        ...
        *,
        ...
        stream_encryption: typing.Optional[
            typing.Union["StreamEncryptionProperty", aws_cdk.core.IResolvable]
        ] = None,
...
class CfnStreamProps:
    def __init__(
        ...
        *,
        ...
        retention_period_hours: typing.Optional[jsii.Number] = None,
        stream_encryption: typing.Optional[
            typing.Union["CfnStream.StreamEncryptionProperty", aws_cdk.core.IResolvable]
        ] = None,
        tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]] = None,
    ) -> None:
...
class Stream(
    ...
    def from_stream_arn(
        cls, scope: aws_cdk.core.Construct, id: str, stream_arn: str
    ) -> "IStream":
