...
class MongoDbUsers:
    def __init__(
        self,
        *,
        password_auth_users: typing.Optional[
            typing.List[aws_cdk.aws_secretsmanager.ISecret]
        ] = None,
    ...
    def password_auth_users(
        ...
        """
        return self._values.get("password_auth_users")
    ...
    def x509_auth_users(self) -> typing.Optional[typing.List["MongoDbX509User"]]:
        ...
        """
        return self._values.get("x509_auth_users")
...
class MongoDbX509User:
    def __init__(
        self, *, certificate: aws_cdk.aws_secretsmanager.ISecret, roles: str
    ) -> None:
