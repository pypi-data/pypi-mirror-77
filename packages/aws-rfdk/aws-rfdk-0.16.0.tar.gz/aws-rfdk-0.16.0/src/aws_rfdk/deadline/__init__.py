...
@jsii.data_type(
    jsii_type="aws-rfdk.deadline.BuildArgs", jsii_struct_bases=[], name_mapping={}
)
class BuildArgs:
...
class DatabaseConnection(
    metaclass=jsii.JSIIAbstractClass, jsii_type="aws-rfdk.deadline.DatabaseConnection"
):
    ...
    def for_doc_db(
        ...
        *,
        ...
        :param database: The Document DB Cluster this connection is for.
    ...
    @abc.abstractmethod
    def container_environment(self) -> typing.Mapping[str, str]:
...
class ECSConnectOptions:
    def __init__(
        self, *, grantee: aws_cdk.aws_iam.IGrantable, hosts: typing.List["IHost"]
    ) -> None:
...
class ECSContainerInstanceProps:
    def __init__(
        ...
        *,
        ...
        filesystem_mount_point: typing.Optional[str] = None,
    ) -> None:
    ...
    @builtins.property
    def filesystem_mount_point(self) -> typing.Optional[str]:
        ...
        :stability: experimental
        """
        return self._values.get("filesystem_mount_point")
...
class ECSDirectConnectProps:
    ...
    def container_instances(self) -> "ECSContainerInstanceProps":
        ...
        :stability: experimental
        """
        return self._values.get("container_instances")
...
class IContainerDirectRepositoryConnection(jsii.compat.Protocol):
...
class _IContainerDirectRepositoryConnectionProxy:
    ...
    __jsii_type__ = "aws-rfdk.deadline.IContainerDirectRepositoryConnection"
...
class _IHostProxy(
    ...
    jsii.proxy_for(_IScriptHost_ad38c9ad),
):
    """Interface for any constructs that are Capable of connecting to Deadline.
    ...
    __jsii_type__ = "aws-rfdk.deadline.IHost"
    pass


@jsii.interface(jsii_type="aws-rfdk.deadline.IReleaseVersion")
class IReleaseVersion(jsii.compat.Protocol):
...
class _IReleaseVersionProxy:
    ...
    __jsii_type__ = "aws-rfdk.deadline.IReleaseVersion"
...
class IRenderQueue(
    aws_cdk.core.IConstruct, aws_cdk.aws_ec2.IConnectable, jsii.compat.Protocol
):
...
class _IRenderQueueProxy(
    ...
    __jsii_type__ = "aws-rfdk.deadline.IRenderQueue"
...
class IRepository(aws_cdk.core.IConstruct, jsii.compat.Protocol):
    ...
    @jsii.member(jsii_name="configureClientInstance")
    def configure_client_instance(self, *, host: "IHost", mount_point: str) -> None:
...
class _IRepositoryProxy(jsii.proxy_for(aws_cdk.core.IConstruct)):
    """Interface for Deadline Repository.
    ...
    __jsii_type__ = "aws-rfdk.deadline.IRepository"
...
class IVersion(IReleaseVersion, jsii.compat.Protocol):
    ...
    def linux_installers(self) -> typing.Optional["PlatformInstallers"]:
    ...
    def linux_full_version_string(self) -> typing.Optional[str]:
...
class _IVersionProxy(jsii.proxy_for(IReleaseVersion)):
    """This interface represents a deadline version.
    ...
    __jsii_type__ = "aws-rfdk.deadline.IVersion"
...
class _IWorkerFleetProxy(
    ...
    __jsii_type__ = "aws-rfdk.deadline.IWorkerFleet"
    pass
...
class Installer:
    def __init__(self, *, object_key: str, s3_bucket: aws_cdk.aws_s3.IBucket) -> None:
...
class InstanceDirectConnectProps:
    def __init__(self, *, host: "IHost", mount_point: str) -> None:
...
class Manifest:
    def __init__(
        self, *, recipes: "DeadlineDockerRecipes", schema: jsii.Number, version: str
    ) -> None:
    ...
    def recipes(self) -> "DeadlineDockerRecipes":
        ...
        :stability: experimental
        """
        return self._values.get("recipes")
...
class MongoDbInstanceConnectionOptions:
    ...
    def client_certificate(self) -> _IX509CertificatePkcs12_63b2574c:
        ...
        :stability: experimental
        """
        return self._values.get("client_certificate")
...
class PlatformInstallers:
    def __init__(
        ...
        *,
        ...
        repository: typing.Optional["Installer"] = None,
    ) -> None:
        ...
        :param repository: The Deadline Repository installer for this platform, as extracted from the bundle on the Thinkbox download site. For example:. - DeadlineRepository-10.1.8.5-linux-x64-installer.run - DeadlineRepository-10.1.8.5-windows-installer.exe Default: No repository installer is provided.
    ...
    def patch_version(self) -> jsii.Number:
        ...
        :stability: experimental
        """
        return self._values.get("patch_version")

    @builtins.property
    def repository(self) -> typing.Optional["Installer"]:
...
class RenderQueue(
    ...
    def __init__(
        ...
        *,
        ...
        health_check_config: typing.Optional[
...
class RenderQueueExternalTLSProps:
    def __init__(
        self,
        *,
        acm_certificate: typing.Optional[
            aws_cdk.aws_certificatemanager.ICertificate
        ] = None,
        acm_certificate_chain: typing.Optional[
    ...
    def acm_certificate(
        ...
        :stability: experimental
        """
        return self._values.get("acm_certificate")
    ...
    def acm_certificate_chain(
        ...
        :stability: experimental
        """
        return self._values.get("acm_certificate_chain")
    ...
    def rfdk_certificate(self) -> typing.Optional[_IX509CertificatePem_da3ef30f]:
        ...
        :stability: experimental
        """
        return self._values.get("rfdk_certificate")
...
class RenderQueueHealthCheckConfiguration:
    ...
    def grace_period(self) -> typing.Optional[aws_cdk.core.Duration]:
        ...
        :stability: experimental
        """
        return self._values.get("grace_period")
...
class RenderQueueImages:
    def __init__(
        self, *, remote_connection_server: aws_cdk.aws_ecs.ContainerImage
    ) -> None:
    ...
    def remote_connection_server(self) -> aws_cdk.aws_ecs.ContainerImage:
        ...
        **must** implement the same environment variable interface as defined in the official
        ...
        :stability: experimental
        """
        return self._values.get("remote_connection_server")
...
class RenderQueueProps:
    def __init__(
        ...
        *,
        ...
        if isinstance(health_check_config, dict):
            health_check_config = RenderQueueHealthCheckConfiguration(
                **health_check_config
            )
    ...
    def render_queue_size(self) -> typing.Optional["RenderQueueSizeConstraints"]:
        ...
        :stability: experimental
        """
        return self._values.get("render_queue_size")
    ...
    def traffic_encryption(
        ...
        :stability: experimental
        """
        return self._values.get("traffic_encryption")
...
class RenderQueueSizeConstraints:
    ...
    def desired(self) -> typing.Optional[jsii.Number]:
        ...
        :stability: experimental
        """
        return self._values.get("desired")
...
class RenderQueueTrafficEncryptionProps:
    def __init__(
        ...
        *,
        ...
        internal_protocol: typing.Optional[
    ...
    def external_tls(self) -> typing.Optional["RenderQueueExternalTLSProps"]:
        ...
        :stability: experimental
        """
        return self._values.get("external_tls")
...
class Repository(
    ...
    def __init__(
        ...
        *,
        ...
        database_audit_logging: typing.Optional[bool] = None,
        ...
        repository_installation_prefix: typing.Optional[str] = None,
        ...
        :param database: Specify the database where the deadline schema needs to be initialized. Default: A Document DB Cluster will be created with a single db.r5.large instance.
        ...
        :param vpc_subnets: If this Repository is creating its own Amazon DocumentDB database and/or Amazon Elastic File System (EFS), then this specifies to which subnets they are deployed. Default: : Private subnets in the VPC
...
class RepositoryBackupOptions:
    def __init__(
        self, *, database_retention: typing.Optional[aws_cdk.core.Duration] = None
    ) -> None:
    ...
    def database_retention(self) -> typing.Optional[aws_cdk.core.Duration]:
        ...
        :stability: experimental
        """
        return self._values.get("database_retention")
...
class RepositoryProps:
    ...
    def backup_options(self) -> typing.Optional["RepositoryBackupOptions"]:
        ...
        :stability: experimental
        """
        return self._values.get("backup_options")
    ...
    @builtins.property
    def database_audit_logging(self) -> typing.Optional[bool]:
        ...
        :stability: experimental
        """
        return self._values.get("database_audit_logging")
    ...
    def document_db_instance_count(self) -> typing.Optional[jsii.Number]:
        ...
        :stability: experimental
        """
        return self._values.get("document_db_instance_count")
    ...
    @builtins.property
    def repository_installation_prefix(self) -> typing.Optional[str]:
        ...
        :stability: experimental
        """
        return self._values.get("repository_installation_prefix")
    ...
    def repository_installation_timeout(self) -> typing.Optional[aws_cdk.core.Duration]:
        ...
        :stability: experimental
        """
        return self._values.get("repository_installation_timeout")

    @builtins.property
    def vpc_subnets(self) -> typing.Optional[aws_cdk.aws_ec2.SubnetSelection]:
        """If this Repository is creating its own Amazon DocumentDB database and/or Amazon Elastic File System (EFS), then this specifies to which subnets they are deployed.
...
class Stage(metaclass=jsii.JSIIMeta, jsii_type="aws-rfdk.deadline.Stage"):
    ...
    @builtins.classmethod
    def from_directory(cls, stage_path: str) -> "Stage":
    ...
    @builtins.classmethod
    def load_manifest(cls, manifest_path: str) -> "Manifest":
    ...
    def get_version(self, scope: aws_cdk.core.Construct, id: str) -> "IVersion":
    ...
    def image_from_recipe(
        self, scope: aws_cdk.core.Construct, id: str, recipe_name: str
...
class ThinkboxDockerRecipes(
    ...
    def __init__(
        self, scope: aws_cdk.core.Construct, id: str, *, stage: "Stage"
    ) -> None:
        """
        :param scope: -
        :param id: -
...
class UsageBasedLicense(
    metaclass=jsii.JSIIMeta, jsii_type="aws-rfdk.deadline.UsageBasedLicense"
):
    ...
    @builtins.classmethod
    def for3ds_max(
        cls, limit: typing.Optional[jsii.Number] = None
    ) -> "UsageBasedLicense":
...
class UsageBasedLicenseProps:
    ...
    def license_name(self) -> str:
        ...
        :stability: experimental
        """
        return self._values.get("license_name")
...
class UsageBasedLicensing(
    ...
    def grant_port_access(
        self, worker_fleet: "IWorkerFleet", licenses: typing.List["UsageBasedLicense"]
    ) -> None:
...
class UsageBasedLicensingImages:
    ...
    def license_forwarder(self) -> aws_cdk.aws_ecs.ContainerImage:
        ...
        :stability: experimental
        """
        return self._values.get("license_forwarder")
...
class UsageBasedLicensingProps:
    ...
    def certificate_secret(self) -> aws_cdk.aws_secretsmanager.ISecret:
        ...
        :stability: experimental
        """
        return self._values.get("certificate_secret")
    ...
    def licenses(self) -> typing.List["UsageBasedLicense"]:
        ...
        :stability: experimental
        """
        return self._values.get("licenses")
    ...
    def render_queue(self) -> "IRenderQueue":
        ...
        :stability: experimental
        """
        return self._values.get("render_queue")
...
class VersionQuery(
    ...
    @builtins.classmethod
    def exact(
        cls, scope: aws_cdk.core.Construct, id: str, version_components: "IPatchVersion"
    ) -> "IVersion":
        ...
        :param scope: The parent scope.
        :param id: The construct ID.
        :param version_components: The individual components of the Deadline release version.
        ...
        Thinkbox reserves the right to revoke patch versions of Deadline and suceeed them with a new patch version.
        ...
        """
        return jsii.sinvoke(cls, "exact", [scope, id, version_components])

    @jsii.member(jsii_name="exactString")
    @builtins.classmethod
    def exact_string(
        cls, scope: aws_cdk.core.Construct, id: str, version_string: str
    ) -> "IVersion":
        ...
        :param scope: The parent scope.
        :param id: The construct ID.
        :param version_string: A fully qualified version string (e.g. 10.1.9.2).

        stability
        :stability: experimental
        """
        return jsii.sinvoke(cls, "exactString", [scope, id, version_string])

    @jsii.member(jsii_name="parseVersionString")
    @builtins.classmethod
    def parse_version_string(cls, versionstr: str) -> "IPatchVersion":
        ...
        :stability: experimental
        """
        return jsii.sinvoke(cls, "parseVersionString", [versionstr])

    @jsii.member(jsii_name="fullVersionString")
    def _full_version_string(self, patch_version: jsii.Number) -> str:
        """
        :param patch_version: -
        ...
        :stability: experimental
        """
        return jsii.invoke(self, "fullVersionString", [patch_version])
    ...
    @jsii.python.classproperty
    @jsii.member(jsii_name="INSTALLER_BUCKET")
    def INSTALLER_BUCKET(cls) -> str:
        """
        stability
        :stability: experimental
        """
        return jsii.sget(cls, "INSTALLER_BUCKET")
    ...
    @builtins.property
    @jsii.member(jsii_name="releaseVersionString")
    def _release_version_string(self) -> str:
        """Helper to concatenate the major, minor, and release version values into a release version string.

        stability
        :stability: experimental
        """
        return jsii.get(self, "releaseVersionString")
...
class WorkerInstanceFleet(
    ...
    def __init__(
        ...
        *,
        ...
        pools: typing.Optional[typing.List[str]] = None,
        ...
        :param health_check_config: Properties for configuring a health check. Default: properties of HealthCheckConfig applies
        :param health_monitor: Health Monitor component to monitor the health of instances. Default: - Health Monitoring is turned-off
...
class WorkerInstanceFleetProps:
    def __init__(
        self,
        *,
        render_queue: "IRenderQueue",
    ...
    def worker_machine_image(self) -> aws_cdk.aws_ec2.IMachineImage:
        ...
        :stability: experimental
        """
        return self._values.get("worker_machine_image")
    ...
    def health_monitor(self) -> typing.Optional[_IHealthMonitor_ab248fa9]:
        ...
        :stability: experimental
        """
        return self._values.get("health_monitor")
    ...
    @builtins.property
    def pools(self) -> typing.Optional[typing.List[str]]:
...
class IPatchVersion(IReleaseVersion, jsii.compat.Protocol):
...
class _IPatchVersionProxy(jsii.proxy_for(IReleaseVersion)):
    """Represents a fully-qualified release version number.
    ...
    __jsii_type__ = "aws-rfdk.deadline.IPatchVersion"
