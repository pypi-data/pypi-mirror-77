...
def iserialize(data, fields=None, rels=None, root=None, exclude=None, functions=None,
    ...
    exclude.update(map(lambda col: getattr(col, 'name', col), getattr(data, 'hidden', set())))
    exclude.update(map(lambda col: getattr(col, 'name', col), getattr(data, '__hidden__', set())))
