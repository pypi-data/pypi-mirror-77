...
class TaskResponse(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, state=None, name=None, started_at=None, finished_at=None, error=None, worker=None, parent_task=None, child_tasks=None, task_group=None, progress_reports=None, created_resources=None, local_vars_configuration=None):  # noqa: E501
