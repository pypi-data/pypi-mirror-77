...
class DenseNet(nn.Module):
    def __init__(self, model_name=None, **model_settings):
        ...
        if not self.model_creator:
            ErrorMapping.throw(InvalidModelDirectoryError(
                arg_name=model_name, reason=f"'{model_name}' is not a supported densenet",
...
@error_handler
def save_untrained_model(untrained_model_path,
