...
class KerasBiLSTM(IntentClassifier):
    ...
    @staticmethod
    def create_model(embedding_matrix, max_len, out_len, learning_rate=0.001):
    ...
    def train(
        ...
        **kwargs: Any,
        ...
        self.clf = self.create_model(embedding_matrix, self.max_len, len(self.le.classes_), self.component_config["learning_rate"] )
