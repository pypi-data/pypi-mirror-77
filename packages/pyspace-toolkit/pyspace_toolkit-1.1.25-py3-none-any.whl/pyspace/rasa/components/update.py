        ...
        def merge_entity_func(temp):
            ...
            if len(temp) == 1:
                ...
                if all([ temp[i+1]['start'] - temp[i]['end'] <= 1 for i in range(len(temp)-1)]):
                    ...
                    temp_value_norm = xNormalizer.tr_normalize(temp_value)
                    ...
                    if all( [xNormalizer.tr_normalize(tt['value']) in temp_value_norm for tt in temp]):
            ...
            for e in entities:
                if e['extractor'] ==  'DucklingHTTPExtractor':
                    ...
                    if e['entity'] in ['B-account', 'B-cardtype', 'B-CARDTYPE']:
                        ...
                        output['_INSTALLMENT_TR_'].append(e['value'])
            ...
            for e in entities:
                if e['extractor'] ==  'DucklingHTTPExtractor':
                    ...
                    if e['entity'] in ['B-DURATION']:
                        ...
                        # TODO get currency information if exists from RAW
                        # output['_CURRENCY_'].append(e['additional_info']['unit'])
