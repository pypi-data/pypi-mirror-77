...
API_ISSUE_ADD_COMMENT_ENDPOINT = '/api/issues/add_comment'
API_ISSUE_EDIT_COMMENT_ENDPOINT = '/api/issues/edit_comment'
API_ISSUE_DELETE_COMMENT_ENDPOINT = '/api/issues/delete_comment'
API_ISSUE_SET_SEVERITY_ENDPOINT = '/api/issues/set_severity'
API_ISSUE_SET_TYPE_ENDPOINT = '/api/issues/set_type'
...
API_RULES_LIST_ENDPOINT = '/api/rules/search'
