...
class SonarQubeQualityprofiles:
    ...
    def activate_rule_for_quality_profile(self, profile_key, rule_key, reset=False, severity=None, **params):
        ...
        :param severity: Severity. Ignored if parameter reset is true. such as:
          * INFO
          * MINOR
          * MAJOR
          * CRITICAL
    ...
    def search_quality_profiles(self, defaults="false", language=None, project_key=None, profile_name=None):
        ...
        :param defaults: If set to true, return only the quality profiles marked as default for each language. such as:
          true, false, yes, no.default value is false.
    ...
    def export_quality_profile(self, exporterKey=None, language=None, profile_name=None):
        ...
        :param exporterKey: Output format. If left empty, the same format as api/qualityprofiles/backup is used.
          Possible values are described by api/qualityprofiles/exporters.such as:
          * sonarlint-vs-vbnet
          * findbugs
          * pmd
          * sonarlint-vs-cs
