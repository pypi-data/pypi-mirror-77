...
class SonarQubeRules:
    ...
    def search_rules(self, **kwargs):
        """
        Search for a collection of relevant rules matching a specified query.optional parameters:
        activation: Filter rules that are activated or deactivated on the selected Quality profile.
        ...
        inheritance: Comma-separated list of values of inheritance for a rule within a quality profile.
          ...
          * INHERITED
          * OVERRIDES
        is_template: Filter template rules.such as true, false, yes, no.
        ...
        sonarsourceSecurity: Comma-separated list of SonarSource security categories.
          ...
          * file-manipulation
          * others
        statuses: Comma-separated list of status codes. such as:
          * BETA
          * DEPRECATED
          * READY
          * REMOVED
    ...
    def update_rule(self, key, **kwargs):
        ...
        severity: Rule severity (Only when updating a custom rule).such as:
          * INFO
          * MINOR
          * MAJOR
          * CRITICAL
          * BLOCKER
        status: Rule status (Only when updating a custom rule). such as:
          * BETA
          * DEPRECATED
          * READY
          * REMOVED
