...
class CfnEndpointGroup(
        ...
        *,
        ...
        endpoint_configurations: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        aws_cdk.core.IResolvable, "EndpointConfigurationProperty"
                    ]
                ],
            ]
        ] = None,
    ...
    def endpoint_configurations(
        ...
        typing.Union[
            aws_cdk.core.IResolvable,
            typing.List[
                typing.Union[aws_cdk.core.IResolvable, "EndpointConfigurationProperty"]
            ],
        ]
    ]:
    ...
    def __init__(
        ...
        *,
        ...
        port_ranges: typing.Union[
            aws_cdk.core.IResolvable,
            typing.List[typing.Union[aws_cdk.core.IResolvable, "PortRangeProperty"]],
        ],
        protocol: str,
    ...
    def __init__(
        ...
        *,
        ...
        port_ranges: typing.Union[
            aws_cdk.core.IResolvable,
            typing.List[
                typing.Union[aws_cdk.core.IResolvable, "CfnListener.PortRangeProperty"]
            ],
        ],
        protocol: str,
        client_affinity: typing.Optional[str] = None,
...
class Listener(
    ...
    def from_listener_arn(
        cls, scope: aws_cdk.core.Construct, id: str, listener_arn: str
    ) -> "IListener":
        """import from ARN.
...
class EndpointGroup(
    ...
    def from_endpoint_group_arn(
        cls, scope: aws_cdk.core.Construct, id: str, endpoint_group_arn: str
    ) -> "IEndpointGroup":
        """import from ARN.
