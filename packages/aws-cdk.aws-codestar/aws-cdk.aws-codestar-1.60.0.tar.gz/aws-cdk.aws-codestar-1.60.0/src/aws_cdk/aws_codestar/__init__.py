...
class CfnGitHubRepository(
    ...
    class CodeProperty:
        def __init__(
            ...
            *,
            s3: typing.Union[
                aws_cdk.core.IResolvable, "CfnGitHubRepository.S3Property"
            ],
        ) -> None:
            """
...
class CfnGitHubRepositoryProps:
    def __init__(
        ...
        *,
        ...
        repository_owner: str,
        code: typing.Optional[
            typing.Union["CfnGitHubRepository.CodeProperty", aws_cdk.core.IResolvable]
        ] = None,
        enable_issues: typing.Optional[
            typing.Union[bool, aws_cdk.core.IResolvable]
        ] = None,
