...
setuptools.setup(
    ...
    # Include data files in `_gui/`
    # Note: this works for both sdist AND bdist.
    # Make sure the data files are under version control.
    # Use check-manifest -c to generate a MANIFEST.in that
    # includes all files under version control.
    # Check the sdist with tar --list -f path-to-tar.gz
    # Check the bdist with print(ZipFile(path-to-whl).namelist())
