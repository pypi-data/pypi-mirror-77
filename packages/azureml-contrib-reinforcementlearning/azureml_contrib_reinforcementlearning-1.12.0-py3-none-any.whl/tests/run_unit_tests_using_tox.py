...
subprocess.check_call(["python", "-m", "pip", "install", "--extra-index-url",
                       "https://dataprepdownloads.azureedge.net/pypi/daily-001996AEA44B4B4CA18D726613/latest/",
                       "--pre", "azureml-dataprep"])
