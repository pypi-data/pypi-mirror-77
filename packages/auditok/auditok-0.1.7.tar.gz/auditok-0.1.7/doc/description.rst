...
.. image:: https://readthedocs.org/projects/auditok/badge/?version=v0.1.7
    :target: http://auditok.readthedocs.org/en/v0.1.7/?badge=v0.1.7
...
The documentation of this version can be found at `Readthedocs <http://auditok.readthedocs.org/en/v0.1.7/>`_.
...
- `Documentation Home <http://auditok.readthedocs.org/en/v0.1.7/>`_
- `Command-line Usage Guide <http://auditok.readthedocs.org/en/v0.1.7/cmdline.html>`_
- `API Tutorial <http://auditok.readthedocs.org/en/v0.1.7/apitutorial.html>`_
- `API Reference <http://auditok.readthedocs.org/en/v0.1.7/index.html>`_
