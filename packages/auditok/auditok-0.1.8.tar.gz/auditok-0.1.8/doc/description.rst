...
.. image:: https://readthedocs.org/projects/auditok/badge/?version=v0.1.8
    :target: http://auditok.readthedocs.org/en/v0.1.8/?badge=v0.1.8
...
The documentation of this version can be found at `Readthedocs <http://auditok.readthedocs.org/en/v0.1.8/>`_.
...
- `Documentation Home <http://auditok.readthedocs.org/en/v0.1.8/>`_
- `Command-line Usage Guide <http://auditok.readthedocs.org/en/v0.1.8/cmdline.html>`_
- `API Tutorial <http://auditok.readthedocs.org/en/v0.1.8/apitutorial.html>`_
- `API Reference <http://auditok.readthedocs.org/en/v0.1.8/index.html>`_
