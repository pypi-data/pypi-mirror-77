...
class LeNetDialog(ClassifierDialogABC):
    epochs: int = rimnn.DeepCNN_4Conv2D.EPOCHS
    learning_rate: float = rimnn.DeepCNN_4Conv2D.LEARNING_RATE
    mini_batch_size = rimnn.DeepCNN_4Conv2D.MINI_BATCH_SIZE
    ...
    def retranslateUi(self, CNN):
        ...
        CNN.setWindowTitle(_translate("CNN", "Train DeepCNN_4Conv2D network"))
        ...
        self.groupBox_5.setTitle(_translate("CNN", "DeepCNN_4Conv2D parameters"))
