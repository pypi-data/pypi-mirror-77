    ...
    def __init__(
        ...
        *,
        authentication_configuration: typing.Union[
            "AuthenticationConfigurationProperty", aws_cdk.core.IResolvable
        ],
        ...
        def __init__(
            ...
            *,
            ...
            overrides: typing.Optional[
                typing.Union[aws_cdk.core.IResolvable, "CfnSkill.OverridesProperty"]
            ] = None,
...
class CfnSkillProps:
    def __init__(
        ...
        *,
        authentication_configuration: typing.Union[
            "CfnSkill.AuthenticationConfigurationProperty", aws_cdk.core.IResolvable
        ],
        skill_package: typing.Union[
            aws_cdk.core.IResolvable, "CfnSkill.SkillPackageProperty"
        ],
        vendor_id: str,
    ) -> None:
