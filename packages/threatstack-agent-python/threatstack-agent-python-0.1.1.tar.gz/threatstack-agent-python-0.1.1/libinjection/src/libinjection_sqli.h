...
/* Simplified check for sql injection in provided string
 * caveat: this does not return the fingerprint of the sqli match
 *
 * \return 1 if SQLi, 0 otherwise
 */
int libinjection_is_sqli_simple(const char* word, size_t len);
