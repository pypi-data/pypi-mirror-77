...
class OrderItemSchema(Schema):
    ...
    product_variant = RelatedResourceLinkField(schema=ProductVariantSchema, data_key='productVariant')
    fulfilment_point = RelatedResourceLinkField(schema=FulfilmentPointSchema, data_key='fulfilmentPoint')
    quantity = fields.Int()
