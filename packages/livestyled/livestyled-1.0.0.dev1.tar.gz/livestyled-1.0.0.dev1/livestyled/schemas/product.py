...
class ProductVariantSchema(Schema):
    ...
    stocks = RelatedResourceLinkField(schema=ProductVariantStocksSchema, many=True)
...
class ProductSchema(Schema):
    ...
    status = fields.String(missing=None)
    reference = fields.String(missing=None)
    modifier_lists = RelatedResourceLinkField(schema=ProductModifierListsSchema, many=True, missing=[], data_key='modifierLists')
    external_id = fields.String(data_key='externalId', missing=None)
