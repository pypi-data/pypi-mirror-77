    ...
    def __init__(
        ...
        *,
        ...
        method_responses: typing.Optional[
            typing.List[aws_cdk.aws_apigateway.MethodResponse]
        ] = None,
        operation_name: typing.Optional[str] = None,
        request_models: typing.Optional[
            typing.Mapping[str, aws_cdk.aws_apigateway.IModel]
        ] = None,
        request_parameters: typing.Optional[typing.Mapping[str, bool]] = None,
        request_validator: typing.Optional[
            aws_cdk.aws_apigateway.IRequestValidator
        ] = None,
        request_validator_options: typing.Optional[
            aws_cdk.aws_apigateway.RequestValidatorOptions
        ] = None,
    ) -> None:
        """
        :param method: -
...
@jsii.implements(aws_cdk.aws_lambda.IEventSource)
class S3EventSource(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-lambda-event-sources.S3EventSource"
):
    ...
    def __init__(
        ...
        *,
        ...
        filters: typing.Optional[
            typing.List[aws_cdk.aws_s3.NotificationKeyFilter]
        ] = None,
    ) -> None:
        """
        :param bucket: -
...
class SnsDlq(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-lambda-event-sources.SnsDlq"
):
...
@jsii.implements(aws_cdk.aws_lambda.IEventSourceDlq)
class SqsDlq(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-lambda-event-sources.SqsDlq"
):
