...
class InteligerMeta(type):
    ...
    def __call__(self) -> Inteliger:
        ...
        :descrição: Função que sobrescreve as chamadas para a classe e verifica se já existe uma instância da classe existente no servidor,
                    se não houver, cria, se houver, us a existente
        :Criação: Nícolas Marinoni Grande - 17/08/2020
        :Edições:
        :return: Instância para ser usada
        """
