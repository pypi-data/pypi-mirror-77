...
class DataNullDataSource(
    ...
    def __init__(
        ...
        id: str,
        *,
        has_computed_default: typing.Optional[str] = None,
        inputs: typing.Optional[typing.Mapping[str, str]] = None,
    ...
    def has_computed_default(self) -> typing.Optional[str]:
        return jsii.get(self, "hasComputedDefault")

    @has_computed_default.setter
    def has_computed_default(self, value: typing.Optional[str]) -> None:
    ...
    def inputs(self) -> typing.Optional[typing.Mapping[str, str]]:
        return jsii.get(self, "inputs")

    @inputs.setter
    def inputs(self, value: typing.Optional[typing.Mapping[str, str]]) -> None:
...
class DataNullDataSourceConfig(cdktf.TerraformMetaArguments):
    ...
    @builtins.property
    def has_computed_default(self) -> typing.Optional[str]:
        return self._values.get("has_computed_default")
...
class NullProviderConfig:
    def __init__(self, *, alias: typing.Optional[str] = None) -> None:
        """
        :param alias: Alias name.
        """
        self._values = {}
