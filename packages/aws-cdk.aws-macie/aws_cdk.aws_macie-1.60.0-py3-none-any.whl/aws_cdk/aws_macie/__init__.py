...
class CfnFindingsFilter(
    ...
    def __init__(
        ...
        *,
        finding_criteria: typing.Union[
            "FindingCriteriaProperty", aws_cdk.core.IResolvable
        ],
        name: str,
    ...
    class FindingCriteriaProperty:
        def __init__(
            self,
            *,
            criterion: typing.Optional[
                typing.Union[
                    aws_cdk.core.IResolvable, "CfnFindingsFilter.CriterionProperty"
                ]
            ] = None,
        ) -> None:
            """
...
class CfnFindingsFilterProps:
    def __init__(
        ...
        *,
        finding_criteria: typing.Union[
            "CfnFindingsFilter.FindingCriteriaProperty", aws_cdk.core.IResolvable
        ],
        name: str,
        action: typing.Optional[str] = None,
        description: typing.Optional[str] = None,
