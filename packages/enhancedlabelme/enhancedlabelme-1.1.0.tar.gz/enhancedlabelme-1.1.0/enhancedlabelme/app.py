...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(
        ...
        # try:
        #     self.fileSearch.setPlaceholderText(self.tr(self.filename))
        # except Exception:
        ...
        utils.addActions(self.menus.help, (help, readme))
        utils.addActions(
            self.menus.view,
            (
    ...
    def preference(self):
        try:
            if platform.system() == 'Darwin':       # macOS
                subprocess.call(('open', os.path.join(os.path.expanduser('~'), 'lconfig')))
            elif platform.system() == 'Windows':    # Windows
                subprocess.call(('notepad.exe', os.path.join(os.path.expanduser('~'), 'lconfig')))
            else:                                   # linux variants
                subprocess.call(('xdg-open', os.path.join(os.path.expanduser('~'), 'lconfig')))
        except Exception:
            pass
