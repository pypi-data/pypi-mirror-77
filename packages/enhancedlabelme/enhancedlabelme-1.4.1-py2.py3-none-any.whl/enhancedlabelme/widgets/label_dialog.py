...
class LabelDialog(QtWidgets.QDialog):
    ...
    def __init__(self, text="Enter object label", parent=None, labels=None,
        ...
        self.edit.setValidator(enhancedlabelme.utils.labelValidator())
        ...
        bb.button(bb.Ok).setIcon(enhancedlabelme.utils.newIcon('done'))
        bb.button(bb.Cancel).setIcon(enhancedlabelme.utils.newIcon('undo'))
