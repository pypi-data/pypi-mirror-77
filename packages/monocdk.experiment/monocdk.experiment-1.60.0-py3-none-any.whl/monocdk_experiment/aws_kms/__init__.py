...
from ..aws_iam import (
    ...
    PrincipalBase as _PrincipalBase_e4459eeb,
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_kms.AliasAttributes",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_kms.AliasProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CfnAlias(
    ...
    jsii_type="monocdk-experiment.aws_kms.CfnAlias",
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_kms.CfnAliasProps",
    jsii_struct_bases=[],
...
class CfnKey(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_kms.CfnKey",
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_kms.CfnKeyProps",
    jsii_struct_bases=[],
    name_mapping={
...
class Key(
    _Resource_884d0774,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_kms.Key",
):
    """Defines a KMS key.
    ...
    def __init__(
        ...
        *,
        ...
        policy: typing.Optional[_PolicyDocument_1d1bca11] = None,
        removal_policy: typing.Optional[_RemovalPolicy_5986e9f3] = None,
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_kms.KeyProps",
    jsii_struct_bases=[],
    name_mapping={
        "alias": "alias",
        "description": "description",
...
class ViaServicePrincipal(
    _PrincipalBase_e4459eeb,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_kms.ViaServicePrincipal",
):
    ...
    def __init__(
        self,
        service_name: str,
        base_principal: typing.Optional[_IPrincipal_97126874] = None,
    ) -> None:
        """
        :param service_name: -
...
class Alias(
    _Resource_884d0774,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_kms.Alias",
):
    ...
    @builtins.classmethod
    def from_alias_name(
        cls, scope: _Construct_f50a3f53, id: str, alias_name: str
    ) -> "IAlias":
