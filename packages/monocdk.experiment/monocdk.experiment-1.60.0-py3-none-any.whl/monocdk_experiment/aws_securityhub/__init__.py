...
class CfnHub(
    ...
    jsii_type="monocdk-experiment.aws_securityhub.CfnHub",
):
    ...
    def __init__(
        self, scope: _Construct_f50a3f53, id: str, *, tags: typing.Any = None
    ) -> None:
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_securityhub.CfnHubProps",
    jsii_struct_bases=[],
