...
from .. import (
    ...
    CustomResource as _CustomResource_ed3258f5,
...
class CfnCustomResource(
    ...
    jsii_type="monocdk-experiment.aws_cloudformation.CfnCustomResource",
):
    ...
    def __init__(
        self, scope: _Construct_f50a3f53, id: str, *, service_token: str
    ) -> None:
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudformation.CfnCustomResourceProps",
    jsii_struct_bases=[],
...
class CfnMacro(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_cloudformation.CfnMacro",
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudformation.CfnMacroProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CfnStack(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_cloudformation.CfnStack",
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudformation.CfnStackProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CfnWaitCondition(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_cloudformation.CfnWaitCondition",
):
    ...
    def attr_data(self) -> _IResolvable_9ceae33e:
        """
...
class CfnWaitConditionHandle(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_cloudformation.CfnWaitConditionHandle",
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudformation.CfnWaitConditionProps",
    jsii_struct_bases=[],
...
@jsii.enum(jsii_type="monocdk-experiment.aws_cloudformation.CloudFormationCapabilities")
...
class CustomResource(
    _CustomResource_ed3258f5,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_cloudformation.CustomResource",
):
    """Deprecated.
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudformation.CustomResourceProps",
    jsii_struct_bases=[],
    name_mapping={
        "provider": "provider",
        "properties": "properties",
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudformation.CustomResourceProviderConfig",
    jsii_struct_bases=[],
    name_mapping={"service_token": "serviceToken"},
)
...
@jsii.interface(
    jsii_type="monocdk-experiment.aws_cloudformation.ICustomResourceProvider"
)
class ICustomResourceProvider(jsii.compat.Protocol):
    ...
    def bind(self, scope: _Construct_f50a3f53) -> "CustomResourceProviderConfig":
...
class _ICustomResourceProviderProxy:
    ...
    __jsii_type__ = "monocdk-experiment.aws_cloudformation.ICustomResourceProvider"
...
class NestedStack(
    _NestedStack_e205561c,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_cloudformation.NestedStack",
):
    ...
    def __init__(
        ...
        id: str,
        *,
        notifications: typing.Optional[typing.List[_ITopic_ef0ebe0e]] = None,
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudformation.NestedStackProps",
    jsii_struct_bases=[],
    name_mapping={
...
class NestedStackProps:
    ...
    @builtins.property
    def notifications(self) -> typing.Optional[typing.List[_ITopic_ef0ebe0e]]:
...
class CustomResourceProvider(
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_cloudformation.CustomResourceProvider",
):
    """Represents a provider for an AWS CloudFormation custom resources.
    ...
    def from_lambda(cls, handler: _IFunction_1c1de0bc) -> "CustomResourceProvider":
    ...
    @builtins.classmethod
    def from_topic(cls, topic: _ITopic_ef0ebe0e) -> "CustomResourceProvider":
    ...
    @builtins.classmethod
    def lambda_(cls, handler: _IFunction_1c1de0bc) -> "CustomResourceProvider":
    ...
    @builtins.classmethod
    def topic(cls, topic: _ITopic_ef0ebe0e) -> "CustomResourceProvider":
    ...
    @jsii.member(jsii_name="bind")
    def bind(self, _: _Construct_f50a3f53) -> "CustomResourceProviderConfig":
        """Called when this provider is used by a ``CustomResource``.
