...
class CfnConnection(
    ...
    def __init__(
        ...
        *,
        connection_name: str,
        host_arn: typing.Optional[str] = None,
    ...
    def host_arn(self) -> typing.Optional[str]:
    ...
    @host_arn.setter
    def host_arn(self, value: typing.Optional[str]) -> None:
        jsii.set(self, "hostArn", value)

    @builtins.property
    @jsii.member(jsii_name="providerType")
    def provider_type(self) -> typing.Optional[str]:
    ...
    def provider_type(self, value: typing.Optional[str]) -> None:
...
class CfnConnectionProps:
    ...
    def host_arn(self) -> typing.Optional[str]:
        ...
        :see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-codestarconnections-connection.html#cfn-codestarconnections-connection-hostarn
        """
        return self._values.get("host_arn")
