...
from ..aws_ecs import (
    ...
    LinuxParameters as _LinuxParameters_4f2b9dff,
    MountPoint as _MountPoint_4cb35154,
    Ulimit as _Ulimit_05b23ec0,
    Volume as _Volume_0361ca6f,
)
from ..aws_iam import IRole as _IRole_e69bbae4


@jsii.enum(jsii_type="monocdk-experiment.aws_batch.AllocationStrategy")
...
class CfnComputeEnvironment(
    ...
    jsii_type="monocdk-experiment.aws_batch.CfnComputeEnvironment",
):
    ...
    def __init__(
        ...
        *,
        service_role: str,
        type: str,
        compute_environment_name: typing.Optional[str] = None,
        compute_resources: typing.Optional[
            typing.Union["ComputeResourcesProperty", _IResolvable_9ceae33e]
        ] = None,
    ...
    def compute_environment_name(self, value: typing.Optional[str]) -> None:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_batch.CfnComputeEnvironment.ComputeResourcesProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class ComputeResourcesProperty:
        def __init__(
            ...
            *,
            ...
            spot_iam_fleet_role: typing.Optional[str] = None,
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_batch.CfnComputeEnvironment.LaunchTemplateSpecificationProperty",
        jsii_struct_bases=[],
        name_mapping={
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_batch.CfnComputeEnvironmentProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CfnComputeEnvironmentProps:
    def __init__(
        ...
        *,
        ...
        compute_resources: typing.Optional[
            typing.Union[
                "CfnComputeEnvironment.ComputeResourcesProperty", _IResolvable_9ceae33e
            ]
        ] = None,
        state: typing.Optional[str] = None,
    ) -> None:
...
class CfnJobDefinition(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_batch.CfnJobDefinition",
):
    ...
    def __init__(
        ...
        *,
        type: str,
        container_properties: typing.Optional[
            typing.Union["ContainerPropertiesProperty", _IResolvable_9ceae33e]
        ] = None,
        job_definition_name: typing.Optional[str] = None,
        node_properties: typing.Optional[
            typing.Union["NodePropertiesProperty", _IResolvable_9ceae33e]
        ] = None,
        parameters: typing.Any = None,
        retry_strategy: typing.Optional[
            typing.Union["RetryStrategyProperty", _IResolvable_9ceae33e]
        ] = None,
        timeout: typing.Optional[
            typing.Union["TimeoutProperty", _IResolvable_9ceae33e]
        ] = None,
    ) -> None:
    ...
    def job_definition_name(self, value: typing.Optional[str]) -> None:
    ...
    def node_properties(
        self,
    ) -> typing.Optional[typing.Union["NodePropertiesProperty", _IResolvable_9ceae33e]]:
    ...
    def retry_strategy(
        self,
    ) -> typing.Optional[typing.Union["RetryStrategyProperty", _IResolvable_9ceae33e]]:
    ...
    def timeout(
        self,
    ) -> typing.Optional[typing.Union["TimeoutProperty", _IResolvable_9ceae33e]]:
    ...
    def timeout(
        self,
        value: typing.Optional[typing.Union["TimeoutProperty", _IResolvable_9ceae33e]],
    ) -> None:
        jsii.set(self, "timeout", value)

    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_batch.CfnJobDefinition.ContainerPropertiesProperty",
        jsii_struct_bases=[],
        name_mapping={
            "image": "image",
            "command": "command",
    ...
    class ContainerPropertiesProperty:
        def __init__(
            ...
            *,
            ...
            job_role_arn: typing.Optional[str] = None,
            linux_parameters: typing.Optional[
                typing.Union[
                    "CfnJobDefinition.LinuxParametersProperty", _IResolvable_9ceae33e
                ]
            ] = None,
            ...
            ulimits: typing.Optional[
                typing.Union[
                    ...
                    typing.List[
                        typing.Union[
                            "CfnJobDefinition.UlimitProperty", _IResolvable_9ceae33e
                        ]
                    ],
                ]
            ] = None,
            ...
            volumes: typing.Optional[
                typing.Union[
                    ...
                    typing.List[
                        typing.Union[
                            "CfnJobDefinition.VolumesProperty", _IResolvable_9ceae33e
                        ]
                    ],
                ]
            ] = None,
        ...
        def environment(
            ...
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        "CfnJobDefinition.EnvironmentProperty", _IResolvable_9ceae33e
                    ]
                ],
            ]
        ]:
        ...
        def mount_points(
            ...
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        "CfnJobDefinition.MountPointsProperty", _IResolvable_9ceae33e
                    ]
                ],
            ]
        ]:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_batch.CfnJobDefinition.DeviceProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_batch.CfnJobDefinition.EnvironmentProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_batch.CfnJobDefinition.LinuxParametersProperty",
        jsii_struct_bases=[],
            ...
            *,
            devices: typing.Optional[
                typing.Union[
                    ...
                    typing.List[
                        typing.Union[
                            "CfnJobDefinition.DeviceProperty", _IResolvable_9ceae33e
                        ]
                    ],
                ]
            ] = None,
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_batch.CfnJobDefinition.MountPointsProperty",
        jsii_struct_bases=[],
        name_mapping={
            "container_path": "containerPath",
            "read_only": "readOnly",
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_batch.CfnJobDefinition.NodePropertiesProperty",
        jsii_struct_bases=[],
        name_mapping={
            "main_node": "mainNode",
    ...
    class NodePropertiesProperty:
        ...
        def node_range_properties(
            ...
            typing.List[
                typing.Union[
                    "CfnJobDefinition.NodeRangePropertyProperty", _IResolvable_9ceae33e
                ]
            ],
        ]:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_batch.CfnJobDefinition.NodeRangePropertyProperty",
        jsii_struct_bases=[],
    ...
    class NodeRangePropertyProperty:
        ...
        def container(
            ...
            typing.Union[
                "CfnJobDefinition.ContainerPropertiesProperty", _IResolvable_9ceae33e
            ]
        ]:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_batch.CfnJobDefinition.ResourceRequirementProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_batch.CfnJobDefinition.RetryStrategyProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_batch.CfnJobDefinition.TimeoutProperty",
        jsii_struct_bases=[],
        name_mapping={"attempt_duration_seconds": "attemptDurationSeconds"},
    )
    class TimeoutProperty:
        def __init__(
            self, *, attempt_duration_seconds: typing.Optional[jsii.Number] = None
        ) -> None:
            """
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_batch.CfnJobDefinition.UlimitProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_batch.CfnJobDefinition.VolumesHostProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_batch.CfnJobDefinition.VolumesProperty",
        jsii_struct_bases=[],
    ...
    class VolumesProperty:
        def __init__(
            ...
            *,
            host: typing.Optional[
                typing.Union[
                    "CfnJobDefinition.VolumesHostProperty", _IResolvable_9ceae33e
                ]
            ] = None,
            name: typing.Optional[str] = None,
        ) -> None:
        ...
        def host(
            ...
            typing.Union["CfnJobDefinition.VolumesHostProperty", _IResolvable_9ceae33e]
        ]:
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_batch.CfnJobDefinitionProps",
    jsii_struct_bases=[],
    name_mapping={
        "type": "type",
...
class CfnJobDefinitionProps:
    def __init__(
        ...
        *,
        ...
        node_properties: typing.Optional[
            typing.Union[
                "CfnJobDefinition.NodePropertiesProperty", _IResolvable_9ceae33e
            ]
        ] = None,
        parameters: typing.Any = None,
        retry_strategy: typing.Optional[
            typing.Union[
                "CfnJobDefinition.RetryStrategyProperty", _IResolvable_9ceae33e
            ]
        ] = None,
        timeout: typing.Optional[
            typing.Union["CfnJobDefinition.TimeoutProperty", _IResolvable_9ceae33e]
        ] = None,
    ) -> None:
    ...
    def node_properties(
        ...
        typing.Union["CfnJobDefinition.NodePropertiesProperty", _IResolvable_9ceae33e]
    ]:
        """``AWS::Batch::JobDefinition.NodeProperties``.
    ...
    def retry_strategy(
        ...
        typing.Union["CfnJobDefinition.RetryStrategyProperty", _IResolvable_9ceae33e]
    ]:
        """``AWS::Batch::JobDefinition.RetryStrategy``.
...
class CfnJobQueue(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_batch.CfnJobQueue",
):
    ...
    def __init__(
        ...
        *,
        compute_environment_order: typing.Union[
            _IResolvable_9ceae33e,
            typing.List[
                typing.Union["ComputeEnvironmentOrderProperty", _IResolvable_9ceae33e]
            ],
        ],
        priority: jsii.Number,
        job_queue_name: typing.Optional[str] = None,
        state: typing.Optional[str] = None,
    ) -> None:
    ...
    def job_queue_name(self, value: typing.Optional[str]) -> None:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_batch.CfnJobQueue.ComputeEnvironmentOrderProperty",
        jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_batch.CfnJobQueueProps",
    jsii_struct_bases=[],
    name_mapping={
    ...
    def __init__(
        ...
        *,
        compute_environment_order: typing.Union[
            ...
            typing.List[
                typing.Union[
                    "CfnJobQueue.ComputeEnvironmentOrderProperty", _IResolvable_9ceae33e
                ]
            ],
        ],
        priority: jsii.Number,
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_batch.ComputeEnvironmentProps",
    jsii_struct_bases=[],
    name_mapping={
        "compute_environment_name": "computeEnvironmentName",
        "compute_resources": "computeResources",
...
@jsii.enum(jsii_type="monocdk-experiment.aws_batch.ComputeResourceType")
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_batch.ComputeResources",
    jsii_struct_bases=[],
    name_mapping={
        "vpc": "vpc",
        "allocation_strategy": "allocationStrategy",
...
class ComputeResources:
    def __init__(
        ...
        *,
        ...
        bid_percentage: typing.Optional[jsii.Number] = None,
        compute_resources_tags: typing.Optional[_Tag_ef7f3fe6] = None,
        desiredv_cpus: typing.Optional[jsii.Number] = None,
        ec2_key_pair: typing.Optional[str] = None,
        image: typing.Optional[_IMachineImage_d5cd7b45] = None,
        instance_role: typing.Optional[str] = None,
        instance_types: typing.Optional[typing.List[_InstanceType_85a97b30]] = None,
        ...
        spot_fleet_role: typing.Optional[_IRole_e69bbae4] = None,
    ...
    @builtins.property
    def compute_resources_tags(self) -> typing.Optional[_Tag_ef7f3fe6]:
        """Key-value pair tags to be applied to resources that are launched in the compute environment.
    ...
    @builtins.property
    def image(self) -> typing.Optional[_IMachineImage_d5cd7b45]:
    ...
    @builtins.property
    def instance_types(self) -> typing.Optional[typing.List[_InstanceType_85a97b30]]:
        """The types of EC2 instances that may be launched in the compute environment.
    ...
    @builtins.property
    def spot_fleet_role(self) -> typing.Optional[_IRole_e69bbae4]:
        """This property will be ignored if you set the environment type to ON_DEMAND.
...
@jsii.interface(jsii_type="monocdk-experiment.aws_batch.IComputeEnvironment")
class IComputeEnvironment(_IResource_72f7ee7e, jsii.compat.Protocol):
...
class _IComputeEnvironmentProxy(jsii.proxy_for(_IResource_72f7ee7e)):
    """Properties of a compute environment.
    ...
    __jsii_type__ = "monocdk-experiment.aws_batch.IComputeEnvironment"
...
@jsii.interface(jsii_type="monocdk-experiment.aws_batch.IJobDefinition")
class IJobDefinition(_IResource_72f7ee7e, jsii.compat.Protocol):
...
class _IJobDefinitionProxy(jsii.proxy_for(_IResource_72f7ee7e)):
    """An interface representing a job definition - either a new one, created with the CDK, *using the {@link JobDefinition} class, or existing ones, referenced using the {@link JobDefinition.fromJobDefinitionArn} method.
    ...
    __jsii_type__ = "monocdk-experiment.aws_batch.IJobDefinition"
...
@jsii.interface(jsii_type="monocdk-experiment.aws_batch.IJobQueue")
class IJobQueue(_IResource_72f7ee7e, jsii.compat.Protocol):
...
class _IJobQueueProxy(jsii.proxy_for(_IResource_72f7ee7e)):
    """Properties of a Job Queue.
    ...
    __jsii_type__ = "monocdk-experiment.aws_batch.IJobQueue"
...
@jsii.interface(jsii_type="monocdk-experiment.aws_batch.IMultiNodeProps")
...
class _IMultiNodePropsProxy:
    ...
    __jsii_type__ = "monocdk-experiment.aws_batch.IMultiNodeProps"
...
@jsii.interface(jsii_type="monocdk-experiment.aws_batch.INodeRangeProps")
...
class _INodeRangePropsProxy:
    ...
    __jsii_type__ = "monocdk-experiment.aws_batch.INodeRangeProps"
...
class JobDefinition(
    _Resource_884d0774,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_batch.JobDefinition",
):
    ...
    def from_job_definition_arn(
        cls, scope: _Construct_f50a3f53, id: str, job_definition_arn: str
    ) -> "IJobDefinition":
        ...
        """
        return jsii.sinvoke(
            cls, "fromJobDefinitionArn", [scope, id, job_definition_arn]
        )
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_batch.JobDefinitionContainer",
    jsii_struct_bases=[],
    name_mapping={
        "image": "image",
        "command": "command",
...
class JobDefinitionContainer:
    def __init__(
        ...
        *,
        ...
        job_role: typing.Optional[_IRole_e69bbae4] = None,
        linux_params: typing.Optional[_LinuxParameters_4f2b9dff] = None,
        memory_limit_mib: typing.Optional[jsii.Number] = None,
        mount_points: typing.Optional[typing.List[_MountPoint_4cb35154]] = None,
        privileged: typing.Optional[bool] = None,
        read_only: typing.Optional[bool] = None,
        ulimits: typing.Optional[typing.List[_Ulimit_05b23ec0]] = None,
        user: typing.Optional[str] = None,
        vcpus: typing.Optional[jsii.Number] = None,
        volumes: typing.Optional[typing.List[_Volume_0361ca6f]] = None,
    ) -> None:
    ...
    @builtins.property
    def job_role(self) -> typing.Optional[_IRole_e69bbae4]:
    ...
    @builtins.property
    def linux_params(self) -> typing.Optional[_LinuxParameters_4f2b9dff]:
    ...
    @builtins.property
    def mount_points(self) -> typing.Optional[typing.List[_MountPoint_4cb35154]]:
    ...
    @builtins.property
    def ulimits(self) -> typing.Optional[typing.List[_Ulimit_05b23ec0]]:
    ...
    @builtins.property
    def volumes(self) -> typing.Optional[typing.List[_Volume_0361ca6f]]:
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_batch.JobDefinitionProps",
    jsii_struct_bases=[],
    name_mapping={
        "container": "container",
        "job_definition_name": "jobDefinitionName",
...
class JobQueue(
    _Resource_884d0774,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_batch.JobQueue",
):
    """Batch Job Queue.
    ...
    def from_job_queue_arn(
        cls, scope: _Construct_f50a3f53, id: str, job_queue_arn: str
    ) -> "IJobQueue":
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_batch.JobQueueComputeEnvironment",
    jsii_struct_bases=[],
    name_mapping={"compute_environment": "computeEnvironment", "order": "order"},
)
class JobQueueComputeEnvironment:
    def __init__(
        self, *, compute_environment: "IComputeEnvironment", order: jsii.Number
    ) -> None:
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_batch.JobQueueProps",
    jsii_struct_bases=[],
    name_mapping={
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_batch.LaunchTemplateSpecification",
    jsii_struct_bases=[],
    name_mapping={"launch_template_name": "launchTemplateName", "version": "version"},
)
class LaunchTemplateSpecification:
    def __init__(
        self, *, launch_template_name: str, version: typing.Optional[str] = None
    ) -> None:
...
class ComputeEnvironment(
    _Resource_884d0774,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_batch.ComputeEnvironment",
):
    ...
    def from_compute_environment_arn(
        cls, scope: _Construct_f50a3f53, id: str, compute_environment_arn: str
    ) -> "IComputeEnvironment":
        ...
        """
        return jsii.sinvoke(
            cls, "fromComputeEnvironmentArn", [scope, id, compute_environment_arn]
        )
