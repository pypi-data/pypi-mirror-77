...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_route53.AliasRecordTargetConfig",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_route53.CaaRecordValue",
    jsii_struct_bases=[],
...
@jsii.enum(jsii_type="monocdk-experiment.aws_route53.CaaTag")
...
class CfnHealthCheck(
    ...
    jsii_type="monocdk-experiment.aws_route53.CfnHealthCheck",
):
    ...
    def __init__(
        ...
        id: str,
        *,
        health_check_config: typing.Union[
            "HealthCheckConfigProperty", _IResolvable_9ceae33e
        ],
        health_check_tags: typing.Optional[
            typing.Union[
                _IResolvable_9ceae33e,
                typing.List[
                    typing.Union["HealthCheckTagProperty", _IResolvable_9ceae33e]
                ],
            ]
        ] = None,
    ) -> None:
        ...
        props = CfnHealthCheckProps(
            health_check_config=health_check_config, health_check_tags=health_check_tags
        )
    ...
    def health_check_config(
        self,
    ) -> typing.Union["HealthCheckConfigProperty", _IResolvable_9ceae33e]:
    ...
    def health_check_config(
        self, value: typing.Union["HealthCheckConfigProperty", _IResolvable_9ceae33e]
    ) -> None:
    ...
    def health_check_tags(
        ...
        typing.Union[
            _IResolvable_9ceae33e,
            typing.List[typing.Union["HealthCheckTagProperty", _IResolvable_9ceae33e]],
        ]
    ]:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_route53.CfnHealthCheck.AlarmIdentifierProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_route53.CfnHealthCheck.HealthCheckConfigProperty",
        jsii_struct_bases=[],
        name_mapping={
            "type": "type",
    ...
    class HealthCheckConfigProperty:
        def __init__(
            ...
            *,
            type: str,
            alarm_identifier: typing.Optional[
                typing.Union[
                    "CfnHealthCheck.AlarmIdentifierProperty", _IResolvable_9ceae33e
                ]
            ] = None,
            child_health_checks: typing.Optional[typing.List[str]] = None,
            enable_sni: typing.Optional[
                typing.Union[bool, _IResolvable_9ceae33e]
            ] = None,
            failure_threshold: typing.Optional[jsii.Number] = None,
            fully_qualified_domain_name: typing.Optional[str] = None,
            health_threshold: typing.Optional[jsii.Number] = None,
            insufficient_data_health_status: typing.Optional[str] = None,
            inverted: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]] = None,
            ip_address: typing.Optional[str] = None,
            measure_latency: typing.Optional[
                typing.Union[bool, _IResolvable_9ceae33e]
            ] = None,
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_route53.CfnHealthCheck.HealthCheckTagProperty",
        jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_route53.CfnHealthCheckProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CfnHealthCheckProps:
    def __init__(
        ...
        *,
        health_check_config: typing.Union[
            "CfnHealthCheck.HealthCheckConfigProperty", _IResolvable_9ceae33e
        ],
        health_check_tags: typing.Optional[
            typing.Union[
                _IResolvable_9ceae33e,
                typing.List[
                    typing.Union[
                        "CfnHealthCheck.HealthCheckTagProperty", _IResolvable_9ceae33e
                    ]
                ],
            ]
        ] = None,
...
class CfnHostedZone(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_route53.CfnHostedZone",
):
    ...
    def __init__(
        ...
        *,
        name: str,
        hosted_zone_config: typing.Optional[
            typing.Union["HostedZoneConfigProperty", _IResolvable_9ceae33e]
        ] = None,
        hosted_zone_tags: typing.Optional[typing.List["HostedZoneTagProperty"]] = None,
        query_logging_config: typing.Optional[
            typing.Union["QueryLoggingConfigProperty", _IResolvable_9ceae33e]
        ] = None,
        vpcs: typing.Optional[
            typing.Union[
                _IResolvable_9ceae33e,
                typing.List[typing.Union["VPCProperty", _IResolvable_9ceae33e]],
            ]
        ] = None,
    ) -> None:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_route53.CfnHostedZone.HostedZoneConfigProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_route53.CfnHostedZone.HostedZoneTagProperty",
        jsii_struct_bases=[],
        name_mapping={"key": "key", "value": "value"},
    )
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_route53.CfnHostedZone.QueryLoggingConfigProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_route53.CfnHostedZone.VPCProperty",
        jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_route53.CfnHostedZoneProps",
    jsii_struct_bases=[],
    name_mapping={
        "name": "name",
...
class CfnHostedZoneProps:
    def __init__(
        ...
        *,
        ...
        hosted_zone_config: typing.Optional[
            typing.Union[
                "CfnHostedZone.HostedZoneConfigProperty", _IResolvable_9ceae33e
            ]
        ] = None,
        hosted_zone_tags: typing.Optional[
            typing.List["CfnHostedZone.HostedZoneTagProperty"]
        ] = None,
        query_logging_config: typing.Optional[
            typing.Union[
                "CfnHostedZone.QueryLoggingConfigProperty", _IResolvable_9ceae33e
            ]
        ] = None,
        vpcs: typing.Optional[
            typing.Union[
                _IResolvable_9ceae33e,
                typing.List[
                    typing.Union["CfnHostedZone.VPCProperty", _IResolvable_9ceae33e]
                ],
            ]
        ] = None,
    ) -> None:
    ...
    def hosted_zone_config(
        ...
        typing.Union["CfnHostedZone.HostedZoneConfigProperty", _IResolvable_9ceae33e]
    ]:
        """``AWS::Route53::HostedZone.HostedZoneConfig``.
    ...
    def query_logging_config(
        ...
        typing.Union["CfnHostedZone.QueryLoggingConfigProperty", _IResolvable_9ceae33e]
    ]:
        """``AWS::Route53::HostedZone.QueryLoggingConfig``.
...
class CfnRecordSet(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_route53.CfnRecordSet",
):
    ...
    def __init__(
        ...
        *,
        name: str,
        type: str,
        alias_target: typing.Optional[
            typing.Union["AliasTargetProperty", _IResolvable_9ceae33e]
        ] = None,
        comment: typing.Optional[str] = None,
        failover: typing.Optional[str] = None,
        geo_location: typing.Optional[
            typing.Union["GeoLocationProperty", _IResolvable_9ceae33e]
        ] = None,
        health_check_id: typing.Optional[str] = None,
        hosted_zone_id: typing.Optional[str] = None,
        hosted_zone_name: typing.Optional[str] = None,
        multi_value_answer: typing.Optional[
            typing.Union[bool, _IResolvable_9ceae33e]
        ] = None,
        region: typing.Optional[str] = None,
        resource_records: typing.Optional[typing.List[str]] = None,
        set_identifier: typing.Optional[str] = None,
    ...
    def alias_target(
        self,
    ) -> typing.Optional[typing.Union["AliasTargetProperty", _IResolvable_9ceae33e]]:
    ...
    @failover.setter
    def failover(self, value: typing.Optional[str]) -> None:
    ...
    def geo_location(
        self,
    ) -> typing.Optional[typing.Union["GeoLocationProperty", _IResolvable_9ceae33e]]:
    ...
    def health_check_id(self, value: typing.Optional[str]) -> None:
    ...
    def hosted_zone_id(self, value: typing.Optional[str]) -> None:
    ...
    def hosted_zone_name(self, value: typing.Optional[str]) -> None:
    ...
    def resource_records(self, value: typing.Optional[typing.List[str]]) -> None:
    ...
    def set_identifier(self, value: typing.Optional[str]) -> None:
    ...
    @ttl.setter
    def ttl(self, value: typing.Optional[str]) -> None:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_route53.CfnRecordSet.AliasTargetProperty",
        jsii_struct_bases=[],
        name_mapping={
            "dns_name": "dnsName",
    ...
    class AliasTargetProperty:
        def __init__(
            ...
            *,
            dns_name: str,
            hosted_zone_id: str,
            evaluate_target_health: typing.Optional[
                typing.Union[bool, _IResolvable_9ceae33e]
            ] = None,
        ) -> None:
            """
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_route53.CfnRecordSet.GeoLocationProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class GeoLocationProperty:
        def __init__(
            ...
            *,
            ...
            subdivision_code: typing.Optional[str] = None,
        ) -> None:
            """
...
class CfnRecordSetGroup(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_route53.CfnRecordSetGroup",
):
    ...
    def __init__(
        ...
        *,
        ...
        hosted_zone_id: typing.Optional[str] = None,
        hosted_zone_name: typing.Optional[str] = None,
        record_sets: typing.Optional[
            typing.Union[
                _IResolvable_9ceae33e,
                typing.List[typing.Union["RecordSetProperty", _IResolvable_9ceae33e]],
            ]
        ] = None,
    ) -> None:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_route53.CfnRecordSetGroup.AliasTargetProperty",
        jsii_struct_bases=[],
        name_mapping={
            "dns_name": "dnsName",
            "hosted_zone_id": "hostedZoneId",
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_route53.CfnRecordSetGroup.GeoLocationProperty",
        jsii_struct_bases=[],
        name_mapping={
            "continent_code": "continentCode",
            "country_code": "countryCode",
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_route53.CfnRecordSetGroup.RecordSetProperty",
        jsii_struct_bases=[],
        name_mapping={
            "name": "name",
            "type": "type",
    ...
    class RecordSetProperty:
        def __init__(
            ...
            *,
            ...
            alias_target: typing.Optional[
                typing.Union[
                    "CfnRecordSetGroup.AliasTargetProperty", _IResolvable_9ceae33e
                ]
            ] = None,
            comment: typing.Optional[str] = None,
            failover: typing.Optional[str] = None,
            geo_location: typing.Optional[
                typing.Union[
                    "CfnRecordSetGroup.GeoLocationProperty", _IResolvable_9ceae33e
                ]
            ] = None,
            health_check_id: typing.Optional[str] = None,
            hosted_zone_id: typing.Optional[str] = None,
        ...
        def alias_target(
            ...
            typing.Union["CfnRecordSetGroup.AliasTargetProperty", _IResolvable_9ceae33e]
        ]:
        ...
        def geo_location(
            ...
            typing.Union["CfnRecordSetGroup.GeoLocationProperty", _IResolvable_9ceae33e]
        ]:
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_route53.CfnRecordSetGroupProps",
    jsii_struct_bases=[],
    name_mapping={
        "comment": "comment",
        "hosted_zone_id": "hostedZoneId",
        ...
        *,
        ...
        record_sets: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        "CfnRecordSetGroup.RecordSetProperty", _IResolvable_9ceae33e
                    ]
                ],
            ]
        ] = None,
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_route53.CfnRecordSetProps",
    jsii_struct_bases=[],
    name_mapping={
        "name": "name",
        "type": "type",
...
class CfnRecordSetProps:
    def __init__(
        ...
        *,
        ...
        type: str,
        alias_target: typing.Optional[
            typing.Union["CfnRecordSet.AliasTargetProperty", _IResolvable_9ceae33e]
        ] = None,
        comment: typing.Optional[str] = None,
        failover: typing.Optional[str] = None,
        geo_location: typing.Optional[
            typing.Union["CfnRecordSet.GeoLocationProperty", _IResolvable_9ceae33e]
        ] = None,
        health_check_id: typing.Optional[str] = None,
        hosted_zone_id: typing.Optional[str] = None,
        hosted_zone_name: typing.Optional[str] = None,
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_route53.CommonHostedZoneProps",
    jsii_struct_bases=[],
    name_mapping={
        "zone_name": "zoneName",
        "comment": "comment",
...
class CommonHostedZoneProps:
    def __init__(
        ...
        *,
        zone_name: str,
        comment: typing.Optional[str] = None,
        query_logs_log_group_arn: typing.Optional[str] = None,
    ) -> None:
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_route53.HostedZoneAttributes",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_route53.HostedZoneProps",
...
class HostedZoneProps(CommonHostedZoneProps):
    def __init__(
        ...
        *,
        ...
        comment: typing.Optional[str] = None,
        query_logs_log_group_arn: typing.Optional[str] = None,
        vpcs: typing.Optional[typing.List[_IVpc_3795853f]] = None,
    ) -> None:
    ...
    @builtins.property
    def vpcs(self) -> typing.Optional[typing.List[_IVpc_3795853f]]:
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_route53.HostedZoneProviderProps",
    jsii_struct_bases=[],
    name_mapping={
...
@jsii.interface(jsii_type="monocdk-experiment.aws_route53.IAliasRecordTarget")
...
class _IAliasRecordTargetProxy:
    ...
    __jsii_type__ = "monocdk-experiment.aws_route53.IAliasRecordTarget"
...
@jsii.interface(jsii_type="monocdk-experiment.aws_route53.IHostedZone")
class IHostedZone(_IResource_72f7ee7e, jsii.compat.Protocol):
...
class _IHostedZoneProxy(jsii.proxy_for(_IResource_72f7ee7e)):
    """Imported or created hosted zone.
    ...
    __jsii_type__ = "monocdk-experiment.aws_route53.IHostedZone"
...
@jsii.interface(jsii_type="monocdk-experiment.aws_route53.IPrivateHostedZone")
...
class _IPrivateHostedZoneProxy(jsii.proxy_for(IHostedZone)):
    ...
    __jsii_type__ = "monocdk-experiment.aws_route53.IPrivateHostedZone"
    pass


@jsii.interface(jsii_type="monocdk-experiment.aws_route53.IPublicHostedZone")
...
class _IPublicHostedZoneProxy(jsii.proxy_for(IHostedZone)):
    ...
    __jsii_type__ = "monocdk-experiment.aws_route53.IPublicHostedZone"
    pass


@jsii.interface(jsii_type="monocdk-experiment.aws_route53.IRecordSet")
class IRecordSet(_IResource_72f7ee7e, jsii.compat.Protocol):
    """A record set.
...
class _IRecordSetProxy(jsii.proxy_for(_IResource_72f7ee7e)):
    """A record set.
    ...
    __jsii_type__ = "monocdk-experiment.aws_route53.IRecordSet"
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_route53.MxRecordValue",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_route53.PrivateHostedZoneProps",
    jsii_struct_bases=[CommonHostedZoneProps],
    name_mapping={
        "zone_name": "zoneName",
        "comment": "comment",
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_route53.PublicHostedZoneProps",
    jsii_struct_bases=[CommonHostedZoneProps],
    name_mapping={
        "zone_name": "zoneName",
        "comment": "comment",
...
class PublicHostedZoneProps(CommonHostedZoneProps):
    def __init__(
        ...
        *,
        ...
        comment: typing.Optional[str] = None,
        query_logs_log_group_arn: typing.Optional[str] = None,
        caa_amazon: typing.Optional[bool] = None,
    ) -> None:
...
class RecordSet(
    _Resource_884d0774,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_route53.RecordSet",
):
    """A record set.
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_route53.RecordSetOptions",
    jsii_struct_bases=[],
    name_mapping={
        "zone": "zone",
        "comment": "comment",
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_route53.RecordSetProps",
...
class RecordTarget(
    metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_route53.RecordTarget"
):
...
@jsii.enum(jsii_type="monocdk-experiment.aws_route53.RecordType")
...
class SrvRecord(
    RecordSet,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_route53.SrvRecord",
):
    """A DNS SRV record.
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_route53.SrvRecordProps",
    jsii_struct_bases=[RecordSetOptions],
    name_mapping={
        "zone": "zone",
        "comment": "comment",
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_route53.SrvRecordValue",
    jsii_struct_bases=[],
    name_mapping={
        "host_name": "hostName",
        "port": "port",
...
class TxtRecord(
    RecordSet,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_route53.TxtRecord",
):
    """A DNS TXT record.
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_route53.TxtRecordProps",
    jsii_struct_bases=[RecordSetOptions],
    name_mapping={
        "zone": "zone",
        "comment": "comment",
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_route53.ZoneDelegationOptions",
    jsii_struct_bases=[],
...
class ZoneDelegationRecord(
    RecordSet,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_route53.ZoneDelegationRecord",
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_route53.ZoneDelegationRecordProps",
    jsii_struct_bases=[RecordSetOptions],
    name_mapping={
        "zone": "zone",
        "comment": "comment",
...
class ARecord(
    RecordSet,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_route53.ARecord",
):
    """A DNS A record.
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_route53.ARecordProps",
    jsii_struct_bases=[RecordSetOptions],
    name_mapping={
        "zone": "zone",
        "comment": "comment",
...
class AaaaRecord(
    RecordSet,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_route53.AaaaRecord",
):
    """A DNS AAAA record.
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_route53.AaaaRecordProps",
    jsii_struct_bases=[RecordSetOptions],
    name_mapping={
        "zone": "zone",
        "comment": "comment",
...
class AddressRecordTarget(
    RecordTarget,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_route53.AddressRecordTarget",
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_route53.CaaAmazonRecordProps",
    jsii_struct_bases=[RecordSetOptions],
    name_mapping={
        "zone": "zone",
        "comment": "comment",
...
class CaaRecord(
    RecordSet,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_route53.CaaRecord",
):
    """A DNS CAA record.
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_route53.CaaRecordProps",
    jsii_struct_bases=[RecordSetOptions],
    name_mapping={
        "zone": "zone",
        "comment": "comment",
...
class CnameRecord(
    RecordSet,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_route53.CnameRecord",
):
    """A DNS CNAME record.
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_route53.CnameRecordProps",
    jsii_struct_bases=[RecordSetOptions],
    name_mapping={
        "zone": "zone",
        "comment": "comment",
...
class HostedZone(
    _Resource_884d0774,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_route53.HostedZone",
):
    ...
    def from_hosted_zone_attributes(
        cls, scope: _Construct_f50a3f53, id: str, *, hosted_zone_id: str, zone_name: str
    ) -> "IHostedZone":
    ...
    def from_hosted_zone_id(
        cls, scope: _Construct_f50a3f53, id: str, hosted_zone_id: str
    ) -> "IHostedZone":
    ...
    def add_vpc(self, vpc: _IVpc_3795853f) -> None:
...
class MxRecord(
    RecordSet,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_route53.MxRecord",
):
    """A DNS MX record.
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_route53.MxRecordProps",
    jsii_struct_bases=[RecordSetOptions],
    name_mapping={
        "zone": "zone",
        "comment": "comment",
...
class PrivateHostedZone(
    HostedZone,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_route53.PrivateHostedZone",
):
    ...
    def from_private_hosted_zone_id(
        cls, scope: _Construct_f50a3f53, id: str, private_hosted_zone_id: str
    ) -> "IPrivateHostedZone":
        ...
        """
        return jsii.sinvoke(
            cls, "fromPrivateHostedZoneId", [scope, id, private_hosted_zone_id]
        )
...
class PublicHostedZone(
    HostedZone,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_route53.PublicHostedZone",
):
    ...
    def from_public_hosted_zone_id(
        cls, scope: _Construct_f50a3f53, id: str, public_hosted_zone_id: str
    ) -> "IPublicHostedZone":
        ...
        """
        return jsii.sinvoke(
            cls, "fromPublicHostedZoneId", [scope, id, public_hosted_zone_id]
        )
    ...
    @jsii.member(jsii_name="addVpc")
    def add_vpc(self, _vpc: _IVpc_3795853f) -> None:
        """Add another VPC to this private hosted zone.
...
class CaaAmazonRecord(
    CaaRecord,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_route53.CaaAmazonRecord",
):
