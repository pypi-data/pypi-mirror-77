...
from ..aws_ses import (
    ReceiptRuleActionConfig as _ReceiptRuleActionConfig_2ed15321,
    IReceiptRule as _IReceiptRule_fc1cf2e3,
    IReceiptRuleAction as _IReceiptRuleAction_cc1b8803,
)
from ..aws_sns import ITopic as _ITopic_ef0ebe0e


@jsii.implements(_IReceiptRuleAction_cc1b8803)
class AddHeader(
    metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_ses_actions.AddHeader"
):
    ...
    def bind(self, _rule: _IReceiptRule_fc1cf2e3) -> _ReceiptRuleActionConfig_2ed15321:
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_ses_actions.AddHeaderProps",
    jsii_struct_bases=[],
...
@jsii.implements(_IReceiptRuleAction_cc1b8803)
class Bounce(
    metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_ses_actions.Bounce"
):
    ...
    def __init__(
        ...
        *,
        ...
        topic: typing.Optional[_ITopic_ef0ebe0e] = None,
    ) -> None:
        """
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_ses_actions.BounceProps",
    jsii_struct_bases=[],
...
class BounceProps:
    ...
    @builtins.property
    def topic(self) -> typing.Optional[_ITopic_ef0ebe0e]:
...
class BounceTemplate(
    ...
    jsii_type="monocdk-experiment.aws_ses_actions.BounceTemplate",
):
    """A bounce template.
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_ses_actions.BounceTemplateProps",
    jsii_struct_bases=[],
    name_mapping={
        "message": "message",
...
@jsii.enum(jsii_type="monocdk-experiment.aws_ses_actions.EmailEncoding")
...
@jsii.implements(_IReceiptRuleAction_cc1b8803)
class Lambda(
    metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_ses_actions.Lambda"
):
    ...
    @jsii.member(jsii_name="bind")
    def bind(self, rule: _IReceiptRule_fc1cf2e3) -> _ReceiptRuleActionConfig_2ed15321:
        """Returns the receipt rule action specification.
...
@jsii.enum(jsii_type="monocdk-experiment.aws_ses_actions.LambdaInvocationType")
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_ses_actions.LambdaProps",
    jsii_struct_bases=[],
    name_mapping={
        "function": "function",
...
class LambdaProps:
    ...
    @builtins.property
    def function(self) -> _IFunction_1c1de0bc:
...
@jsii.implements(_IReceiptRuleAction_cc1b8803)
class S3(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_ses_actions.S3"):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_ses_actions.S3Props",
    jsii_struct_bases=[],
    name_mapping={
        "bucket": "bucket",
        "kms_key": "kmsKey",
...
@jsii.implements(_IReceiptRuleAction_cc1b8803)
class Sns(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_ses_actions.Sns"):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_ses_actions.SnsProps",
    jsii_struct_bases=[],
...
@jsii.implements(_IReceiptRuleAction_cc1b8803)
class Stop(
    metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_ses_actions.Stop"
):
    ...
    def __init__(self, *, topic: typing.Optional[_ITopic_ef0ebe0e] = None) -> None:
        """
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_ses_actions.StopProps",
    jsii_struct_bases=[],
