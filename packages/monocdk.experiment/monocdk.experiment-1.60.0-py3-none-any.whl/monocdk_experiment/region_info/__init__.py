...
class Default(
    metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.region_info.Default"
):
...
class FactName(
    metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.region_info.FactName"
):
...
class RegionInfo(
    metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.region_info.RegionInfo"
):
