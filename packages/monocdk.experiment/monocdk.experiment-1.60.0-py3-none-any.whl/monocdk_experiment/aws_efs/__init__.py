...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"create_acl": "createAcl", "path": "path", "posix_user": "posixUser"},
)
...
class CfnAccessPoint(
    ...
    def __init__(
        ...
        *,
        file_system_id: str,
        access_point_tags: typing.Optional[
            typing.Union[
                _IResolvable_9ceae33e,
                typing.List[
                    typing.Union["AccessPointTagProperty", _IResolvable_9ceae33e]
                ],
            ]
        ] = None,
        client_token: typing.Optional[str] = None,
        posix_user: typing.Optional[
            typing.Union["PosixUserProperty", _IResolvable_9ceae33e]
        ] = None,
        root_directory: typing.Optional[
            typing.Union["RootDirectoryProperty", _IResolvable_9ceae33e]
        ] = None,
    ) -> None:
    ...
    def access_point_tags(
        ...
        typing.Union[
            _IResolvable_9ceae33e,
            typing.List[typing.Union["AccessPointTagProperty", _IResolvable_9ceae33e]],
        ]
    ]:
    ...
    class RootDirectoryProperty:
        def __init__(
            self,
            *,
            creation_info: typing.Optional[
                typing.Union[
                    "CfnAccessPoint.CreationInfoProperty", _IResolvable_9ceae33e
                ]
            ] = None,
            path: typing.Optional[str] = None,
        ) -> None:
        ...
        def creation_info(
            ...
            typing.Union["CfnAccessPoint.CreationInfoProperty", _IResolvable_9ceae33e]
        ]:
        ...
        *,
        ...
        access_point_tags: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        "CfnAccessPoint.AccessPointTagProperty", _IResolvable_9ceae33e
                    ]
                ],
            ]
        ] = None,
        client_token: typing.Optional[str] = None,
        posix_user: typing.Optional[
            typing.Union["CfnAccessPoint.PosixUserProperty", _IResolvable_9ceae33e]
        ] = None,
        root_directory: typing.Optional[
            typing.Union["CfnAccessPoint.RootDirectoryProperty", _IResolvable_9ceae33e]
        ] = None,
    ) -> None:
...
class CfnFileSystem(
    ...
    def __init__(
        ...
        *,
        backup_policy: typing.Optional[
            typing.Union["BackupPolicyProperty", _IResolvable_9ceae33e]
        ] = None,
        encrypted: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]] = None,
        file_system_policy: typing.Any = None,
        file_system_tags: typing.Optional[
            typing.List["ElasticFileSystemTagProperty"]
        ] = None,
        kms_key_id: typing.Optional[str] = None,
        lifecycle_policies: typing.Optional[
            typing.Union[
                _IResolvable_9ceae33e,
                typing.List[
    ...
    def lifecycle_policies(
        ...
        typing.Union[
            _IResolvable_9ceae33e,
            typing.List[typing.Union["LifecyclePolicyProperty", _IResolvable_9ceae33e]],
        ]
    ]:
...
class CfnFileSystemProps:
    def __init__(
        ...
        *,
        backup_policy: typing.Optional[
            typing.Union["CfnFileSystem.BackupPolicyProperty", _IResolvable_9ceae33e]
        ] = None,
        encrypted: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]] = None,
        file_system_policy: typing.Any = None,
        file_system_tags: typing.Optional[
            typing.List["CfnFileSystem.ElasticFileSystemTagProperty"]
        ] = None,
        kms_key_id: typing.Optional[str] = None,
        lifecycle_policies: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        "CfnFileSystem.LifecyclePolicyProperty", _IResolvable_9ceae33e
                    ]
                ],
            ]
        ] = None,
...
class FileSystemAttributes:
    def __init__(
        self, *, file_system_id: str, security_group: _ISecurityGroup_d72ab8e8
    ) -> None:
...
class _IFileSystemProxy(
    jsii.proxy_for(_IConnectable_a587039f), jsii.proxy_for(_IResource_72f7ee7e)
):
    """Interface to implement AWS File Systems.
...
class AccessPoint(
    ...
    def from_access_point_id(
        cls, scope: _Construct_f50a3f53, id: str, access_point_id: str
    ) -> "IAccessPoint":
