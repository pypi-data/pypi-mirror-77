...
class CfnBroker(
    ...
    def __init__(
        ...
        *,
        ...
        users: typing.Union[
            ...
            typing.List[typing.Union["UserProperty", _IResolvable_9ceae33e]],
        ],
        ...
        encryption_options: typing.Optional[
            typing.Union["EncryptionOptionsProperty", _IResolvable_9ceae33e]
        ] = None,
        ldap_metadata: typing.Optional[
            typing.Union["LdapMetadataProperty", _IResolvable_9ceae33e]
        ] = None,
        ldap_server_metadata: typing.Optional[
            typing.Union["LdapServerMetadataProperty", _IResolvable_9ceae33e]
        ] = None,
        logs: typing.Optional[
            typing.Union["LogListProperty", _IResolvable_9ceae33e]
        ] = None,
        maintenance_window_start_time: typing.Optional[
            typing.Union["MaintenanceWindowProperty", _IResolvable_9ceae33e]
        ] = None,
    ...
    class LdapMetadataProperty:
        def __init__(
            self,
            *,
            server_metadata: typing.Union[
                "CfnBroker.ServerMetadataProperty", _IResolvable_9ceae33e
            ],
            inter_broker_creds: typing.Optional[
                typing.Union[
                    _IResolvable_9ceae33e,
                    typing.List[
                        typing.Union[
                            "CfnBroker.InterBrokerCredProperty", _IResolvable_9ceae33e
                        ]
                    ],
                ]
            ] = None,
...
class CfnBrokerProps:
    def __init__(
        ...
        *,
        ...
        users: typing.Union[
            _IResolvable_9ceae33e,
            typing.List[typing.Union["CfnBroker.UserProperty", _IResolvable_9ceae33e]],
        ],
        authentication_strategy: typing.Optional[str] = None,
        configuration: typing.Optional[
            typing.Union["CfnBroker.ConfigurationIdProperty", _IResolvable_9ceae33e]
        ] = None,
        encryption_options: typing.Optional[
            typing.Union["CfnBroker.EncryptionOptionsProperty", _IResolvable_9ceae33e]
        ] = None,
        ldap_metadata: typing.Optional[
            typing.Union["CfnBroker.LdapMetadataProperty", _IResolvable_9ceae33e]
        ] = None,
        ldap_server_metadata: typing.Optional[
            typing.Union["CfnBroker.LdapServerMetadataProperty", _IResolvable_9ceae33e]
        ] = None,
        logs: typing.Optional[
            typing.Union["CfnBroker.LogListProperty", _IResolvable_9ceae33e]
        ] = None,
        maintenance_window_start_time: typing.Optional[
            typing.Union["CfnBroker.MaintenanceWindowProperty", _IResolvable_9ceae33e]
        ] = None,
        security_groups: typing.Optional[typing.List[str]] = None,
        storage_type: typing.Optional[str] = None,
        subnet_ids: typing.Optional[typing.List[str]] = None,
    ...
    def __init__(
        ...
        *,
        ...
        configuration: typing.Union[
            "CfnConfigurationAssociation.ConfigurationIdProperty", _IResolvable_9ceae33e
        ],
    ) -> None:
