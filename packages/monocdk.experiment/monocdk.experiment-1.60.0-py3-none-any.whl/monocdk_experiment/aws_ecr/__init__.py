...
class CfnRepository(
    ...
    jsii_type="monocdk-experiment.aws_ecr.CfnRepository",
):
    ...
    def __init__(
        ...
        *,
        lifecycle_policy: typing.Optional[
            typing.Union["LifecyclePolicyProperty", _IResolvable_9ceae33e]
        ] = None,
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_ecr.CfnRepository.LifecyclePolicyProperty",
        jsii_struct_bases=[],
        name_mapping={
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_ecr.CfnRepositoryProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CfnRepositoryProps:
    def __init__(
        ...
        *,
        lifecycle_policy: typing.Optional[
            typing.Union["CfnRepository.LifecyclePolicyProperty", _IResolvable_9ceae33e]
        ] = None,
        repository_name: typing.Optional[str] = None,
        repository_policy_text: typing.Any = None,
        tags: typing.Optional[typing.List[_CfnTag_b4661f1a]] = None,
...
@jsii.interface(jsii_type="monocdk-experiment.aws_ecr.IRepository")
...
class _IRepositoryProxy(jsii.proxy_for(_IResource_72f7ee7e)):
    ...
    __jsii_type__ = "monocdk-experiment.aws_ecr.IRepository"
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_ecr.LifecycleRule",
    jsii_struct_bases=[],
    name_mapping={
        "description": "description",
...
class LifecycleRule:
    def __init__(
        ...
        *,
        description: typing.Optional[str] = None,
        max_image_age: typing.Optional[_Duration_5170c158] = None,
    ...
    @builtins.property
    def max_image_age(self) -> typing.Optional[_Duration_5170c158]:
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_ecr.OnCloudTrailImagePushedOptions",
...
class OnCloudTrailImagePushedOptions(_OnEventOptions_926fbcf9):
    def __init__(
        self,
        *,
        description: typing.Optional[str] = None,
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_ecr.OnImageScanCompletedOptions",
    jsii_struct_bases=[_OnEventOptions_926fbcf9],
    name_mapping={
        "description": "description",
        "event_pattern": "eventPattern",
...
class OnImageScanCompletedOptions(_OnEventOptions_926fbcf9):
    def __init__(
        self,
        *,
        description: typing.Optional[str] = None,
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_ecr.RepositoryAttributes",
    jsii_struct_bases=[],
    name_mapping={
...
class RepositoryBase(
    ...
    jsii_type="monocdk-experiment.aws_ecr.RepositoryBase",
):
...
class _RepositoryBaseProxy(RepositoryBase, jsii.proxy_for(_Resource_884d0774)):
    @jsii.member(jsii_name="addToResourcePolicy")
    def add_to_resource_policy(
        self, statement: _PolicyStatement_f75dc775
    ) -> _AddToResourcePolicyResult_d2a345d1:
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_ecr.RepositoryProps",
    jsii_struct_bases=[],
    name_mapping={
...
@jsii.enum(jsii_type="monocdk-experiment.aws_ecr.TagStatus")
...
class Repository(
    RepositoryBase,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_ecr.Repository",
):
    ...
    def arn_for_local_repository(
        ...
        """
        return jsii.sinvoke(
            cls, "arnForLocalRepository", [repository_name, scope, account]
        )
