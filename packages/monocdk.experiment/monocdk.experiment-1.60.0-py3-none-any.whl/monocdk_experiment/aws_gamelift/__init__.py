...
class CfnAlias(
    ...
    def __init__(
        ...
        *,
        name: str,
        routing_strategy: typing.Union[
            "RoutingStrategyProperty", _IResolvable_9ceae33e
        ],
    ...
    def routing_strategy(
        self, value: typing.Union["RoutingStrategyProperty", _IResolvable_9ceae33e]
    ) -> None:
...
class CfnAliasProps:
    def __init__(
        ...
        *,
        name: str,
        routing_strategy: typing.Union[
            "CfnAlias.RoutingStrategyProperty", _IResolvable_9ceae33e
        ],
        description: typing.Optional[str] = None,
    ) -> None:
...
class CfnBuild(
    ...
    def __init__(
        ...
        *,
        ...
        storage_location: typing.Optional[
...
class CfnBuildProps:
    def __init__(
        ...
        *,
        ...
        operating_system: typing.Optional[str] = None,
        storage_location: typing.Optional[
            typing.Union["CfnBuild.S3LocationProperty", _IResolvable_9ceae33e]
        ] = None,
        version: typing.Optional[str] = None,
    ) -> None:
...
class CfnFleet(
    ...
    def __init__(
        ...
        *,
        ...
        certificate_configuration: typing.Optional[
            typing.Union["CertificateConfigurationProperty", _IResolvable_9ceae33e]
        ] = None,
        description: typing.Optional[str] = None,
        desired_ec2_instances: typing.Optional[jsii.Number] = None,
        ec2_inbound_permissions: typing.Optional[
            typing.Union[
                _IResolvable_9ceae33e,
                typing.List[
                    typing.Union["IpPermissionProperty", _IResolvable_9ceae33e]
                ],
            ]
        ] = None,
        ...
        resource_creation_limit_policy: typing.Optional[
            typing.Union["ResourceCreationLimitPolicyProperty", _IResolvable_9ceae33e]
        ] = None,
        runtime_configuration: typing.Optional[
            typing.Union["RuntimeConfigurationProperty", _IResolvable_9ceae33e]
        ] = None,
    ...
    def ec2_inbound_permissions(
        ...
        typing.Union[
            _IResolvable_9ceae33e,
            typing.List[typing.Union["IpPermissionProperty", _IResolvable_9ceae33e]],
        ]
    ]:
    ...
    class RuntimeConfigurationProperty:
        def __init__(
            self,
            *,
            game_session_activation_timeout_seconds: typing.Optional[
                jsii.Number
            ] = None,
            max_concurrent_game_session_activations: typing.Optional[
                jsii.Number
            ] = None,
            server_processes: typing.Optional[
                typing.Union[
                    _IResolvable_9ceae33e,
                    typing.List[
                        typing.Union[
                            "CfnFleet.ServerProcessProperty", _IResolvable_9ceae33e
                        ]
                    ],
                ]
            ] = None,
...
class CfnFleetProps:
    def __init__(
        ...
        *,
        ...
        certificate_configuration: typing.Optional[
            typing.Union[
                "CfnFleet.CertificateConfigurationProperty", _IResolvable_9ceae33e
            ]
        ] = None,
        description: typing.Optional[str] = None,
        desired_ec2_instances: typing.Optional[jsii.Number] = None,
        ec2_inbound_permissions: typing.Optional[
            typing.Union[
                _IResolvable_9ceae33e,
                typing.List[
                    typing.Union["CfnFleet.IpPermissionProperty", _IResolvable_9ceae33e]
                ],
            ]
        ] = None,
        fleet_type: typing.Optional[str] = None,
        ...
        resource_creation_limit_policy: typing.Optional[
            typing.Union[
                "CfnFleet.ResourceCreationLimitPolicyProperty", _IResolvable_9ceae33e
            ]
        ] = None,
        runtime_configuration: typing.Optional[
            typing.Union["CfnFleet.RuntimeConfigurationProperty", _IResolvable_9ceae33e]
        ] = None,
        script_id: typing.Optional[str] = None,
        server_launch_parameters: typing.Optional[str] = None,
        server_launch_path: typing.Optional[str] = None,
    ...
    def certificate_configuration(
        ...
        typing.Union["CfnFleet.CertificateConfigurationProperty", _IResolvable_9ceae33e]
    ]:
        """``AWS::GameLift::Fleet.CertificateConfiguration``.
...
class CfnGameSessionQueue(
    ...
    def __init__(
        ...
        *,
        ...
        destinations: typing.Optional[
            typing.Union[
                _IResolvable_9ceae33e,
                typing.List[typing.Union["DestinationProperty", _IResolvable_9ceae33e]],
            ]
        ] = None,
        player_latency_policies: typing.Optional[
            typing.Union[
                _IResolvable_9ceae33e,
                typing.List[
                    typing.Union["PlayerLatencyPolicyProperty", _IResolvable_9ceae33e]
                ],
            ]
        ] = None,
    ...
    class PlayerLatencyPolicyProperty:
        def __init__(
            self,
            *,
            maximum_individual_player_latency_milliseconds: typing.Optional[
                jsii.Number
            ] = None,
        ...
        *,
        ...
        destinations: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        "CfnGameSessionQueue.DestinationProperty", _IResolvable_9ceae33e
                    ]
                ],
            ]
        ] = None,
...
class CfnMatchmakingConfiguration(
    ...
    def __init__(
        ...
        id: str,
        *,
        acceptance_required: typing.Union[bool, _IResolvable_9ceae33e],
        ...
        description: typing.Optional[str] = None,
        game_properties: typing.Optional[
            typing.Union[
                _IResolvable_9ceae33e,
                typing.List[
                    typing.Union["GamePropertyProperty", _IResolvable_9ceae33e]
                ],
            ]
        ] = None,
    ...
    def acceptance_required(self) -> typing.Union[bool, _IResolvable_9ceae33e]:
    ...
    def game_properties(
        ...
        typing.Union[
            _IResolvable_9ceae33e,
            typing.List[typing.Union["GamePropertyProperty", _IResolvable_9ceae33e]],
        ]
    ]:
...
class CfnMatchmakingRuleSet(
    ...
    def __init__(
        self, scope: _Construct_f50a3f53, id: str, *, name: str, rule_set_body: str
    ) -> None:
...
class CfnScript(
    ...
    @storage_location.setter
    def storage_location(
        self, value: typing.Union["S3LocationProperty", _IResolvable_9ceae33e]
    ) -> None:
        jsii.set(self, "storageLocation", value)
...
class CfnScriptProps:
    def __init__(
        self,
        *,
        storage_location: typing.Union[
            "CfnScript.S3LocationProperty", _IResolvable_9ceae33e
        ],
        name: typing.Optional[str] = None,
        version: typing.Optional[str] = None,
    ) -> None:
