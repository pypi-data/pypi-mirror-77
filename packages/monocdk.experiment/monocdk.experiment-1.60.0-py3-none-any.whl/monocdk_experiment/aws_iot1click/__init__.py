...
class CfnDevice(
    ...
    jsii_type="monocdk-experiment.aws_iot1click.CfnDevice",
):
    ...
    def attr_enabled(self) -> _IResolvable_9ceae33e:
        """
        cloudformationAttribute:
    ...
    @enabled.setter
    def enabled(self, value: typing.Union[bool, _IResolvable_9ceae33e]) -> None:
        jsii.set(self, "enabled", value)


@jsii.data_type(
    jsii_type="monocdk-experiment.aws_iot1click.CfnDeviceProps",
    jsii_struct_bases=[],
    name_mapping={"device_id": "deviceId", "enabled": "enabled"},
)
class CfnDeviceProps:
    def __init__(
        self, *, device_id: str, enabled: typing.Union[bool, _IResolvable_9ceae33e]
    ) -> None:
...
class CfnPlacement(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_iot1click.CfnPlacement",
):
    ...
    def __init__(
        ...
        *,
        ...
        placement_name: typing.Optional[str] = None,
    ) -> None:
    ...
    def placement_name(self, value: typing.Optional[str]) -> None:
        jsii.set(self, "placementName", value)


@jsii.data_type(
    jsii_type="monocdk-experiment.aws_iot1click.CfnPlacementProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CfnProject(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_iot1click.CfnProject",
):
    ...
    def __init__(
        ...
        id: str,
        *,
        placement_template: typing.Union[
            "PlacementTemplateProperty", _IResolvable_9ceae33e
        ],
    ...
    def placement_template(
        self,
    ) -> typing.Union["PlacementTemplateProperty", _IResolvable_9ceae33e]:
    ...
    def placement_template(
        self, value: typing.Union["PlacementTemplateProperty", _IResolvable_9ceae33e]
    ) -> None:
    ...
    @project_name.setter
    def project_name(self, value: typing.Optional[str]) -> None:
        jsii.set(self, "projectName", value)

    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_iot1click.CfnProject.DeviceTemplateProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_iot1click.CfnProject.PlacementTemplateProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class PlacementTemplateProperty:
        def __init__(
            ...
            *,
            ...
            device_templates: typing.Optional[
                typing.Union[
                    _IResolvable_9ceae33e,
                    typing.Mapping[
                        str,
                        typing.Union[
                            "CfnProject.DeviceTemplateProperty", _IResolvable_9ceae33e
                        ],
                    ],
                ]
            ] = None,
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_iot1click.CfnProjectProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CfnProjectProps:
    def __init__(
        ...
        *,
        placement_template: typing.Union[
            "CfnProject.PlacementTemplateProperty", _IResolvable_9ceae33e
        ],
        description: typing.Optional[str] = None,
        project_name: typing.Optional[str] = None,
    ) -> None:
    ...
    def placement_template(
        self,
    ) -> typing.Union["CfnProject.PlacementTemplateProperty", _IResolvable_9ceae33e]:
        """``AWS::IoT1Click::Project.PlacementTemplate``.
