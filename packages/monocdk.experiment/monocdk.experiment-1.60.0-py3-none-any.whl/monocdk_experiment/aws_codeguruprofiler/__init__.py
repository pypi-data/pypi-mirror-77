...
class CfnProfilingGroup(
    ...
    def __init__(
        ...
        *,
        ...
        anomaly_detection_notification_configuration: typing.Optional[
            typing.Union[
                _IResolvable_9ceae33e,
                typing.List[typing.Union["ChannelProperty", _IResolvable_9ceae33e]],
            ]
        ] = None,
...
class CfnProfilingGroupProps:
        ...
        *,
        ...
        anomaly_detection_notification_configuration: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        "CfnProfilingGroup.ChannelProperty", _IResolvable_9ceae33e
                    ]
                ],
            ]
        ] = None,
    ...
    def anomaly_detection_notification_configuration(
        ...
        typing.Union[
            _IResolvable_9ceae33e,
            typing.List[
                typing.Union["CfnProfilingGroup.ChannelProperty", _IResolvable_9ceae33e]
            ],
        ]
    ]:
        """``AWS::CodeGuruProfiler::ProfilingGroup.AnomalyDetectionNotificationConfiguration``.
    ...
    def __init__(
        ...
        *,
        ...
        props = ProfilingGroupProps(
            compute_platform=compute_platform, profiling_group_name=profiling_group_name
        )
