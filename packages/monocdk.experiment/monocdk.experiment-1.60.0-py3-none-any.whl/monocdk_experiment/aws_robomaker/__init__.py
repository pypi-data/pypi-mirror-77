...
class CfnFleet(
    ...
    jsii_type="monocdk-experiment.aws_robomaker.CfnFleet",
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_robomaker.CfnFleetProps",
    jsii_struct_bases=[],
    name_mapping={"name": "name", "tags": "tags"},
)
class CfnFleetProps:
    def __init__(
        self, *, name: typing.Optional[str] = None, tags: typing.Any = None
    ) -> None:
...
class CfnRobot(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_robomaker.CfnRobot",
):
    ...
    def __init__(
        ...
        *,
        ...
        fleet: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
        tags: typing.Any = None,
    ) -> None:
    ...
    def greengrass_group_id(self, value: str) -> None:
    ...
    @fleet.setter
    def fleet(self, value: typing.Optional[str]) -> None:
...
class CfnRobotApplication(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_robomaker.CfnRobotApplication",
):
    ...
    def __init__(
        ...
        id: str,
        *,
        robot_software_suite: typing.Union[
            "RobotSoftwareSuiteProperty", _IResolvable_9ceae33e
        ],
        sources: typing.Union[
            _IResolvable_9ceae33e,
            typing.List[typing.Union["SourceConfigProperty", _IResolvable_9ceae33e]],
        ],
        current_revision_id: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
        tags: typing.Any = None,
    ) -> None:
    ...
    def robot_software_suite(
        self,
    ) -> typing.Union["RobotSoftwareSuiteProperty", _IResolvable_9ceae33e]:
    ...
    def robot_software_suite(
        self, value: typing.Union["RobotSoftwareSuiteProperty", _IResolvable_9ceae33e]
    ) -> None:
    ...
    def current_revision_id(self, value: typing.Optional[str]) -> None:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_robomaker.CfnRobotApplication.RobotSoftwareSuiteProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_robomaker.CfnRobotApplication.SourceConfigProperty",
        jsii_struct_bases=[],
        name_mapping={
            "architecture": "architecture",
            "s3_bucket": "s3Bucket",
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_robomaker.CfnRobotApplicationProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CfnRobotApplicationProps:
    def __init__(
        ...
        *,
        robot_software_suite: typing.Union[
            "CfnRobotApplication.RobotSoftwareSuiteProperty", _IResolvable_9ceae33e
        ],
        sources: typing.Union[
            _IResolvable_9ceae33e,
            typing.List[
                typing.Union[
                    "CfnRobotApplication.SourceConfigProperty", _IResolvable_9ceae33e
                ]
            ],
        ],
        current_revision_id: typing.Optional[str] = None,
...
class CfnRobotApplicationVersion(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_robomaker.CfnRobotApplicationVersion",
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_robomaker.CfnRobotApplicationVersionProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CfnRobotApplicationVersionProps:
    def __init__(
        self, *, application: str, current_revision_id: typing.Optional[str] = None
    ) -> None:
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_robomaker.CfnRobotProps",
    jsii_struct_bases=[],
    name_mapping={
        "architecture": "architecture",
...
class CfnSimulationApplication(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_robomaker.CfnSimulationApplication",
):
    ...
    def __init__(
        ...
        id: str,
        *,
        rendering_engine: typing.Union[
            "RenderingEngineProperty", _IResolvable_9ceae33e
        ],
        robot_software_suite: typing.Union[
            "RobotSoftwareSuiteProperty", _IResolvable_9ceae33e
        ],
        simulation_software_suite: typing.Union[
            "SimulationSoftwareSuiteProperty", _IResolvable_9ceae33e
        ],
        sources: typing.Union[
            _IResolvable_9ceae33e,
            typing.List[typing.Union["SourceConfigProperty", _IResolvable_9ceae33e]],
    ...
    def rendering_engine(
        self,
    ) -> typing.Union["RenderingEngineProperty", _IResolvable_9ceae33e]:
    ...
    def rendering_engine(
        self, value: typing.Union["RenderingEngineProperty", _IResolvable_9ceae33e]
    ) -> None:
    ...
    def simulation_software_suite(
        self,
    ) -> typing.Union["SimulationSoftwareSuiteProperty", _IResolvable_9ceae33e]:
    ...
    def simulation_software_suite(
        self,
        value: typing.Union["SimulationSoftwareSuiteProperty", _IResolvable_9ceae33e],
    ) -> None:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_robomaker.CfnSimulationApplication.RenderingEngineProperty",
        jsii_struct_bases=[],
        name_mapping={"name": "name", "version": "version"},
    )
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_robomaker.CfnSimulationApplication.RobotSoftwareSuiteProperty",
        jsii_struct_bases=[],
        name_mapping={"name": "name", "version": "version"},
    )
    class RobotSoftwareSuiteProperty:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_robomaker.CfnSimulationApplication.SimulationSoftwareSuiteProperty",
        jsii_struct_bases=[],
        name_mapping={"name": "name", "version": "version"},
    )
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_robomaker.CfnSimulationApplication.SourceConfigProperty",
        jsii_struct_bases=[],
        name_mapping={
            "architecture": "architecture",
            "s3_bucket": "s3Bucket",
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_robomaker.CfnSimulationApplicationProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CfnSimulationApplicationProps:
    def __init__(
        ...
        *,
        rendering_engine: typing.Union[
            "CfnSimulationApplication.RenderingEngineProperty", _IResolvable_9ceae33e
        ],
        robot_software_suite: typing.Union[
            "CfnSimulationApplication.RobotSoftwareSuiteProperty", _IResolvable_9ceae33e
        ],
        simulation_software_suite: typing.Union[
    ...
    def sources(
        ...
        typing.List[
            typing.Union[
                "CfnSimulationApplication.SourceConfigProperty", _IResolvable_9ceae33e
            ]
        ],
    ]:
        """``AWS::RoboMaker::SimulationApplication.Sources``.
...
class CfnSimulationApplicationVersion(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_robomaker.CfnSimulationApplicationVersion",
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_robomaker.CfnSimulationApplicationVersionProps",
    jsii_struct_bases=[],
    name_mapping={
        "application": "application",
        "current_revision_id": "currentRevisionId",
