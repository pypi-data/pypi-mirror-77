...
class CfnAnalyzer(
    ...
    jsii_type="monocdk-experiment.aws_accessanalyzer.CfnAnalyzer",
):
    ...
    def __init__(
        ...
        *,
        type: str,
        analyzer_name: typing.Optional[str] = None,
        archive_rules: typing.Optional[
            typing.Union[
                _IResolvable_9ceae33e,
                typing.List[typing.Union["ArchiveRuleProperty", _IResolvable_9ceae33e]],
            ]
        ] = None,
    ...
    def analyzer_name(self, value: typing.Optional[str]) -> None:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_accessanalyzer.CfnAnalyzer.ArchiveRuleProperty",
        jsii_struct_bases=[],
        ...
        def __init__(
            ...
            *,
            filter: typing.Union[
                _IResolvable_9ceae33e,
                typing.List[
                    typing.Union["CfnAnalyzer.FilterProperty", _IResolvable_9ceae33e]
                ],
            ],
            rule_name: str,
        ) -> None:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_accessanalyzer.CfnAnalyzer.FilterProperty",
        jsii_struct_bases=[],
        name_mapping={
            "property": "property",
            "contains": "contains",
    ...
    class FilterProperty:
        def __init__(
            ...
            *,
            property: str,
            contains: typing.Optional[typing.List[str]] = None,
            eq: typing.Optional[typing.List[str]] = None,
            exists: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]] = None,
        ...
        @builtins.property
        def exists(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_accessanalyzer.CfnAnalyzerProps",
    jsii_struct_bases=[],
    name_mapping={
        "type": "type",
...
class CfnAnalyzerProps:
        ...
        *,
        ...
        archive_rules: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        "CfnAnalyzer.ArchiveRuleProperty", _IResolvable_9ceae33e
                    ]
                ],
            ]
        ] = None,
    ...
    def archive_rules(
        ...
        typing.Union[
            _IResolvable_9ceae33e,
            typing.List[
                typing.Union["CfnAnalyzer.ArchiveRuleProperty", _IResolvable_9ceae33e]
            ],
        ]
    ]:
        """``AWS::AccessAnalyzer::Analyzer.ArchiveRules``.
