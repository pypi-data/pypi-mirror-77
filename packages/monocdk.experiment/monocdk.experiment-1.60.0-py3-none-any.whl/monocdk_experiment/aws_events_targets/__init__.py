...
class AwsApi(
    metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_events_targets.AwsApi"
):
    ...
    def bind(
        self, rule: _IRule_f3f4a615, id: typing.Optional[str] = None
...
@jsii.implements(_IRuleTarget_41800a77)
class BatchJob(
    metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_events_targets.BatchJob"
):
    ...
    @jsii.member(jsii_name="bind")
    def bind(
        self, rule: _IRule_f3f4a615, _id: typing.Optional[str] = None
    ) -> _RuleTargetConfig_98e52371:
...
class CodeBuildProject(
    ...
    @jsii.member(jsii_name="bind")
    def bind(
        self, _rule: _IRule_f3f4a615, _id: typing.Optional[str] = None
    ) -> _RuleTargetConfig_98e52371:
...
class CodeBuildProjectProps:
    def __init__(
        self, *, event: typing.Optional[_RuleTargetInput_01c951fa] = None
    ) -> None:
...
@jsii.implements(_IRuleTarget_41800a77)
class EcsTask(
    metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_events_targets.EcsTask"
):
...
class SfnStateMachineProps:
    def __init__(
        self, *, input: typing.Optional[_RuleTargetInput_01c951fa] = None
    ) -> None:
...
@jsii.implements(_IRuleTarget_41800a77)
class SnsTopic(
    metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_events_targets.SnsTopic"
):
...
class SnsTopicProps:
    def __init__(
        self, *, message: typing.Optional[_RuleTargetInput_01c951fa] = None
    ) -> None:
...
@jsii.implements(_IRuleTarget_41800a77)
class SqsQueue(
    metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_events_targets.SqsQueue"
):
