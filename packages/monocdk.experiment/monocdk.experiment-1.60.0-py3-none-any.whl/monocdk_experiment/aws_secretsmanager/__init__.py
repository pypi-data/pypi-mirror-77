    ...
    def __init__(
        ...
        *,
        ...
        hosted_rotation_lambda: typing.Optional[
            typing.Union["HostedRotationLambdaProperty", _IResolvable_9ceae33e]
        ] = None,
        rotation_lambda_arn: typing.Optional[str] = None,
        rotation_rules: typing.Optional[
            typing.Union["RotationRulesProperty", _IResolvable_9ceae33e]
        ] = None,
    ) -> None:
...
class CfnRotationScheduleProps:
    def __init__(
        ...
        *,
        ...
        rotation_rules: typing.Optional[
            typing.Union[
                "CfnRotationSchedule.RotationRulesProperty", _IResolvable_9ceae33e
            ]
        ] = None,
    ) -> None:
    ...
    def hosted_rotation_lambda(
        ...
        typing.Union[
            "CfnRotationSchedule.HostedRotationLambdaProperty", _IResolvable_9ceae33e
        ]
    ]:
        """``AWS::SecretsManager::RotationSchedule.HostedRotationLambda``.
    ...
    def rotation_rules(
        ...
        typing.Union["CfnRotationSchedule.RotationRulesProperty", _IResolvable_9ceae33e]
    ]:
        """``AWS::SecretsManager::RotationSchedule.RotationRules``.
    ...
    def __init__(
        ...
        *,
        ...
        generate_secret_string: typing.Optional[
            typing.Union["GenerateSecretStringProperty", _IResolvable_9ceae33e]
        ] = None,
...
class CfnSecretProps:
    def __init__(
        ...
        *,
        ...
        generate_secret_string: typing.Optional[
            typing.Union[
                "CfnSecret.GenerateSecretStringProperty", _IResolvable_9ceae33e
            ]
        ] = None,
        kms_key_id: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
    ...
    def generate_secret_string(
        ...
        typing.Union["CfnSecret.GenerateSecretStringProperty", _IResolvable_9ceae33e]
    ]:
        """``AWS::SecretsManager::Secret.GenerateSecretString``.
...
class SecretAttributes:
    def __init__(
        self, *, secret_arn: str, encryption_key: typing.Optional[_IKey_3336c79d] = None
    ) -> None:
