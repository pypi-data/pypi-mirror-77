...
from ..aws_iam import IRole as _IRole_e69bbae4, IGrantable as _IGrantable_0fcfc53a
...
class Expires(
    metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_s3_deployment.Expires"
):
...
class ISource(jsii.compat.Protocol):
    ...
    def bind(
        self, scope: _Construct_f50a3f53, *, handler_role: _IRole_e69bbae4
    ) -> "SourceConfig":
...
class Source(
    metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_s3_deployment.Source"
):
