...
class CfnQueue(
    ...
    jsii_type="monocdk-experiment.aws_sqs.CfnQueue",
):
    ...
    def __init__(
        ...
        *,
        ...
        fifo_queue: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]] = None,
    ...
    def fifo_queue(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
...
class CfnQueuePolicy(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_sqs.CfnQueuePolicy",
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_sqs.CfnQueuePolicyProps",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_sqs.CfnQueueProps",
    jsii_struct_bases=[],
    name_mapping={
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_sqs.DeadLetterQueue",
    jsii_struct_bases=[],
...
@jsii.interface(jsii_type="monocdk-experiment.aws_sqs.IQueue")
class IQueue(_IResource_72f7ee7e, jsii.compat.Protocol):
    ...
    def encryption_master_key(self) -> typing.Optional[_IKey_3336c79d]:
    ...
    def grant(
        self, grantee: _IGrantable_0fcfc53a, *queue_actions: str
    ) -> _Grant_96af6d2d:
    ...
    def grant_consume_messages(self, grantee: _IGrantable_0fcfc53a) -> _Grant_96af6d2d:
    ...
    def grant_purge(self, grantee: _IGrantable_0fcfc53a) -> _Grant_96af6d2d:
    ...
    def grant_send_messages(self, grantee: _IGrantable_0fcfc53a) -> _Grant_96af6d2d:
...
class _IQueueProxy(jsii.proxy_for(_IResource_72f7ee7e)):
    """Represents an SQS queue.
    ...
    __jsii_type__ = "monocdk-experiment.aws_sqs.IQueue"
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_sqs.QueueAttributes",
    jsii_struct_bases=[],
    name_mapping={
        "queue_arn": "queueArn",
        "key_arn": "keyArn",
...
class QueueBase(
    ...
    jsii_type="monocdk-experiment.aws_sqs.QueueBase",
):
...
class _QueueBaseProxy(QueueBase, jsii.proxy_for(_Resource_884d0774)):
    @builtins.property
    @jsii.member(jsii_name="autoCreatePolicy")
    def _auto_create_policy(self) -> bool:
        """Controls automatic creation of policy objects.
...
@jsii.enum(jsii_type="monocdk-experiment.aws_sqs.QueueEncryption")
...
class QueuePolicy(
    _Resource_884d0774,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_sqs.QueuePolicy",
):
    ...
    def __init__(
        self, scope: _Construct_f50a3f53, id: str, *, queues: typing.List["IQueue"]
    ) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_sqs.QueuePolicyProps",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_sqs.QueueProps",
    jsii_struct_bases=[],
    name_mapping={
        "content_based_deduplication": "contentBasedDeduplication",
...
class QueueProps:
    def __init__(
        ...
        *,
        ...
        data_key_reuse: typing.Optional[_Duration_5170c158] = None,
        dead_letter_queue: typing.Optional["DeadLetterQueue"] = None,
        delivery_delay: typing.Optional[_Duration_5170c158] = None,
        encryption: typing.Optional["QueueEncryption"] = None,
        encryption_master_key: typing.Optional[_IKey_3336c79d] = None,
        fifo: typing.Optional[bool] = None,
        max_message_size_bytes: typing.Optional[jsii.Number] = None,
        queue_name: typing.Optional[str] = None,
        receive_message_wait_time: typing.Optional[_Duration_5170c158] = None,
        retention_period: typing.Optional[_Duration_5170c158] = None,
        visibility_timeout: typing.Optional[_Duration_5170c158] = None,
    ) -> None:
    ...
    @builtins.property
    def data_key_reuse(self) -> typing.Optional[_Duration_5170c158]:
    ...
    @builtins.property
    def delivery_delay(self) -> typing.Optional[_Duration_5170c158]:
    ...
    @builtins.property
    def receive_message_wait_time(self) -> typing.Optional[_Duration_5170c158]:
    ...
    @builtins.property
    def visibility_timeout(self) -> typing.Optional[_Duration_5170c158]:
...
class Queue(
    QueueBase, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_sqs.Queue"
):
    ...
    def from_queue_arn(
        cls, scope: _Construct_f50a3f53, id: str, queue_arn: str
    ) -> "IQueue":
