...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codepipeline.ActionArtifactBounds",
    jsii_struct_bases=[],
    name_mapping={
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codepipeline.ActionBindOptions",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codepipeline.ActionConfig",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codepipeline.ActionProperties",
    jsii_struct_bases=[],
    name_mapping={
...
class Artifact(
    metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_codepipeline.Artifact"
):
...
class ArtifactPath(
    ...
    jsii_type="monocdk-experiment.aws_codepipeline.ArtifactPath",
):
...
class CfnCustomActionType(
    ...
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_codepipeline.CfnCustomActionType",
):
    ...
    def __init__(
        ...
        *,
        category: str,
        input_artifact_details: typing.Union["ArtifactDetailsProperty", _IResolvable_9ceae33e],
        output_artifact_details: typing.Union["ArtifactDetailsProperty", _IResolvable_9ceae33e],
        provider: str,
        version: str,
        configuration_properties: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["ConfigurationPropertiesProperty", _IResolvable_9ceae33e]]]] = None,
        settings: typing.Optional[typing.Union["SettingsProperty", _IResolvable_9ceae33e]] = None,
    ...
    def input_artifact_details(
        self,
    ) -> typing.Union["ArtifactDetailsProperty", _IResolvable_9ceae33e]:
    ...
    def input_artifact_details(
        self, value: typing.Union["ArtifactDetailsProperty", _IResolvable_9ceae33e]
    ) -> None:
    ...
    def configuration_properties(
        self,
    ) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["ConfigurationPropertiesProperty", _IResolvable_9ceae33e]]]]:
    ...
    def configuration_properties(
        self,
        value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["ConfigurationPropertiesProperty", _IResolvable_9ceae33e]]]],
    ) -> None:
    ...
    def settings(
        self,
    ) -> typing.Optional[typing.Union["SettingsProperty", _IResolvable_9ceae33e]]:
    ...
    def settings(
        self,
        value: typing.Optional[typing.Union["SettingsProperty", _IResolvable_9ceae33e]],
    ) -> None:
        jsii.set(self, "settings", value)

    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codepipeline.CfnCustomActionType.ArtifactDetailsProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class ArtifactDetailsProperty:
        def __init__(
            self, *, maximum_count: jsii.Number, minimum_count: jsii.Number
        ) -> None:
            """
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codepipeline.CfnCustomActionType.ConfigurationPropertiesProperty",
        jsii_struct_bases=[],
        name_mapping={
            "key": "key",
            "name": "name",
    ...
    class ConfigurationPropertiesProperty:
        def __init__(
            self,
            *,
            key: typing.Union[bool, _IResolvable_9ceae33e],
            name: str,
            required: typing.Union[bool, _IResolvable_9ceae33e],
            secret: typing.Union[bool, _IResolvable_9ceae33e],
            description: typing.Optional[str] = None,
            queryable: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]] = None,
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codepipeline.CfnCustomActionType.SettingsProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class SettingsProperty:
        def __init__(
            self,
            *,
            entity_url_template: typing.Optional[str] = None,
            execution_url_template: typing.Optional[str] = None,
            revision_url_template: typing.Optional[str] = None,
            third_party_configuration_url: typing.Optional[str] = None,
        ) -> None:
            """
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codepipeline.CfnCustomActionTypeProps",
    jsii_struct_bases=[],
    name_mapping={
        "category": "category",
...
class CfnCustomActionTypeProps:
    def __init__(
        ...
        *,
        category: str,
        input_artifact_details: typing.Union["CfnCustomActionType.ArtifactDetailsProperty", _IResolvable_9ceae33e],
        output_artifact_details: typing.Union["CfnCustomActionType.ArtifactDetailsProperty", _IResolvable_9ceae33e],
        provider: str,
        version: str,
        configuration_properties: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnCustomActionType.ConfigurationPropertiesProperty", _IResolvable_9ceae33e]]]] = None,
        settings: typing.Optional[typing.Union["CfnCustomActionType.SettingsProperty", _IResolvable_9ceae33e]] = None,
        tags: typing.Optional[typing.List[_CfnTag_b4661f1a]] = None,
    ) -> None:
    ...
    def input_artifact_details(
        self,
    ) -> typing.Union["CfnCustomActionType.ArtifactDetailsProperty", _IResolvable_9ceae33e]:
        """``AWS::CodePipeline::CustomActionType.InputArtifactDetails``.
    ...
    def configuration_properties(
        self,
    ) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnCustomActionType.ConfigurationPropertiesProperty", _IResolvable_9ceae33e]]]]:
        """``AWS::CodePipeline::CustomActionType.ConfigurationProperties``.
    ...
    def settings(
        self,
    ) -> typing.Optional[typing.Union["CfnCustomActionType.SettingsProperty", _IResolvable_9ceae33e]]:
        """``AWS::CodePipeline::CustomActionType.Settings``.
...
class CfnPipeline(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_codepipeline.CfnPipeline",
):
    ...
    def __init__(
        ...
        *,
        role_arn: str,
        stages: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["StageDeclarationProperty", _IResolvable_9ceae33e]]],
        artifact_store: typing.Optional[typing.Union["ArtifactStoreProperty", _IResolvable_9ceae33e]] = None,
        artifact_stores: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["ArtifactStoreMapProperty", _IResolvable_9ceae33e]]]] = None,
        disable_inbound_stage_transitions: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["StageTransitionProperty", _IResolvable_9ceae33e]]]] = None,
        name: typing.Optional[str] = None,
        restart_execution_on_update: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]] = None,
        tags: typing.Optional[typing.List[_CfnTag_b4661f1a]] = None,
    ) -> None:
    ...
    def stages(
        self,
    ) -> typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["StageDeclarationProperty", _IResolvable_9ceae33e]]]:
    ...
    def stages(
        self,
        value: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["StageDeclarationProperty", _IResolvable_9ceae33e]]],
    ) -> None:
    ...
    def artifact_store(
        self,
    ) -> typing.Optional[typing.Union["ArtifactStoreProperty", _IResolvable_9ceae33e]]:
    ...
    def artifact_store(
        self,
        value: typing.Optional[typing.Union["ArtifactStoreProperty", _IResolvable_9ceae33e]],
    ) -> None:
    ...
    def artifact_stores(
        self,
    ) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["ArtifactStoreMapProperty", _IResolvable_9ceae33e]]]]:
    ...
    def artifact_stores(
        self,
        value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["ArtifactStoreMapProperty", _IResolvable_9ceae33e]]]],
    ) -> None:
    ...
    def disable_inbound_stage_transitions(
        self,
    ) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["StageTransitionProperty", _IResolvable_9ceae33e]]]]:
    ...
    def disable_inbound_stage_transitions(
        self,
        value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["StageTransitionProperty", _IResolvable_9ceae33e]]]],
    ) -> None:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codepipeline.CfnPipeline.ActionDeclarationProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class ActionDeclarationProperty:
        def __init__(
            self,
            *,
            action_type_id: typing.Union["CfnPipeline.ActionTypeIdProperty", _IResolvable_9ceae33e],
            name: str,
            configuration: typing.Any = None,
            input_artifacts: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnPipeline.InputArtifactProperty", _IResolvable_9ceae33e]]]] = None,
            namespace: typing.Optional[str] = None,
            output_artifacts: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnPipeline.OutputArtifactProperty", _IResolvable_9ceae33e]]]] = None,
            region: typing.Optional[str] = None,
        ...
        def action_type_id(
            self,
        ) -> typing.Union["CfnPipeline.ActionTypeIdProperty", _IResolvable_9ceae33e]:
        ...
        def input_artifacts(
            self,
        ) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnPipeline.InputArtifactProperty", _IResolvable_9ceae33e]]]]:
        ...
        def output_artifacts(
            self,
        ) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnPipeline.OutputArtifactProperty", _IResolvable_9ceae33e]]]]:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codepipeline.CfnPipeline.ActionTypeIdProperty",
        jsii_struct_bases=[],
        name_mapping={
            "category": "category",
            "owner": "owner",
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codepipeline.CfnPipeline.ArtifactStoreMapProperty",
        jsii_struct_bases=[],
    ...
    class ArtifactStoreMapProperty:
        def __init__(
            self,
            *,
            artifact_store: typing.Union["CfnPipeline.ArtifactStoreProperty", _IResolvable_9ceae33e],
            region: str,
        ) -> None:
            """
        ...
        def artifact_store(
            self,
        ) -> typing.Union["CfnPipeline.ArtifactStoreProperty", _IResolvable_9ceae33e]:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codepipeline.CfnPipeline.ArtifactStoreProperty",
        jsii_struct_bases=[],
        name_mapping={
            "location": "location",
            "type": "type",
    ...
    class ArtifactStoreProperty:
        def __init__(
            ...
            *,
            location: str,
            type: str,
            encryption_key: typing.Optional[typing.Union["CfnPipeline.EncryptionKeyProperty", _IResolvable_9ceae33e]] = None,
        ) -> None:
            """
        ...
        def encryption_key(
            self,
        ) -> typing.Optional[typing.Union["CfnPipeline.EncryptionKeyProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codepipeline.CfnPipeline.BlockerDeclarationProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codepipeline.CfnPipeline.EncryptionKeyProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codepipeline.CfnPipeline.InputArtifactProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codepipeline.CfnPipeline.OutputArtifactProperty",
        jsii_struct_bases=[],
        name_mapping={"name": "name"},
    )
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codepipeline.CfnPipeline.StageDeclarationProperty",
        jsii_struct_bases=[],
    ...
    class StageDeclarationProperty:
        def __init__(
            self,
            *,
            actions: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnPipeline.ActionDeclarationProperty", _IResolvable_9ceae33e]]],
            name: str,
            blockers: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnPipeline.BlockerDeclarationProperty", _IResolvable_9ceae33e]]]] = None,
        ) -> None:
            """
        ...
        def actions(
            self,
        ) -> typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnPipeline.ActionDeclarationProperty", _IResolvable_9ceae33e]]]:
        ...
        def blockers(
            self,
        ) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnPipeline.BlockerDeclarationProperty", _IResolvable_9ceae33e]]]]:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codepipeline.CfnPipeline.StageTransitionProperty",
        jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codepipeline.CfnPipelineProps",
    jsii_struct_bases=[],
    name_mapping={
        "role_arn": "roleArn",
        "stages": "stages",
...
class CfnPipelineProps:
    def __init__(
        ...
        *,
        role_arn: str,
        stages: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnPipeline.StageDeclarationProperty", _IResolvable_9ceae33e]]],
        artifact_store: typing.Optional[typing.Union["CfnPipeline.ArtifactStoreProperty", _IResolvable_9ceae33e]] = None,
        artifact_stores: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnPipeline.ArtifactStoreMapProperty", _IResolvable_9ceae33e]]]] = None,
        disable_inbound_stage_transitions: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnPipeline.StageTransitionProperty", _IResolvable_9ceae33e]]]] = None,
        name: typing.Optional[str] = None,
        restart_execution_on_update: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]] = None,
        tags: typing.Optional[typing.List[_CfnTag_b4661f1a]] = None,
    ) -> None:
    ...
    def stages(
        self,
    ) -> typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnPipeline.StageDeclarationProperty", _IResolvable_9ceae33e]]]:
        """``AWS::CodePipeline::Pipeline.Stages``.
    ...
    def artifact_store(
        self,
    ) -> typing.Optional[typing.Union["CfnPipeline.ArtifactStoreProperty", _IResolvable_9ceae33e]]:
        """``AWS::CodePipeline::Pipeline.ArtifactStore``.
    ...
    def artifact_stores(
        self,
    ) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnPipeline.ArtifactStoreMapProperty", _IResolvable_9ceae33e]]]]:
        """``AWS::CodePipeline::Pipeline.ArtifactStores``.
    ...
    def disable_inbound_stage_transitions(
        self,
    ) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnPipeline.StageTransitionProperty", _IResolvable_9ceae33e]]]]:
        """``AWS::CodePipeline::Pipeline.DisableInboundStageTransitions``.
...
class CfnWebhook(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_codepipeline.CfnWebhook",
):
    ...
    def __init__(
        ...
        *,
        authentication: str,
        authentication_configuration: typing.Union["WebhookAuthConfigurationProperty", _IResolvable_9ceae33e],
        filters: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["WebhookFilterRuleProperty", _IResolvable_9ceae33e]]],
        target_action: str,
        target_pipeline: str,
        target_pipeline_version: jsii.Number,
        name: typing.Optional[str] = None,
        register_with_third_party: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]] = None,
    ) -> None:
    ...
    def authentication_configuration(
        self,
    ) -> typing.Union["WebhookAuthConfigurationProperty", _IResolvable_9ceae33e]:
    ...
    def authentication_configuration(
        self,
        value: typing.Union["WebhookAuthConfigurationProperty", _IResolvable_9ceae33e],
    ) -> None:
    ...
    def filters(
        self,
    ) -> typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["WebhookFilterRuleProperty", _IResolvable_9ceae33e]]]:
    ...
    def filters(
        self,
        value: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["WebhookFilterRuleProperty", _IResolvable_9ceae33e]]],
    ) -> None:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codepipeline.CfnWebhook.WebhookAuthConfigurationProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class WebhookAuthConfigurationProperty:
        def __init__(
            self,
            *,
            allowed_ip_range: typing.Optional[str] = None,
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codepipeline.CfnWebhook.WebhookFilterRuleProperty",
        jsii_struct_bases=[],
        name_mapping={"json_path": "jsonPath", "match_equals": "matchEquals"},
    )
    class WebhookFilterRuleProperty:
        def __init__(
            self, *, json_path: str, match_equals: typing.Optional[str] = None
        ) -> None:
            """
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codepipeline.CfnWebhookProps",
    jsii_struct_bases=[],
    name_mapping={
        "authentication": "authentication",
...
class CfnWebhookProps:
    def __init__(
        ...
        *,
        authentication: str,
        authentication_configuration: typing.Union["CfnWebhook.WebhookAuthConfigurationProperty", _IResolvable_9ceae33e],
        filters: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnWebhook.WebhookFilterRuleProperty", _IResolvable_9ceae33e]]],
        target_action: str,
        target_pipeline: str,
        target_pipeline_version: jsii.Number,
        name: typing.Optional[str] = None,
    ...
    def authentication_configuration(
        self,
    ) -> typing.Union["CfnWebhook.WebhookAuthConfigurationProperty", _IResolvable_9ceae33e]:
        """``AWS::CodePipeline::Webhook.AuthenticationConfiguration``.
    ...
    def filters(
        self,
    ) -> typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnWebhook.WebhookFilterRuleProperty", _IResolvable_9ceae33e]]]:
        """``AWS::CodePipeline::Webhook.Filters``.
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codepipeline.CommonActionProps",
    jsii_struct_bases=[],
    name_mapping={
        "action_name": "actionName",
        "run_order": "runOrder",
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codepipeline.CommonAwsActionProps",
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codepipeline.CrossRegionSupport",
    jsii_struct_bases=[],
    name_mapping={"replication_bucket": "replicationBucket", "stack": "stack"},
)
class CrossRegionSupport:
    def __init__(
        self, *, replication_bucket: _IBucket_25bad983, stack: _Stack_05f4505a
    ) -> None:
...
class GlobalVariables(
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_codepipeline.GlobalVariables",
):
...
class Pipeline(
    _Resource_884d0774,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_codepipeline.Pipeline",
):
    ...
    def __init__(
        ...
        id: str,
        *,
        artifact_bucket: typing.Optional[_IBucket_25bad983] = None,
        cross_region_replication_buckets: typing.Optional[typing.Mapping[str, _IBucket_25bad983]] = None,
        pipeline_name: typing.Optional[str] = None,
        restart_execution_on_update: typing.Optional[bool] = None,
        role: typing.Optional[_IRole_e69bbae4] = None,
    ...
    def from_pipeline_arn(
        cls, scope: _Construct_f50a3f53, id: str, pipeline_arn: str
    ) -> "IPipeline":
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codepipeline.PipelineProps",
    jsii_struct_bases=[],
    name_mapping={
...
class PipelineProps:
    ...
    def cross_region_replication_buckets(
        self,
    ) -> typing.Optional[typing.Mapping[str, _IBucket_25bad983]]:
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codepipeline.StagePlacement",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codepipeline.StageProps",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codepipeline.StageOptions",
