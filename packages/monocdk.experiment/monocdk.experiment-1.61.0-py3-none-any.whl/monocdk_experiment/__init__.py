...
class Annotations(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.Annotations"):
...
class Aspects(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.Aspects"):
...
@jsii.interface(jsii_type="monocdk-experiment.ILocalBundling")
...
class _ILocalBundlingProxy:
    ...
    __jsii_type__ = "monocdk-experiment.ILocalBundling"
...
@jsii.data_type(
    jsii_type="monocdk-experiment.ResourceEnvironment",
    jsii_struct_bases=[],
    name_mapping={"account": "account", "region": "region"},
)
...
class Tags(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.Tags"):
...
class TokenComparison(
    metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.TokenComparison"
):
...
class Resource(
    Construct,
    metaclass=jsii.JSIIAbstractClass,
    jsii_type="monocdk-experiment.Resource",
):
