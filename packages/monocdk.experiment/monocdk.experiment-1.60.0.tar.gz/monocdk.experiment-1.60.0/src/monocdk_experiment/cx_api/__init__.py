...
class CloudArtifact(
    metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.cx_api.CloudArtifact"
):
    ...
    def __init__(
        ...
        *,
        ...
        metadata: typing.Optional[
            typing.Mapping[str, typing.List[_MetadataEntry_1c069657]]
        ] = None,
        properties: typing.Optional[
            typing.Union[
                _AwsCloudFormationStackProperties_cbabc075,
                _AssetManifestProperties_8c80271b,
                _TreeArtifactProperties_8af66c6c,
                _NestedCloudAssemblyProperties_2d939e98,
            ]
        ] = None,
    ) -> None:
        """
...
class CloudAssembly(
    metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.cx_api.CloudAssembly"
):
...
class CloudAssemblyBuilder(
    metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.cx_api.CloudAssemblyBuilder"
):
    ...
    def add_missing(
        ...
        *,
        key: str,
        props: typing.Union[
            _AmiContextQuery_f862ae87,
            _AvailabilityZonesContextQuery_9a5bac5f,
            _HostedZoneContextQuery_42616509,
            _SSMParameterContextQuery_f21616f8,
            _VpcContextQuery_65dc9cbf,
            _EndpointServiceAvailabilityZonesContextQuery_ea2c3fa6,
        ],
...
class CloudFormationStackArtifact(
    ...
    def assets(
        ...
        typing.Union[
            _FileAssetMetadataEntry_401d6b3e, _ContainerImageAssetMetadataEntry_d177c3e3
        ]
    ]:
...
class EnvironmentUtils(
    metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.cx_api.EnvironmentUtils"
):
    """
    stability
    :stability: experimental
...
class _IEnvironmentPlaceholderProviderProxy:
    ...
    __jsii_type__ = "monocdk-experiment.cx_api.IEnvironmentPlaceholderProvider"
    ...
    def __init__(
        ...
        *,
        ...
        data: typing.Optional[
            typing.Union[
                str,
                _FileAssetMetadataEntry_401d6b3e,
                _ContainerImageAssetMetadataEntry_d177c3e3,
                typing.List[_Tag_9bdb11cc],
            ]
        ] = None,
...
class SynthesisMessage:
    def __init__(
        self, *, entry: _MetadataEntry_1c069657, id: str, level: "SynthesisMessageLevel"
    ) -> None:
        """
        :param entry: 
        :param id: 
