...
class CfnResolverEndpoint(
    ...
    jsii_type="monocdk-experiment.aws_route53resolver.CfnResolverEndpoint",
):
    ...
    def __init__(
        ...
        *,
        ...
        ip_addresses: typing.Union[
            ...
            typing.List[
                typing.Union["IpAddressRequestProperty", _IResolvable_9ceae33e]
            ],
        ],
    ...
    def ip_addresses(
        ...
        _IResolvable_9ceae33e,
        typing.List[typing.Union["IpAddressRequestProperty", _IResolvable_9ceae33e]],
    ]:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_route53resolver.CfnResolverEndpoint.IpAddressRequestProperty",
        jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_route53resolver.CfnResolverEndpointProps",
    jsii_struct_bases=[],
    name_mapping={
        "direction": "direction",
...
class CfnResolverEndpointProps:
    ...
    def ip_addresses(
        ...
        typing.List[
            typing.Union[
                "CfnResolverEndpoint.IpAddressRequestProperty", _IResolvable_9ceae33e
            ]
        ],
    ]:
        """``AWS::Route53Resolver::ResolverEndpoint.IpAddresses``.
...
class CfnResolverRule(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_route53resolver.CfnResolverRule",
):
    ...
    def __init__(
        ...
        *,
        ...
        tags: typing.Optional[typing.List[_CfnTag_b4661f1a]] = None,
        target_ips: typing.Optional[
            typing.Union[
                _IResolvable_9ceae33e,
                typing.List[
                    typing.Union["TargetAddressProperty", _IResolvable_9ceae33e]
                ],
            ]
        ] = None,
    ) -> None:
    ...
    def target_ips(
        ...
        typing.Union[
            _IResolvable_9ceae33e,
            typing.List[typing.Union["TargetAddressProperty", _IResolvable_9ceae33e]],
        ]
    ]:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_route53resolver.CfnResolverRule.TargetAddressProperty",
        jsii_struct_bases=[],
...
class CfnResolverRuleAssociation(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_route53resolver.CfnResolverRuleAssociation",
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_route53resolver.CfnResolverRuleAssociationProps",
    jsii_struct_bases=[],
    name_mapping={
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_route53resolver.CfnResolverRuleProps",
    jsii_struct_bases=[],
    name_mapping={
        ...
        *,
        ...
        target_ips: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        "CfnResolverRule.TargetAddressProperty", _IResolvable_9ceae33e
                    ]
                ],
            ]
        ] = None,
