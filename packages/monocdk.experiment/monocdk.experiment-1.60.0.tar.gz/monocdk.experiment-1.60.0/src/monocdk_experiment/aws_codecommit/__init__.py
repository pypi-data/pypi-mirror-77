...
class CfnRepository(
    ...
    jsii_type="monocdk-experiment.aws_codecommit.CfnRepository",
):
    ...
    def __init__(
        ...
        *,
        ...
        code: typing.Optional[
            typing.Union["CodeProperty", _IResolvable_9ceae33e]
        ] = None,
        ...
        triggers: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union["RepositoryTriggerProperty", _IResolvable_9ceae33e]
                ],
            ]
        ] = None,
    ) -> None:
    ...
    def code(
        self,
    ) -> typing.Optional[typing.Union["CodeProperty", _IResolvable_9ceae33e]]:
    ...
    def code(
        self,
        value: typing.Optional[typing.Union["CodeProperty", _IResolvable_9ceae33e]],
    ) -> None:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codecommit.CfnRepository.CodeProperty",
        jsii_struct_bases=[],
        name_mapping={"s3": "s3"},
    )
    class CodeProperty:
        def __init__(
            self, *, s3: typing.Union["CfnRepository.S3Property", _IResolvable_9ceae33e]
        ) -> None:
            """
        ...
        @builtins.property
        def s3(self) -> typing.Union["CfnRepository.S3Property", _IResolvable_9ceae33e]:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codecommit.CfnRepository.RepositoryTriggerProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codecommit.CfnRepository.S3Property",
        jsii_struct_bases=[],
        name_mapping={
            "bucket": "bucket",
            "key": "key",
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codecommit.CfnRepositoryProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CfnRepositoryProps:
    def __init__(
        ...
        *,
        repository_name: str,
        code: typing.Optional[
            typing.Union["CfnRepository.CodeProperty", _IResolvable_9ceae33e]
        ] = None,
        repository_description: typing.Optional[str] = None,
        tags: typing.Optional[typing.List[_CfnTag_b4661f1a]] = None,
        triggers: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        "CfnRepository.RepositoryTriggerProperty", _IResolvable_9ceae33e
                    ]
                ],
            ]
        ] = None,
...
@jsii.interface(jsii_type="monocdk-experiment.aws_codecommit.IRepository")
class IRepository(_IResource_72f7ee7e, jsii.compat.Protocol):
    """
    stability
    :stability: experimental
    """
    ...
    def grant_pull(self, grantee: _IGrantable_0fcfc53a) -> _Grant_96af6d2d:
    ...
    def grant_pull_push(self, grantee: _IGrantable_0fcfc53a) -> _Grant_96af6d2d:
...
class _IRepositoryProxy(jsii.proxy_for(_IResource_72f7ee7e)):
    """
    stability
    :stability: experimental
    """

    __jsii_type__ = "monocdk-experiment.aws_codecommit.IRepository"
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codecommit.OnCommitOptions",
...
class OnCommitOptions(_OnEventOptions_926fbcf9):
    def __init__(
        self,
        *,
        description: typing.Optional[str] = None,
...
class ReferenceEvent(
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_codecommit.ReferenceEvent",
):
...
class Repository(
    _Resource_884d0774,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_codecommit.Repository",
):
    ...
    def from_repository_arn(
        cls, scope: _Construct_f50a3f53, id: str, repository_arn: str
    ) -> "IRepository":
    ...
    def from_repository_name(
        cls, scope: _Construct_f50a3f53, id: str, repository_name: str
    ) -> "IRepository":
        """
        :param scope: -
        :param id: -
...
@jsii.enum(jsii_type="monocdk-experiment.aws_codecommit.RepositoryEventTrigger")
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codecommit.RepositoryProps",
    jsii_struct_bases=[],
    name_mapping={"repository_name": "repositoryName", "description": "description"},
)
class RepositoryProps:
    def __init__(
        self, *, repository_name: str, description: typing.Optional[str] = None
    ) -> None:
        """
        :param repository_name: Name of the repository. This property is required for all CodeCommit repositories.
        :param description: A description of the repository. Use the description to identify the purpose of the repository. Default: - No description.
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codecommit.RepositoryTriggerOptions",
    jsii_struct_bases=[],
    name_mapping={
        "branches": "branches",
        "custom_data": "customData",
