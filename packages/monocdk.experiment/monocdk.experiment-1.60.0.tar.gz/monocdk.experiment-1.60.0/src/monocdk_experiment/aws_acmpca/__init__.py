...
class CfnCertificate(
    ...
    jsii_type="monocdk-experiment.aws_acmpca.CfnCertificate",
):
    ...
    def __init__(
        ...
        *,
        ...
        validity: typing.Union["ValidityProperty", _IResolvable_9ceae33e],
        template_arn: typing.Optional[str] = None,
    ) -> None:
    ...
    def certificate_authority_arn(self, value: str) -> None:
    ...
    def signing_algorithm(self, value: str) -> None:
        jsii.set(self, "signingAlgorithm", value)

    @builtins.property
    @jsii.member(jsii_name="validity")
    def validity(self) -> typing.Union["ValidityProperty", _IResolvable_9ceae33e]:
    ...
    @validity.setter
    def validity(
        self, value: typing.Union["ValidityProperty", _IResolvable_9ceae33e]
    ) -> None:
    ...
    @template_arn.setter
    def template_arn(self, value: typing.Optional[str]) -> None:
        jsii.set(self, "templateArn", value)

    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_acmpca.CfnCertificate.ValidityProperty",
        jsii_struct_bases=[],
...
class CfnCertificateAuthority(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_acmpca.CfnCertificateAuthority",
):
    ...
    def __init__(
        ...
        *,
        key_algorithm: str,
        signing_algorithm: str,
        subject: typing.Union["SubjectProperty", _IResolvable_9ceae33e],
        type: str,
        revocation_configuration: typing.Optional[
            typing.Union["RevocationConfigurationProperty", _IResolvable_9ceae33e]
        ] = None,
    ...
    def key_algorithm(self, value: str) -> None:
    ...
    def subject(self) -> typing.Union["SubjectProperty", _IResolvable_9ceae33e]:
    ...
    @subject.setter
    def subject(
        self, value: typing.Union["SubjectProperty", _IResolvable_9ceae33e]
    ) -> None:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_acmpca.CfnCertificateAuthority.CrlConfigurationProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_acmpca.CfnCertificateAuthority.RevocationConfigurationProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_acmpca.CfnCertificateAuthority.SubjectProperty",
        jsii_struct_bases=[],
        name_mapping={
...
class CfnCertificateAuthorityActivation(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_acmpca.CfnCertificateAuthorityActivation",
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_acmpca.CfnCertificateAuthorityActivationProps",
    jsii_struct_bases=[],
    name_mapping={
        "certificate": "certificate",
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_acmpca.CfnCertificateAuthorityProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CfnCertificateAuthorityProps:
    def __init__(
        ...
        *,
        ...
        subject: typing.Union[
            "CfnCertificateAuthority.SubjectProperty", _IResolvable_9ceae33e
        ],
        type: str,
        revocation_configuration: typing.Optional[
            typing.Union[
    ...
    def subject(
        self,
    ) -> typing.Union["CfnCertificateAuthority.SubjectProperty", _IResolvable_9ceae33e]:
        """``AWS::ACMPCA::CertificateAuthority.Subject``.
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_acmpca.CfnCertificateProps",
    jsii_struct_bases=[],
    name_mapping={
        "certificate_authority_arn": "certificateAuthorityArn",
...
class CfnCertificateProps:
    def __init__(
        ...
        *,
        ...
        validity: typing.Union[
            "CfnCertificate.ValidityProperty", _IResolvable_9ceae33e
        ],
        template_arn: typing.Optional[str] = None,
    ) -> None:
    ...
    def validity(
        self,
    ) -> typing.Union["CfnCertificate.ValidityProperty", _IResolvable_9ceae33e]:
        """``AWS::ACMPCA::Certificate.Validity``.
