...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudwatch.AlarmActionConfig",
    jsii_struct_bases=[],
...
class AlarmRule(
    metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudwatch.AlarmRule"
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudwatch.AlarmStatusWidgetProps",
    jsii_struct_bases=[],
    name_mapping={
        "alarms": "alarms",
        "height": "height",
...
class CfnAlarm(
    ...
    jsii_type="monocdk-experiment.aws_cloudwatch.CfnAlarm",
):
        ...
        *,
        ...
        dimensions: typing.Optional[
            typing.Union[
                ...
                typing.List[typing.Union["DimensionProperty", _IResolvable_9ceae33e]],
            ]
        ] = None,
        ...
        metrics: typing.Optional[
            typing.Union[
                _IResolvable_9ceae33e,
                typing.List[
                    typing.Union["MetricDataQueryProperty", _IResolvable_9ceae33e]
                ],
            ]
        ] = None,
    ...
    def metrics(
        ...
        typing.Union[
            _IResolvable_9ceae33e,
            typing.List[typing.Union["MetricDataQueryProperty", _IResolvable_9ceae33e]],
        ]
    ]:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_cloudwatch.CfnAlarm.DimensionProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_cloudwatch.CfnAlarm.MetricDataQueryProperty",
        jsii_struct_bases=[],
        name_mapping={
            "id": "id",
        ...
        def __init__(
            ...
            *,
            ...
            metric_stat: typing.Optional[
                typing.Union["CfnAlarm.MetricStatProperty", _IResolvable_9ceae33e]
            ] = None,
            period: typing.Optional[jsii.Number] = None,
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_cloudwatch.CfnAlarm.MetricProperty",
        jsii_struct_bases=[],
        name_mapping={
            "dimensions": "dimensions",
    ...
    class MetricProperty:
            ...
            *,
            dimensions: typing.Optional[
                typing.Union[
                    ...
                    typing.List[
                        typing.Union[
                            "CfnAlarm.DimensionProperty", _IResolvable_9ceae33e
                        ]
                    ],
                ]
            ] = None,
        ...
        def dimensions(
            ...
            typing.Union[
                _IResolvable_9ceae33e,
                typing.List[
                    typing.Union["CfnAlarm.DimensionProperty", _IResolvable_9ceae33e]
                ],
            ]
        ]:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_cloudwatch.CfnAlarm.MetricStatProperty",
        jsii_struct_bases=[],
        name_mapping={
            "metric": "metric",
            "period": "period",
    ...
    class MetricStatProperty:
        def __init__(
            self,
            *,
            metric: typing.Union["CfnAlarm.MetricProperty", _IResolvable_9ceae33e],
            period: jsii.Number,
            stat: str,
            unit: typing.Optional[str] = None,
        ) -> None:
        ...
        def metric(
            self,
        ) -> typing.Union["CfnAlarm.MetricProperty", _IResolvable_9ceae33e]:
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudwatch.CfnAlarmProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CfnAlarmProps:
        ...
        *,
        ...
        metrics: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        "CfnAlarm.MetricDataQueryProperty", _IResolvable_9ceae33e
                    ]
                ],
            ]
        ] = None,
    ...
    def metrics(
        ...
        typing.Union[
            _IResolvable_9ceae33e,
            typing.List[
                typing.Union["CfnAlarm.MetricDataQueryProperty", _IResolvable_9ceae33e]
            ],
        ]
    ]:
        """``AWS::CloudWatch::Alarm.Metrics``.
...
class CfnAnomalyDetector(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_cloudwatch.CfnAnomalyDetector",
):
    ...
    def configuration(
        self,
    ) -> typing.Optional[typing.Union["ConfigurationProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_cloudwatch.CfnAnomalyDetector.ConfigurationProperty",
        jsii_struct_bases=[],
        name_mapping={
            ...
            *,
            excluded_time_ranges: typing.Optional[
                typing.Union[
                    ...
                    typing.List[
                        typing.Union[
                            "CfnAnomalyDetector.RangeProperty", _IResolvable_9ceae33e
                        ]
                    ],
                ]
            ] = None,
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_cloudwatch.CfnAnomalyDetector.DimensionProperty",
        jsii_struct_bases=[],
        name_mapping={"name": "name", "value": "value"},
    )
    class DimensionProperty:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_cloudwatch.CfnAnomalyDetector.RangeProperty",
        jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudwatch.CfnAnomalyDetectorProps",
    jsii_struct_bases=[],
    name_mapping={
        "metric_name": "metricName",
        "namespace": "namespace",
...
class CfnAnomalyDetectorProps:
    def __init__(
        ...
        *,
        ...
        configuration: typing.Optional[
            typing.Union[
                "CfnAnomalyDetector.ConfigurationProperty", _IResolvable_9ceae33e
            ]
        ] = None,
        dimensions: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        "CfnAnomalyDetector.DimensionProperty", _IResolvable_9ceae33e
                    ]
                ],
            ]
        ] = None,
    ...
    def configuration(
        ...
        typing.Union["CfnAnomalyDetector.ConfigurationProperty", _IResolvable_9ceae33e]
    ]:
        """``AWS::CloudWatch::AnomalyDetector.Configuration``.
...
class CfnCompositeAlarm(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_cloudwatch.CfnCompositeAlarm",
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudwatch.CfnCompositeAlarmProps",
    jsii_struct_bases=[],
    name_mapping={
        "alarm_name": "alarmName",
...
class CfnDashboard(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_cloudwatch.CfnDashboard",
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudwatch.CfnDashboardProps",
    jsii_struct_bases=[],
...
class CfnInsightRule(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_cloudwatch.CfnInsightRule",
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudwatch.CfnInsightRuleProps",
    jsii_struct_bases=[],
    name_mapping={
        "rule_body": "ruleBody",
        "rule_name": "ruleName",
...
class Color(
    metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudwatch.Color"
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudwatch.CommonMetricOptions",
    jsii_struct_bases=[],
    name_mapping={
        "account": "account",
        "color": "color",
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudwatch.CompositeAlarmProps",
    jsii_struct_bases=[],
    name_mapping={
        "alarm_rule": "alarmRule",
        "actions_enabled": "actionsEnabled",
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudwatch.CreateAlarmOptions",
    jsii_struct_bases=[],
    name_mapping={
        "evaluation_periods": "evaluationPeriods",
        "threshold": "threshold",
...
class Dashboard(
    _Resource_884d0774,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_cloudwatch.Dashboard",
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudwatch.DashboardProps",
    jsii_struct_bases=[],
    name_mapping={
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudwatch.Dimension",
    jsii_struct_bases=[],
    name_mapping={"name": "name", "value": "value"},
)
class Dimension:
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudwatch.HorizontalAnnotation",
    jsii_struct_bases=[],
    name_mapping={
        "value": "value",
        "color": "color",
...
@jsii.enum(jsii_type="monocdk-experiment.aws_cloudwatch.LogQueryVisualizationType")
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudwatch.LogQueryWidgetProps",
    jsii_struct_bases=[],
    name_mapping={
...
class MathExpression(
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_cloudwatch.MathExpression",
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudwatch.MathExpressionOptions",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudwatch.MathExpressionProps",
...
@jsii.implements(IMetric)
class Metric(
    metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudwatch.Metric"
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudwatch.MetricAlarmConfig",
    jsii_struct_bases=[],
    name_mapping={
        "metric_name": "metricName",
        "namespace": "namespace",
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudwatch.MetricConfig",
    jsii_struct_bases=[],
    name_mapping={
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudwatch.MetricExpressionConfig",
    jsii_struct_bases=[],
    name_mapping={
        "expression": "expression",
        "period": "period",
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudwatch.MetricGraphConfig",
    jsii_struct_bases=[],
    name_mapping={
        "metric_name": "metricName",
        "namespace": "namespace",
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudwatch.MetricOptions",
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudwatch.MetricProps",
    jsii_struct_bases=[CommonMetricOptions],
    name_mapping={
        "account": "account",
        "color": "color",
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudwatch.MetricRenderingProperties",
    jsii_struct_bases=[],
    name_mapping={
        "period": "period",
        "color": "color",
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudwatch.MetricStatConfig",
    jsii_struct_bases=[],
    name_mapping={
        "metric_name": "metricName",
        "namespace": "namespace",
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudwatch.MetricWidgetProps",
    jsii_struct_bases=[],
    name_mapping={
        "height": "height",
        "region": "region",
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudwatch.SingleValueWidgetProps",
...
@jsii.implements(IWidget)
class Spacer(
    metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudwatch.Spacer"
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudwatch.SpacerProps",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudwatch.TextWidgetProps",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudwatch.YAxisProps",
    jsii_struct_bases=[],
    name_mapping={
        "label": "label",
        "max": "max",
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudwatch.AlarmProps",
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudwatch.AlarmWidgetProps",
    jsii_struct_bases=[MetricWidgetProps],
    name_mapping={
        "height": "height",
        "region": "region",
...
@jsii.implements(IWidget)
class Column(
    metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudwatch.Column"
):
...
class ConcreteWidget(
    ...
    jsii_type="monocdk-experiment.aws_cloudwatch.ConcreteWidget",
):
...
class GraphWidget(
    ConcreteWidget,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_cloudwatch.GraphWidget",
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudwatch.GraphWidgetProps",
    jsii_struct_bases=[MetricWidgetProps],
    name_mapping={
        "height": "height",
        "region": "region",
...
class LogQueryWidget(
    ConcreteWidget,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_cloudwatch.LogQueryWidget",
):
...
class SingleValueWidget(
    ConcreteWidget,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_cloudwatch.SingleValueWidget",
):
...
class TextWidget(
    ConcreteWidget,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_cloudwatch.TextWidget",
):
...
class AlarmBase(
    _Resource_884d0774,
    metaclass=jsii.JSIIAbstractClass,
    jsii_type="monocdk-experiment.aws_cloudwatch.AlarmBase",
):
...
class AlarmStatusWidget(
    ConcreteWidget,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_cloudwatch.AlarmStatusWidget",
):
...
class AlarmWidget(
    ConcreteWidget,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_cloudwatch.AlarmWidget",
):
...
class CompositeAlarm(
    AlarmBase,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_cloudwatch.CompositeAlarm",
):
    ...
    def from_composite_alarm_arn(
        cls, scope: _Construct_f50a3f53, id: str, composite_alarm_arn: str
    ) -> "IAlarm":
    ...
    def from_composite_alarm_name(
        cls, scope: _Construct_f50a3f53, id: str, composite_alarm_name: str
    ) -> "IAlarm":
...
class Alarm(
    AlarmBase,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_cloudwatch.Alarm",
):
    ...
    @builtins.classmethod
    def from_alarm_arn(
        cls, scope: _Construct_f50a3f53, id: str, alarm_arn: str
    ) -> "IAlarm":
