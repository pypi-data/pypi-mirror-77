...
class CfnGraph(
    ...
    jsii_type="monocdk-experiment.aws_detective.CfnGraph",
):
...
class CfnMemberInvitation(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_detective.CfnMemberInvitation",
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_detective.CfnMemberInvitationProps",
    jsii_struct_bases=[],
    name_mapping={
        "graph_arn": "graphArn",
