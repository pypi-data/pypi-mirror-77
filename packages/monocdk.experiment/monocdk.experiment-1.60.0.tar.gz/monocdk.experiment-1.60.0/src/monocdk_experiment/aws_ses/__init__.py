...
class CfnConfigurationSet(
    ...
    jsii_type="monocdk-experiment.aws_ses.CfnConfigurationSet",
):
    ...
    def __init__(
        self, scope: _Construct_f50a3f53, id: str, *, name: typing.Optional[str] = None
    ) -> None:
...
class CfnConfigurationSetEventDestination(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_ses.CfnConfigurationSetEventDestination",
):
    ...
    def __init__(
        ...
        *,
        ...
        event_destination: typing.Union[
            "EventDestinationProperty", _IResolvable_9ceae33e
        ],
    ) -> None:
    ...
    def event_destination(
        self,
    ) -> typing.Union["EventDestinationProperty", _IResolvable_9ceae33e]:
    ...
    def event_destination(
        self, value: typing.Union["EventDestinationProperty", _IResolvable_9ceae33e]
    ) -> None:
        jsii.set(self, "eventDestination", value)

    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_ses.CfnConfigurationSetEventDestination.CloudWatchDestinationProperty",
        jsii_struct_bases=[],
    ...
    class CloudWatchDestinationProperty:
        def __init__(
            self,
            *,
            dimension_configurations: typing.Optional[
                typing.Union[
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_ses.CfnConfigurationSetEventDestination.DimensionConfigurationProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_ses.CfnConfigurationSetEventDestination.EventDestinationProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class EventDestinationProperty:
        def __init__(
            ...
            *,
            ...
            cloud_watch_destination: typing.Optional[
                typing.Union[
            ...
            kinesis_firehose_destination: typing.Optional[
                typing.Union[
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_ses.CfnConfigurationSetEventDestination.KinesisFirehoseDestinationProperty",
        jsii_struct_bases=[],
        name_mapping={
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_ses.CfnConfigurationSetEventDestinationProps",
    jsii_struct_bases=[],
    name_mapping={
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_ses.CfnConfigurationSetProps",
    jsii_struct_bases=[],
...
class CfnReceiptFilter(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_ses.CfnReceiptFilter",
):
    ...
    def __init__(
        ...
        id: str,
        *,
        filter: typing.Union["FilterProperty", _IResolvable_9ceae33e],
    ) -> None:
    ...
    def filter(self) -> typing.Union["FilterProperty", _IResolvable_9ceae33e]:
    ...
    @filter.setter
    def filter(
        self, value: typing.Union["FilterProperty", _IResolvable_9ceae33e]
    ) -> None:
        jsii.set(self, "filter", value)

    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_ses.CfnReceiptFilter.FilterProperty",
        jsii_struct_bases=[],
    ...
    class FilterProperty:
        def __init__(
            ...
            *,
            ip_filter: typing.Union[
                "CfnReceiptFilter.IpFilterProperty", _IResolvable_9ceae33e
            ],
            name: typing.Optional[str] = None,
        ) -> None:
            """
        ...
        def ip_filter(
            self,
        ) -> typing.Union["CfnReceiptFilter.IpFilterProperty", _IResolvable_9ceae33e]:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_ses.CfnReceiptFilter.IpFilterProperty",
        jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_ses.CfnReceiptFilterProps",
    jsii_struct_bases=[],
...
class CfnReceiptFilterProps:
    def __init__(
        self,
        *,
        filter: typing.Union["CfnReceiptFilter.FilterProperty", _IResolvable_9ceae33e],
    ) -> None:
    ...
    def filter(
        self,
    ) -> typing.Union["CfnReceiptFilter.FilterProperty", _IResolvable_9ceae33e]:
        """``AWS::SES::ReceiptFilter.Filter``.
...
class CfnReceiptRule(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_ses.CfnReceiptRule",
):
    ...
    def __init__(
        ...
        id: str,
        *,
        rule: typing.Union["RuleProperty", _IResolvable_9ceae33e],
        rule_set_name: str,
    ...
    def rule(self) -> typing.Union["RuleProperty", _IResolvable_9ceae33e]:
    ...
    @rule.setter
    def rule(self, value: typing.Union["RuleProperty", _IResolvable_9ceae33e]) -> None:
    ...
    @after.setter
    def after(self, value: typing.Optional[str]) -> None:
        jsii.set(self, "after", value)

    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_ses.CfnReceiptRule.ActionProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class ActionProperty:
        def __init__(
            self,
            *,
            add_header_action: typing.Optional[
                typing.Union[
                    "CfnReceiptRule.AddHeaderActionProperty", _IResolvable_9ceae33e
                ]
            ] = None,
            bounce_action: typing.Optional[
                typing.Union[
                    "CfnReceiptRule.BounceActionProperty", _IResolvable_9ceae33e
                ]
            ] = None,
            lambda_action: typing.Optional[
                typing.Union[
                    "CfnReceiptRule.LambdaActionProperty", _IResolvable_9ceae33e
                ]
            ] = None,
            s3_action: typing.Optional[
                typing.Union["CfnReceiptRule.S3ActionProperty", _IResolvable_9ceae33e]
            ] = None,
            sns_action: typing.Optional[
                typing.Union["CfnReceiptRule.SNSActionProperty", _IResolvable_9ceae33e]
            ] = None,
            stop_action: typing.Optional[
                typing.Union["CfnReceiptRule.StopActionProperty", _IResolvable_9ceae33e]
            ] = None,
            workmail_action: typing.Optional[
                typing.Union[
                    "CfnReceiptRule.WorkmailActionProperty", _IResolvable_9ceae33e
                ]
            ] = None,
        ) -> None:
            """
        ...
        def bounce_action(
            ...
            typing.Union["CfnReceiptRule.BounceActionProperty", _IResolvable_9ceae33e]
        ]:
        ...
        def lambda_action(
            ...
            typing.Union["CfnReceiptRule.LambdaActionProperty", _IResolvable_9ceae33e]
        ]:
        ...
        def workmail_action(
            ...
            typing.Union["CfnReceiptRule.WorkmailActionProperty", _IResolvable_9ceae33e]
        ]:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_ses.CfnReceiptRule.AddHeaderActionProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_ses.CfnReceiptRule.BounceActionProperty",
        jsii_struct_bases=[],
        name_mapping={
            "message": "message",
            "sender": "sender",
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_ses.CfnReceiptRule.LambdaActionProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class LambdaActionProperty:
        def __init__(
            ...
            *,
            function_arn: str,
            invocation_type: typing.Optional[str] = None,
            topic_arn: typing.Optional[str] = None,
        ) -> None:
            """
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_ses.CfnReceiptRule.RuleProperty",
        jsii_struct_bases=[],
        name_mapping={
            "actions": "actions",
            "enabled": "enabled",
    ...
    class RuleProperty:
            ...
            *,
            actions: typing.Optional[
                typing.Union[
                    ...
                    typing.List[
                        typing.Union[
                            "CfnReceiptRule.ActionProperty", _IResolvable_9ceae33e
                        ]
                    ],
                ]
            ] = None,
            ...
            scan_enabled: typing.Optional[
                typing.Union[bool, _IResolvable_9ceae33e]
            ] = None,
            tls_policy: typing.Optional[str] = None,
        ) -> None:
            """
        ...
        def actions(
            ...
            typing.Union[
                _IResolvable_9ceae33e,
                typing.List[
                    typing.Union["CfnReceiptRule.ActionProperty", _IResolvable_9ceae33e]
                ],
            ]
        ]:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_ses.CfnReceiptRule.S3ActionProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class S3ActionProperty:
        def __init__(
            ...
            *,
            ...
            object_key_prefix: typing.Optional[str] = None,
            topic_arn: typing.Optional[str] = None,
        ) -> None:
            """
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_ses.CfnReceiptRule.SNSActionProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_ses.CfnReceiptRule.StopActionProperty",
        jsii_struct_bases=[],
        name_mapping={"scope": "scope", "topic_arn": "topicArn"},
    )
    class StopActionProperty:
        def __init__(
            self, *, scope: str, topic_arn: typing.Optional[str] = None
        ) -> None:
            """
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_ses.CfnReceiptRule.WorkmailActionProperty",
        jsii_struct_bases=[],
        name_mapping={"organization_arn": "organizationArn", "topic_arn": "topicArn"},
    )
    class WorkmailActionProperty:
        def __init__(
            self, *, organization_arn: str, topic_arn: typing.Optional[str] = None
        ) -> None:
            """
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_ses.CfnReceiptRuleProps",
    jsii_struct_bases=[],
...
class CfnReceiptRuleProps:
    def __init__(
        self,
        *,
        rule: typing.Union["CfnReceiptRule.RuleProperty", _IResolvable_9ceae33e],
        rule_set_name: str,
        after: typing.Optional[str] = None,
    ) -> None:
    ...
    def rule(
        self,
    ) -> typing.Union["CfnReceiptRule.RuleProperty", _IResolvable_9ceae33e]:
        """``AWS::SES::ReceiptRule.Rule``.
...
class CfnReceiptRuleSet(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_ses.CfnReceiptRuleSet",
):
    ...
    def __init__(
        ...
        id: str,
        *,
        rule_set_name: typing.Optional[str] = None,
    ) -> None:
    ...
    @rule_set_name.setter
    def rule_set_name(self, value: typing.Optional[str]) -> None:
        jsii.set(self, "ruleSetName", value)


@jsii.data_type(
    jsii_type="monocdk-experiment.aws_ses.CfnReceiptRuleSetProps",
    jsii_struct_bases=[],
...
class CfnTemplate(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_ses.CfnTemplate",
):
    ...
    def __init__(
        ...
        *,
        template: typing.Optional[
            typing.Union["TemplateProperty", _IResolvable_9ceae33e]
        ] = None,
    ) -> None:
    ...
    def template(
        self,
    ) -> typing.Optional[typing.Union["TemplateProperty", _IResolvable_9ceae33e]]:
    ...
    def template(
        self,
        value: typing.Optional[typing.Union["TemplateProperty", _IResolvable_9ceae33e]],
    ) -> None:
        jsii.set(self, "template", value)

    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_ses.CfnTemplate.TemplateProperty",
        jsii_struct_bases=[],
        name_mapping={
            "html_part": "htmlPart",
    ...
    class TemplateProperty:
        def __init__(
            ...
            *,
            ...
            subject_part: typing.Optional[str] = None,
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_ses.CfnTemplateProps",
    jsii_struct_bases=[],
...
class CfnTemplateProps:
    def __init__(
        ...
        *,
        template: typing.Optional[
            typing.Union["CfnTemplate.TemplateProperty", _IResolvable_9ceae33e]
        ] = None,
    ) -> None:
...
class DropSpamReceiptRule(
    _Construct_f50a3f53,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_ses.DropSpamReceiptRule",
):
    ...
    def __init__(
        ...
        *,
        ...
        receipt_rule_name: typing.Optional[str] = None,
        recipients: typing.Optional[typing.List[str]] = None,
        scan_enabled: typing.Optional[bool] = None,
...
@jsii.interface(jsii_type="monocdk-experiment.aws_ses.IReceiptRule")
class IReceiptRule(_IResource_72f7ee7e, jsii.compat.Protocol):
    """A receipt rule.
...
class _IReceiptRuleProxy(jsii.proxy_for(_IResource_72f7ee7e)):
    """A receipt rule.
    ...
    __jsii_type__ = "monocdk-experiment.aws_ses.IReceiptRule"
...
@jsii.interface(jsii_type="monocdk-experiment.aws_ses.IReceiptRuleAction")
...
class _IReceiptRuleActionProxy:
    ...
    __jsii_type__ = "monocdk-experiment.aws_ses.IReceiptRuleAction"
...
@jsii.interface(jsii_type="monocdk-experiment.aws_ses.IReceiptRuleSet")
class IReceiptRuleSet(_IResource_72f7ee7e, jsii.compat.Protocol):
    """A receipt rule set.
...
class _IReceiptRuleSetProxy(jsii.proxy_for(_IResource_72f7ee7e)):
    """A receipt rule set.
    ...
    __jsii_type__ = "monocdk-experiment.aws_ses.IReceiptRuleSet"
...
class ReceiptFilter(
    _Resource_884d0774,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_ses.ReceiptFilter",
):
    """A receipt filter.
    ...
    def __init__(
        ...
        *,
        ...
        receipt_filter_name: typing.Optional[str] = None,
    ) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.enum(jsii_type="monocdk-experiment.aws_ses.ReceiptFilterPolicy")
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_ses.ReceiptFilterProps",
    jsii_struct_bases=[],
    name_mapping={
        "ip": "ip",
        "policy": "policy",
...
class ReceiptRule(
    _Resource_884d0774,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_ses.ReceiptRule",
):
    """A new receipt rule.
    ...
    def from_receipt_rule_name(
        cls, scope: _Construct_f50a3f53, id: str, receipt_rule_name: str
    ) -> "IReceiptRule":
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_ses.ReceiptRuleActionConfig",
    jsii_struct_bases=[],
    name_mapping={
        "add_header_action": "addHeaderAction",
        "bounce_action": "bounceAction",
...
class ReceiptRuleActionConfig:
    def __init__(
        ...
        *,
        ...
        if isinstance(add_header_action, dict):
            add_header_action = CfnReceiptRule.AddHeaderActionProperty(
                **add_header_action
            )
    ...
    def workmail_action(
        self,
    ) -> typing.Optional["CfnReceiptRule.WorkmailActionProperty"]:
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_ses.ReceiptRuleOptions",
    jsii_struct_bases=[],
    name_mapping={
        "actions": "actions",
        "after": "after",
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_ses.ReceiptRuleProps",
...
class ReceiptRuleSet(
    _Resource_884d0774,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_ses.ReceiptRuleSet",
):
    ...
    def __init__(
        ...
        id: str,
        *,
        drop_spam: typing.Optional[bool] = None,
        receipt_rule_set_name: typing.Optional[str] = None,
    ...
    def from_receipt_rule_set_name(
        cls, scope: _Construct_f50a3f53, id: str, receipt_rule_set_name: str
    ) -> "IReceiptRuleSet":
        ...
        """
        return jsii.sinvoke(
            cls, "fromReceiptRuleSetName", [scope, id, receipt_rule_set_name]
        )
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_ses.ReceiptRuleSetProps",
    jsii_struct_bases=[],
    name_mapping={
        "drop_spam": "dropSpam",
...
@jsii.enum(jsii_type="monocdk-experiment.aws_ses.TlsPolicy")
...
class WhiteListReceiptFilter(
    _Construct_f50a3f53,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_ses.WhiteListReceiptFilter",
):
    ...
    def __init__(
        self, scope: _Construct_f50a3f53, id: str, *, ips: typing.List[str]
    ) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_ses.WhiteListReceiptFilterProps",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_ses.DropSpamReceiptRuleProps",
