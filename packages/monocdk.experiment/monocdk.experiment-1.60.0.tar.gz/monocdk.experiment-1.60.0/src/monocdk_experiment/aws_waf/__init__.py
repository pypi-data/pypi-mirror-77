...
class CfnByteMatchSet(
    ...
    jsii_type="monocdk-experiment.aws_waf.CfnByteMatchSet",
):
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_waf.CfnByteMatchSet.ByteMatchTupleProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_waf.CfnByteMatchSet.FieldToMatchProperty",
        jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_waf.CfnByteMatchSetProps",
    jsii_struct_bases=[],
...
class CfnIPSet(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_waf.CfnIPSet",
):
    ...
    @jsii.interface(
        jsii_type="monocdk-experiment.aws_waf.CfnIPSet.IPSetDescriptorProperty"
    )
    ...
    class _IPSetDescriptorPropertyProxy:
        ...
        __jsii_type__ = "monocdk-experiment.aws_waf.CfnIPSet.IPSetDescriptorProperty"
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_waf.CfnIPSetProps",
    jsii_struct_bases=[],
...
class CfnRule(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_waf.CfnRule",
):
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_waf.CfnRule.PredicateProperty",
        jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_waf.CfnRuleProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CfnSizeConstraintSet(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_waf.CfnSizeConstraintSet",
):
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_waf.CfnSizeConstraintSet.FieldToMatchProperty",
        jsii_struct_bases=[],
        name_mapping={"type": "type", "data": "data"},
    )
    class FieldToMatchProperty:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_waf.CfnSizeConstraintSet.SizeConstraintProperty",
        jsii_struct_bases=[],
        name_mapping={
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_waf.CfnSizeConstraintSetProps",
    jsii_struct_bases=[],
...
class CfnSqlInjectionMatchSet(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_waf.CfnSqlInjectionMatchSet",
):
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_waf.CfnSqlInjectionMatchSet.FieldToMatchProperty",
        jsii_struct_bases=[],
        name_mapping={"type": "type", "data": "data"},
    )
    class FieldToMatchProperty:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_waf.CfnSqlInjectionMatchSet.SqlInjectionMatchTupleProperty",
        jsii_struct_bases=[],
        name_mapping={
            "field_to_match": "fieldToMatch",
            "text_transformation": "textTransformation",
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_waf.CfnSqlInjectionMatchSetProps",
    jsii_struct_bases=[],
    name_mapping={
        "name": "name",
...
class CfnWebACL(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_waf.CfnWebACL",
):
    ...
    def __init__(
        ...
        id: str,
        *,
        default_action: typing.Union["WafActionProperty", _IResolvable_9ceae33e],
        metric_name: str,
        name: str,
        rules: typing.Optional[
            typing.Union[
                _IResolvable_9ceae33e,
                typing.List[
                    typing.Union["ActivatedRuleProperty", _IResolvable_9ceae33e]
                ],
            ]
        ] = None,
    ) -> None:
    ...
    def default_action(
        self,
    ) -> typing.Union["WafActionProperty", _IResolvable_9ceae33e]:
    ...
    def default_action(
        self, value: typing.Union["WafActionProperty", _IResolvable_9ceae33e]
    ) -> None:
    ...
    def rules(
        ...
        typing.Union[
            _IResolvable_9ceae33e,
            typing.List[typing.Union["ActivatedRuleProperty", _IResolvable_9ceae33e]],
        ]
    ]:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_waf.CfnWebACL.ActivatedRuleProperty",
        jsii_struct_bases=[],
        ...
        def __init__(
            ...
            *,
            ...
            action: typing.Optional[
                typing.Union["CfnWebACL.WafActionProperty", _IResolvable_9ceae33e]
            ] = None,
        ) -> None:
            """
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_waf.CfnWebACL.WafActionProperty",
        jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_waf.CfnWebACLProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CfnWebACLProps:
    def __init__(
        ...
        *,
        default_action: typing.Union[
            "CfnWebACL.WafActionProperty", _IResolvable_9ceae33e
        ],
        metric_name: str,
        name: str,
        rules: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        "CfnWebACL.ActivatedRuleProperty", _IResolvable_9ceae33e
                    ]
                ],
            ]
        ] = None,
    ...
    def rules(
        ...
        typing.Union[
            _IResolvable_9ceae33e,
            typing.List[
                typing.Union["CfnWebACL.ActivatedRuleProperty", _IResolvable_9ceae33e]
            ],
        ]
    ]:
        """``AWS::WAF::WebACL.Rules``.
...
class CfnXssMatchSet(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_waf.CfnXssMatchSet",
):
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_waf.CfnXssMatchSet.FieldToMatchProperty",
        jsii_struct_bases=[],
        name_mapping={"type": "type", "data": "data"},
    )
    class FieldToMatchProperty:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_waf.CfnXssMatchSet.XssMatchTupleProperty",
        jsii_struct_bases=[],
        name_mapping={
            "field_to_match": "fieldToMatch",
            "text_transformation": "textTransformation",
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_waf.CfnXssMatchSetProps",
    jsii_struct_bases=[],
...
class CfnXssMatchSetProps:
    ...
    def xss_match_tuples(
        ...
        _IResolvable_9ceae33e,
        typing.List[
            typing.Union["CfnXssMatchSet.XssMatchTupleProperty", _IResolvable_9ceae33e]
        ],
    ]:
        """``AWS::WAF::XssMatchSet.XssMatchTuples``.
