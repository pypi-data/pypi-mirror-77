...
class CfnAssessmentTarget(
    ...
    jsii_type="monocdk-experiment.aws_inspector.CfnAssessmentTarget",
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_inspector.CfnAssessmentTargetProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CfnAssessmentTemplate(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_inspector.CfnAssessmentTemplate",
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_inspector.CfnAssessmentTemplateProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CfnResourceGroup(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_inspector.CfnResourceGroup",
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_inspector.CfnResourceGroupProps",
    jsii_struct_bases=[],
