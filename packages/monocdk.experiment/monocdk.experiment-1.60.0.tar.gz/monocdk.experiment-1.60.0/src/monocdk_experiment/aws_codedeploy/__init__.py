...
from ..aws_lambda import Alias as _Alias_67f7db75, IFunction as _IFunction_1c1de0bc


@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codedeploy.AutoRollbackConfig",
    jsii_struct_bases=[],
    name_mapping={
...
class AutoRollbackConfig:
    def __init__(
        self,
        *,
        deployment_in_alarm: typing.Optional[bool] = None,
        failed_deployment: typing.Optional[bool] = None,
        stopped_deployment: typing.Optional[bool] = None,
    ) -> None:
...
class CfnApplication(
    ...
    jsii_type="monocdk-experiment.aws_codedeploy.CfnApplication",
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codedeploy.CfnApplicationProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CfnDeploymentConfig(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_codedeploy.CfnDeploymentConfig",
):
    ...
    def __init__(
        ...
        *,
        ...
        minimum_healthy_hosts: typing.Optional[
            typing.Union["MinimumHealthyHostsProperty", _IResolvable_9ceae33e]
        ] = None,
    ) -> None:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codedeploy.CfnDeploymentConfig.MinimumHealthyHostsProperty",
        jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codedeploy.CfnDeploymentConfigProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CfnDeploymentConfigProps:
    def __init__(
        ...
        *,
        ...
        minimum_healthy_hosts: typing.Optional[
            typing.Union[
                "CfnDeploymentConfig.MinimumHealthyHostsProperty", _IResolvable_9ceae33e
            ]
        ] = None,
    ) -> None:
...
class CfnDeploymentGroup(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_codedeploy.CfnDeploymentGroup",
):
    ...
    def __init__(
        ...
        *,
        ...
        alarm_configuration: typing.Optional[
            typing.Union["AlarmConfigurationProperty", _IResolvable_9ceae33e]
        ] = None,
        auto_rollback_configuration: typing.Optional[
            typing.Union["AutoRollbackConfigurationProperty", _IResolvable_9ceae33e]
        ] = None,
        auto_scaling_groups: typing.Optional[typing.List[str]] = None,
        deployment: typing.Optional[
            typing.Union["DeploymentProperty", _IResolvable_9ceae33e]
        ] = None,
        deployment_config_name: typing.Optional[str] = None,
        deployment_group_name: typing.Optional[str] = None,
        deployment_style: typing.Optional[
            typing.Union["DeploymentStyleProperty", _IResolvable_9ceae33e]
        ] = None,
        ec2_tag_filters: typing.Optional[
            typing.Union[
                _IResolvable_9ceae33e,
                typing.List[
                    typing.Union["EC2TagFilterProperty", _IResolvable_9ceae33e]
                ],
            ]
        ] = None,
        ec2_tag_set: typing.Optional[
            typing.Union["EC2TagSetProperty", _IResolvable_9ceae33e]
        ] = None,
        load_balancer_info: typing.Optional[
            typing.Union["LoadBalancerInfoProperty", _IResolvable_9ceae33e]
        ] = None,
        on_premises_instance_tag_filters: typing.Optional[
            typing.Union[
                _IResolvable_9ceae33e,
                typing.List[typing.Union["TagFilterProperty", _IResolvable_9ceae33e]],
            ]
        ] = None,
        on_premises_tag_set: typing.Optional[
            typing.Union["OnPremisesTagSetProperty", _IResolvable_9ceae33e]
        ] = None,
        trigger_configurations: typing.Optional[
            typing.Union[
                _IResolvable_9ceae33e,
                typing.List[
                    typing.Union["TriggerConfigProperty", _IResolvable_9ceae33e]
                ],
            ]
        ] = None,
    ) -> None:
    ...
    def deployment(
        self,
    ) -> typing.Optional[typing.Union["DeploymentProperty", _IResolvable_9ceae33e]]:
    ...
    def ec2_tag_filters(
        ...
        typing.Union[
            _IResolvable_9ceae33e,
            typing.List[typing.Union["EC2TagFilterProperty", _IResolvable_9ceae33e]],
        ]
    ]:
    ...
    def ec2_tag_set(
        self,
    ) -> typing.Optional[typing.Union["EC2TagSetProperty", _IResolvable_9ceae33e]]:
    ...
    def trigger_configurations(
        ...
        typing.Union[
            _IResolvable_9ceae33e,
            typing.List[typing.Union["TriggerConfigProperty", _IResolvable_9ceae33e]],
        ]
    ]:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codedeploy.CfnDeploymentGroup.AlarmConfigurationProperty",
        jsii_struct_bases=[],
        name_mapping={
            "alarms": "alarms",
            "enabled": "enabled",
    ...
    class AlarmConfigurationProperty:
        def __init__(
            self,
            *,
            alarms: typing.Optional[
                typing.Union[
                    _IResolvable_9ceae33e,
                    typing.List[
                        typing.Union[
                            "CfnDeploymentGroup.AlarmProperty", _IResolvable_9ceae33e
                        ]
                    ],
                ]
            ] = None,
            enabled: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]] = None,
            ignore_poll_alarm_failure: typing.Optional[
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codedeploy.CfnDeploymentGroup.AlarmProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codedeploy.CfnDeploymentGroup.AutoRollbackConfigurationProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codedeploy.CfnDeploymentGroup.DeploymentProperty",
        jsii_struct_bases=[],
        name_mapping={
            "revision": "revision",
        ...
        def __init__(
            ...
            *,
            revision: typing.Union[
                "CfnDeploymentGroup.RevisionLocationProperty", _IResolvable_9ceae33e
            ],
            description: typing.Optional[str] = None,
            ignore_application_stop_failures: typing.Optional[
                typing.Union[bool, _IResolvable_9ceae33e]
            ] = None,
        ) -> None:
            """
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codedeploy.CfnDeploymentGroup.DeploymentStyleProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class DeploymentStyleProperty:
        def __init__(
            self,
            *,
            deployment_option: typing.Optional[str] = None,
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codedeploy.CfnDeploymentGroup.EC2TagFilterProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codedeploy.CfnDeploymentGroup.EC2TagSetListObjectProperty",
        jsii_struct_bases=[],
    ...
    class EC2TagSetListObjectProperty:
        ...
        def ec2_tag_group(
            ...
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        "CfnDeploymentGroup.EC2TagFilterProperty", _IResolvable_9ceae33e
                    ]
                ],
            ]
        ]:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codedeploy.CfnDeploymentGroup.EC2TagSetProperty",
        jsii_struct_bases=[],
    ...
    class EC2TagSetProperty:
        def __init__(
            self,
            *,
            ec2_tag_set_list: typing.Optional[
                typing.Union[
                    _IResolvable_9ceae33e,
                    typing.List[
                        typing.Union[
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codedeploy.CfnDeploymentGroup.ELBInfoProperty",
        jsii_struct_bases=[],
        name_mapping={"name": "name"},
    )
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codedeploy.CfnDeploymentGroup.GitHubLocationProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codedeploy.CfnDeploymentGroup.LoadBalancerInfoProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class LoadBalancerInfoProperty:
        def __init__(
            self,
            *,
            elb_info_list: typing.Optional[
                typing.Union[
                    _IResolvable_9ceae33e,
                    typing.List[
                        typing.Union[
                            "CfnDeploymentGroup.ELBInfoProperty", _IResolvable_9ceae33e
                        ]
                    ],
                ]
            ] = None,
            target_group_info_list: typing.Optional[
                typing.Union[
                    _IResolvable_9ceae33e,
                    typing.List[
                        typing.Union[
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codedeploy.CfnDeploymentGroup.OnPremisesTagSetListObjectProperty",
        jsii_struct_bases=[],
    ...
    class OnPremisesTagSetListObjectProperty:
        def __init__(
            self,
            *,
            on_premises_tag_group: typing.Optional[
                typing.Union[
                    _IResolvable_9ceae33e,
                    typing.List[
                        typing.Union[
        ...
        def on_premises_tag_group(
            ...
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        "CfnDeploymentGroup.TagFilterProperty", _IResolvable_9ceae33e
                    ]
                ],
            ]
        ]:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codedeploy.CfnDeploymentGroup.OnPremisesTagSetProperty",
        jsii_struct_bases=[],
    ...
    class OnPremisesTagSetProperty:
        def __init__(
            self,
            *,
            on_premises_tag_set_list: typing.Optional[
                typing.Union[
                    _IResolvable_9ceae33e,
                    typing.List[
                        typing.Union[
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codedeploy.CfnDeploymentGroup.RevisionLocationProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class RevisionLocationProperty:
        def __init__(
            self,
            *,
            git_hub_location: typing.Optional[
                typing.Union[
                    "CfnDeploymentGroup.GitHubLocationProperty", _IResolvable_9ceae33e
                ]
            ] = None,
            revision_type: typing.Optional[str] = None,
            s3_location: typing.Optional[
                typing.Union[
                    "CfnDeploymentGroup.S3LocationProperty", _IResolvable_9ceae33e
                ]
            ] = None,
        ) -> None:
            """
        ...
        def s3_location(
            ...
            typing.Union["CfnDeploymentGroup.S3LocationProperty", _IResolvable_9ceae33e]
        ]:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codedeploy.CfnDeploymentGroup.S3LocationProperty",
        jsii_struct_bases=[],
        name_mapping={
            "bucket": "bucket",
            "key": "key",
    ...
    class S3LocationProperty:
        def __init__(
            ...
            *,
            bucket: str,
            key: str,
            bundle_type: typing.Optional[str] = None,
            e_tag: typing.Optional[str] = None,
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codedeploy.CfnDeploymentGroup.TagFilterProperty",
        jsii_struct_bases=[],
        name_mapping={"key": "key", "type": "type", "value": "value"},
    )
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codedeploy.CfnDeploymentGroup.TargetGroupInfoProperty",
        jsii_struct_bases=[],
        name_mapping={"name": "name"},
    )
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codedeploy.CfnDeploymentGroup.TriggerConfigProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class TriggerConfigProperty:
        def __init__(
            self,
            *,
            trigger_events: typing.Optional[typing.List[str]] = None,
            trigger_name: typing.Optional[str] = None,
            trigger_target_arn: typing.Optional[str] = None,
        ) -> None:
            """
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codedeploy.CfnDeploymentGroupProps",
    jsii_struct_bases=[],
    name_mapping={
        "application_name": "applicationName",
...
class CfnDeploymentGroupProps:
    def __init__(
        ...
        *,
        ...
        auto_scaling_groups: typing.Optional[typing.List[str]] = None,
        deployment: typing.Optional[
            typing.Union["CfnDeploymentGroup.DeploymentProperty", _IResolvable_9ceae33e]
        ] = None,
        deployment_config_name: typing.Optional[str] = None,
        deployment_group_name: typing.Optional[str] = None,
        deployment_style: typing.Optional[
            typing.Union[
                "CfnDeploymentGroup.DeploymentStyleProperty", _IResolvable_9ceae33e
            ]
        ] = None,
        ec2_tag_filters: typing.Optional[
            typing.Union[
        ...
        ec2_tag_set: typing.Optional[
            typing.Union["CfnDeploymentGroup.EC2TagSetProperty", _IResolvable_9ceae33e]
        ] = None,
        load_balancer_info: typing.Optional[
            typing.Union[
                "CfnDeploymentGroup.LoadBalancerInfoProperty", _IResolvable_9ceae33e
            ]
        ] = None,
        on_premises_instance_tag_filters: typing.Optional[
            typing.Union[
        ...
        on_premises_tag_set: typing.Optional[
            typing.Union[
                "CfnDeploymentGroup.OnPremisesTagSetProperty", _IResolvable_9ceae33e
            ]
        ] = None,
        trigger_configurations: typing.Optional[
            typing.Union[
    ...
    def trigger_configurations(
        ...
        typing.Union[
            ...
            typing.List[
                typing.Union[
                    "CfnDeploymentGroup.TriggerConfigProperty", _IResolvable_9ceae33e
                ]
            ],
        ]
    ]:
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codedeploy.EcsApplicationProps",
    jsii_struct_bases=[],
...
class EcsDeploymentConfig(
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_codedeploy.EcsDeploymentConfig",
):
    ...
    def from_ecs_deployment_config_name(
        cls, _scope: _Construct_f50a3f53, _id: str, ecs_deployment_config_name: str
        ...
        return jsii.sinvoke(
            ...
            [_scope, _id, ecs_deployment_config_name],
        )
...
class EcsDeploymentGroup(
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_codedeploy.EcsDeploymentGroup",
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codedeploy.EcsDeploymentGroupAttributes",
    jsii_struct_bases=[],
    name_mapping={
        "application": "application",
        "deployment_group_name": "deploymentGroupName",
...
class IServerDeploymentGroup(_IResource_72f7ee7e, jsii.compat.Protocol):
    ...
    def auto_scaling_groups(
        self,
    ) -> typing.Optional[typing.List[_IAutoScalingGroup_a753dc94]]:
        """
        stability
        :stability: experimental
        """
...
class InstanceTagSet(
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_codedeploy.InstanceTagSet",
):
    ...
    def __init__(
        self, *instance_tag_groups: typing.Mapping[str, typing.List[str]]
    ) -> None:
        """
...
class LambdaApplication(
    _Resource_884d0774,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_codedeploy.LambdaApplication",
):
    ...
    def from_lambda_application_name(
        cls, scope: _Construct_f50a3f53, id: str, lambda_application_name: str
    ) -> "ILambdaApplication":
        ...
        """
        return jsii.sinvoke(
            cls, "fromLambdaApplicationName", [scope, id, lambda_application_name]
        )
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codedeploy.LambdaApplicationProps",
    jsii_struct_bases=[],
    name_mapping={"application_name": "applicationName"},
)
...
class LambdaDeploymentConfig(
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_codedeploy.LambdaDeploymentConfig",
):
    ...
    @builtins.classmethod
    def import_(
        cls, _scope: _Construct_f50a3f53, _id: str, *, deployment_config_name: str
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codedeploy.LambdaDeploymentConfigImportProps",
    jsii_struct_bases=[],
...
class LambdaDeploymentGroup(
    _Resource_884d0774,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_codedeploy.LambdaDeploymentGroup",
):
    """
    stability
    :stability: experimental
    ...
    def __init__(
        ...
        id: str,
        *,
        alias: _Alias_67f7db75,
        alarms: typing.Optional[typing.List[_IAlarm_478ec33c]] = None,
        ...
        post_hook: typing.Optional[_IFunction_1c1de0bc] = None,
        pre_hook: typing.Optional[_IFunction_1c1de0bc] = None,
    ...
    def from_lambda_deployment_group_attributes(
        ...
        *,
        ...
        return jsii.sinvoke(
            cls, "fromLambdaDeploymentGroupAttributes", [scope, id, attrs]
        )
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codedeploy.LambdaDeploymentGroupAttributes",
    jsii_struct_bases=[],
    name_mapping={
        "application": "application",
        "deployment_group_name": "deploymentGroupName",
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codedeploy.LambdaDeploymentGroupProps",
    jsii_struct_bases=[],
    name_mapping={
        "alias": "alias",
        "alarms": "alarms",
...
class LoadBalancer(
    ...
    jsii_type="monocdk-experiment.aws_codedeploy.LoadBalancer",
):
    ...
    @builtins.classmethod
    def application(
        cls, alb_target_group: _ApplicationTargetGroup_7d0a8d54
    ) -> "LoadBalancer":
...
class MinimumHealthyHosts(
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_codedeploy.MinimumHealthyHosts",
):
...
class ServerApplication(
    _Resource_884d0774,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_codedeploy.ServerApplication",
):
    ...
    def from_server_application_name(
        cls, scope: _Construct_f50a3f53, id: str, server_application_name: str
    ) -> "IServerApplication":
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codedeploy.ServerApplicationProps",
    jsii_struct_bases=[],
    name_mapping={"application_name": "applicationName"},
)
...
class ServerDeploymentConfig(
    _Resource_884d0774,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_codedeploy.ServerDeploymentConfig",
):
    ...
    def from_server_deployment_config_name(
        cls, scope: _Construct_f50a3f53, id: str, server_deployment_config_name: str
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codedeploy.ServerDeploymentConfigProps",
    jsii_struct_bases=[],
    name_mapping={
        "minimum_healthy_hosts": "minimumHealthyHosts",
        "deployment_config_name": "deploymentConfigName",
...
class ServerDeploymentGroup(
    _Resource_884d0774,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_codedeploy.ServerDeploymentGroup",
):
    ...
    def __init__(
        ...
        *,
        ...
        auto_scaling_groups: typing.Optional[
            typing.List[_IAutoScalingGroup_a753dc94]
        ] = None,
    ...
    def from_server_deployment_group_attributes(
        ...
        *,
        ...
        return jsii.sinvoke(
            cls, "fromServerDeploymentGroupAttributes", [scope, id, attrs]
        )
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codedeploy.ServerDeploymentGroupAttributes",
    jsii_struct_bases=[],
    name_mapping={
        "application": "application",
        "deployment_group_name": "deploymentGroupName",
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codedeploy.ServerDeploymentGroupProps",
    jsii_struct_bases=[],
    name_mapping={
        "alarms": "alarms",
        "application": "application",
...
class EcsApplication(
    _Resource_884d0774,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_codedeploy.EcsApplication",
):
    ...
    def from_ecs_application_name(
        cls, scope: _Construct_f50a3f53, id: str, ecs_application_name: str
    ) -> "IEcsApplication":
        """Import an Application defined either outside the CDK, or in a different CDK Stack.
        ...
        """
        return jsii.sinvoke(
            cls, "fromEcsApplicationName", [scope, id, ecs_application_name]
        )
