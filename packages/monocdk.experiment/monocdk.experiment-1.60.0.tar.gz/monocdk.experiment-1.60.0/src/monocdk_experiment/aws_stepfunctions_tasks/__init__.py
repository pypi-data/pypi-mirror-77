...
from ..aws_batch import (
    IJobDefinition as _IJobDefinition_48a64d37,
    IJobQueue as _IJobQueue_370c9b9b,
)
    ...
    def __init__(
        ...
        *,
        ...
        integration_pattern: typing.Optional[
            _ServiceIntegrationPattern_efe8c8bf
        ] = None,
    ) -> None:
    ...
    def __init__(
        ...
        *,
        placement_constraints: typing.Optional[
            typing.List[_PlacementConstraint_dc6aebd4]
        ] = None,
        placement_strategies: typing.Optional[
            typing.List[_PlacementStrategy_e3f6282b]
        ] = None,
    ) -> None:
...
@jsii.interface(jsii_type="monocdk-experiment.aws_stepfunctions_tasks.IEcsLaunchTarget")
...
class _IEcsLaunchTargetProxy:
    ...
    __jsii_type__ = "monocdk-experiment.aws_stepfunctions_tasks.IEcsLaunchTarget"
...
class InvokeActivityProps:
    def __init__(
        self, *, heartbeat: typing.Optional[_Duration_5170c158] = None
    ) -> None:
...
class StoppingCondition:
    def __init__(
        self, *, max_runtime: typing.Optional[_Duration_5170c158] = None
    ) -> None:
