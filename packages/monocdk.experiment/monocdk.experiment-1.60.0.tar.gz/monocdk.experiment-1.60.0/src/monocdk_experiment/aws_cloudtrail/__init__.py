...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudtrail.AddEventSelectorOptions",
    jsii_struct_bases=[],
    name_mapping={
...
class AddEventSelectorOptions:
    def __init__(
        self,
        *,
        include_management_events: typing.Optional[bool] = None,
...
class CfnTrail(
    ...
    jsii_type="monocdk-experiment.aws_cloudtrail.CfnTrail",
):
    ...
    def __init__(
        ...
        id: str,
        *,
        is_logging: typing.Union[bool, _IResolvable_9ceae33e],
        s3_bucket_name: str,
        cloud_watch_logs_log_group_arn: typing.Optional[str] = None,
        cloud_watch_logs_role_arn: typing.Optional[str] = None,
        enable_log_file_validation: typing.Optional[
            typing.Union[bool, _IResolvable_9ceae33e]
        ] = None,
        event_selectors: typing.Optional[
            typing.Union[
                _IResolvable_9ceae33e,
                typing.List[
                    typing.Union["EventSelectorProperty", _IResolvable_9ceae33e]
                ],
            ]
        ] = None,
        include_global_service_events: typing.Optional[
            typing.Union[bool, _IResolvable_9ceae33e]
        ] = None,
        is_multi_region_trail: typing.Optional[
            typing.Union[bool, _IResolvable_9ceae33e]
        ] = None,
        kms_key_id: typing.Optional[str] = None,
        s3_key_prefix: typing.Optional[str] = None,
        sns_topic_name: typing.Optional[str] = None,
        tags: typing.Optional[typing.List[_CfnTag_b4661f1a]] = None,
        trail_name: typing.Optional[str] = None,
    ) -> None:
    ...
    def event_selectors(
        ...
        typing.Union[
            _IResolvable_9ceae33e,
            typing.List[typing.Union["EventSelectorProperty", _IResolvable_9ceae33e]],
        ]
    ]:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_cloudtrail.CfnTrail.DataResourceProperty",
        jsii_struct_bases=[],
        name_mapping={"type": "type", "values": "values"},
    )
    class DataResourceProperty:
        def __init__(
            self, *, type: str, values: typing.Optional[typing.List[str]] = None
        ) -> None:
            """
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_cloudtrail.CfnTrail.EventSelectorProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class EventSelectorProperty:
        def __init__(
            self,
            *,
            data_resources: typing.Optional[
                typing.Union[
                    _IResolvable_9ceae33e,
                    typing.List[
                        typing.Union[
                            "CfnTrail.DataResourceProperty", _IResolvable_9ceae33e
                        ]
                    ],
                ]
            ] = None,
            include_management_events: typing.Optional[
                typing.Union[bool, _IResolvable_9ceae33e]
            ] = None,
            read_write_type: typing.Optional[str] = None,
        ) -> None:
            """
        ...
        def data_resources(
            ...
            typing.Union[
                _IResolvable_9ceae33e,
                typing.List[
                    typing.Union["CfnTrail.DataResourceProperty", _IResolvable_9ceae33e]
                ],
            ]
        ]:
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudtrail.CfnTrailProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CfnTrailProps:
        ...
        *,
        ...
        event_selectors: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        "CfnTrail.EventSelectorProperty", _IResolvable_9ceae33e
                    ]
                ],
            ]
        ] = None,
    ...
    def event_selectors(
        ...
        typing.Union[
            _IResolvable_9ceae33e,
            typing.List[
                typing.Union["CfnTrail.EventSelectorProperty", _IResolvable_9ceae33e]
            ],
        ]
    ]:
        """``AWS::CloudTrail::Trail.EventSelectors``.
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudtrail.S3EventSelector",
    jsii_struct_bases=[],
    name_mapping={"bucket": "bucket", "object_prefix": "objectPrefix"},
)
class S3EventSelector:
    def __init__(
        self, *, bucket: _IBucket_25bad983, object_prefix: typing.Optional[str] = None
    ) -> None:
...
class Trail(
    _Resource_884d0774,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_cloudtrail.Trail",
):
    ...
    def __init__(
        ...
        *,
        ...
        cloud_watch_log_group: typing.Optional[_ILogGroup_6b54c8e1] = None,
        cloud_watch_logs_retention: typing.Optional[_RetentionDays_bdc7ad1f] = None,
        enable_file_validation: typing.Optional[bool] = None,
        encryption_key: typing.Optional[_IKey_3336c79d] = None,
        include_global_service_events: typing.Optional[bool] = None,
        is_multi_region_trail: typing.Optional[bool] = None,
        kms_key: typing.Optional[_IKey_3336c79d] = None,
        management_events: typing.Optional["ReadWriteType"] = None,
        s3_key_prefix: typing.Optional[str] = None,
        send_to_cloud_watch_logs: typing.Optional[bool] = None,
        sns_topic: typing.Optional[_ITopic_ef0ebe0e] = None,
        trail_name: typing.Optional[str] = None,
    ) -> None:
        """
        :param scope: -
    ...
    def add_event_selector(
        ...
        data_resource_values: typing.List[str],
        *,
        include_management_events: typing.Optional[bool] = None,
        read_write_type: typing.Optional["ReadWriteType"] = None,
    ) -> None:
        ...
        return jsii.invoke(
            self,
            "addEventSelector",
            [data_resource_type, data_resource_values, options],
        )

    @jsii.member(jsii_name="addLambdaEventSelector")
    def add_lambda_event_selector(
        self,
        handlers: typing.List[_IFunction_1c1de0bc],
        *,
        include_management_events: typing.Optional[bool] = None,
        read_write_type: typing.Optional["ReadWriteType"] = None,
    ) -> None:
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_cloudtrail.TrailProps",
    jsii_struct_bases=[],
    name_mapping={
        "bucket": "bucket",
