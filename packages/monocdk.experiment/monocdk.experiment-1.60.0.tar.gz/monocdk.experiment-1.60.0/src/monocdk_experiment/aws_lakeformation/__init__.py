...
class CfnDataLakeSettings(
    ...
    jsii_type="monocdk-experiment.aws_lakeformation.CfnDataLakeSettings",
):
        ...
        *,
        admins: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union["DataLakePrincipalProperty", _IResolvable_9ceae33e]
                ],
            ]
        ] = None,
    ) -> None:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_lakeformation.CfnDataLakeSettings.DataLakePrincipalProperty",
        jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_lakeformation.CfnDataLakeSettingsProps",
    jsii_struct_bases=[],
...
class CfnPermissions(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_lakeformation.CfnPermissions",
):
    ...
    def __init__(
        ...
        id: str,
        *,
        data_lake_principal: typing.Union[
            "DataLakePrincipalProperty", _IResolvable_9ceae33e
        ],
        resource: typing.Union["ResourceProperty", _IResolvable_9ceae33e],
    ...
    def data_lake_principal(
        self, value: typing.Union["DataLakePrincipalProperty", _IResolvable_9ceae33e]
    ) -> None:
        jsii.set(self, "dataLakePrincipal", value)

    @builtins.property
    @jsii.member(jsii_name="resource")
    def resource(self) -> typing.Union["ResourceProperty", _IResolvable_9ceae33e]:
    ...
    @resource.setter
    def resource(
        self, value: typing.Union["ResourceProperty", _IResolvable_9ceae33e]
    ) -> None:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_lakeformation.CfnPermissions.ColumnWildcardProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_lakeformation.CfnPermissions.DataLakePrincipalProperty",
        jsii_struct_bases=[],
        name_mapping={"data_lake_principal_identifier": "dataLakePrincipalIdentifier"},
    )
    class DataLakePrincipalProperty:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_lakeformation.CfnPermissions.DataLocationResourceProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_lakeformation.CfnPermissions.DatabaseResourceProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_lakeformation.CfnPermissions.ResourceProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class ResourceProperty:
        def __init__(
            self,
            *,
            database_resource: typing.Optional[
                typing.Union[
                    "CfnPermissions.DatabaseResourceProperty", _IResolvable_9ceae33e
                ]
            ] = None,
            data_location_resource: typing.Optional[
                typing.Union[
                    "CfnPermissions.DataLocationResourceProperty", _IResolvable_9ceae33e
                ]
            ] = None,
            table_resource: typing.Optional[
                typing.Union[
                    "CfnPermissions.TableResourceProperty", _IResolvable_9ceae33e
                ]
            ] = None,
            table_with_columns_resource: typing.Optional[
                typing.Union[
        ...
        def table_resource(
            ...
            typing.Union["CfnPermissions.TableResourceProperty", _IResolvable_9ceae33e]
        ]:
        ...
        def table_with_columns_resource(
            ...
            typing.Union[
                "CfnPermissions.TableWithColumnsResourceProperty", _IResolvable_9ceae33e
            ]
        ]:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_lakeformation.CfnPermissions.TableResourceProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_lakeformation.CfnPermissions.TableWithColumnsResourceProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class TableWithColumnsResourceProperty:
        def __init__(
            ...
            *,
            ...
            column_wildcard: typing.Optional[
                typing.Union[
                    "CfnPermissions.ColumnWildcardProperty", _IResolvable_9ceae33e
                ]
            ] = None,
            database_name: typing.Optional[str] = None,
            name: typing.Optional[str] = None,
        ...
        def column_wildcard(
            ...
            typing.Union["CfnPermissions.ColumnWildcardProperty", _IResolvable_9ceae33e]
        ]:
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_lakeformation.CfnPermissionsProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CfnPermissionsProps:
    def __init__(
        ...
        *,
        data_lake_principal: typing.Union[
            "CfnPermissions.DataLakePrincipalProperty", _IResolvable_9ceae33e
        ],
        resource: typing.Union[
            "CfnPermissions.ResourceProperty", _IResolvable_9ceae33e
        ],
        permissions: typing.Optional[typing.List[str]] = None,
        permissions_with_grant_option: typing.Optional[typing.List[str]] = None,
    ) -> None:
    ...
    def resource(
        self,
    ) -> typing.Union["CfnPermissions.ResourceProperty", _IResolvable_9ceae33e]:
        """``AWS::LakeFormation::Permissions.Resource``.
...
class CfnResource(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_lakeformation.CfnResource",
):
    ...
    def __init__(
        ...
        *,
        resource_arn: str,
        use_service_linked_role: typing.Union[bool, _IResolvable_9ceae33e],
    ...
    def use_service_linked_role(self) -> typing.Union[bool, _IResolvable_9ceae33e]:
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_lakeformation.CfnResourceProps",
    jsii_struct_bases=[],
    name_mapping={
