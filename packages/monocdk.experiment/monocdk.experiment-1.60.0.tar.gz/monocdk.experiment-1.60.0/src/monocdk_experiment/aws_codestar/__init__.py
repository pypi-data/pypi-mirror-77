...
class CfnGitHubRepository(
    ...
    jsii_type="monocdk-experiment.aws_codestar.CfnGitHubRepository",
):
    ...
    def __init__(
        ...
        *,
        ...
        enable_issues: typing.Optional[
            typing.Union[bool, _IResolvable_9ceae33e]
        ] = None,
        is_private: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]] = None,
    ...
    def is_private(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codestar.CfnGitHubRepository.CodeProperty",
        jsii_struct_bases=[],
        name_mapping={"s3": "s3"},
    )
    class CodeProperty:
        def __init__(
            self,
            *,
            s3: typing.Union["CfnGitHubRepository.S3Property", _IResolvable_9ceae33e],
        ) -> None:
            """
        ...
        def s3(
            self,
        ) -> typing.Union["CfnGitHubRepository.S3Property", _IResolvable_9ceae33e]:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_codestar.CfnGitHubRepository.S3Property",
        jsii_struct_bases=[],
        name_mapping={
            "bucket": "bucket",
            "key": "key",
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codestar.CfnGitHubRepositoryProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CfnGitHubRepositoryProps:
    def __init__(
        ...
        *,
        ...
        repository_owner: str,
        code: typing.Optional[
            typing.Union["CfnGitHubRepository.CodeProperty", _IResolvable_9ceae33e]
        ] = None,
        enable_issues: typing.Optional[
            typing.Union[bool, _IResolvable_9ceae33e]
        ] = None,
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_codestar.GitHubRepositoryProps",
    jsii_struct_bases=[],
    name_mapping={
...
class GitHubRepositoryProps:
    def __init__(
        ...
        *,
        ...
        contents_bucket: _IBucket_25bad983,
        contents_key: str,
        owner: str,
        repository_name: str,
    ...
    @builtins.property
    def contents_bucket(self) -> _IBucket_25bad983:
...
@jsii.interface(jsii_type="monocdk-experiment.aws_codestar.IGitHubRepository")
class IGitHubRepository(_IResource_72f7ee7e, jsii.compat.Protocol):
...
class _IGitHubRepositoryProxy(jsii.proxy_for(_IResource_72f7ee7e)):
    """GitHubRepository resource interface.
    ...
    __jsii_type__ = "monocdk-experiment.aws_codestar.IGitHubRepository"
...
@jsii.enum(jsii_type="monocdk-experiment.aws_codestar.RepositoryVisibility")
...
class GitHubRepository(
    _Resource_884d0774,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_codestar.GitHubRepository",
):
