...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_s3.Inventory",
    jsii_struct_bases=[],
    name_mapping={
        "destination": "destination",
        "enabled": "enabled",
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_s3.InventoryDestination",
    jsii_struct_bases=[],
    name_mapping={
        "bucket": "bucket",
...
@jsii.enum(jsii_type="monocdk-experiment.aws_s3.InventoryFormat")
...
@jsii.enum(jsii_type="monocdk-experiment.aws_s3.InventoryFrequency")
...
@jsii.enum(jsii_type="monocdk-experiment.aws_s3.InventoryObjectVersion")
