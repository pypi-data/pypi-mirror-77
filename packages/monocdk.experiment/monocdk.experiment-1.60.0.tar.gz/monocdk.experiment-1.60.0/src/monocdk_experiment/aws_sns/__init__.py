...
class CfnSubscription(
    ...
    def __init__(
        ...
        *,
        ...
        raw_message_delivery: typing.Optional[
...
class CfnTopic(
    ...
    def __init__(
        ...
        *,
        ...
        fifo_topic: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]] = None,
        kms_master_key_id: typing.Optional[str] = None,
        subscription: typing.Optional[
            typing.Union[
                _IResolvable_9ceae33e,
                typing.List[
                    typing.Union["SubscriptionProperty", _IResolvable_9ceae33e]
                ],
            ]
        ] = None,
    ...
    def fifo_topic(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    def subscription(
        ...
        typing.Union[
            _IResolvable_9ceae33e,
            typing.List[typing.Union["SubscriptionProperty", _IResolvable_9ceae33e]],
        ]
    ]:
        ...
        *,
        ...
        subscription: typing.Optional[
            typing.Union[
                _IResolvable_9ceae33e,
                typing.List[
                    typing.Union["CfnTopic.SubscriptionProperty", _IResolvable_9ceae33e]
                ],
            ]
        ] = None,
        tags: typing.Optional[typing.List[_CfnTag_b4661f1a]] = None,
...
class ITopic(_IResource_72f7ee7e, jsii.compat.Protocol):
...
class _ITopicProxy(jsii.proxy_for(_IResource_72f7ee7e)):
    """Represents an SNS topic.
    ...
    __jsii_type__ = "monocdk-experiment.aws_sns.ITopic"
    ...
    def metric_number_of_notifications_filtered_out_invalid_attributes(
        ...
        *,
        ...
        return jsii.invoke(
            self, "metricNumberOfNotificationsFilteredOutInvalidAttributes", [props]
        )
    ...
    def metric_number_of_notifications_filtered_out_no_message_attributes(
        ...
        *,
        ...
        return jsii.invoke(
            self, "metricNumberOfNotificationsFilteredOutNoMessageAttributes", [props]
        )
...
class _ITopicSubscriptionProxy:
    ...
    __jsii_type__ = "monocdk-experiment.aws_sns.ITopicSubscription"
...
class Subscription(
    ...
    def __init__(
        ...
        *,
        ...
        filter_policy: typing.Optional[
            typing.Mapping[str, "SubscriptionFilter"]
        ] = None,
...
class SubscriptionFilter(
    metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_sns.SubscriptionFilter"
):
...
class _TopicBaseProxy(TopicBase, jsii.proxy_for(_Resource_884d0774)):
    @builtins.property
    @jsii.member(jsii_name="autoCreatePolicy")
    def _auto_create_policy(self) -> bool:
        """Controls automatic creation of policy objects.
...
class TopicPolicy(
    ...
    def __init__(
        self, scope: _Construct_f50a3f53, id: str, *, topics: typing.List["ITopic"]
    ) -> None:
        """
        :param scope: -
        :param id: -
...
class Topic(
    TopicBase, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_sns.Topic"
):
    """A new SNS topic.
    ...
    @builtins.classmethod
    def from_topic_arn(
        cls, scope: _Construct_f50a3f53, id: str, topic_arn: str
    ) -> "ITopic":
