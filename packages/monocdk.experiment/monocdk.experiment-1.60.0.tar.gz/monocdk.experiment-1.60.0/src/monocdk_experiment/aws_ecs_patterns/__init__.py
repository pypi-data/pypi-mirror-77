...
class ApplicationLoadBalancedServiceBase(
    ...
    def _create_aws_log_driver(self, prefix: str) -> _AwsLogDriver_a24c479b:
        """
        :param prefix: -
    ...
    def _get_default_cluster(
        self, scope: _Construct_f50a3f53, vpc: typing.Optional[_IVpc_3795853f] = None
    ) -> _Cluster_d0079260:
...
class ApplicationLoadBalancedServiceBaseProps:
    ...
    @builtins.property
    def open_listener(self) -> typing.Optional[bool]:
        ...
        :stability: experimental
        """
        return self._values.get("open_listener")
    ...
    @builtins.property
    def redirect_http(self) -> typing.Optional[bool]:
        ...
        :stability: experimental
        """
        return self._values.get("redirect_http")
...
class ApplicationLoadBalancedTaskImageOptions:
    def __init__(
        ...
        *,
        ...
        secrets: typing.Optional[typing.Mapping[str, _Secret_3f6909a4]] = None,
    ...
    @builtins.property
    def secrets(self) -> typing.Optional[typing.Mapping[str, _Secret_3f6909a4]]:
...
class ApplicationMultipleTargetGroupsServiceBase(
    ...
    def _target_groups(
        self, value: typing.List[_ApplicationTargetGroup_7d0a8d54]
    ) -> None:
...
class QueueProcessingServiceBase(
    ...
    def _configure_autoscaling_for_service(
        self, service: _BaseService_c6e5f19d
    ) -> None:
...
class ScheduledTaskBase(
    ...
    def _add_task_definition_to_event_target(
        self, task_definition: _TaskDefinition_acfbb011
    ) -> _EcsTask_1d951afe:
