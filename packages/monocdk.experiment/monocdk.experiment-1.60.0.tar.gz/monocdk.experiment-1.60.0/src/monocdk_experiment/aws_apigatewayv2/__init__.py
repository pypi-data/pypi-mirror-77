...
class CfnApiGatewayManagedOverrides(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_apigatewayv2.CfnApiGatewayManagedOverrides",
):
    ...
    def __init__(
        ...
        *,
        api_id: str,
        integration: typing.Optional[
            typing.Union["IntegrationOverridesProperty", _IResolvable_9ceae33e]
        ] = None,
        route: typing.Optional[
            typing.Union["RouteOverridesProperty", _IResolvable_9ceae33e]
        ] = None,
        stage: typing.Optional[
            typing.Union["StageOverridesProperty", _IResolvable_9ceae33e]
        ] = None,
    ) -> None:
    ...
    def route(
        self,
    ) -> typing.Optional[typing.Union["RouteOverridesProperty", _IResolvable_9ceae33e]]:
    ...
    def stage(
        self,
    ) -> typing.Optional[typing.Union["StageOverridesProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_apigatewayv2.CfnApiGatewayManagedOverrides.AccessLogSettingsProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_apigatewayv2.CfnApiGatewayManagedOverrides.IntegrationOverridesProperty",
        jsii_struct_bases=[],
        name_mapping={
            "description": "description",
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_apigatewayv2.CfnApiGatewayManagedOverrides.RouteOverridesProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_apigatewayv2.CfnApiGatewayManagedOverrides.RouteSettingsProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_apigatewayv2.CfnApiGatewayManagedOverrides.StageOverridesProperty",
        jsii_struct_bases=[],
        name_mapping={
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_apigatewayv2.CfnApiGatewayManagedOverridesProps",
    jsii_struct_bases=[],
    name_mapping={
        "api_id": "apiId",
        "integration": "integration",
...
class CfnVpcLink(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_apigatewayv2.CfnVpcLink",
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_apigatewayv2.CfnVpcLinkProps",
    jsii_struct_bases=[],
    name_mapping={
        "name": "name",
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_apigatewayv2.HttpRouteIntegrationBindOptions",
    jsii_struct_bases=[],
    name_mapping={"route": "route", "scope": "scope"},
)
class HttpRouteIntegrationBindOptions:
    def __init__(self, *, route: "IHttpRoute", scope: _Construct_f50a3f53) -> None:
    ...
    @builtins.property
    def scope(self) -> _Construct_f50a3f53:
...
class IHttpRouteIntegration(jsii.compat.Protocol):
    ...
    def bind(
        self, *, route: "IHttpRoute", scope: _Construct_f50a3f53
...
class HttpProxyIntegration(
    ...
    def bind(
        ...
        :stability: experimental
        """
        _ = HttpRouteIntegrationBindOptions(route=route, scope=scope)
