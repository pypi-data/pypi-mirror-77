...
class CfnServer(
    ...
    jsii_type="monocdk-experiment.aws_opsworkscm.CfnServer",
):
    ...
    def __init__(
        ...
        *,
        ...
        disable_automated_backup: typing.Optional[
            typing.Union[bool, _IResolvable_9ceae33e]
        ] = None,
        engine: typing.Optional[str] = None,
        engine_attributes: typing.Optional[
            typing.Union[
                _IResolvable_9ceae33e,
                typing.List[
                    typing.Union["EngineAttributeProperty", _IResolvable_9ceae33e]
                ],
            ]
        ] = None,
    ...
    def engine_attributes(
        ...
        typing.Union[
            _IResolvable_9ceae33e,
            typing.List[typing.Union["EngineAttributeProperty", _IResolvable_9ceae33e]],
        ]
    ]:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_opsworkscm.CfnServer.EngineAttributeProperty",
        jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_opsworkscm.CfnServerProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CfnServerProps:
        ...
        *,
        ...
        engine_attributes: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        "CfnServer.EngineAttributeProperty", _IResolvable_9ceae33e
                    ]
                ],
            ]
        ] = None,
    ...
    def engine_attributes(
        ...
        typing.Union[
            _IResolvable_9ceae33e,
            typing.List[
                typing.Union["CfnServer.EngineAttributeProperty", _IResolvable_9ceae33e]
            ],
        ]
    ]:
        """``AWS::OpsWorksCM::Server.EngineAttributes``.
