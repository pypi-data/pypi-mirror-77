...
class CfnServer(
    ...
    def __init__(
        ...
        *,
        ...
        endpoint_details: typing.Optional[
            typing.Union["EndpointDetailsProperty", _IResolvable_9ceae33e]
        ] = None,
        endpoint_type: typing.Optional[str] = None,
        identity_provider_details: typing.Optional[
            typing.Union["IdentityProviderDetailsProperty", _IResolvable_9ceae33e]
        ] = None,
...
class CfnServerProps:
    def __init__(
        ...
        *,
        certificate: typing.Optional[str] = None,
        endpoint_details: typing.Optional[
            typing.Union["CfnServer.EndpointDetailsProperty", _IResolvable_9ceae33e]
        ] = None,
        endpoint_type: typing.Optional[str] = None,
        identity_provider_details: typing.Optional[
            typing.Union[
                "CfnServer.IdentityProviderDetailsProperty", _IResolvable_9ceae33e
            ]
        ] = None,
        identity_provider_type: typing.Optional[str] = None,
        logging_role: typing.Optional[str] = None,
    ...
    def identity_provider_details(
        ...
        typing.Union["CfnServer.IdentityProviderDetailsProperty", _IResolvable_9ceae33e]
    ]:
        """``AWS::Transfer::Server.IdentityProviderDetails``.
...
class CfnUser(
    ...
    def __init__(
        ...
        *,
        ...
        home_directory_mappings: typing.Optional[
            typing.Union[
                _IResolvable_9ceae33e,
                typing.List[
                    typing.Union["HomeDirectoryMapEntryProperty", _IResolvable_9ceae33e]
                ],
            ]
        ] = None,
        ...
        *,
        ...
        home_directory_mappings: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        "CfnUser.HomeDirectoryMapEntryProperty", _IResolvable_9ceae33e
                    ]
                ],
            ]
        ] = None,
