...
class CfnWorkspace(
    ...
    def __init__(
        ...
        *,
        ...
        directory_id: str,
        user_name: str,
        root_volume_encryption_enabled: typing.Optional[
            typing.Union[bool, _IResolvable_9ceae33e]
        ] = None,
        tags: typing.Optional[typing.List[_CfnTag_b4661f1a]] = None,
        user_volume_encryption_enabled: typing.Optional[
            typing.Union[bool, _IResolvable_9ceae33e]
        ] = None,
        volume_encryption_key: typing.Optional[str] = None,
        workspace_properties: typing.Optional[
            typing.Union["WorkspacePropertiesProperty", _IResolvable_9ceae33e]
        ] = None,
    ) -> None:
    ...
    def volume_encryption_key(self, value: typing.Optional[str]) -> None:
    ...
    class WorkspacePropertiesProperty:
        def __init__(
            self,
            *,
            compute_type_name: typing.Optional[str] = None,
            root_volume_size_gib: typing.Optional[jsii.Number] = None,
            running_mode: typing.Optional[str] = None,
            running_mode_auto_stop_timeout_in_minutes: typing.Optional[
                jsii.Number
            ] = None,
...
class CfnWorkspaceProps:
    def __init__(
        ...
        *,
        ...
        workspace_properties: typing.Optional[
            typing.Union[
                "CfnWorkspace.WorkspacePropertiesProperty", _IResolvable_9ceae33e
            ]
        ] = None,
    ) -> None:
    ...
    def workspace_properties(
        ...
        typing.Union["CfnWorkspace.WorkspacePropertiesProperty", _IResolvable_9ceae33e]
    ]:
        """``AWS::WorkSpaces::Workspace.WorkspaceProperties``.
