    ...
    def __init__(
        ...
        *,
        ...
        finding_criteria: typing.Union[
            "FindingCriteriaProperty", _IResolvable_9ceae33e
        ],
        name: str,
        rank: jsii.Number,
    ) -> None:
        ...
        def __init__(
            ...
            *,
            ...
            item_type: typing.Optional[
                typing.Union["CfnFilter.ConditionProperty", _IResolvable_9ceae33e]
            ] = None,
        ) -> None:
            """
...
class CfnFilterProps:
    def __init__(
        ...
        *,
        ...
        detector_id: str,
        finding_criteria: typing.Union[
            "CfnFilter.FindingCriteriaProperty", _IResolvable_9ceae33e
        ],
        name: str,
        rank: jsii.Number,
    ) -> None:
