...
class CfnCertificate(
    ...
    jsii_type="monocdk-experiment.aws_iot.CfnCertificate",
):
    ...
    def __init__(
        ...
        *,
        ...
        props = CfnCertificateProps(
            certificate_signing_request=certificate_signing_request, status=status
        )
    ...
    def certificate_signing_request(self, value: str) -> None:
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_iot.CfnCertificateProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CfnPolicy(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_iot.CfnPolicy",
):
    ...
    @policy_name.setter
    def policy_name(self, value: typing.Optional[str]) -> None:
...
class CfnPolicyPrincipalAttachment(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_iot.CfnPolicyPrincipalAttachment",
):
    ...
    def __init__(
        self, scope: _Construct_f50a3f53, id: str, *, policy_name: str, principal: str
    ) -> None:
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_iot.CfnPolicyPrincipalAttachmentProps",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_iot.CfnPolicyProps",
    jsii_struct_bases=[],
    name_mapping={"policy_document": "policyDocument", "policy_name": "policyName"},
)
class CfnPolicyProps:
    def __init__(
        self, *, policy_document: typing.Any, policy_name: typing.Optional[str] = None
    ) -> None:
...
class CfnProvisioningTemplate(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_iot.CfnProvisioningTemplate",
):
    ...
    def __init__(
        ...
        *,
        ...
        pre_provisioning_hook: typing.Optional[
            typing.Union["ProvisioningHookProperty", _IResolvable_9ceae33e]
        ] = None,
    ...
    def attr_template_arn(self) -> str:
        """
        cloudformationAttribute:
    ...
    def provisioning_role_arn(self, value: str) -> None:
    ...
    def template_body(self, value: str) -> None:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_iot.CfnProvisioningTemplate.ProvisioningHookProperty",
        jsii_struct_bases=[],
    ...
    class ProvisioningHookProperty:
        def __init__(
            self,
            *,
            payload_version: typing.Optional[str] = None,
            target_arn: typing.Optional[str] = None,
        ) -> None:
            """
        ...
        @builtins.property
        def payload_version(self) -> typing.Optional[str]:
            ...
            """
            return self._values.get("payload_version")
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_iot.CfnProvisioningTemplate.TagsProperty",
        jsii_struct_bases=[],
        name_mapping={"tags": "tags"},
    )
    class TagsProperty:
        def __init__(
            self, *, tags: typing.Optional[typing.List[typing.Any]] = None
        ) -> None:
            """
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_iot.CfnProvisioningTemplateProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CfnProvisioningTemplateProps:
    ...
    def provisioning_role_arn(self) -> str:
        ...
        :see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iot-provisioningtemplate.html#cfn-iot-provisioningtemplate-provisioningrolearn
        """
        return self._values.get("provisioning_role_arn")
    ...
    def pre_provisioning_hook(
        ...
        typing.Union[
            "CfnProvisioningTemplate.ProvisioningHookProperty", _IResolvable_9ceae33e
        ]
    ]:
        """``AWS::IoT::ProvisioningTemplate.PreProvisioningHook``.
        ...
        :see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iot-provisioningtemplate.html#cfn-iot-provisioningtemplate-preprovisioninghook
        """
        return self._values.get("pre_provisioning_hook")
...
class CfnThing(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_iot.CfnThing",
):
    ...
    def __init__(
        ...
        id: str,
        *,
        attribute_payload: typing.Optional[
            typing.Union["AttributePayloadProperty", _IResolvable_9ceae33e]
        ] = None,
    ...
    @thing_name.setter
    def thing_name(self, value: typing.Optional[str]) -> None:
        jsii.set(self, "thingName", value)

    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_iot.CfnThing.AttributePayloadProperty",
        jsii_struct_bases=[],
...
class CfnThingPrincipalAttachment(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_iot.CfnThingPrincipalAttachment",
):
    ...
    def __init__(
        self, scope: _Construct_f50a3f53, id: str, *, principal: str, thing_name: str
    ) -> None:
    ...
    @thing_name.setter
    def thing_name(self, value: str) -> None:
        jsii.set(self, "thingName", value)


@jsii.data_type(
    jsii_type="monocdk-experiment.aws_iot.CfnThingPrincipalAttachmentProps",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_iot.CfnThingProps",
    jsii_struct_bases=[],
...
class CfnThingProps:
    def __init__(
        ...
        *,
        attribute_payload: typing.Optional[
            typing.Union["CfnThing.AttributePayloadProperty", _IResolvable_9ceae33e]
        ] = None,
        thing_name: typing.Optional[str] = None,
    ) -> None:
...
class CfnTopicRule(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_iot.CfnTopicRule",
):
    ...
    def __init__(
        ...
        id: str,
        *,
        topic_rule_payload: typing.Union[
            "TopicRulePayloadProperty", _IResolvable_9ceae33e
        ],
    ...
    def topic_rule_payload(
        self,
    ) -> typing.Union["TopicRulePayloadProperty", _IResolvable_9ceae33e]:
    ...
    def topic_rule_payload(
        self, value: typing.Union["TopicRulePayloadProperty", _IResolvable_9ceae33e]
    ) -> None:
    ...
    @rule_name.setter
    def rule_name(self, value: typing.Optional[str]) -> None:
        jsii.set(self, "ruleName", value)

    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.ActionProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class ActionProperty:
        def __init__(
            self,
            *,
            cloudwatch_alarm: typing.Optional[
                typing.Union[
                    "CfnTopicRule.CloudwatchAlarmActionProperty", _IResolvable_9ceae33e
                ]
            ] = None,
            cloudwatch_metric: typing.Optional[
                typing.Union[
                    "CfnTopicRule.CloudwatchMetricActionProperty", _IResolvable_9ceae33e
                ]
            ] = None,
            dynamo_db: typing.Optional[
                typing.Union[
                    "CfnTopicRule.DynamoDBActionProperty", _IResolvable_9ceae33e
                ]
            ] = None,
            dynamo_d_bv2: typing.Optional[
                typing.Union[
                    "CfnTopicRule.DynamoDBv2ActionProperty", _IResolvable_9ceae33e
                ]
            ] = None,
            elasticsearch: typing.Optional[
                typing.Union[
                    "CfnTopicRule.ElasticsearchActionProperty", _IResolvable_9ceae33e
                ]
            ] = None,
            firehose: typing.Optional[
                typing.Union[
                    "CfnTopicRule.FirehoseActionProperty", _IResolvable_9ceae33e
                ]
            ] = None,
            http: typing.Optional[
                typing.Union["CfnTopicRule.HttpActionProperty", _IResolvable_9ceae33e]
            ] = None,
            iot_analytics: typing.Optional[
                typing.Union[
                    "CfnTopicRule.IotAnalyticsActionProperty", _IResolvable_9ceae33e
                ]
            ] = None,
            iot_events: typing.Optional[
                typing.Union[
                    "CfnTopicRule.IotEventsActionProperty", _IResolvable_9ceae33e
                ]
            ] = None,
            iot_site_wise: typing.Optional[
                typing.Union[
                    "CfnTopicRule.IotSiteWiseActionProperty", _IResolvable_9ceae33e
                ]
            ] = None,
            kinesis: typing.Optional[
                typing.Union[
                    "CfnTopicRule.KinesisActionProperty", _IResolvable_9ceae33e
                ]
            ] = None,
            lambda_: typing.Optional[
                typing.Union["CfnTopicRule.LambdaActionProperty", _IResolvable_9ceae33e]
            ] = None,
            republish: typing.Optional[
                typing.Union[
                    "CfnTopicRule.RepublishActionProperty", _IResolvable_9ceae33e
                ]
            ] = None,
            s3: typing.Optional[
                typing.Union["CfnTopicRule.S3ActionProperty", _IResolvable_9ceae33e]
            ] = None,
            sns: typing.Optional[
                typing.Union["CfnTopicRule.SnsActionProperty", _IResolvable_9ceae33e]
            ] = None,
            sqs: typing.Optional[
                typing.Union["CfnTopicRule.SqsActionProperty", _IResolvable_9ceae33e]
            ] = None,
            step_functions: typing.Optional[
                typing.Union[
                    "CfnTopicRule.StepFunctionsActionProperty", _IResolvable_9ceae33e
                ]
            ] = None,
        ) -> None:
            """
        ...
        def dynamo_db(
            ...
            typing.Union["CfnTopicRule.DynamoDBActionProperty", _IResolvable_9ceae33e]
        ]:
        ...
        def dynamo_d_bv2(
            ...
            typing.Union["CfnTopicRule.DynamoDBv2ActionProperty", _IResolvable_9ceae33e]
        ]:
        ...
        def firehose(
            ...
            typing.Union["CfnTopicRule.FirehoseActionProperty", _IResolvable_9ceae33e]
        ]:
        ...
        def iot_events(
            ...
            typing.Union["CfnTopicRule.IotEventsActionProperty", _IResolvable_9ceae33e]
        ]:
        ...
        def kinesis(
            ...
            typing.Union["CfnTopicRule.KinesisActionProperty", _IResolvable_9ceae33e]
        ]:
        ...
        def republish(
            ...
            typing.Union["CfnTopicRule.RepublishActionProperty", _IResolvable_9ceae33e]
        ]:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.AssetPropertyTimestampProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class AssetPropertyTimestampProperty:
        def __init__(
            self, *, time_in_seconds: str, offset_in_nanos: typing.Optional[str] = None
        ) -> None:
            """
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.AssetPropertyValueProperty",
        jsii_struct_bases=[],
        name_mapping={"timestamp": "timestamp", "value": "value", "quality": "quality"},
    )
        ...
        def __init__(
            ...
            *,
            timestamp: typing.Union[
                "CfnTopicRule.AssetPropertyTimestampProperty", _IResolvable_9ceae33e
            ],
            value: typing.Union[
                "CfnTopicRule.AssetPropertyVariantProperty", _IResolvable_9ceae33e
            ],
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.AssetPropertyVariantProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class AssetPropertyVariantProperty:
        def __init__(
            self,
            *,
            boolean_value: typing.Optional[str] = None,
            double_value: typing.Optional[str] = None,
            integer_value: typing.Optional[str] = None,
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.CloudwatchAlarmActionProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class CloudwatchAlarmActionProperty:
        def __init__(
            self, *, alarm_name: str, role_arn: str, state_reason: str, state_value: str
        ) -> None:
            """
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.CloudwatchMetricActionProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class CloudwatchMetricActionProperty:
        def __init__(
            ...
            *,
            ...
            metric_value: str,
            role_arn: str,
            metric_timestamp: typing.Optional[str] = None,
        ) -> None:
            """
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.DynamoDBActionProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class DynamoDBActionProperty:
        def __init__(
            ...
            *,
            ...
            role_arn: str,
            table_name: str,
            hash_key_type: typing.Optional[str] = None,
            payload_field: typing.Optional[str] = None,
            range_key_field: typing.Optional[str] = None,
            range_key_type: typing.Optional[str] = None,
            range_key_value: typing.Optional[str] = None,
        ) -> None:
            """
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.DynamoDBv2ActionProperty",
        jsii_struct_bases=[],
    ...
    class DynamoDBv2ActionProperty:
        def __init__(
            self,
            *,
            put_item: typing.Optional[
                typing.Union["CfnTopicRule.PutItemInputProperty", _IResolvable_9ceae33e]
            ] = None,
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.ElasticsearchActionProperty",
        jsii_struct_bases=[],
        name_mapping={
            "endpoint": "endpoint",
            "id": "id",
    ...
    class ElasticsearchActionProperty:
        def __init__(
            self, *, endpoint: str, id: str, index: str, role_arn: str, type: str
        ) -> None:
            """
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.FirehoseActionProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.HttpActionHeaderProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.HttpActionProperty",
        jsii_struct_bases=[],
        name_mapping={
            "url": "url",
            "auth": "auth",
    ...
    class HttpActionProperty:
        def __init__(
            ...
            *,
            ...
            auth: typing.Optional[
                typing.Union[
                    "CfnTopicRule.HttpAuthorizationProperty", _IResolvable_9ceae33e
                ]
            ] = None,
            confirmation_url: typing.Optional[str] = None,
        ...
        def headers(
            ...
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        "CfnTopicRule.HttpActionHeaderProperty", _IResolvable_9ceae33e
                    ]
                ],
            ]
        ]:
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.HttpAuthorizationProperty",
        jsii_struct_bases=[],
    ...
    class HttpAuthorizationProperty:
        def __init__(
            self,
            *,
            sigv4: typing.Optional[
                typing.Union[
                    "CfnTopicRule.SigV4AuthorizationProperty", _IResolvable_9ceae33e
                ]
            ] = None,
        ) -> None:
            """
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.IotAnalyticsActionProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.IotEventsActionProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.IotSiteWiseActionProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.KinesisActionProperty",
        jsii_struct_bases=[],
        name_mapping={
            "role_arn": "roleArn",
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.LambdaActionProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.PutAssetPropertyValueEntryProperty",
        jsii_struct_bases=[],
        name_mapping={
        ...
        def __init__(
            ...
            *,
            property_values: typing.Union[
                ...
                typing.List[
                    typing.Union[
                        "CfnTopicRule.AssetPropertyValueProperty", _IResolvable_9ceae33e
                    ]
                ],
            ],
            asset_id: typing.Optional[str] = None,
            entry_id: typing.Optional[str] = None,
            property_alias: typing.Optional[str] = None,
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.PutItemInputProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.RepublishActionProperty",
        jsii_struct_bases=[],
        name_mapping={"role_arn": "roleArn", "topic": "topic", "qos": "qos"},
    )
    class RepublishActionProperty:
        def __init__(
            self, *, role_arn: str, topic: str, qos: typing.Optional[jsii.Number] = None
        ) -> None:
            """
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.S3ActionProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.SigV4AuthorizationProperty",
        jsii_struct_bases=[],
        name_mapping={
            "role_arn": "roleArn",
    ...
    class SigV4AuthorizationProperty:
        def __init__(
            self, *, role_arn: str, service_name: str, signing_region: str
        ) -> None:
            """
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.SnsActionProperty",
        jsii_struct_bases=[],
        name_mapping={
            "role_arn": "roleArn",
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.SqsActionProperty",
        jsii_struct_bases=[],
        name_mapping={
            "queue_url": "queueUrl",
            "role_arn": "roleArn",
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.StepFunctionsActionProperty",
        jsii_struct_bases=[],
        name_mapping={
            "role_arn": "roleArn",
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.TopicRulePayloadProperty",
        jsii_struct_bases=[],
        name_mapping={
            "actions": "actions",
    ...
    class TopicRulePayloadProperty:
        def __init__(
            ...
            *,
            actions: typing.Union[
                _IResolvable_9ceae33e,
                typing.List[
                    typing.Union["CfnTopicRule.ActionProperty", _IResolvable_9ceae33e]
                ],
            ],
            rule_disabled: typing.Union[bool, _IResolvable_9ceae33e],
            sql: str,
            aws_iot_sql_version: typing.Optional[str] = None,
            description: typing.Optional[str] = None,
            error_action: typing.Optional[
                typing.Union["CfnTopicRule.ActionProperty", _IResolvable_9ceae33e]
            ] = None,
        ) -> None:
            """
        ...
        @builtins.property
        def rule_disabled(self) -> typing.Union[bool, _IResolvable_9ceae33e]:
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_iot.CfnTopicRuleProps",
    jsii_struct_bases=[],
...
class CfnTopicRuleProps:
    def __init__(
        ...
        *,
        topic_rule_payload: typing.Union[
            "CfnTopicRule.TopicRulePayloadProperty", _IResolvable_9ceae33e
        ],
        rule_name: typing.Optional[str] = None,
    ) -> None:
    ...
    def topic_rule_payload(
        self,
    ) -> typing.Union["CfnTopicRule.TopicRulePayloadProperty", _IResolvable_9ceae33e]:
        """``AWS::IoT::TopicRule.TopicRulePayload``.
