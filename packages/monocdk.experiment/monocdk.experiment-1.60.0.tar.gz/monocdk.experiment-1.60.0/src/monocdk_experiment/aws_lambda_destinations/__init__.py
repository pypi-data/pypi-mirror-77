...
from ..aws_lambda import (
    DestinationConfig as _DestinationConfig_ab93b607,
    IFunction as _IFunction_1c1de0bc,
    DestinationOptions as _DestinationOptions_4bc6a3c7,
    DestinationType as _DestinationType_644824de,
...
class EventBridgeDestination(
    ...
    jsii_type="monocdk-experiment.aws_lambda_destinations.EventBridgeDestination",
):
    ...
    def bind(
        ...
        *,
        type: _DestinationType_644824de,
    ) -> _DestinationConfig_ab93b607:
...
class LambdaDestination(
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_lambda_destinations.LambdaDestination",
):
    ...
    def __init__(
        self, fn: _IFunction_1c1de0bc, *, response_only: typing.Optional[bool] = None
    ) -> None:
        """
        :param fn: -
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_lambda_destinations.LambdaDestinationOptions",
    jsii_struct_bases=[],
...
class SnsDestination(
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_lambda_destinations.SnsDestination",
):
...
class SqsDestination(
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_lambda_destinations.SqsDestination",
):
