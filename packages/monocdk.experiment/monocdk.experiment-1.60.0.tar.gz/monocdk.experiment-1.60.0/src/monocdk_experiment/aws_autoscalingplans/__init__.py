...
class CfnScalingPlan(
    ...
    def __init__(
        ...
        *,
        application_source: typing.Union[
            "ApplicationSourceProperty", _IResolvable_9ceae33e
        ],
        scaling_instructions: typing.Union[
            _IResolvable_9ceae33e,
            typing.List[
                typing.Union["ScalingInstructionProperty", _IResolvable_9ceae33e]
            ],
        ],
    ) -> None:
    ...
    def scaling_instructions(
        ...
        _IResolvable_9ceae33e,
        typing.List[typing.Union["ScalingInstructionProperty", _IResolvable_9ceae33e]],
    ]:
            ...
            *,
            ...
            tag_filters: typing.Optional[
                typing.Union[
                    ...
                    typing.List[
                        typing.Union[
                            "CfnScalingPlan.TagFilterProperty", _IResolvable_9ceae33e
                        ]
                    ],
                ]
            ] = None,
    ...
    class CustomizedLoadMetricSpecificationProperty:
        ...
        def dimensions(
            ...
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        "CfnScalingPlan.MetricDimensionProperty", _IResolvable_9ceae33e
                    ]
                ],
            ]
        ]:
...
class CfnScalingPlanProps:
    def __init__(
        ...
        *,
        application_source: typing.Union[
            "CfnScalingPlan.ApplicationSourceProperty", _IResolvable_9ceae33e
        ],
        scaling_instructions: typing.Union[
            _IResolvable_9ceae33e,
            typing.List[
                typing.Union[
                    "CfnScalingPlan.ScalingInstructionProperty", _IResolvable_9ceae33e
                ]
            ],
        ],
    ) -> None:
