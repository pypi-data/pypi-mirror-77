...
class CfnStream(
    ...
    jsii_type="monocdk-experiment.aws_kinesis.CfnStream",
):
    ...
    def __init__(
        ...
        *,
        ...
        stream_encryption: typing.Optional[
            typing.Union["StreamEncryptionProperty", _IResolvable_9ceae33e]
        ] = None,
    ...
    @jsii.data_type(
        jsii_type="monocdk-experiment.aws_kinesis.CfnStream.StreamEncryptionProperty",
        jsii_struct_bases=[],
...
class CfnStreamConsumer(
    _CfnResource_7760e8e4,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_kinesis.CfnStreamConsumer",
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_kinesis.CfnStreamConsumerProps",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_kinesis.CfnStreamProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CfnStreamProps:
    def __init__(
        ...
        *,
        ...
        retention_period_hours: typing.Optional[jsii.Number] = None,
        stream_encryption: typing.Optional[
            typing.Union["CfnStream.StreamEncryptionProperty", _IResolvable_9ceae33e]
        ] = None,
        tags: typing.Optional[typing.List[_CfnTag_b4661f1a]] = None,
    ) -> None:
...
class Stream(
    _Resource_884d0774,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_kinesis.Stream",
):
    """A Kinesis stream.
    ...
    def from_stream_arn(
        cls, scope: _Construct_f50a3f53, id: str, stream_arn: str
    ) -> "IStream":
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_kinesis.StreamAttributes",
    jsii_struct_bases=[],
    name_mapping={"stream_arn": "streamArn", "encryption_key": "encryptionKey"},
)
class StreamAttributes:
    def __init__(
        self, *, stream_arn: str, encryption_key: typing.Optional[_IKey_3336c79d] = None
    ) -> None:
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_kinesis.StreamProps",
    jsii_struct_bases=[],
    name_mapping={
        "encryption": "encryption",
