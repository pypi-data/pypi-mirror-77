...
class IntradayRechargeOperationStrategy(OperationStrategy):
    ...
    def __init__(self, general_config: GeneralSimulationConfig, fcr_config: EnergyManagementConfig):
        ...
        self.__max_idm_power = fcr_config.max_idm_power  # Watt
        ...
        self.__fcr_reserve = 0.25  # h
        self.__flag_idm_charge = False  # Flag, if IDM is necessary to charge the storage system
        self.__flag_idm_discharge = False  # Flag, if IDM is necessary to dischrage the storage system
