...
from simses.simulation.storage_system.technology.hydrogen.electrolyzer.stack_model.electrolyzer_stack_model import ElectrolyzerStackModel
from simses.simulation.storage_system.technology.hydrogen.electrolyzer.stack_model.pem_electrolyzer_multi_dim_analytic_model.pem_efficiency_curves import \
    PemElectrolyzerEfficiencyCurves
from simses.simulation.storage_system.technology.hydrogen.electrolyzer.stack_model.pem_electrolyzer_multi_dim_analytic_model.pem_electrical_model import \
    PemElectricalModel
from simses.simulation.storage_system.technology.hydrogen.electrolyzer.stack_model.pem_electrolyzer_multi_dim_analytic_model.pem_fluid_model import PemFluidModel
...
from simses.simulation.storage_system.technology.hydrogen.electrolyzer.stack_model.pem_electrolyzer_multi_dim_analytic_model.pem_pressure_model import PemPressureModel
...
class PemElectrolyzerMultiDimAnalytic(ElectrolyzerStackModel):
    ...
    __HEAT_CAPACITY = 0.448  # c = 448 J/K/W for stacks >= 50 kW from: Maximilian Möckl ZAE
    ...
    def get_reference_voltage_eol(self, resistance_increase, exchange_current_decrease) -> float:
        ...
        ref_electrolyzer_state.pressure_cathode = 0  # barg
