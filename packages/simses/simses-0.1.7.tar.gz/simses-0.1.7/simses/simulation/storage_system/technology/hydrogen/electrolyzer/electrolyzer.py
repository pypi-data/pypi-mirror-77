...
from simses.simulation.storage_system.technology.hydrogen.electrolyzer.degradation_model.degradation_model import \
    DegradationModel
from simses.simulation.storage_system.technology.hydrogen.electrolyzer.electrolyzer_factory import ElectrolyzerFactory
...
class Electrolyzer:
    ...
    def __init__(self, system_id: int, storage_id: int, electrolyzer: str, max_power: float,
        ...
        self.__thermal_model: ThermalModel = factory.create_thermal_model(self.__stack_model, self.__water_heating,
                                                                          self.__pump, ambient_thermal_model)
        self.__degradation_model: DegradationModel = factory.create_degradation_model(self.__stack_model)
        self.__state: ElectrolyzerState = factory.create_state(system_id, storage_id, ambient_thermal_model, self.__stack_model)
        factory.close()
