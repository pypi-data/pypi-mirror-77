...
class HydrogenManagementSystem:
    ...
    def __init__(self, max_power_electrolyzer: float, max_power_fuel_cell: float, config: HydrogenConfig):
    ...
    def __power_in_range(self, state: HydrogenState):
        return -self.__max_discharge_power < state.power < self.__max_charge_power
