...
class EconomicAnalysisConfig(AnalysisConfig):
    ...
    @property
    def add_electricity_consumption_revenue_stream(self) -> bool:
        """ Determine if electricity costs are summed up """
        return self.get_property(self.__section, 'ADD_ELECTRCITY_CONSUMPTION_REVENUE_STREAM') in ['True']
