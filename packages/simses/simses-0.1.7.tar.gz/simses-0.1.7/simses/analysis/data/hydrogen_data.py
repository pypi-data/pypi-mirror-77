...
class HydrogenData(Data):
    ...
    def total_energy_h2_lhv(self):
        return get_sum_for(
            self.hydrogen_outflow) * self.__config.timestep * 2 * ConstantsHydrogen.MOLAR_MASS_HYDROGEN * ConstantsHydrogen.LHV_H2

    @property
    def total_amount_h2_kg(self):
        return get_sum_for(self.hydrogen_outflow) * self.__config.timestep * 2 * ConstantsHydrogen.MOLAR_MASS_HYDROGEN

    @property
    def total_amount_h2_nqm(self):
        return get_sum_for(self.hydrogen_outflow) * self.__config.timestep * 2 * \
               ConstantsHydrogen.MOLAR_MASS_HYDROGEN * ConstantsHydrogen.HYDROGEN_NORM_QUBIC_M
