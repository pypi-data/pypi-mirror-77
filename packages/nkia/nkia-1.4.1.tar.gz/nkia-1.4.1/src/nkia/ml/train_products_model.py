...
class trainProductsModel(object):
    ...
    def __init__(self, model_to_train, show_confusion_matrix=False):
        ...
        self.new_model_path, self.last_model_path = '/home/alvaro/Área de Trabalho/servicos-biodigital/src/nkia/ml/saved_model/category_model/1.4.1', '/home/alvaro/Área de Trabalho/servicos-biodigital/src/nkia/ml/saved_model/category_model/1.3.1'
        self.train_model()
    ...
    def standardize_model_version(self, output_list):
        ...
        another_model_new_version = another_model_path + '/' + ''.join(self.new_model_path.split('/')[-1]) 
        another_model_last_version = another_model_path + '/' + os.listdir(another_model_path)[0]

        os.rename(another_model_last_version, another_model_new_version)
