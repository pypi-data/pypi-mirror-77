    ...
    def __init__(
        ...
        *,
        ...
        delivery_options: typing.Optional[
            typing.Union["DeliveryOptionsProperty", aws_cdk.core.IResolvable]
        ] = None,
        reputation_options: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "ReputationOptionsProperty"]
        ] = None,
        sending_options: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "SendingOptionsProperty"]
        ] = None,
        tags: typing.Optional[typing.List["TagsProperty"]] = None,
        tracking_options: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "TrackingOptionsProperty"]
        ] = None,
    ) -> None:
...
class CfnConfigurationSetProps:
    def __init__(
        ...
        *,
        ...
        delivery_options: typing.Optional[
            typing.Union[
                "CfnConfigurationSet.DeliveryOptionsProperty", aws_cdk.core.IResolvable
            ]
        ] = None,
        reputation_options: typing.Optional[
            typing.Union[
        ...
        sending_options: typing.Optional[
            typing.Union[
                aws_cdk.core.IResolvable, "CfnConfigurationSet.SendingOptionsProperty"
            ]
        ] = None,
        tags: typing.Optional[typing.List["CfnConfigurationSet.TagsProperty"]] = None,
        tracking_options: typing.Optional[
            typing.Union[
                aws_cdk.core.IResolvable, "CfnConfigurationSet.TrackingOptionsProperty"
            ]
        ] = None,
    ) -> None:
    ...
    def reputation_options(
        ...
        typing.Union[
            aws_cdk.core.IResolvable, "CfnConfigurationSet.ReputationOptionsProperty"
        ]
    ]:
        """``AWS::PinpointEmail::ConfigurationSet.ReputationOptions``.
    ...
    def __init__(
        ...
        *,
        ...
        mail_from_attributes: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "MailFromAttributesProperty"]
        ] = None,
        tags: typing.Optional[typing.List["TagsProperty"]] = None,
    ) -> None:
...
class CfnIdentityProps:
    def __init__(
        ...
        *,
        ...
        mail_from_attributes: typing.Optional[
            typing.Union[
                aws_cdk.core.IResolvable, "CfnIdentity.MailFromAttributesProperty"
            ]
        ] = None,
    ...
    def mail_from_attributes(
        ...
        typing.Union[aws_cdk.core.IResolvable, "CfnIdentity.MailFromAttributesProperty"]
    ]:
        """``AWS::PinpointEmail::Identity.MailFromAttributes``.
