...
class VariantSet:
	...
	def to_dict(self, add_inheritance=True,
		...
		for variant in self.variant_dict :
			...
			variant_set_dict['variants'][var.variant_id] = {}
			variant_set_dict['variants'][var.variant_id]['chromosome'] = var.chrom
			variant_set_dict['variants'][var.variant_id]['position'] = var.pos
			variant_set_dict['variants'][var.variant_id]['ref'] = var.ref
			variant_set_dict['variants'][var.variant_id]['alt'] = var.alt
			variant_set_dict['variants'][var.variant_id]['filter_status'] = '|'.join(var.filter_status)

			variant_set_dict['variants'][var.variant_id]['worst_consequence'] = var.get_worst_consequence()

			if add_inheritance == True:

				variant_set_dict['variants'][var.variant_id]['inheritance_models'] = '|'.join(var.get_matching_inheritance_models(compound_het_dict= self.final_compound_hets,
																							lenient=lenient,
																							min_parental_gq_dn=min_parental_gq_dn,
																							min_parental_depth_dn =min_parental_depth_dn,
																							max_parental_alt_ref_ratio_dn= max_parental_alt_ref_ratio_dn,
			...
			variant_set_dict['variants'][var.variant_id]['info_annotations'] = deepcopy(var.info_annotations)

			variant_set_dict['variants'][var.variant_id]['transcript_annotations'] = deepcopy(var.transcript_annotations)


		

			variant_set_dict['variants'][var.variant_id]['genotypes'] = {}
		
			for sample in var.genotypes:

					variant_set_dict['variants'][var.variant_id]['genotypes'][sample] ={}
					variant_set_dict['variants'][var.variant_id]['genotypes'][sample]['genotype'] = '/'.join(var.genotypes[sample]['genotype'])
					variant_set_dict['variants'][var.variant_id]['genotypes'][sample]['allele_depths'] = ','.join(str(x) for x in var.genotypes[sample]['allele_depths'])
					variant_set_dict['variants'][var.variant_id]['genotypes'][sample]['depth'] = var.genotypes[sample]['depth']
					variant_set_dict['variants'][var.variant_id]['genotypes'][sample]['genotype_quality'] = var.genotypes[sample]['genotype_quality']
