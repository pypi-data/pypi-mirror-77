...
setup(
  name = 'ai-ops-libs',         # How you named your package folder
  packages = ['ai-ops-libs'],   # Chose the same as "name"
  ...
  keywords = ['Pytorch', 'Deep Learning', 'Neural Network'],   # Keywords that define your package best
