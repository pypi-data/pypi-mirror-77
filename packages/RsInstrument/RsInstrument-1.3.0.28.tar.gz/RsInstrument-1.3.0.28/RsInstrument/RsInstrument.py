...
class RsInstrument:
	_driver_version_const = '1.3.0.28'
	...
	def __init__(
		...
		Parameter options tokens examples:
			...
			- 'SelectVisa = 'pyvisa' - uses python implementation of VISA, where you do not need the VISA-C installation
