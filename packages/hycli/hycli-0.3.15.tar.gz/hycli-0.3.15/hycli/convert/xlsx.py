...
def write_workbook(
    output_path: str, sheets: List[dict], vat_validation, validation: bool,
):
...
def write_sheet(
    worksheet, records: list, bold_header, red_to_green_formats: list, validation: bool,
):
    ...
    for idx, row in enumerate(records):
        ...
        for key, value in row.items():
            ...
            if isinstance(value, tuple):
                ...
                column_value, probability, validation_errors = (value, None, None)
