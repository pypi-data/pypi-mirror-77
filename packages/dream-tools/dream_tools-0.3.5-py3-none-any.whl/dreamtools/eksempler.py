...
series = df.set_index(["afsender", "modtager"]).stack()
series.index.names = ["afsender", "modtager", "t"]
db.create_parameter("var_navn", ["afsender", "modtager", "t"], "beskrivelse", series, add_missing_domains=True)
