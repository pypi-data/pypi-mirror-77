...
@jsii.data_type(
    jsii_type="@aws-cdk/aws-appsync.BaseGraphqlTypeOptions",
    jsii_struct_bases=[],
    name_mapping={
        "is_list": "isList",
...
class BaseGraphqlTypeOptions:
    ...
    def __repr__(self) -> str:
        return "BaseGraphqlTypeOptions(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class Directive(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-appsync.Directive"):
    ...
    def custom(cls, statement: str) -> "Directive":
        ...
        :param statement: - the directive statement to append Note: doesn't guarantee functionality.
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"graphql_api_id": "graphqlApiId", "graphql_api_arn": "graphqlApiArn"},
)
...
class GraphqlType(
    ...
    def aws_date(
        ...
        *,
        ...
        :stability: experimental
        """
        options = BaseGraphqlTypeOptions(
    ...
    def intermediate(
        cls,
        *,
        intermediate_type: typing.Optional["InterfaceType"] = None,
        is_list: typing.Optional[bool] = None,
        is_required: typing.Optional[bool] = None,
        is_required_list: typing.Optional[bool] = None,
    ) -> "GraphqlType":
...
@jsii.data_type(
    ...
    jsii_struct_bases=[BaseGraphqlTypeOptions],
    name_mapping={
        "is_list": "isList",
        "is_required": "isRequired",
        "is_required_list": "isRequiredList",
...
class GraphqlTypeOptions(BaseGraphqlTypeOptions):
    def __init__(
        self,
        *,
        is_list: typing.Optional[bool] = None,
...
class InterfaceType(
    ...
    def __init__(
        self, name: str, *, definition: typing.Mapping[str, "GraphqlType"]
    ) -> None:
        """
        :param name: -
    ...
    @builtins.property
    @jsii.member(jsii_name="definition")
    def definition(self) -> typing.Mapping[str, "GraphqlType"]:
...
class IntermediateTypeProps:
    def __init__(self, *, definition: typing.Mapping[str, "GraphqlType"]) -> None:
...
class ObjectType(
    ...
    def __init__(
        ...
        *,
        ...
        definition: typing.Mapping[str, "GraphqlType"],
    ) -> None:
        """
        :param name: -
    ...
    @jsii.member(jsii_name="implementInterface")
    @builtins.classmethod
    def implement_interface(
        ...
        *,
        ...
        return jsii.sinvoke(cls, "implementInterface", [name, props])
...
class GraphQLApi(
    GraphqlApiBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-appsync.GraphQLApi"
):
    ...
    def add_type(
        ...
        *,
        ...
        return jsii.invoke(self, "addType", [name, props])

    @jsii.member(jsii_name="appendToSchema")
    def append_to_schema(
        ...
        :stability: experimental
        """
        return jsii.invoke(self, "appendToSchema", [addition, delimiter])
