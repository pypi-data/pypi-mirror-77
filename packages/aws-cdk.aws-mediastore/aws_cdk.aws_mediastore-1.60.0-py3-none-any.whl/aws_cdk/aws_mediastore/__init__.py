...
class CfnContainer(
    ...
    def __init__(
        ...
        *,
        container_name: str,
        access_logging_enabled: typing.Optional[
            typing.Union[bool, aws_cdk.core.IResolvable]
        ] = None,
        cors_policy: typing.Optional[
            typing.Union[
                aws_cdk.core.IResolvable,
                typing.List[typing.Union[aws_cdk.core.IResolvable, "CorsRuleProperty"]],
            ]
        ] = None,
        lifecycle_policy: typing.Optional[str] = None,
        metric_policy: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "MetricPolicyProperty"]
        ] = None,
    ...
    class MetricPolicyProperty:
        def __init__(
            ...
            *,
            ...
            metric_policy_rules: typing.Optional[
                typing.Union[
                    aws_cdk.core.IResolvable,
                    typing.List[
                        typing.Union[
...
class CfnContainerProps:
        ...
        *,
        ...
        cors_policy: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        aws_cdk.core.IResolvable, "CfnContainer.CorsRuleProperty"
                    ]
                ],
            ]
        ] = None,
        lifecycle_policy: typing.Optional[str] = None,
        metric_policy: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "CfnContainer.MetricPolicyProperty"]
        ] = None,
        policy: typing.Optional[str] = None,
        tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]] = None,
    ) -> None:
    ...
    def cors_policy(
        ...
        typing.Union[
            aws_cdk.core.IResolvable,
            typing.List[
                typing.Union[aws_cdk.core.IResolvable, "CfnContainer.CorsRuleProperty"]
            ],
        ]
    ]:
        """``AWS::MediaStore::Container.CorsPolicy``.
