...
def initialize( modelfile="gpt_0.5.pth", #TODO: replace this model with the one Jamie has (the best GPT-2 only model so far)
    ...
    model.load_state_dict(torch.load(cur + "/GPT_MODELS/gpt_0.5.pth"))
    with torch.no_grad():
        model.eval()
    print("Model...")
