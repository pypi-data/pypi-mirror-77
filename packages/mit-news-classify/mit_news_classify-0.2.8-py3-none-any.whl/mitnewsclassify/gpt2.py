...
def initialize( modelfile="gpt_0.5.pth", #Jamie's model -- TODO: check if I can put the model in the folder it's supposed to be in
                ldloc = 'labelsdict.p', #name of the labels dictionary generated by nb.py (should be labels_dict.csv) -- TODO: check if Jamie's ordering of labels matches mine
    ...
    model.load_state_dict(torch.load(cur + "/GPT_MODELS/gpt_0.5.pth")['state_dict'])
    with torch.no_grad():
        model.eval()
    print("Model...")
