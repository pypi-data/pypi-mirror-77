...
class RawDataApi:
    ...
    def get_em_fund_hold_asset(self, start_date: str = '', end_date: str = ''):
        with RawDatabaseConnector().managed_session() as raw_session:
            try:
    ...
    def get_em_fund_hold_industry(self, end_date: str = ''):
        with RawDatabaseConnector().managed_session() as raw_session:
            try:
    ...
    def get_em_fund_hold_stock(self, end_date: str = ''):
        with RawDatabaseConnector().managed_session() as raw_session:
            try:
    ...
    def get_em_fund_hold_bond(self, end_date: str = ''):
        with RawDatabaseConnector().managed_session() as raw_session:
            try:
    ...
    def get_em_fund_mng_change(self):
        with RawDatabaseConnector().managed_session() as db_session:
            try:
                query = db_session.query(
                    EMFundMngChange
    ...
    def get_em_fund_com_core_mng(self):
        with RawDatabaseConnector().managed_session() as db_session:
            try:
                query = db_session.query(
                    EMFundCompCoreMng
    ...
    def em_stock_dividend(self, end_date: str = ''):
        with RawDatabaseConnector().managed_session() as raw_session:
            try:
    ...
    def em_bond_rating(self, end_date: str = ''):
        with RawDatabaseConnector().managed_session() as raw_session:
            try:
