...
class Performer(object):
    ...
    def __init__(self, key=None, max_work_shifts=31, performer_features=[], transport_restrictions=None, own_transport_type=None, local_vars_configuration=None):  # noqa: E501
