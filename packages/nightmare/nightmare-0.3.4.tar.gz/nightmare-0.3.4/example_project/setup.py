...
setuptools.setup(
    name="nightmare", # Put your username here!
    version="0.3.4", #The version of your package!
    author="Team ViewSelect", # Your name here!
    author_email="teamviewselect@gmail.com", # Your e-mail here!
    description="OFFICIAL API FOR https://crackhead.ml", # A short description here!
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://crackhead.ml", # Link your package website here! (most commonly a GitHub repo)
