...
class ReportFilter(object):
    ...
    Attributes:
     ...
     - componentNames
     - bugPathLength
     - outstandingReportDate
    """


    def __init__(self, filepath=None, checkerMsg=None, checkerName=None, reportHash=None, severity=None, reviewStatus=None, detectionStatus=None, runHistoryTag=None, firstDetectionDate=None, fixDate=None, isUnique=None, runName=None, runTag=None, componentNames=None, bugPathLength=None, outstandingReportDate=None,):
        self.filepath = filepath
        self.checkerMsg = checkerMsg
        ...
        self.bugPathLength = bugPathLength
        self.outstandingReportDate = outstandingReportDate
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.I64:
                    self.outstandingReportDate = iprot.readI64()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.bugPathLength is not None:
            ...
            oprot.writeFieldEnd()
        if self.outstandingReportDate is not None:
            oprot.writeFieldBegin('outstandingReportDate', TType.I64, 16)
            oprot.writeI64(self.outstandingReportDate)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class CompareData(object):
    ...
    def __init__(self, runIds=None, diffType=None, runTag=None, outstandingReportDate=None,):
        self.runIds = runIds
    ...
    def write(self, oprot):
        ...
        if self.runTag is not None:
            ...
            oprot.writeFieldEnd()
        if self.outstandingReportDate is not None:
            oprot.writeFieldBegin('outstandingReportDate', TType.I64, 4)
            oprot.writeI64(self.outstandingReportDate)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
ReportFilter.thrift_spec = (
    ...
    (16, TType.I64, 'outstandingReportDate', None, None, ),  # 16
)
...
CompareData.thrift_spec = (
    ...
    (4, TType.I64, 'outstandingReportDate', None, None, ),  # 4
)
