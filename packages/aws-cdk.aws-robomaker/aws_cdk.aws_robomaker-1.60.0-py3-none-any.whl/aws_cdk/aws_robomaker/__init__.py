...
class CfnRobotApplication(
    ...
    def __init__(
        ...
        *,
        robot_software_suite: typing.Union[
            "RobotSoftwareSuiteProperty", aws_cdk.core.IResolvable
        ],
        sources: typing.Union[
            aws_cdk.core.IResolvable,
            typing.List[typing.Union[aws_cdk.core.IResolvable, "SourceConfigProperty"]],
        ],
    ...
    def robot_software_suite(
        self,
    ) -> typing.Union["RobotSoftwareSuiteProperty", aws_cdk.core.IResolvable]:
    ...
    def robot_software_suite(
        self,
        value: typing.Union["RobotSoftwareSuiteProperty", aws_cdk.core.IResolvable],
    ) -> None:
...
class CfnRobotApplicationProps:
    def __init__(
        ...
        *,
        robot_software_suite: typing.Union[
            "CfnRobotApplication.RobotSoftwareSuiteProperty", aws_cdk.core.IResolvable
        ],
        sources: typing.Union[
            aws_cdk.core.IResolvable,
            typing.List[
                typing.Union[
                    aws_cdk.core.IResolvable, "CfnRobotApplication.SourceConfigProperty"
                ]
            ],
        ],
        current_revision_id: typing.Optional[str] = None,
...
class CfnSimulationApplication(
    ...
    def __init__(
        ...
        *,
        rendering_engine: typing.Union[
            aws_cdk.core.IResolvable, "RenderingEngineProperty"
        ],
        robot_software_suite: typing.Union[
            aws_cdk.core.IResolvable, "RobotSoftwareSuiteProperty"
        ],
        simulation_software_suite: typing.Union[
            aws_cdk.core.IResolvable, "SimulationSoftwareSuiteProperty"
        ],
        sources: typing.Union[
            aws_cdk.core.IResolvable,
            typing.List[typing.Union[aws_cdk.core.IResolvable, "SourceConfigProperty"]],
    ...
    def rendering_engine(
        self,
    ) -> typing.Union[aws_cdk.core.IResolvable, "RenderingEngineProperty"]:
    ...
    def rendering_engine(
        self, value: typing.Union[aws_cdk.core.IResolvable, "RenderingEngineProperty"]
    ) -> None:
    ...
    def robot_software_suite(
        self,
    ) -> typing.Union[aws_cdk.core.IResolvable, "RobotSoftwareSuiteProperty"]:
    ...
    def robot_software_suite(
        self,
        value: typing.Union[aws_cdk.core.IResolvable, "RobotSoftwareSuiteProperty"],
    ) -> None:
        jsii.set(self, "robotSoftwareSuite", value)
    ...
    def simulation_software_suite(
        self,
    ) -> typing.Union[aws_cdk.core.IResolvable, "SimulationSoftwareSuiteProperty"]:
...
class CfnSimulationApplicationProps:
    def __init__(
        ...
        *,
        rendering_engine: typing.Union[
            aws_cdk.core.IResolvable, "CfnSimulationApplication.RenderingEngineProperty"
        ],
        robot_software_suite: typing.Union[
            aws_cdk.core.IResolvable,
    ...
    def robot_software_suite(
        ...
        aws_cdk.core.IResolvable, "CfnSimulationApplication.RobotSoftwareSuiteProperty"
    ]:
        """``AWS::RoboMaker::SimulationApplication.RobotSoftwareSuite``.
