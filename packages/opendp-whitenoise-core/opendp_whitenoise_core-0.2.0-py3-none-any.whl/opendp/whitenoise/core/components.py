...
Don't modify this file manually. (Generated: 2020-08-14 03:23:44.333777)
"""
...
def column_bind(data, names, **kwargs):
    """
    ColumnBind Component
    
    Name columns of an array or indexmap to produce a Dataframe with the specified names
...
def dp_count(data, lower=0, upper=None, distinct=False, mechanism="SimpleGeometric", privacy_usage=None, **kwargs):
    ...
    :param distinct: Set to true for the number of unique members in the data.
    :param mechanism: Privatizing mechanism to use. One of [`SimpleGeometric`, `Laplace`, `Gaussian`]. Only `SimpleGeometric` is accepted if floating-point protections are enabled.
...
def dp_median(data, candidates=None, mechanism='Automatic', privacy_usage=None, interpolation="midpoint", **kwargs):
    """
    DPMedian Component
...
def dp_sum(data, lower=None, upper=None, mechanism="Automatic", privacy_usage=None, **kwargs):
    ...
    :param mechanism: Privatizing mechanism to use. One of [`Automatic`, `Laplace`, `Gaussian`, `SimpleGeometric`]. `Automatic` chooses based on the input data type.
    :param privacy_usage: Object describing the type and amount of privacy to be used for the mechanism release.
    :param kwargs: data bounds of the form [argument]_[bound]=[lower | upper | categories | ...]
...
def simple_geometric_mechanism(data, lower, upper, privacy_usage=None, **kwargs):
    """
