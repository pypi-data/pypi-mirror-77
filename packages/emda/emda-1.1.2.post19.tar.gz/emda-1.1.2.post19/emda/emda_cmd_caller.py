...
cmdl_parser.add_argument('--version', action='version', 
                                      version='%(prog)s-' + emda.config.__version__)

subparsers = cmdl_parser.add_subparsers(title="available commands",dest='command')
...
def overallcc(args):
    ...
    occ, hocc = overall_cc(map1name=args.m1, 
                     map2name=args.m2, 
                     maskname=args.msk, 
                     space=args.spc)
