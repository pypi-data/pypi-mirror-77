...
It should be somewhere inside the Destination Directory. Check the Preview pane.""".format(override_flag))
            return
...
If you continue, your submission will probably fail. 
Images should be written somewhere below the Destination Directory. 
You should change either the path in Render Settings, or the Conductor destination directory.""".format(label))
                        return
            except ValueError:
                self.add_warning(
                    """The {} path set in Render Settings is not a valid path. 
If you continue, your submission will probably fail. 
Images should be written somewhere below the Destination Directory as specified in the general section of the Conductor dialog. 
You should change either the path in Render Settings, or the Conductor destination directory.""".format(label))
                return
        self.add_warning(
