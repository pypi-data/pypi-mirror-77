    ...
    """
{
    ...
    "package_data": {
        "cloudcomponents.cdk_codepipeline_slack._jsii": [
            "cdk-codepipeline-slack@1.0.82.jsii.tgz"
        ],
        "cloudcomponents.cdk_codepipeline_slack": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-codebuild>=1.61.0, <2.0.0",
        "aws-cdk.aws-codepipeline-actions>=1.61.0, <2.0.0",
        "aws-cdk.aws-codepipeline>=1.61.0, <2.0.0",
        "aws-cdk.aws-events-targets>=1.61.0, <2.0.0",
        "aws-cdk.aws-events>=1.61.0, <2.0.0",
        "aws-cdk.aws-iam>=1.61.0, <2.0.0",
        "aws-cdk.aws-lambda>=1.61.0, <2.0.0",
        "aws-cdk.aws-s3>=1.61.0, <2.0.0",
        "aws-cdk.aws-sns-subscriptions>=1.61.0, <2.0.0",
        "aws-cdk.aws-sns>=1.61.0, <2.0.0",
