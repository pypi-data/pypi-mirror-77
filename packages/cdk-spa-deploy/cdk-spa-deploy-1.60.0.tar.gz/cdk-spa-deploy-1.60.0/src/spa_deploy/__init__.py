...
class HostedZoneConfig:
    def __init__(
        ...
        *,
        ...
        website_folder: str,
        zone_name: str,
        error_doc: typing.Optional[str] = None,
    ) -> None:
        """
        :param index_doc: -
...
class SPADeploy(
    ...
    def __init__(
        ...
        id: str,
        *,
        encrypt_bucket: typing.Optional[bool] = None,
        ip_filter: typing.Optional[bool] = None,
        ip_list: typing.Optional[typing.List[str]] = None,
    ) -> None:
        """
        :param scope: -
        :param id: -
    ...
    def create_basic_site(
        ...
        *,
        ...
        cf_aliases: typing.Optional[typing.List[str]] = None,
        error_doc: typing.Optional[str] = None,
        export_website_url_name: typing.Optional[str] = None,
        export_website_url_output: typing.Optional[bool] = None,
    ) -> "SPADeployment":
...
class SPADeployment:
    ...
    def website_bucket(self) -> aws_cdk.aws_s3.Bucket:
        return self._values.get("website_bucket")
