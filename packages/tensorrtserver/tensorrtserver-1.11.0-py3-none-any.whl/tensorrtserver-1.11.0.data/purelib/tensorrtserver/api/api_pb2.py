...
_INFERSHAREDMEMORY = _descriptor.Descriptor(
  name='InferSharedMemory',
  full_name='nvidia.inferenceserver.InferSharedMemory',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='nvidia.inferenceserver.InferSharedMemory.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='offset', full_name='nvidia.inferenceserver.InferSharedMemory.offset', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='byte_size', full_name='nvidia.inferenceserver.InferSharedMemory.byte_size', index=2,
...
_INFERREQUESTHEADER_INPUT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='shared_memory', full_name='nvidia.inferenceserver.InferRequestHeader.Input.shared_memory', index=3,
...
_INFERREQUESTHEADER_OUTPUT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='shared_memory', full_name='nvidia.inferenceserver.InferRequestHeader.Output.shared_memory', index=2,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_INFERREQUESTHEADER_INPUT.fields_by_name['shared_memory'].message_type = _INFERSHAREDMEMORY
...
_INFERREQUESTHEADER_OUTPUT.fields_by_name['shared_memory'].message_type = _INFERSHAREDMEMORY
...
DESCRIPTOR.message_types_by_name['InferSharedMemory'] = _INFERSHAREDMEMORY
...
InferSharedMemory = _reflection.GeneratedProtocolMessageType('InferSharedMemory', (_message.Message,), dict(
  DESCRIPTOR = _INFERSHAREDMEMORY,
  __module__ = 'api_pb2'
  # @@protoc_insertion_point(class_scope:nvidia.inferenceserver.InferSharedMemory)
  ))
_sym_db.RegisterMessage(InferSharedMemory)
