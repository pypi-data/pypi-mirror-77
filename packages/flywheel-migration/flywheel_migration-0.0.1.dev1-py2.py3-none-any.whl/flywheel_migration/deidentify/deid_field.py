...
class DeIdField:
    ...
    def __init__(self, fieldname, is_regex=False):
    ...
    def factory(cls, config):
        ...
        for subclass in cls.__subclasses__():
            for key in config.keys():
                if subclass.key == key:
                    result = subclass(fieldname, is_regex=is_regex)
                    break
            if result:
                break
...
class DeIdRegexSubField(DeIdField):
    ...
    def __init__(self, fieldname, is_regex=False):
        super(DeIdRegexSubField, self).__init__(fieldname, is_regex=is_regex)
...
class DeIdRegexSubListItem:
    ...
    def _load_group_config(self, group_list):
        ...
        for group_config in group_list:
            group_member_field = DeIdField.factory(group_config)
