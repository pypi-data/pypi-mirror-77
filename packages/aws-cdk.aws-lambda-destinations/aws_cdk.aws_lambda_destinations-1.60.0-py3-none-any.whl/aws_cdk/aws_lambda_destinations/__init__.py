...
class EventBridgeDestination(
    ...
    def __init__(
        self, event_bus: typing.Optional[aws_cdk.aws_events.IEventBus] = None
    ) -> None:
        """
        :param event_bus: -
...
class LambdaDestination(
    ...
    def __init__(
        ...
        fn: aws_cdk.aws_lambda.IFunction,
        *,
        response_only: typing.Optional[bool] = None,
    ) -> None:
        """
        :param fn: -
...
class SnsDestination(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-lambda-destinations.SnsDestination"
):
...
class SqsDestination(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-lambda-destinations.SqsDestination"
):
