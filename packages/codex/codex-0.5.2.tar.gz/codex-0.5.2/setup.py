...
{'': ['*'],
 'codex': ['static_root/*',
           ...
           'templates/admin/*',
           'templates/admin/codex/adminflag/change_list.html',
           'templates/admin/codex/library/change_list.html',
