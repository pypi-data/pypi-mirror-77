...
def create_custom_entities(
    *, client: Client, json_body: CustomEntityCreate,
    ...
    response = httpx.post(url=url, headers=client.get_headers(), json=json_body,)
...
def update_custom_entity(
    *, client: Client, custom_entity_id: str, json_body: CustomEntityPatch,
    ...
    response = httpx.patch(url=url, headers=client.get_headers(), json=json_body,)
...
def bulk_create_custom_entities(
