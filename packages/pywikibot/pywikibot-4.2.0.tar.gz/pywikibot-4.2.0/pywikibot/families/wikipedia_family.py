...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'vi', 'ja', 'zh', 'arz', 'ar', 'pt', 'uk', 'fa', 'ca', 'sr', 'id',
        ...
        'lv', 'tg', 'zh-yue', 'bn', 'mg', 'af', 'oc', 'bs', 'sq', 'ky', 'nds',
        'new', 'be-tarask', 'ml', 'te', 'tl', 'br', 'pms', 'su', 'mr', 'sw',
        'ht', 'lb', 'sco', 'vec', 'jv', 'pnb', 'ga', 'ba', 'szl', 'is', 'my',
        'fy', 'cv', 'lmo', 'wuu', 'an', 'pa', 'ne', 'yo', 'bar', 'ku', 'diq',
        'io', 'gu', 'als', 'ckb', 'kn', 'scn', 'bpy', 'qu', 'ia', 'mn',
        'bat-smg', 'or', 'nv', 'si', 'cdo', 'ilo', 'gd', 'am', 'yi', 'nap',
        'bug', 'wa', 'xmf', 'sd', 'hsb', 'mai', 'map-bms', 'fo', 'mzn', 'li',
        'sah', 'eml', 'os', 'ps', 'sa', 'frr', 'bcl', 'zh-classical', 'ace',
        'mrj', 'mhr', 'hif', 'hak', 'roa-tara', 'avk', 'pam', 'gor', 'hyw',
        'km', 'nso', 'rue', 'se', 'crh', 'bh', 'shn', 'vls', 'as', 'mi',
        'nds-nl', 'nah', 'sc', 'vep', 'gan', 'myv', 'ab', 'glk', 'bo', 'sn',
        'co', 'so', 'tk', 'fiu-vro', 'lrc', 'csb', 'kv', 'ha', 'ie', 'gv',
        'udm', 'pcd', 'ay', 'zea', 'kab', 'nrm', 'sat', 'ug', 'lij', 'kw',
        'lez', 'stq', 'frp', 'lfn', 'zu', 'gn', 'mwl', 'gom', 'rm', 'ban',
        'mt', 'lo', 'lad', 'koi', 'fur', 'olo', 'dty', 'ang', 'dsb', 'bjn',
        'ext', 'ln', 'cbk-zam', 'dv', 'ksh', 'gag', 'pfl', 'tyv', 'pag', 'pi',
        'av', 'awa', 'haw', 'bxr', 'ary', 'xal', 'krc', 'pap', 'za', 'pdc',
        'kaa', 'rw', 'szy', 'arc', 'to', 'nov', 'jam', 'tpi', 'kbp', 'kbd',
        'ig', 'na', 'tet', 'inh', 'wo', 'tcy', 'ki', 'jbo', 'atj', 'roa-rup',
        'bi', 'lbe', 'kg', 'ty', 'lg', 'mdf', 'srn', 'xh', 'gcr', 'ltg', 'fj',
        'chr', 'ak', 'sm', 'lld', 'kl', 'om', 'got', 'pih', 'cu', 'ny', 'tn',
        'tw', 'nqo', 'st', 'ts', 'rmy', 'bm', 'mnw', 'chy', 'rn', 'tum', 'ss',
