...
def main():
    ...
    validationobj = ValidationAnalysis(inputmap, inputmodel, pid, halfeven, halfodd, rawmap,
                                       contourlevel, emdid, dir, emmethod, resolution, fscfile, masks, modelsmaps)
