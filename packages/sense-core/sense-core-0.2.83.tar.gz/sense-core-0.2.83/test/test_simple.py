...
def test_mq_delay_produce():
    ...
    for _k in range(1, 20):
        ...
        produce.send_safely(topic='lk_alg_delay_queue', message=json.dumps(st), delay=1, dlx_queue='lk_relay',
                            dlx_exchange='lk_relay_exchange', dlx_routing='lk_relay_exchange', ttl=60000)
