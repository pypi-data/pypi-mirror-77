...
def SCDotNetReference(configurationfile: str):
    ...
    if configparser.getboolean('dotnet', 'generatereference'):
        ...
        shutil.copyfile(_private_get_csprojfile_filename(configparser)+os.path.sep+_private_get_coverage_filename(configparser), _private_get_buildscript_config_item(configparser, 'dotnet', 'coveragefolder')+os.path.sep+os.path.sep+_private_get_coverage_filename(configparser))
