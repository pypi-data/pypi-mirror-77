...
def wf_bandstructure2D(structure, c=None):
    ...
    mpr2d = MPScanRelaxSet2D(structure, force_gamma=True, potcar_functional='PAW_PBE')
    '''check bandstructure.yaml'''
    wf = get_wf(structure, "bandstructure.yaml", vis=MPScanRelaxSet2D(structure, force_gamma=True, potcar_functional='PAW_PBE'), \
