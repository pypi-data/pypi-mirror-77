    ...
    def login(self):
        ...
        if self.body.login != None:
            ...
            if self.session != None and self.session._session != None:
                return self.session._session.get('ws_channel').split('_')[1]
        ...
        if self.body.login != None:
            ...
            if self.session != None and self.session._session != None:
                try:
                    ...
                    if ws_channel != None:
                        return User.objects.get(username=self.session._session.get('ws_channel').split('_')[1])
                    else:
                        return None
                except User.DoesNotExist:
                    raise Exception('user not enable type')
...
class DSResponse(RPCResponse):
    ...
    def __init__(self,
        ...
        if isinstance(data, list):
            ...
            if self.startRow != None and self.endRow != None:
