    ...
    def get_emissions_per_powertrain(self, powertrain_type, euro_class):
        ...
        if powertrain_type == "diesel":
            ...
            if euro_class == 6.0:
               ...
               "2.84e-08 * c ** 3 - 5.482e-06 * c ** 2 + 0.0002699 * c + 0.01125"
                ...
                #SO2
                em_arr[:, 7] = ne.evaluate(
                "3.993e-10 * c ** 3 - 7.997e-09 * c ** 2 - 5.447e-06 * c + 0.001213"
                )
                #N2O
                em_arr[:, 8] = 0.01
                #NH3
            ...
            if euro_class == 6.1:
                ...
                #SO2
                em_arr[:, 7] = ne.evaluate(
                "3.612e-10 * c ** 3 - 5.179e-09 * c ** 2 - 5.282e-06 * c + 0.001133"
                )
                #N2O
                em_arr[:, 8] = 0.01
                #NH3
            ...
            if euro_class == 6.2:
                ...
                #SO2
                em_arr[:, 7] = ne.evaluate(
                "3.238e-10 * c **3 + 2.633e-09 * c ** 2  - 5.843e-06 * c + 0.001135"
                )
                #N2O
                em_arr[:, 8] = 0.01
                #NH3
        ...
        if powertrain_type == "petrol":
            ...
            if euro_class == 6.0:
                ...
                # NMVOC
                em_arr[:, 5] = ne.evaluate(
                    "1.116e-08 * c ** 3 - 1.973e-06 * c ** 2 + 0.0001102 * c + 0.0006032"
                )
                # Pb
                em_arr[:, 6] = ne.evaluate(
                ...
                # SO2
                em_arr[:, 7] = ne.evaluate(
                    "-4.344e-10 * c ** 3 + 2.007e-07 * c ** 2 - 2.273e-05 * c + 0.001426"
                )
                # N2O
                em_arr[:, 8] = 2.5e-4
                # NH3
            ...
            if euro_class == 6.1:
                ...
                # NMVOC
                em_arr[:, 5] = ne.evaluate(
                    "4.401e-09 * c ** 3 - 8.06e-07 * c ** 2 + 5.285e-05 * c - 0.0005146"
                )
                # Pb
                em_arr[:, 6] = ne.evaluate(
                ...
                # SO2
                em_arr[:, 7] = ne.evaluate(
                    "-4.053e-10 * c ** 3 + 1.837e-07 * c ** 2 - 2.073e-05 * c + 0.001288"
                )
                # N2O
                em_arr[:, 8] = 2.5e-4
                # NH3
            ...
            if euro_class == 6.2:
                ...
                # NMVOC
                em_arr[:, 5] = ne.evaluate(
                    "-4.639e-09 * c ** 3 + 1.745e-06 * c ** 2 - 0.0001449 * c + 0.005121"
                )
                # Pb
                em_arr[:, 6] = ne.evaluate(
                ...
                # SO2
                em_arr[:, 7] = ne.evaluate(
                    "-3.808e-10 * c ** 3 + 1.743e-07 * c ** 2 - 1.972e-05 * c + 0.001247"
                )
                # N2O
                em_arr[:, 8] = 2.5e-4
                # NH3
            ...
            if euro_class == 6.3:
                ...
                # NMVOC
                em_arr[:, 5] = ne.evaluate(
                    "-6.554e-09 * c ** 3 + 2.199e-06 * c ** 2 - 0.0001784 * c + 0.005709"
                )
                # Pb
                em_arr[:, 6] = ne.evaluate(
                ...
                # SO2
                em_arr[:, 7] = ne.evaluate(
                    "-2.917e-10 * c ** 3 + 1.42e-07 * c ** 2 - 1.625e-05 * c + 0.001087"
                )
                # N2O
                em_arr[:, 8] = 2.5e-4
                # NH3
