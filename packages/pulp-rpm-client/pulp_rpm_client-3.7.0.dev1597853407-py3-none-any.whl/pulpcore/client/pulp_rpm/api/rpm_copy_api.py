...
class RpmCopyApi(object):
    ...
    def create(self, copy, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create(copy, async_req=True)
        >>> result = thread.get()
        ...
        return self.create_with_http_info(copy, **kwargs)  # noqa: E501

    def create_with_http_info(self, copy, **kwargs):  # noqa: E501
        """Copy content  # noqa: E501

        Trigger an asynchronous task to copy RPM contentfrom one repository into another, creating a newrepository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_with_http_info(copy, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('copy' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `copy` when calling `create`")  # noqa: E501
