...
def generate_runner_parser():
    ...
    parser.add_argument("-v", "--environment", "--env", type=str, required=False, default='qa',
...
class AppTestRun:
    ...
    def initialize(self, args):
        ...
        setup_env_params(environment, update_main_envs=True)
        ...
        step = args.timestep
        self.event_type = constants.get('global.event_type')
    ...
    def run(self):
        print("Running the main module started ...")
