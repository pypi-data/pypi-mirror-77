...
from worker.data.operations import setup_env_params
...
class ToLocalTransfer(LoggingMixin):
    ...
    def __init__(self, args):
        ...
        self._source_api_worker = None
        self._local_api_worker = None
        self._local_redis_worker = None
    ...
    def initialize(self, args):
        ...
        self._source_api_worker, _ = setup_env_params(self.source_env, self.app_name)
        self._local_api_worker, self._local_redis_worker = setup_env_params(self.local_env, self.app_name)
    ...
    def source_api_worker(self):
        return self._source_api_worker

    @cached_property
    def local_api_worker(self):
        return self._local_api_worker

    @cached_property
    def local_redis_worker(self):
        return self._local_redis_worker
    ...
    def store_config_data(self):
        ...
        for col in self.CONFIG_COLLECTIONS:
            ...
            for r in records:
                r['company_id'] = 1
                r['asset_id'] = self.local_asset_id
                r.pop('_id', None)
