    ...
    def __init__(
        ...
        *,
        ...
        acceleration_settings: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "AccelerationSettingsProperty"]
        ] = None,
        ...
        hop_destinations: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union[aws_cdk.core.IResolvable, "HopDestinationProperty"]
                ],
            ]
        ] = None,
...
class CfnJobTemplateProps:
    def __init__(
        ...
        *,
        ...
        acceleration_settings: typing.Optional[
            typing.Union[
                aws_cdk.core.IResolvable, "CfnJobTemplate.AccelerationSettingsProperty"
            ]
        ] = None,
        category: typing.Optional[str] = None,
        description: typing.Optional[str] = None,
