...
def main():
	...
	if options.plot_alpha:
		...
		print ('plot(PC1, PC2, col = alpha(Colors, %f), pch=%d, cex=%f, main="PCA 2D map")' % (options.plot_alpha, pch[options.plot_char], options.dot_size), file=ROUT)
	else:
		print ('plot(PC1, PC2, col = Colors, pch=%d, cex=%f, main="PCA 2D map")' % (pch[options.plot_char], options.dot_size), file=ROUT)	
