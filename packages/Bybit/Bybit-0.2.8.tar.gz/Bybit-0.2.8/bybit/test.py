import bybit
#
client = bybit.bybit(test=True, api_key="rHWpqFVAnlTdqTNODX", api_secret="eDZZGzzkojYaf96xKUowGOhlNQEuebOPNEE1")
#
# # # Get server time
...
# print(client.Conditional.Conditional_new(order_type="Limit",side="Buy",symbol="BTCUSD",qty=1,price=8100,base_price=8300,stop_px=8150,time_in_force="GoodTillCancel", order_link_id="cus_order_id_2").result())
# #
# # #Get Conditional Order
# print(client.Conditional.Conditional_getOrders(stop_order_status="Untriggered").result())
# #
# # #Cancel conditional order
# print(client.Conditional.Conditional_cancel(symbol="BTCUSD", stop_order_id="a85b7718-aba9-4a6a-be02-90502012c4b5").result())
# #
# # #changeMargin
