    ...
    """
{
    ...
    "package_data": {
        "cloudcomponents.cdk_cloudfront_authorization._jsii": [
            "cdk-cloudfront-authorization@1.1.3.jsii.tgz"
        ],
        "cloudcomponents.cdk_cloudfront_authorization": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-cloudfront-origins>=1.61.0, <2.0.0",
        "aws-cdk.aws-cloudfront>=1.61.0, <2.0.0",
        "aws-cdk.aws-cognito>=1.61.0, <2.0.0",
        "aws-cdk.aws-iam>=1.61.0, <2.0.0",
        "aws-cdk.aws-lambda>=1.61.0, <2.0.0",
        "aws-cdk.aws-s3>=1.61.0, <2.0.0",
        "aws-cdk.core>=1.61.0, <2.0.0",
        "aws-cdk.custom-resources>=1.61.0, <2.0.0",
        "cloudcomponents.cdk-deletable-bucket>=1.0.27, <2.0.0",
        "cloudcomponents.cdk-lambda-at-edge-pattern>=1.0.10, <2.0.0",
