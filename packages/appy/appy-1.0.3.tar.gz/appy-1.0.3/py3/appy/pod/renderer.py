...
class Renderer:
    ...
    def __init__(self, template, context, result, pythonWithUnoPath=None,
      ...
      pageStart=1, tabbedCR=False, fonts=None):
    ...
    def importPod(self, content=None, at=None, format='odt', context=None,
          ...
          managePageStyles='rename', resolveFields=False, forceOoCall=INHERIT):
        ...
        # renderer ran by a PodImporter will inherit from this attribute,
