...
#- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# In the UI config as defined hereafter, several attributes will hold the path
# to a static resource (image, CSS file, etc) coming from Appy itself, from your
# app or ext. In your app/ext, if you use the standard Appy conventions, any
# static resource is located in its "static" sub-folder. If you want to refer to
# such a static resource from your app/ext, use a string of the form
#
#                "<app or ext name>/<name of the static resource>"
#
# Here is an example. Suppose you app is named "myApp". In myApp/static, you
# have an image name "myBackground.png" that you want to use as background image
# for the home page.
#
# In your UI Config instance, you must specify, for attribute "homeBackground",
#
#                         "myApp/myBackground.png"
#
# Resources coming from Appy itself follow the same syntax, with one difference:
# the <app name> part is replaced with "appy".
...
class Config:
    ...
    def __init__(self):
        # For specifying paths to static resources, consult the doc at the start
        # of this file.
        # ~~~
        ...
        self.headerLogo = None
        # The logo at the top of the portlet
        ...
        self.headerBgColor = '#002039'
        # Text color for links
        self.linkColor = '#002039'
        self.visitedColor = '#002039'
        # Alternate text color, also used for button borders other discreet
        # places.
        ...
        self.tabBorder = '1px solid %s' % self.linkColor
...
class Sidebar:
    ...
    px = Px('''
     ...
     css='''.sidebar { padding: 28px 8px 30px 0px;
