...
class Executor(Base):
    ...
    def _init_pipeline(self):
        self._vp.verbose_print("Start initializing pipeline")
        ...
        self._vp.verbose_print("Finish initializing pipeline")
    ...
    def go(self):
        ...
        self.run_pipeline()
        self.cleanup_pipeline()
        self._vp.verbose_print("End of go")
