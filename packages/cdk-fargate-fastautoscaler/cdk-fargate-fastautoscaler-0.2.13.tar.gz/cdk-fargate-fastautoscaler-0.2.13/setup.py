    ...
    """
{
    ...
    "package_data": {
        "cdk_fargate_fastautoscaler._jsii": [
            "cdk-fargate-fastautoscaler@0.2.13.jsii.tgz"
        ],
        "cdk_fargate_fastautoscaler": [
            "py.typed"
        ]
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-ec2>=1.61.0, <2.0.0",
        "aws-cdk.aws-ecs>=1.61.0, <2.0.0",
        "aws-cdk.aws-elasticloadbalancingv2>=1.61.0, <2.0.0",
        "aws-cdk.aws-iam>=1.61.0, <2.0.0",
        "aws-cdk.aws-lambda>=1.61.0, <2.0.0",
        "aws-cdk.aws-sns>=1.61.0, <2.0.0",
        "aws-cdk.aws-stepfunctions-tasks>=1.61.0, <2.0.0",
        "aws-cdk.aws-stepfunctions>=1.61.0, <2.0.0",
