...
class FargateFastAutoscaler(
    ...
    def __init__(
        ...
        *,
        ...
        aws_cli_layer_arn: typing.Optional[str] = None,
        aws_cli_layer_version: typing.Optional[str] = None,
    ...
    def fargate_service(self) -> aws_cdk.aws_ecs.FargateService:
        ...
        :stability: experimental
        """
        return jsii.get(self, "fargateService")
    ...
    def fargate_task_def(self) -> aws_cdk.aws_ecs.FargateTaskDefinition:
        ...
        :stability: experimental
        """
        return jsii.get(self, "fargateTaskDef")

    @builtins.property
    @jsii.member(jsii_name="fargateWatcherFuncArn")
    def fargate_watcher_func_arn(self) -> str:
        """
        stability
        :stability: experimental
        """
        return jsii.get(self, "fargateWatcherFuncArn")
...
class FargateFastAutoscalerProps:
    ...
    def backend_container(self) -> aws_cdk.aws_ecs.ContainerDefinitionOptions:
        ...
        :stability: experimental
        """
        return self._values.get("backend_container")
    ...
    def backend_container_port_mapping(
        ...
        :stability: experimental
        """
        return self._values.get("backend_container_port_mapping")
    ...
    @builtins.property
    def aws_cli_layer_arn(self) -> typing.Optional[str]:
        ...
        :stability: experimental
        """
        return self._values.get("aws_cli_layer_arn")

    @builtins.property
    def aws_cli_layer_version(self) -> typing.Optional[str]:
        ...
        :stability: experimental
        """
        return self._values.get("aws_cli_layer_version")
    ...
    def initial_task_number(self) -> typing.Optional[jsii.Number]:
        ...
        :stability: experimental
        """
        return self._values.get("initial_task_number")
