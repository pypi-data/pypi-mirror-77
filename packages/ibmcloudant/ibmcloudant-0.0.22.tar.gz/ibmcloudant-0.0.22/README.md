...
[![Build Status](https://travis.ibm.com/cloudant/cloudant-python-sdk.svg?token=mznyNGrXDEQAGFgGBpfL&branch=master)](https://travis.ibm.com/cloudant/cloudant-python-sdk)
[![semantic-release](https://img.shields.io/badge/%20%20%F0%9F%93%A6%F0%9F%9A%80-semantic--release-e10079.svg)](https://github.com/semantic-release/semantic-release)

# IBM Cloudant Python SDK Version 0.0.22
...
```bash
pip install --upgrade "ibmcloudant>=0.0.22"
```

or

```bash
easy_install --upgrade "ibmcloudant>=0.0.22"
```
...
examples_client = CloudantV1.new_instance(service_name="EXAMPLES")

# 2. Get server information ===========================================
server_information = examples_client.get_server_information(
).get_result()
...
db_information = examples_client.get_database_information(
    db=db_name
).get_result()
...
document_about_zebra = examples_client.get_document(
    db=db_name,
    doc_id="zebra"
).get_result()
