...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'aiven', '3.1.0-alpha.1598472310+014b6e4d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource aiven 3.1.0-alpha.1598472310+014b6e4d`
                """)
            else:
                raise
