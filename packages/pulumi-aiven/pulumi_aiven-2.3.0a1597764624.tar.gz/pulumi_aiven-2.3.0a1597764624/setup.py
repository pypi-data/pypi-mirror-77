...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'aiven', '2.3.0-alpha.1597764624+80e5034f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource aiven 2.3.0-alpha.1597764624+80e5034f`
                """)
            else:
                raise
