...
class _IClusterParameterGroupProxy(jsii.proxy_for(aws_cdk.core.IResource)):
    ...
    __jsii_type__ = "@aws-cdk/aws-docdb.IClusterParameterGroup"
...
class _IDatabaseClusterProxy(
    ...
    __jsii_type__ = "@aws-cdk/aws-docdb.IDatabaseCluster"
...
class IDatabaseInstance(aws_cdk.core.IResource, jsii.compat.Protocol):
    """A database instance.
...
class _IDatabaseInstanceProxy(jsii.proxy_for(aws_cdk.core.IResource)):
    """A database instance.
    ...
    __jsii_type__ = "@aws-cdk/aws-docdb.IDatabaseInstance"
