...
class VolumeAPI(API):
    ...
    @deprecation.deprecated(
        ...
        details="Use VolumeAPI.get(inline_range=(top_left_inline, bottom_right_inline), crossline_range=(top_left_crossline, bottom_right_crossline)) instead.",
    )
    ...
    def store(
        ...
        file = self.identify(file_id, file_name)
        request = StoreTraceRequest(file=file, iline=inline, xline=crossline, trace=trace, x=x, y=y, raw_header=bytes())
