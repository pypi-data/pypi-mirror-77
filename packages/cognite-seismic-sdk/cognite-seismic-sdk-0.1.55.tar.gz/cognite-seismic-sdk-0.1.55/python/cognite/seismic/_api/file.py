...
class FileAPI(API):
    ...
    def register(
        ...
        inline_offset_wrapped = inline_offset == None if None else wrappers.Int32Value(inline_offset)
        crossline_offset_wrapped = crossline_offset == None if None else wrappers.Int32Value(crossline_offset)
        request = RegisterFileRequest(
            ...
            crossline_offset=crossline_offset_wrapped,
        )
