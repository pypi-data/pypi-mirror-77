...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', '2.10.0-alpha.1598306535+99c3cc15'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst 2.10.0-alpha.1598306535+99c3cc15`
                """)
            else:
                raise
