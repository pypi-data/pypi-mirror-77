...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', '2.10.0-alpha.1598472293+3ea553d9'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst 2.10.0-alpha.1598472293+3ea553d9`
                """)
            else:
                raise
