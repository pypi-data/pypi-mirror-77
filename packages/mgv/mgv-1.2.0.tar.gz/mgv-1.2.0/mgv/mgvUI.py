...
class MgvActionWindow(QtWidgets.QWidget):
    ...
    def exe(self, node_version, action):
        ...
        item_button.clicked.connect(lambda x=item: self.selectRow(item))
        h = QtWidgets.QHBoxLayout(item_button)
        h.setContentsMargins(0, 0, 0, 0)
        h.addStretch()
        close_button = QtWidgets.QPushButton()
        start_button = QtWidgets.QPushButton()
        start_button.setMaximumWidth(12)
        close_button.setMaximumWidth(12)
        ...
        start_button.clicked.connect(lambda i=0, x=task: self.now(x))
        close_button.clicked.connect(lambda i=0, x=task: self.kill(x))
