...
class FirewallProfilesApi(object):
    ...
    def get_firewall_profiles_using_get(self, **kwargs):  # noqa: E501
        """View firewall profiles for an organization  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_firewall_profiles_using_get(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_firewall_profiles_using_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_firewall_profiles_using_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_firewall_profiles_using_get_with_http_info(self, **kwargs):  # noqa: E501
        """View firewall profiles for an organization  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_firewall_profiles_using_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['fields', 'filters']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_firewall_profiles_using_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/latest/firewall-profiles', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
