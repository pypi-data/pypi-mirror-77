...
class ApiActionPayload(object):
    ...
    def __init__(self, action=None):  # noqa: E501
        """ApiActionPayload - a model defined in Swagger"""  # noqa: E501
        self._action = None
    ...
    @property
    def action(self):
        """Gets the action of this ApiActionPayload.  # noqa: E501


        :return: The action of this ApiActionPayload.  # noqa: E501
        :rtype: str
        """
        return self._action
    ...
    def action(self, action):
        """Sets the action of this ApiActionPayload.


        :param action: The action of this ApiActionPayload.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ApiActionPayload, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ApiActionPayload):
            return False
