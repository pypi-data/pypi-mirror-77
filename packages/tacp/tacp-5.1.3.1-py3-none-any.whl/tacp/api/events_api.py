...
class EventsApi(object):
    ...
    def get_notifications_using_get(self, **kwargs):  # noqa: E501
        """View notifications for an organization  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_notifications_using_get(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param datetime end_timestamp: return notifications finishing at the specified timestamp
        ...
        :param int limit: limit the number of notifications returned
        :param int offset: returns notifications starting at the specified index in the list
        :param datetime start_timestamp: return notifications starting at the specified timestamp
        :return: list[ApiNotificationPayload]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_notifications_using_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_notifications_using_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_notifications_using_get_with_http_info(self, **kwargs):  # noqa: E501
        """View notifications for an organization  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_notifications_using_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['end_timestamp', 'fields', 'filters', 'limit', 'offset', 'start_timestamp']  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='list[ApiNotificationPayload]',  # noqa: E501
