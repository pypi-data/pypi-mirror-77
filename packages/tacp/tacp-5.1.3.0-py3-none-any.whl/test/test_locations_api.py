...
class TestLocationsApi(unittest.TestCase):
    ...
    def test_get_location_information_using_get(self):
        """Test case for get_location_information_using_get

        View the properties of a location  # noqa: E501
        """
        pass

    def test_get_locations_for_organization_using_get(self):
        """Test case for get_locations_for_organization_using_get
