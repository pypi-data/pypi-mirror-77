...
class UserRequestInfoSpec(object):
    ...
    def __init__(self, user_id=None, org_id=None, requested_resource=None, requested_resource_type=None, request_information=None, state=None, local_vars_configuration=None):  # noqa: E501
