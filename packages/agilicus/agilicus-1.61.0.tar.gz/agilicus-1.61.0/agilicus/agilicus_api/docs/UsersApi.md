...
> ListUserApplicationAccessInfoResponse list_user_application_access_info(org_id=org_id, limit=limit, user_id=user_id)
...
user_id = '1234' # str | Query based on user id (optional)
    ...
    try:
        # Query various users' application access information
        api_response = api_instance.list_user_application_access_info(org_id=org_id, limit=limit, user_id=user_id)
        pprint(api_response)
    except ApiException as e:
