...
class UsersApi(object):
    ...
    def list_user_application_access_info(self, **kwargs):  # noqa: E501
        """Query various users' application access information  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_user_application_access_info(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_user_application_access_info_with_http_info(**kwargs)  # noqa: E501

    def list_user_application_access_info_with_http_info(self, **kwargs):  # noqa: E501
        """Query various users' application access information  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_user_application_access_info_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['org_id', 'limit', 'user_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
