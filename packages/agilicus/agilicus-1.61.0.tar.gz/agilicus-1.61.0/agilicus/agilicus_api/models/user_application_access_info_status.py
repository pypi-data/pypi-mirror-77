...
class UserApplicationAccessInfoStatus(object):
    ...
    def __init__(self, user_id=None, org_id=None, application_name=None, application_url=None, application_description=None, application_category=None, icon_url='https://storage.googleapis.com/agilicus/logo.svg', access_level=None, local_vars_configuration=None):  # noqa: E501
