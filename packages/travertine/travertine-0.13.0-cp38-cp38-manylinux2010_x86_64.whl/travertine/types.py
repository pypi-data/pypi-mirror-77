...
from xotless.domains import Range, Domain
...
class TypeName(enum.Enum):
    ...
    # (or implement a completely need field and widget).  The 4th can
    # completely fool the web client and the website for some types of values
    # (e.g, datetime).
    #
    # When serializing/unserializing values of this type, we must know how to
    # serialize/unseralized its underlying type.
    #
    # For now we're hacking our way out of this mess in clients of this
    # module.  But I need to let this clear: This type must be fixed!
    SELECTION = "selection"
