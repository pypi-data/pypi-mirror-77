...
class CameraIntrinsics:
    ...
    :param loads: A dictionary containig 'camera_matrix' and 'distortion_coefficients'
    ...
    def __init__(
        ...
        **kwargs: float,
        ...
        if loads:
            ...
            if "distortion_coefficients" not in loads:
                self._distortion_coefficients = None
            else:
                self._distortion_coefficients = DistortionCoefficients(
                    loads=loads["distortion_coefficients"]
                )
            return
    ...
    def set_camera_matrix(
        self, matrix: Optional[Sequence[Sequence[float]]] = None, **kwargs: float,
    ) -> None:
