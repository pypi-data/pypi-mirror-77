...
class Vector(Sequence[float]):
    ...
    def __new__(
        ...
        **kwargs: float,
        ...
        if not cls._DIMENSION:
            ...
            data = (0,) * cls._DIMENSION
        elif len(data) != cls._DIMENSION:
            raise ValueError(f"Wrong dimension of input data. Require {cls._DIMENSION} dimension.")
    ...
    def __str__(self) -> str:
        """Returns the string format of the vector.
    ...
    def __getitem__(self, index: Union[int, slice]) -> Union[Sequence[float], float]:
        ...
        :param index: An int index or a slice for indexing
        :return: A float or a Sequence of float corresponding to the input index
        """
    ...
    def __len__(self) -> int:
        ...
        :returns: Number of dimension of the vector.
        """
    ...
    def _process_args(
        ...
        **kwargs: float,
        ...
        if isinstance(data, collections.abc.Sequence):
            return tuple(data)  # type: ignore[arg-type]
