...
class Segment(NameClass, Sequence[Data]):
    ...
    which represents a list of Data without sensor info.

    :param loads: {
        "name": <str>
        "description": <str>
        "annotations": [
            data_dict{...}, <without sensor info>
            data_dict{...},
            ...
            ...
        [
    ...
    def __init__(
        ...
        if loads:
            ...
            for data_dict in loads["annotations"]:
    ...
    def dumps(self) -> Dict[str, Any]:
        ...
        data["annotations"] = [data.dumps() for data in self._data]
...
class FusionSegment(NameClass, Sequence[Frame]):
    ...
    def __init__(
        ...
        if loads:
            ...
            for frame_dict in loads["annotations"]:
    ...
    def dumps(self) -> Dict[str, Any]:
        ...
        data: Dict[str, Any] = super().dumps()
        data["sensors"] = [sensor.dumps() for sensor in self._sensors.values()]
        data["annotations"] = [frame.dumps() for frame in self._frames]
