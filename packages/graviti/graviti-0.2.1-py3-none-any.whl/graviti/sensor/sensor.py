...
class Sensor(NameClass, TypeClass[SensorType]):
    ...
    def set_extrinsics(
        ...
        *,
        ...
        matrix: Transform3D.MatrixType = None,
        **kwargs: Quaternion.KwargsType,
        ...
        :param kwargs: Other parameters to initialize rotation based on pyquaternion
        """
        self._extrinsics = Transform3D(translation, rotation, loads=loads, matrix=matrix, **kwargs)
    ...
    def set_rotation(
        self, *args: Union[Quaternion.ArgsType, float], **kwargs: Quaternion.KwargsType,
    ) -> None:
...
class Camera(Sensor, enum=SensorType.CAMERA):
    ...
    name, description, translation , rotation, camera_matrix and distortion_coefficients.
