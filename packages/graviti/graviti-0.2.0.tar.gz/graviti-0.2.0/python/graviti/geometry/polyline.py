...
class Polyline2D(PointList2D):
    ...
    @staticmethod
    def _insert_points(
        polyline_info1: Iterator[Dict[str, Any]], polyline_info2: Iterator[Dict[str, Any]]
    ...
    def uniform_frechet_distance(
        polyline1: Sequence[Sequence[float]], polyline2: Sequence[Sequence[float]]
    ) -> float:
