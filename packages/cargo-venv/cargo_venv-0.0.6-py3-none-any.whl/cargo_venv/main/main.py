...
def main(name):
    ...
    with open(f'{ROOT_DIR}/templates/activate.fish', 'r') as fish_template:
    ...
    with open(f'{ROOT_DIR}/templates/activate', 'r') as bash_template:
    ...
    with open(f'{ROOT_DIR}/templates/activate.csh', 'r') as csh_template:
