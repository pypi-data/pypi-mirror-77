    ...
    def __init__(
        ...
        *,
        ...
        vpc_settings: typing.Union[
            "CfnMicrosoftAD.VpcSettingsProperty", aws_cdk.core.IResolvable
        ],
        create_alias: typing.Optional[
            typing.Union[bool, aws_cdk.core.IResolvable]
        ] = None,
...
class CfnSimpleADProps:
    def __init__(
        ...
        *,
        ...
        size: str,
        vpc_settings: typing.Union[
            aws_cdk.core.IResolvable, "CfnSimpleAD.VpcSettingsProperty"
        ],
        create_alias: typing.Optional[
            typing.Union[bool, aws_cdk.core.IResolvable]
        ] = None,
