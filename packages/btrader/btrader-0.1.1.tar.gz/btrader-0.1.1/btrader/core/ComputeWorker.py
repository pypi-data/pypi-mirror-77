...
class ComputeWorker (StoppableThread):
  ...
  def __init__ (self, trader_matrix, trader_lock, queue, queue_lock, config, trading_lock, trading_queue, client, counter, level=logging.DEBUG, log_file=None, *args, **kwargs):
