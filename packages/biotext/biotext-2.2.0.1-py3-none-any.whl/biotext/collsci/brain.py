...
from biotext.hfclus import HFclus
...
class Brain():    
    ...
    def sweep2clus(self):        
        ...
        # clusterizar
        clus_s = np.array([HFclus(self.mat[LEN(self.corpus)>=5]).clus()]).T
