...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', '3.3.0-alpha.1598472444+ecb1f182'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic 3.3.0-alpha.1598472444+ecb1f182`
                """)
            else:
                raise
