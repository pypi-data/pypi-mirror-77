...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', '3.3.0-alpha.1597696375+ae453fd0'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic 3.3.0-alpha.1597696375+ae453fd0`
                """)
            else:
                raise
