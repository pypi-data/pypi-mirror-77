...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', '3.3.0-alpha.1598463867+ad5c4ddf'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic 3.3.0-alpha.1598463867+ad5c4ddf`
                """)
            else:
                raise
