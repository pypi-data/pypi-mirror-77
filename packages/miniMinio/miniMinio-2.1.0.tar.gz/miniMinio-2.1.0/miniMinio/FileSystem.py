...
class FileSystem(ABC):
    ...
    @abstractmethod
    def get_file(self, source: str, destination: str):
        pass
...
class MinioFS(FileSystem):
    ...
    def ls(self, path: str, recursive: bool = False, grep: str = None):
        """
        :param recursive:
        ...
        objects = [obj.object_name for obj in self.__client__.list_objects(bucket,
                                                                           prefix=prefix,
                                                                           recursive=recursive)]
        if grep:
    ...
    def rm(self, paths):
        ...
        self.__client__.remove_objects(bucket_name=bucket, objects_iter=filenames)
...
class LocalFS(FileSystem):
    ...
    def get_file(self, source, destination):
        ...
        :param destination: Path to where to copy the file to
        :return:
        """
