...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '3.21.0-alpha.1598389493+3f849f9e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 3.21.0-alpha.1598389493+3f849f9e`
                """)
            else:
                raise
