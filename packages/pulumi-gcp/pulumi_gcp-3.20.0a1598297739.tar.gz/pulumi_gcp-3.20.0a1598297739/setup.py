...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '3.20.0-alpha.1598297739+e2b06e2f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 3.20.0-alpha.1598297739+e2b06e2f`
                """)
            else:
                raise
