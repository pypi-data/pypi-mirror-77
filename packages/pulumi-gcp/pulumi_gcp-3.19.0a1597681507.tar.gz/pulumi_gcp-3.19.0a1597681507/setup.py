...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '3.19.0-alpha.1597681507+3826c8c0'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 3.19.0-alpha.1597681507+3826c8c0`
                """)
            else:
                raise
