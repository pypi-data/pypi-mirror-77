...
def _send_file(url, files, params, experiment_id):
    # type: (str, Any, Dict[str, str], str) -> Response
...
def send_file(
    ...
    # type: (str, str, str, str, str, Optional[Dict[str, str]], Optional[Dict[Any, Any]]) -> Response
    ...
    with open(file_path, "rb") as _file:
        ...
        return _send_file(
            post_endpoint, params=params, files=files, experiment_id=experiment_id
        )
...
def send_file_like(
    ...
    # type: (str, str, str, str, Any, Optional[Dict[str, str]], Optional[Dict[Any, Any]]) -> Response
    params = {"experimentId": experiment_id, "projectId": project_id, "apiKey": api_key}
