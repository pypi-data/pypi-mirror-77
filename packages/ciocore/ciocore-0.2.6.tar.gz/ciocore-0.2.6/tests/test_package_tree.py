...
class ConformTest(unittest.TestCase):
    ...
    def test_conform_adds_plugin_ids_to_host(self):
        packages = [
            {"description":"host1", "package_id":"1", "plugins": ["10","11"], "plugin_hosts": []},
            {"description":"host2", "package_id":"2", "plugins": [], "plugin_hosts": []},
            {"description":"plug1", "package_id":"10", "plugins": [], "plugin_hosts": ["1", "2"]},
            {"description":"plug2", "package_id":"11", "plugins": [], "plugin_hosts": ["1", "2"]}
        ]
        ptree._conform(packages)
        self.assertEqual(packages[1]["plugins"], ["10", "11"] )


    def test_conform_adds_redshift_plugin_ids_to_host(self):
        packages = [
            {"product":"cinema4d", "package_id":"1", "plugins": [], "major_version":"20", "plugin_host_product": "", "plugin_host_version":"" },
            {"product":"cinema4d", "package_id":"2", "plugins": [], "major_version":"22", "plugin_host_product": "", "plugin_host_version":"" },
            {"product":"redshift", "package_id":"10", "plugins": [], "major_version":"1", "plugin_host_product": "cinema4d", "plugin_host_version":"R20" },
            {"product":"redshift", "package_id":"11", "plugins": [], "major_version":"2", "plugin_host_product": "cinema4d", "plugin_host_version":"R22" },
            {"product":"redshift", "package_id":"12", "plugins": [], "major_version":"3", "plugin_host_product": "cinema4d", "plugin_host_version":"R22" }
        ]
        ptree._conform_redshift(packages)
        self.assertIn("10", packages[0]["plugins"])
        self.assertIn("11", packages[1]["plugins"])
        self.assertIn("12", packages[1]["plugins"])
...
class SoftwareDataFindByKeysTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # ptree.PackageTree(data, product="houdini")
