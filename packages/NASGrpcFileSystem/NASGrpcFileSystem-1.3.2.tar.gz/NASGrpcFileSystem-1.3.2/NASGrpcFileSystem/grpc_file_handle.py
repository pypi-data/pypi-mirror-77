...
class FileHandler:
    ...
    def create_file(self, caller_code, remote_path, x_type, file=None, filename=None,
        ...
        :return:
        """
        return create_file(caller_code, remote_path, x_type, self.req_url, file=file, filename=filename,
                file_path=file_path, mount_path=mount_path, replace=replace,
                recovery_path=recovery_path, timeout=timeout, logger=logger, stub=self.stub)
    ...
    def describe_file(self, caller_code, remote_full_path, local_full_path=None,
        ...
        :return:
        """
        return describe_file(caller_code, remote_full_path, self.req_url, local_full_path=local_full_path,
