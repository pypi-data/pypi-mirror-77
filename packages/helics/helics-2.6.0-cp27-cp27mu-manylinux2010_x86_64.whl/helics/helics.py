...
def helicsBrokerSetTimeBarrier(broker, barrierTime):
    r"""
...
def helicsEndpointSetDefaultDestination(endpoint, dst):
    r"""
...
def helicsEndpointSendMessageRaw(endpoint, dst, data):
    r"""
...
def helicsEndpointSendEventRaw(endpoint, dst, data, time):
    r"""
...
def helicsMessageSetDestination(message, dst):
    r"""
...
def helicsMessageSetOriginalDestination(message, dst):
    r"""
...
def helicsMessageCopy(src_message, dst_message):
    r"""
...
def helicsFilterAddDestinationTarget(filt, dst):
    r"""
