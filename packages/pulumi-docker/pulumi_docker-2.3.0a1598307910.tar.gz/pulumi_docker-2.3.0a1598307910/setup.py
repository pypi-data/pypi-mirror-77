...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', '2.3.0-alpha.1598307910+ef982c58'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker 2.3.0-alpha.1598307910+ef982c58`
                """)
            else:
                raise
