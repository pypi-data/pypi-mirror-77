...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', '2.3.0-alpha.1598462975+6bccc50f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker 2.3.0-alpha.1598462975+6bccc50f`
                """)
            else:
                raise
