...
class CfnResolverEndpoint(
    ...
    def __init__(
        ...
        *,
        ...
        ip_addresses: typing.Union[
            ...
            typing.List[
                typing.Union["IpAddressRequestProperty", aws_cdk.core.IResolvable]
            ],
        ],
    ...
    def ip_addresses(
        ...
        aws_cdk.core.IResolvable,
        typing.List[typing.Union["IpAddressRequestProperty", aws_cdk.core.IResolvable]],
    ]:
...
class CfnResolverEndpointProps:
    ...
    def ip_addresses(
        ...
        typing.List[
            typing.Union[
                "CfnResolverEndpoint.IpAddressRequestProperty", aws_cdk.core.IResolvable
            ]
        ],
    ]:
        """``AWS::Route53Resolver::ResolverEndpoint.IpAddresses``.
        ...
        *,
        ...
        target_ips: typing.Optional[
            typing.Union[
                aws_cdk.core.IResolvable,
                typing.List[
                    typing.Union[aws_cdk.core.IResolvable, "TargetAddressProperty"]
                ],
            ]
        ] = None,
    ) -> None:
...
class CfnResolverRuleProps:
    ...
    def target_ips(
        ...
        typing.Union[
            ...
            typing.List[
                typing.Union[
                    aws_cdk.core.IResolvable, "CfnResolverRule.TargetAddressProperty"
                ]
            ],
        ]
    ]:
