...
from xiyang_morph.face_detection import face_detection
from xiyang_morph.face_points_detection import face_points_detection
from xiyang_morph.face_swap import warp_image_2d, warp_image_3d, mask_from_points, apply_mask, correct_colours, transformation_from_points
...
def morph(src_img_path, dst_img_path, result_img_path):
    # Read images
    ...
    ## 2d warp
    #if args.warp_2d:
    unwarped_src_face = warp_image_3d(warped_src_face, dst_points[:48], src_points[:48], src_face.shape[:2])
    ...
    dir_path = os.path.dirname(result_img_path)
...
if __name__ == '__main__':
    morph("imgs/test6.jpg", "imgs/test7.jpg", "img/result.jpg")
