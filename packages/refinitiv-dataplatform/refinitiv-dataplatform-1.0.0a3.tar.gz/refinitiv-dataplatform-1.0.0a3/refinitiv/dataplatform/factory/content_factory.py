...
def get_esg_standard_measures(universe, start=None, end=None):
    from refinitiv.dataplatform.content.esg.esg import ESG
    return ContentFactory._get_esg_data(universe=universe, data_type=ESG.DataType.StandardMeasures, start=start,
                                        end=end)
...
def convert_symbols(symbols, from_symbol_type=SymbolTypes.RIC, to_symbol_types=None):
    return ContentFactory._convert_symbols(symbols=symbols, from_symbol_type=from_symbol_type,
