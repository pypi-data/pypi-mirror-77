...
class OMMStreamObserver:
    ...
    def __check_omm_stream_listener(self, omm_stream_listener):
        if omm_stream_listener is None:
            raise AttributeError(f'omm_stream_listener is None.')

        if omm_stream_listener.id is None:
            raise AttributeError(f"omm_stream_listener was not subscribed.")
    ...
    def __on_refresh_omm_stream(self, omm_stream, message):
        ...
        if omm_stream:
            ...
            self.log(logging.ERROR,
                     f'Received refresh message from None stream')
    ...
    def __on_update_omm_stream(self, omm_stream, update):
        if omm_stream:
            ...
            self.log(logging.ERROR,
                     f'Received update message from None stream')
    ...
    def __on_complete_omm_stream(self, omm_stream):
        ...
        if omm_stream:
            ...
            self.log(logging.ERROR,
                     f'Received refresh complete from None stream')
    ...
    def __on_status_omm_stream(self, omm_stream, status):
        ...
        if omm_stream:
            ...
            self.log(logging.ERROR,
                     f'Received refresh status from None stream')
    ...
    def __on_error_omm_stream(self, omm_stream, error):
        ...
        if omm_stream:
            ...
            self.log(logging.ERROR,
                     f'Received error message from None stream')
