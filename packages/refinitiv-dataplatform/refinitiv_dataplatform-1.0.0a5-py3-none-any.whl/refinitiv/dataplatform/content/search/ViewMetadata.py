    ...
    class ViewMetadataData(Endpoint.EndpointData):
        ...
        def _convertPropertyAttributes(propertyAttributeToPropertyDictDict,
            ...
            if propertyAttributeType == ViewMetadata.ViewMetadataData._ResponseNestedTypeName:
                ...
                for nestedPropertyName, nestedPropertyAttributeDict in list(thisPropertiesOfNestedType.items()):
        ...
        def _convertMetadataReponseToDataframe(raw):
            ...
            for propertyName, propertyAttributeDict in list(properties.items()):
            ...
            dataframe = {}
            for propertyAttributeName, propertyDict in list(propertyAttributeToPropertyDictDict.items()):
                for propertyKey, propertyValue in list(propertyDict.items()):
