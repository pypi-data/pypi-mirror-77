    ...
    class Data(Endpoint.EndpointData):
        ...
        def df(self):
            ...
            if self.analytics_data:
                ...
                numpy_array = numpy.array(self.analytics_data)
                data_dataframe = DataFrame(numpy_array, columns=headers).convert_dtypes()
            else:
                data_dataframe = DataFrame([], columns=headers)
