...
class HistoricalPricing(object):
    ...
    def _convert_historical_json_to_pandas(json_historical_data):
        _fields = [field['name'] for field in json_historical_data['headers']]
        field_timestamp = 'DATE_TIME' if 'DATE_TIME' in _fields else 'DATE'
        ...
        _data = json_historical_data['data']
        ...
        if _data:
            ...
            historical_dataframe = DataFrame([], columns=fields)
