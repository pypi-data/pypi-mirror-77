...
class PretrainedEmbeddings:
    ...
    def __init__(self, preprobObj, embSize = 64, embeddingOption = 'fasttext',
        ...
        self.__preprocessingObj(preprobObj)
    ...
    def __preprocessingObj(self,preprobObj):
        if preprobObj.__class__.__name__ != 'Preprocessing':
            raise Warning("Please provide a dataset object of type Preprocessing.")
    ...
    def __trainFast(self):
        ...
        print(self.__dataFile, self.__embSize)
