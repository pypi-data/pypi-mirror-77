    ...
    def __init__(
        ...
        *,
        ...
        integration: typing.Optional[
            typing.Union["IntegrationOverridesProperty", aws_cdk.core.IResolvable]
        ] = None,
        route: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "RouteOverridesProperty"]
        ] = None,
        stage: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "StageOverridesProperty"]
        ] = None,
    ) -> None:
        ...
        *,
        ...
        domain_name_configurations: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        aws_cdk.core.IResolvable, "DomainNameConfigurationProperty"
                    ]
                ],
            ]
        ] = None,
...
class IHttpRouteIntegration(jsii.compat.Protocol):
    ...
    def bind(
        self, *, route: "IHttpRoute", scope: aws_cdk.core.Construct
