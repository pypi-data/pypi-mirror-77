...
# @Last Modified time: 2020-08-26 14:24:33
import os
	...
	def getBussiness(self,helloBikeToken,user_agent,user="",isServer=True):
		...
		if response['status']:
			...
			for bussiness in infos:
				...
				if temp['value']:
					result.append(temp)
					businessDic[bussiness['label']] = teamTemp
			return result,businessDic
		else:
...
if __name__ == '__main__':
	...
	print(hb.getEcsServerInfos("AppHellobikeBikeStateService",
		"uat",
