...
# @Last Modified time: 2020-08-25 17:27:34
import os
...
class HBRequest(object):
	...
	def getBussiness(self,helloBikeToken,user_agent,user=""):
		"""
			获取个业务线拥有的团队
		"""
		result = []
	...
	def getBussinessServiceName(self,teamList,helloBikeToken,user_agent,user=""):
		"""
			获取某个业务线下所有服务名
		"""
		result = []
...
if __name__ == '__main__':
	hb = HBRequest()
	# print(hb.getBussiness("51e4618683215c6d62caa5499845c666",
