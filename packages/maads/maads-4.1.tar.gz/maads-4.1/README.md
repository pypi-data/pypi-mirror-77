...
**MAADS-VIPER connector to manage Apache KAFKA:** 
  - MAADS-VIPER python library connects to VIPER instances on any servers; VIPER manages Apache Kafka.  VIPER is REST based and cross-platform that can run on windows, linux, MAC, etc.. 
- **listtopics ** 
...
**22. maads.vipersubscribeconsumer(vipertoken,host,port,topic,companyname,contactname,contactemail,location,description,brokerhost='',brokerport=-999,groupid='',microserviceid='')**
...
**23. viperunsubscribeconsumer(vipertoken,host,port,consumerid,brokerhost='',brokerport=-999,microserviceid='')**
**Parameters:**	
...
**24. viperproducetotopic(vipertoken,host,port,topic,producerid,inputdata='',maadstoken='',getoptimal=0,externalprediction='',brokerhost='',brokerport=-999,microserviceid='')**
**Parameters:**	
...
**25. viperconsumefromtopic(vipertoken,host,port,topic,consumerid,companyname,offset=0,brokerhost='',brokerport=-999,microserviceid='')**
**Parameters:**	
...
*offset*: int, optional
- Offset to start the reading from..if 0 then reading will start from the beginning of the topic.
...
**26. viperhpdepredict(vipertoken,host,port,consumefrom,produceto,companyname,consumerid,producerid,hpdehost,hpdeport=-999,brokerhost='',brokerport=9092,
...
**27. viperhpdeoptimize(vipertoken,host,port,consumefrom,produceto,companyname,consumerid,producerid,hpdehost,hpdeport=-999,usedeploy=0,
...
**28. viperhpdetraining(vipertoken,host,port,consumefrom,produceto,companyname,consumerid,producerid,hpdehost,hpdeport=-999,offset=0,islogistic=0,
...
**29. viperproducetotopicstream(vipertoken,host,port,topic,producerid,offset,brokerhost='',brokerport=-999,microserviceid='')**
**Parameters:**	
...
**30. vipercreatetrainingdata(vipertoken,host,port,consumefrom,produceto,dependentvariable,independentvariables,
                            consumerid,producerid,offset,companyname,maxrows=-1,brokerhost='',brokerport=-999,microserviceid='')**
**Parameters:**	
...
**31. vipercreatetopic(vipertoken,host,port,topic,companyname,contactname,contactemail,location,description,brokerhost='',brokerport=-999,numpartitions=1,replication=1,microserviceid='')**
...
**32. viperconsumefromstreamtopic(vipertoken,host,port,topic,consumerid,companyname,offset=0,brokerhost='',brokerport=-999,microserviceid='')**
**Parameters:**	
...
**33. vipercreatejointopicstreams(vipertoken,host,port,topic,topicstojoin,companyname,contactname,contactemail,description,
                                location,brokerhost='',brokerport=-999,replication=1,numpartitions=1,microserviceid='')**
**Parameters:**	
...
**34. vipercreateconsumergroup(vipertoken,host,port,topic,groupname,companyname,contactname,contactemail,description,
...
**35. viperconsumergroupconsumefromtopic(vipertoken,host,port,topic,consumerid,groupid,companyname,offset=0,brokerhost='',brokerport=-999,microserviceid='')**
**Parameters:**	
...
**36. vipermodifyconsumerdetails(vipertoken,host,port,topic,companyname,consumerid,contactname='',contactemail='',location='',brokerhost='',brokerport=9092,microserviceid='')**
**Parameters:**	
...
**37. vipermodifytopicdetails(vipertoken,host,port,topic,companyname,contactname='',contactemail='',location='',brokerhost='',brokerport=9092,microserviceid='')**
...
**38. viperactivatetopic(vipertoken,host,port,topic,microserviceid='')**
**Parameters:**	
...
**39. viperdeactivatetopic(vipertoken,host,port,topic,microserviceid='')**
**Parameters:**	
...
**40. vipergroupactivate(vipertoken,host,port,groupname,groupid,microserviceid='')**
**Parameters:**	
...
**41.  vipergroupdeactivate(vipertoken,host,port,groupname,groupid,microserviceid='')**
**Parameters:**	
