...
class RouteTask(object):
    ...
    def __init__(self, waypoints=None, transport_type=None, departure_time=None, result_timezone=0, geo_provider=None, detail=False, polyline=True, local_vars_configuration=None):  # noqa: E501
