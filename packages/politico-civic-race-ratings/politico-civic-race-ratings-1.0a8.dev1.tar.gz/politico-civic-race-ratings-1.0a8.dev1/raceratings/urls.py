...
from raceratings.views import CumulativeWinnerStatusCheckView
...
urlpatterns = [
    ...
    path(
        "cumulative-summaries/status-check/<slug:task_id>/",
        CumulativeWinnerStatusCheckView.as_view(),
        name="cumulative-summaries-status-check",
    ),
