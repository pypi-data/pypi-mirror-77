...
class CfnAnalyzer(
        ...
        *,
        ...
        archive_rules: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union["ArchiveRuleProperty", aws_cdk.core.IResolvable]
                ],
            ]
        ] = None,
    ...
    def archive_rules(
        ...
        typing.Union[
            aws_cdk.core.IResolvable,
            typing.List[typing.Union["ArchiveRuleProperty", aws_cdk.core.IResolvable]],
        ]
    ]:
        ...
        def __init__(
            ...
            *,
            filter: typing.Union[
                aws_cdk.core.IResolvable,
                typing.List[
                    typing.Union[aws_cdk.core.IResolvable, "CfnAnalyzer.FilterProperty"]
                ],
            ],
            rule_name: str,
        ) -> None:
        ...
        *,
        ...
        archive_rules: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        "CfnAnalyzer.ArchiveRuleProperty", aws_cdk.core.IResolvable
                    ]
                ],
            ]
        ] = None,
