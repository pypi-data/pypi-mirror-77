# -*- coding: utf-8 -*-
# File generated according to Generator/ClassesRef/Machine/MagnetType10.csv
# WARNING! All changes made in this file will be lost!
"""Method code available at https://github.com/Eomys/pyleecan/tree/master/pyleecan/Methods/Machine/MagnetType10
"""
...
try:
    from ..Methods.Machine.MagnetType10.build_geometry import build_geometry
except ImportError as error:
    build_geometry = error

try:
    from ..Methods.Machine.MagnetType10.comp_height import comp_height
except ImportError as error:
    comp_height = error

try:
    from ..Methods.Machine.MagnetType10.comp_surface import comp_surface
except ImportError as error:
    comp_surface = error
...
class MagnetType10(MagnetFlat):
    ...
    def __str__(self):
        ...
        MagnetType10_str += super(MagnetType10, self).__str__()
        MagnetType10_str += "Wmag = " + str(self.Wmag) + linesep
        MagnetType10_str += "Hmag = " + str(self.Hmag) + linesep
