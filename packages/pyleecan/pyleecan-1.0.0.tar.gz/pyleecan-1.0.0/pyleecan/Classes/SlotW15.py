...
try:
    from ..Methods.Slot.SlotW15.build_geometry_wind import build_geometry_wind
except ImportError as error:
...
try:
    from ..Methods.Slot.SlotW15.comp_height_wind import comp_height_wind
except ImportError as error:
