...
from ......GUI.Dialog.DMachineSetup.SMagnet.PMagnet11.Gen_PMagnet11 import Gen_PMagnet11


class PMagnet11(Gen_PMagnet11, QDialog):
    ...
    def __init__(self, machine=None):
        ...
        wid_list = [self.unit_H0, self.unit_Hmag]
        for wid in wid_list:
