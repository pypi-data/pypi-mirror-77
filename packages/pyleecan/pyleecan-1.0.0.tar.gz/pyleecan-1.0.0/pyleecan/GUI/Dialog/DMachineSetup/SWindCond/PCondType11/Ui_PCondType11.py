...
class Ui_PCondType11(object):
    def setupUi(self, PCondType11):
        ...
        self.in_Lewout = QtWidgets.QLabel(PCondType11)
        ...
        self.unit_Lewout = QtWidgets.QLabel(PCondType11)
    ...
    def retranslateUi(self, PCondType11):
        ...
        self.in_Lewout.setToolTip(
            _translate("PCondType11", "End-winding length on one side for a half-turn")
        )
        self.in_Lewout.setWhatsThis(
            _translate("PCondType11", "End-winding length on one side for a half-turn")
        )
        self.in_Lewout.setText(_translate("PCondType11", "Lewout:"))
        ...
        self.unit_Lewout.setText(_translate("PCondType11", "m"))
