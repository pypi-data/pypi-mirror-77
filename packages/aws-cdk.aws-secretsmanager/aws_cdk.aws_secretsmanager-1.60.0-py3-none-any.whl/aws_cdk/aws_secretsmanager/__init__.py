...
class CfnRotationSchedule(
    ...
    def __init__(
        ...
        *,
        secret_id: str,
        hosted_rotation_lambda: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "HostedRotationLambdaProperty"]
        ] = None,
        rotation_lambda_arn: typing.Optional[str] = None,
        rotation_rules: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "RotationRulesProperty"]
        ] = None,
    ) -> None:
...
class CfnRotationScheduleProps:
    def __init__(
        ...
        *,
        ...
        rotation_rules: typing.Optional[
            typing.Union[
                aws_cdk.core.IResolvable, "CfnRotationSchedule.RotationRulesProperty"
            ]
        ] = None,
    ) -> None:
    ...
    def hosted_rotation_lambda(
        ...
        typing.Union[
            aws_cdk.core.IResolvable, "CfnRotationSchedule.HostedRotationLambdaProperty"
        ]
    ]:
        """``AWS::SecretsManager::RotationSchedule.HostedRotationLambda``.
...
class CfnSecret(
    ...
    def __init__(
        ...
        *,
        ...
        generate_secret_string: typing.Optional[
            typing.Union[aws_cdk.core.IResolvable, "GenerateSecretStringProperty"]
        ] = None,
    ...
    class GenerateSecretStringProperty:
        def __init__(
            ...
            *,
            ...
            exclude_lowercase: typing.Optional[
                typing.Union[bool, aws_cdk.core.IResolvable]
            ] = None,
            exclude_numbers: typing.Optional[
                typing.Union[bool, aws_cdk.core.IResolvable]
            ] = None,
            exclude_punctuation: typing.Optional[
                typing.Union[bool, aws_cdk.core.IResolvable]
            ] = None,
            exclude_uppercase: typing.Optional[
                typing.Union[bool, aws_cdk.core.IResolvable]
            ] = None,
            generate_string_key: typing.Optional[str] = None,
            include_space: typing.Optional[
                typing.Union[bool, aws_cdk.core.IResolvable]
            ] = None,
            password_length: typing.Optional[jsii.Number] = None,
            require_each_included_type: typing.Optional[
                typing.Union[bool, aws_cdk.core.IResolvable]
            ] = None,
...
class CfnSecretProps:
    def __init__(
        ...
        *,
        ...
        generate_secret_string: typing.Optional[
            typing.Union[
                aws_cdk.core.IResolvable, "CfnSecret.GenerateSecretStringProperty"
            ]
        ] = None,
        kms_key_id: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
    ...
    def generate_secret_string(
        ...
        typing.Union[aws_cdk.core.IResolvable, "CfnSecret.GenerateSecretStringProperty"]
    ]:
        """``AWS::SecretsManager::Secret.GenerateSecretString``.
...
class ISecret(aws_cdk.core.IResource, jsii.compat.Protocol):
    ...
    def add_rotation_schedule(
        ...
        id: str,
        *,
        rotation_lambda: aws_cdk.aws_lambda.IFunction,
...
class ResourcePolicy(
    ...
    def __init__(
        self, scope: aws_cdk.core.Construct, id: str, *, secret: "ISecret"
    ) -> None:
        """
        :param scope: -
        :param id: -
...
class Secret(
    ...
    def from_secret_arn(
        cls, scope: aws_cdk.core.Construct, id: str, secret_arn: str
    ) -> "ISecret":
        """
        :param scope: -
        :param id: -
...
class SecretRotationApplication(
    ...
    def __init__(
        ...
        *,
        ...
        jsii.create(
            SecretRotationApplication, self, [application_id, semantic_version, options]
        )
...
class SecretTargetAttachment(
    ...
    def from_secret_target_attachment_secret_arn(
        ...
        return jsii.sinvoke(
            ...
            [scope, id, secret_target_attachment_secret_arn],
        )
