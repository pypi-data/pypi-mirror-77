...
The *none* project is released under the licensing terms of the MIT License
...
included within the *none* project but does not fall under the terms stated
above.
...
The below-signed are contributors to the project named *none*. Each below-signed
