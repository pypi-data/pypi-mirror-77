...
class CfnMember(
    ...
    def __init__(
        ...
        id: str,
        *,
        member_configuration: typing.Union[
            "MemberConfigurationProperty", aws_cdk.core.IResolvable
        ],
    ...
    def member_configuration(
        self,
    ) -> typing.Union["MemberConfigurationProperty", aws_cdk.core.IResolvable]:
    ...
    def member_configuration(
        self,
        value: typing.Union["MemberConfigurationProperty", aws_cdk.core.IResolvable],
    ) -> None:
    ...
    class MemberConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            member_framework_configuration: typing.Optional[
                typing.Union[
    ...
    class MemberFrameworkConfigurationProperty:
        def __init__(
            self,
            *,
            member_fabric_configuration: typing.Optional[
                typing.Union[
                    aws_cdk.core.IResolvable,
        ...
        def member_fabric_configuration(
            ...
            typing.Union[
                aws_cdk.core.IResolvable, "CfnMember.MemberFabricConfigurationProperty"
            ]
        ]:
        ...
        def __init__(
            ...
            *,
            ...
            voting_policy: typing.Union[
                aws_cdk.core.IResolvable, "CfnMember.VotingPolicyProperty"
            ],
            description: typing.Optional[str] = None,
            network_framework_configuration: typing.Optional[
                typing.Union[
                    aws_cdk.core.IResolvable,
    ...
    class NetworkFrameworkConfigurationProperty:
        def __init__(
            self,
            *,
            network_fabric_configuration: typing.Optional[
                typing.Union[
                    aws_cdk.core.IResolvable,
        ...
        def network_fabric_configuration(
            ...
            typing.Union[
                aws_cdk.core.IResolvable, "CfnMember.NetworkFabricConfigurationProperty"
            ]
        ]:
    ...
    class VotingPolicyProperty:
        def __init__(
            self,
            *,
            approval_threshold_policy: typing.Optional[
                typing.Union[
                    aws_cdk.core.IResolvable,
        ...
        def approval_threshold_policy(
            ...
            typing.Union[
                aws_cdk.core.IResolvable, "CfnMember.ApprovalThresholdPolicyProperty"
            ]
        ]:
...
class CfnMemberProps:
    def __init__(
        ...
        *,
        member_configuration: typing.Union[
            "CfnMember.MemberConfigurationProperty", aws_cdk.core.IResolvable
        ],
        invitation_id: typing.Optional[str] = None,
        network_configuration: typing.Optional[
            typing.Union[
                aws_cdk.core.IResolvable, "CfnMember.NetworkConfigurationProperty"
            ]
        ] = None,
        network_id: typing.Optional[str] = None,
    ) -> None:
    ...
    def network_configuration(
        ...
        typing.Union[aws_cdk.core.IResolvable, "CfnMember.NetworkConfigurationProperty"]
    ]:
        """``AWS::ManagedBlockchain::Member.NetworkConfiguration``.
...
class CfnNode(
    ...
    def __init__(
        ...
        *,
        member_id: str,
        network_id: str,
        node_configuration: typing.Union[
            aws_cdk.core.IResolvable, "NodeConfigurationProperty"
        ],
    ) -> None:
    ...
    def node_configuration(
        self,
    ) -> typing.Union[aws_cdk.core.IResolvable, "NodeConfigurationProperty"]:
    ...
    def node_configuration(
        self, value: typing.Union[aws_cdk.core.IResolvable, "NodeConfigurationProperty"]
    ) -> None:
...
class CfnNodeProps:
    def __init__(
        ...
        *,
        ...
        network_id: str,
        node_configuration: typing.Union[
            aws_cdk.core.IResolvable, "CfnNode.NodeConfigurationProperty"
        ],
    ) -> None:
