...
def ctc_beam_search_decoder(probs, alphabet, beam_size, cutoff_prob, cutoff_top_n, ext_scorer, num_results=1):
    return _swigwrapper.ctc_beam_search_decoder(probs, alphabet, beam_size, cutoff_prob, cutoff_top_n, ext_scorer, num_results)

def ctc_beam_search_decoder_batch(probs, seq_lengths, alphabet, beam_size, num_processes, cutoff_prob, cutoff_top_n, ext_scorer, num_results=1):
    return _swigwrapper.ctc_beam_search_decoder_batch(probs, seq_lengths, alphabet, beam_size, num_processes, cutoff_prob, cutoff_top_n, ext_scorer, num_results)
