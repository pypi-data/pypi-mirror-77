...
function Pedido(ventas,ligas) {
  ...
  for (var i = 0; i < ventas.length; i++) {
    var fol=ventas[i][2];
    Detalle_(ventas[i][2]).then((pedido) => {
      var si_llamada='';
      var remisionado='';
      var facturado='';
