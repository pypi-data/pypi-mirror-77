    ...
    def createFromRequest(self, request):
        ...
        if precent:
            with transaction.atomic():
                ...
                item = Item.objects.get(id=precent.get('precent_item_id'))
                ...
                for precent_item in Precent_items_view.objects.get(id=item.id):
                    ...
                    material_ids = precent.get('precent_material_ids')
                    if isinstance(material_ids, list):
                        for material_id in material_ids:
                            Demand_materials.objects.get_or_create(demand=res, material_id=material_id)
