...
class Ready_2_launchManager(AuditManager):
    ...
    def getRecord(record):
        res = {
            ...
            'item__STMP_1_id': record.item.STMP_1.id if record.item.STMP_1 != None else None,
            'item__STMP_1__value_str': record.item.STMP_1.value_str if record.item.STMP_1 != None else None,
            'item__STMP_2_id': record.item.STMP_2.id if record.item.STMP_2 != None else None,
            'item__STMP_2__value_str': record.item.STMP_2.value_str if record.item.STMP_2 != None else None,
            'notes': record.notes,
