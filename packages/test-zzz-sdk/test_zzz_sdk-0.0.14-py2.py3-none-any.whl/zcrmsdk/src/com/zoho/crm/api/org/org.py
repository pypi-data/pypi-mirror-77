...
class Org(object):
	...
	def set_mc_status(self, mc_status):
		...
		if not isinstance(mc_status, bool):
	...
	def set_gapps_enabled(self, gapps_enabled):
		...
		if not isinstance(gapps_enabled, bool):
	...
	def set_domain_name(self, domain_name):
		...
		Parameters:
			domain_name (string) : A string value
		"""
	...
	def set_currency_locale(self, currency_locale):
		...
		if not isinstance(currency_locale, str):
	...
	def set_primary_zuid(self, primary_zuid):
		...
		if not isinstance(primary_zuid, str):
	...
	def set_zia_portal_id(self, zia_portal_id):
		...
		if not isinstance(zia_portal_id, str):
	...
	def set_license_details(self, license_details):
		...
		if not isinstance(license_details, LicenseDetails):
	...
	def set_privacy_settings(self, privacy_settings):
		...
		if not isinstance(privacy_settings, bool):
