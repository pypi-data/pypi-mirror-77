...
class ShareRecord(object):
	...
	def set_share_related_records(self, share_related_records):
		...
		Parameters:
			share_related_records (bool) : A bool value
		"""

		if not isinstance(share_related_records, bool):
	...
	def set_shared_through(self, shared_through):
		...
		if not isinstance(shared_through, SharedThrough):
	...
	def set_shared_time(self, shared_time):
		...
		if not isinstance(shared_time, datetime):
	...
	def set_permission(self, permission):
		...
		Parameters:
			permission (string) : A string value
		"""
	...
	def set_shared_by(self, shared_by):
		...
		if not isinstance(shared_by, User):
