...
class Field(object):
	...
	def set_system_mandatory(self, system_mandatory):
		...
		if not isinstance(system_mandatory, bool):
	...
	def set_layouts(self, layouts):
		...
		if not isinstance(layouts, Layout):
	...
	def set_transition_sequence(self, transition_sequence):
		...
		if not isinstance(transition_sequence, int):
	...
	def set_related_details(self, related_details):
		...
		if not isinstance(related_details, RelatedDetails):
	...
	def set_created_source(self, created_source):
		...
		if not isinstance(created_source, str):
	...
	def set_field_read_only(self, field_read_only):
		...
		if not isinstance(field_read_only, bool):
	...
	def set_association_details(self, association_details):
		...
		if not isinstance(association_details, AssociationDetails):
	...
	def set_quick_sequence_number(self, quick_sequence_number):
		...
		if not isinstance(quick_sequence_number, int):
	...
	def set_businesscard_supported(self, businesscard_supported):
		...
		if not isinstance(businesscard_supported, bool):
	...
	def set_multi_module_lookup(self, multi_module_lookup):
		...
		if not isinstance(multi_module_lookup, dict):
	...
	def set_custom_field(self, custom_field):
		...
		if not isinstance(custom_field, bool):
	...
	def set_lookup(self, lookup):
		...
		if not isinstance(lookup, Module):
	...
	def set_subform(self, subform):
		...
		if not isinstance(subform, Module):
	...
	def set_unique(self, unique):
		...
		if not isinstance(unique, Unique):
	...
	def set_history_tracking(self, history_tracking):
		...
		if not isinstance(history_tracking, bool):
	...
	def set_mass_update(self, mass_update):
		...
		if not isinstance(mass_update, bool):
	...
	def set_blueprint_supported(self, blueprint_supported):
		...
		if not isinstance(blueprint_supported, bool):
	...
	def set_multiselectlookup(self, multiselectlookup):
		...
		if not isinstance(multiselectlookup, MultiSelectLookup):
	...
	def set_pick_list_values(self, pick_list_values):
		...
		if not isinstance(pick_list_values, list):
	...
	def set_auto_number(self, auto_number):
		...
		if not isinstance(auto_number, AutoNumber):
	...
	def set_convert_mapping(self, convert_mapping):
		...
		if not isinstance(convert_mapping, dict):
