...
class Transition(object):
	...
	def set_percent_partial_save(self, percent_partial_save):
		...
		Parameters:
			percent_partial_save (float) : A float value
		"""

		if not isinstance(percent_partial_save, float):
	...
	def set_next_field_value(self, next_field_value):
		...
		if not isinstance(next_field_value, str):
	...
	def set_criteria_matched(self, criteria_matched):
		...
		if not isinstance(criteria_matched, bool):
	...
	def set_criteria_message(self, criteria_message):
		...
		if not isinstance(criteria_message, str):
