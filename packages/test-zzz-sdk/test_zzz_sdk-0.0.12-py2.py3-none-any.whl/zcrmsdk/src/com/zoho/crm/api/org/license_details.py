...
class LicenseDetails(object):
	...
	def set_paid_expiry(self, paid_expiry):
		...
		if not isinstance(paid_expiry, datetime):
	...
	def set_users_license_purchased(self, users_license_purchased):
		...
		Parameters:
			users_license_purchased (int) : A int value
		"""

		if not isinstance(users_license_purchased, int):
	...
	def set_trial_expiry(self, trial_expiry):
		...
		if not isinstance(trial_expiry, str):
	...
	def set_paid_type(self, paid_type):
		...
		if not isinstance(paid_type, str):
