...
class Currency(object):
	...
	def set_exchange_rate(self, exchange_rate):
		...
		Parameters:
			exchange_rate (string) : A string value
		"""

		if not isinstance(exchange_rate, str):
	...
	def set_prefix_symbol(self, prefix_symbol):
		...
		Parameters:
			prefix_symbol (bool) : A bool value
		"""

		if not isinstance(prefix_symbol, bool):
