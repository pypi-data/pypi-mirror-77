...
class DataTypeConverter(object):
    ...
    def init():
        ...
        DataTypeConverter.add_to_map("Date", lambda obj: date.fromisoformat(obj), lambda obj: obj.isoformat())
        DataTypeConverter.add_to_map("DateTime", lambda obj: datetime.fromisoformat(obj).astimezone(tz.tzlocal()), lambda obj: obj.replace(microsecond=0).astimezone(tz.tzlocal()).isoformat())
        DataTypeConverter.add_to_map("Object", lambda obj: obj, lambda obj: obj)
