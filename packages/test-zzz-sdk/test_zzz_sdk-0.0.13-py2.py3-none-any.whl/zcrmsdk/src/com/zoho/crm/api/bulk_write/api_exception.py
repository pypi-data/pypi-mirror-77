...
class APIException(ActionResponse, ResponseWrapper, ResponseHandler):
	...
	def set_error_message(self, error_message):
		...
		if not isinstance(error_message, Choice):
	...
	def set_x_error(self, x_error):
		...
		if not isinstance(x_error, Choice):
	...
	def set_x_info(self, x_info):
		...
		if not isinstance(x_info, Choice):
	...
	def set_http_status(self, http_status):
		...
		Parameters:
			http_status (string) : A string value
		"""
