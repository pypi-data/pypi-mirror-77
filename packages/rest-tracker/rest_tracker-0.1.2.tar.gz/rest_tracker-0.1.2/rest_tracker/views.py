...
class Rest_Tracker_View(viewsets.GenericViewSet, mixins.ListModelMixin):
    ...
    def count_methods(self):
        ...
        for val in value_list:
            base[val] += Rest_Tracker_Request.objects.filter(method__method=val).count()
        return base
    ...
    def count_schemes(self):
        ...
        base = {val: 0 for val in value_list}
        for val in value_list:
            base[val] += Rest_Tracker_Request.objects.filter(scheme__scheme=val).count()
        return base
    ...
    def count_user_agents(self):
        ...
        base = {val: 0 for val in value_list}
        for val in value_list:
            base[val] += Rest_Tracker_Request.objects.filter(user_agent__user_agent=val).count()
        return base
    ...
    def count_hosts(self):
        ...
        base = {val: 0 for val in value_list}
        for val in value_list:
            base[val] += Rest_Tracker_Request.objects.filter(url__host=val).count()
        return base
