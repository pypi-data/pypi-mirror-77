...
class SimulateOptions(BasicDictionary):
    ...
    __swig_setmethods__["output_file"] = _roadrunner.SimulateOptions_output_file_set
    __swig_getmethods__["output_file"] = _roadrunner.SimulateOptions_output_file_get
    if _newclass:
        output_file = _swig_property(_roadrunner.SimulateOptions_output_file_get, _roadrunner.SimulateOptions_output_file_set)
