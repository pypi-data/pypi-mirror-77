...
setup(
  ...
  download_url = 'https://github.com/luccaportes/Scikit-DYN2SEL/archive/v_011.tar.gz',    # I explain this later on
  keywords = ['Dynamic Selection', 'Machine Learning', 'Data Streams'],   # Keywords that define your package best
