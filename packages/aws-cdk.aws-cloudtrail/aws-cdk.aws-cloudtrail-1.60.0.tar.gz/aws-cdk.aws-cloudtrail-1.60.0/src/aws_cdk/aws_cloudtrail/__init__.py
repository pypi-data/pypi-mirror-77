...
class CfnTrail(
    ...
    def __init__(
        ...
        id: str,
        *,
        is_logging: typing.Union[bool, aws_cdk.core.IResolvable],
        s3_bucket_name: str,
        ...
        event_selectors: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union[aws_cdk.core.IResolvable, "EventSelectorProperty"]
                ],
            ]
        ] = None,
    ...
    @is_logging.setter
    def is_logging(self, value: typing.Union[bool, aws_cdk.core.IResolvable]) -> None:
...
class CfnTrailProps:
        ...
        *,
        ...
        event_selectors: typing.Optional[
            typing.Union[
                ...
                typing.List[
                    typing.Union[
                        aws_cdk.core.IResolvable, "CfnTrail.EventSelectorProperty"
                    ]
                ],
            ]
        ] = None,
    ...
    def event_selectors(
        ...
        typing.Union[
            aws_cdk.core.IResolvable,
            typing.List[
                typing.Union[aws_cdk.core.IResolvable, "CfnTrail.EventSelectorProperty"]
            ],
        ]
    ]:
        """``AWS::CloudTrail::Trail.EventSelectors``.
...
class S3EventSelector:
    def __init__(
        ...
        *,
        ...
        object_prefix: typing.Optional[str] = None,
    ) -> None:
...
class Trail(
    ...
    def __init__(
        ...
        *,
        ...
        cloud_watch_logs_retention: typing.Optional[
