...
class KinesisFirehoseToAnalyticsAndS3(
    ...
    def __init__(
        ...
        *,
        ...
        kinesis_firehose_props: typing.Optional[aws_cdk.aws_kinesisfirehose.CfnDeliveryStreamProps] = None,
    ) -> None:
        """
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(kinesis_firehose_props, dict):
            kinesis_firehose_props = aws_cdk.aws_kinesisfirehose.CfnDeliveryStreamProps(**kinesis_firehose_props)
        self._values = {}
