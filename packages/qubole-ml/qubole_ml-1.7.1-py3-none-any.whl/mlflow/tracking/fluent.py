...
def start_run(run_id=None, experiment_id=None, run_name=None, nested=False):
    ...
    if existing_run_id:
        ...
        context_registry.pre_start_run_actions()
        ...
        context_registry.post_start_run_actions(active_run_obj)
...
def log_artifact(local_path, artifact_path=None):
    ...
    context_registry.post_log_artifact_actions(local_path, artifact_path)
...
def log_artifacts(local_dir, artifact_path=None):
    ...
    context_registry.post_log_artifact_actions(local_dir, artifact_path)
...
def create_experiment(name, artifact_location=None):
    ...
    """
    experiment = MlflowClient().create_experiment(name, artifact_location)
    context_registry.post_create_experiment_actions(experiment)
    return experiment
