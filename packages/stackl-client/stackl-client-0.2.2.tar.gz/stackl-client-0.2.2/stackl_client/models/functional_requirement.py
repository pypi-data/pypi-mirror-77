...
class FunctionalRequirement(object):
    ...
    def __init__(self, name=None, category=None, type='functional_requirement', params=None, secrets=None, description='Base Document', invocation=None, outputs=None, outputs_format='json', local_vars_configuration=None):  # noqa: E501
