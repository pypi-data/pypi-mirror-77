...
class RedisCache(Cache):
    def __init__(self, maxsize, client=None, host=None, port=None, password=None, db=None, ttl=15 * 60,
        ...
        self.client_ = client
        self.host = host or mlconfig.REDIS_HOST
        self.port = port or mlconfig.REDIS_PORT
        self.password = password or mlconfig.REDIS_PASSWORD
        self.db = db or mlconfig.REDIS_DB
