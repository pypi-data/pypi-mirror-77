...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.3978615.svg)](https://doi.org/10.5281/zenodo.3978615)
...
```
Samapriya Roy. (2020, August 10). samapriya/geeup: geeup: Simple CLI for Earth Engine Uploads (Version 0.4.2).
Zenodo. http://doi.org/10.5281/zenodo.3978615
```
