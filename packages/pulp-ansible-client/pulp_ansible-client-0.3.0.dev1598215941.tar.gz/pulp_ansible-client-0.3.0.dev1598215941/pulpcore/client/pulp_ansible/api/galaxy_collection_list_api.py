...
class GalaxyCollectionListApi(object):
    ...
    def list(self, ansible_collection_version_href, **kwargs):  # noqa: E501
        """list  # noqa: E501

        APIView for Collections by namespace/name.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list(ansible_collection_version_href, async_req=True)
        >>> result = thread.get()
        ...
        return self.list_with_http_info(ansible_collection_version_href, **kwargs)  # noqa: E501

    def list_with_http_info(self, ansible_collection_version_href, **kwargs):  # noqa: E501
        """list  # noqa: E501

        APIView for Collections by namespace/name.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_with_http_info(ansible_collection_version_href, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('ansible_collection_version_href' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `ansible_collection_version_href` when calling `list`")  # noqa: E501
