...
with open(path.join(here, 'doc/PyPI.md'), encoding='utf-8') as f:
...
setup(
    ...
    version='0.1.1a7',  # Required (reset to this before PyPI publish)
    ...
    #},
    # DO NOT USE package_data AND MANIFEST.in AT THE SAME TIME
