...
from derobertis_cv.pltemplates.logo import svg_text, image_base64
...
_CATEGORIES = [
    ...
    CategoryModel('Alternative Assets', logo_fa_icon_class_str='fab fa-etherium'),
    ...
    CategoryModel('Volatility', logo_base64=image_base64('sigma-lower.png')),
