...
def get_academic_jobs():
    ...
    courses = get_courses()
    uf_courses = [course for course in courses if course.university == UF]
    vcu_courses = [course for course in courses if course.university == VCU]
    ...
    return [
        AcademicEmployment(
            ...
            UF, 'August 2014 - Present', 'Graduate Assistant', 'Gainesville, FL',
        ...
        AcademicEmployment(
            ...
            VCU, 'September 2013 - August 2014', 'Graduate Assistant', 'Richmond, FL',
