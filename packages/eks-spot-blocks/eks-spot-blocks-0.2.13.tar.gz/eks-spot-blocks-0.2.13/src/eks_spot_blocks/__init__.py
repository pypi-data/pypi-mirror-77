...
@jsii.data_type(
    jsii_type="cdk-serverless-api.BaseSpotFleetProps",
...
@jsii.enum(jsii_type="cdk-serverless-api.BlockDuration")
...
class EksSpotCluster(
    ...
    jsii_type="cdk-serverless-api.EksSpotCluster",
):
    """
    stability
    :stability: experimental
...
@jsii.data_type(
    jsii_type="cdk-serverless-api.EksSpotClusterProps",
...
@jsii.interface(jsii_type="cdk-serverless-api.ILaunchtemplate")
...
class _ILaunchtemplateProxy:
    ...
    __jsii_type__: typing.ClassVar[str] = "cdk-serverless-api.ILaunchtemplate"
...
@jsii.enum(jsii_type="cdk-serverless-api.InstanceInterruptionBehavior")
...
class LaunchTemplate(
    metaclass=jsii.JSIIMeta,
    jsii_type="cdk-serverless-api.LaunchTemplate",
):
    """
    stability
    :stability: experimental
...
class SpotFleet(
    aws_cdk.core.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="cdk-serverless-api.SpotFleet",
):
    """
    stability
    :stability: experimental
...
@jsii.data_type(
    jsii_type="cdk-serverless-api.SpotFleetLaunchTemplateConfig",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="cdk-serverless-api.SpotFleetProps",
