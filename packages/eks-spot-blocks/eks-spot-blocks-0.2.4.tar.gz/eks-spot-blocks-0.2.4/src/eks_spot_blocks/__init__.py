...
class EksSpotCluster(
    ...
    def add_hours(
        self, date: datetime.datetime, hours: jsii.Number
    ) -> datetime.datetime:
        """
        :param date: -
        :param hours: -
    ...
    def add_minutes(
        self, date: datetime.datetime, minutes: jsii.Number
    ) -> datetime.datetime:
        """
        :param date: -
        :param minutes: -
...
class LaunchTemplate(
    metaclass=jsii.JSIIMeta, jsii_type="eks-spot-blocks.LaunchTemplate"
):
    """
    stability
    :stability: experimental
