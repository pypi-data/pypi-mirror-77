...
class ProgettiHWSWAPI:
	...
	def get_relay(self, relay_number: int, relay_mode: str = "bistable", is_old: bool = False) -> Relay:
		"""Return the Relay class."""
		return Relay(self.api, relay_number, relay_mode, is_old)

	def get_input(self, input_number: int, is_old: bool = False) -> Input:
		"""Return the Input class."""
		return Input(self.api, input_number, is_old)