...
try:
    ...
    from cral.tracking.pyfunc import load_pyfunc as load_model
from cral.tracking.protos.databricks_pb2 import MALFORMED_REQUEST, BAD_REQUEST
from cral.tracking.server.handlers import catch_mlflow_exception
...
def _handle_serving_error(error_message, error_code):
    ...
    :param error_code: An appropriate error code for the reraised exception. This should be one of
                       the codes listed in the `cral.tracking.protos.databricks_pb2` proto.
    """
