from cral.tracking.entities.model_registry import RegisteredModel, RegisteredModelDetailed, \
    ModelVersion, ModelVersionDetailed
from cral.tracking.protos.model_registry_pb2 import ModelRegistryService, CreateRegisteredModel, \
