...
from cral.tracking.entities.model_registry.model_version_stages import get_canonical_stage, \
...
import cral.tracking.store.db.utils
from cral.tracking.store.db.base_sql_model import Base
from cral.tracking.store.entities.paged_list import PagedList
from cral.tracking.store.model_registry.abstract_store import AbstractStore
from cral.tracking.store.model_registry.dbmodels.models import SqlRegisteredModel, SqlModelVersion
from cral.tracking.utils.search_utils import SearchUtils
from cral.tracking.utils.uri import extract_db_type_from_uri
...
class SqlAlchemyStore(AbstractStore):
    ...
    :py:class:`cral.tracking.store.model_registry.models.RegisteredModel` and
    :py:class:`cral.tracking.store.model_registry.models.ModelVersion`
    """
    ...
    def __init__(self, db_uri):
        ...
        self.engine = cral.tracking.store.db.utils.create_sqlalchemy_engine(db_uri)
        ...
        self.ManagedSessionMaker = cral.tracking.store.db.utils._get_managed_session_maker(SessionMaker)
        ...
        # cral.tracking.store.db.utils._verify_schema(self.engine)
    ...
    def _verify_registry_tables_exist(engine):
        ...
        if any([table not in inspected_tables for table in expected_tables]):
            ...
            # cral.tracking.store.db.utils._initialize_tables(self.engine)
    ...
    def update_registered_model(self, registered_model, new_name=None, description=None):
        ...
        :param registered_model: :py:class:`cral.tracking.entities.model_registry.RegisteredModel` object.
    ...
    def create_model_version(self, name, source, run_id):
        ...
        :return: A single object of :py:class:`cral.tracking.entities.model_registry.ModelVersion`
        created in the backend.
        """
    ...
    def update_model_version(self, model_version, stage=None, description=None):
        ...
        :param model_version: :py:class:`cral.tracking.entities.model_registry.ModelVersion` object.
    ...
    def search_model_versions(self, filter_string):
        ...
        :return: PagedList of :py:class:`cral.tracking.entities.model_registry.ModelVersionDetailed`
                 objects.
        """
