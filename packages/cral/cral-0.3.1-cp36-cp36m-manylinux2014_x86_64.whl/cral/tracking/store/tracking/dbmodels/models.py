...
from cral.tracking.entities import (
...
class SqlExperiment(Base):
    """
    DB model for :py:class:`cral.tracking.entities.Experiment`. These are recorded in ``experiment`` table.
    """
...
class SqlRun(Base):
    """
    DB model for :py:class:`cral.tracking.entities.Run`. These are recorded in ``runs`` table.
    """
    __tablename__ = 'runs'
    ...
    """
    SQLAlchemy relationship (many:one) with :py:class:`cral.tracking.store.dbmodels.models.SqlExperiment`.
    """
    ...
    def to_mlflow_entity(self):
        ...
        :return: :py:class:`cral.tracking.entities.Run`.
        """
        run_info = RunInfo(
...
class SqlExperimentTag(Base):
    """
    DB model for :py:class:`cral.tracking.entities.RunTag`.
    ...
    def to_mlflow_entity(self):
        ...
        :return: :py:class:`cral.tracking.entities.RunTag`.
        """
...
class SqlTag(Base):
    """
    DB model for :py:class:`cral.tracking.entities.RunTag`. These are recorded in ``tags`` table.
    """
    __tablename__ = 'tags'
    ...
    """
    SQLAlchemy relationship (many:one) with :py:class:`cral.tracking.store.dbmodels.models.SqlRun`.
    """
...
class SqlMetric(Base):
    ...
    def to_mlflow_entity(self):
        ...
        :return: :py:class:`cral.tracking.entities.Metric`.
        """
        return Metric(
            key=self.key,
...
class SqlParam(Base):
    ...
    def to_mlflow_entity(self):
        ...
        :return: :py:class:`cral.tracking.entities.Param`.
        """
        return Param(
            key=self.key,
            value=self.value)
