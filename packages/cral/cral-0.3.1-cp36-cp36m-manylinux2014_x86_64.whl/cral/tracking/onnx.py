"""
The ``cral.tracking.onnx`` module provides APIs for logging and loading ONNX models in the MLflow Model
...
def save_model(onnx_model, path, conda_env=None, mlflow_model=Model()):
    ...
    pyfunc.add_to_model(mlflow_model, loader_module="cral.tracking.onnx",
...
def load_model(model_uri):
    ...
    :param model_uri: The location, in URI format, of the MLflow model, for example:
                      ...
                      `Artifacts Documentation <https://www.cral.tracking.org/docs/latest/
...
def log_model(onnx_model, artifact_path, conda_env=None, registered_model_name=None):
    ...
    """
    Model.log(artifact_path=artifact_path, flavor=cral.tracking.onnx,
