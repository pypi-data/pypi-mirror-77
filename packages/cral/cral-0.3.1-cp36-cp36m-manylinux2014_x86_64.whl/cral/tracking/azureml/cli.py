...
from cral.tracking.utils import cli_args, experimental
...
def build_image(model_uri, workspace_name, subscription_id, image_name, model_name,
    ...
    documentation: https://www.cral.tracking.org/docs/latest/models.html#azureml-deployment.
    """
    ...
    cral.tracking.azureml.build_image(
