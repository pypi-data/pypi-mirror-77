...
from cral.tracking import tracking
from cral.tracking.entities import RunStatus
from cral.tracking.exceptions import MlflowException
from cral.tracking.projects.submitted_run import SubmittedRun
from cral.tracking.protos.databricks_pb2 import INVALID_PARAMETER_VALUE
from cral.tracking.utils import rest_utils, file_utils, databricks_utils
from cral.tracking.exceptions import ExecutionException
from cral.tracking.utils.mlflow_tags import MLFLOW_DATABRICKS_RUN_URL, MLFLOW_DATABRICKS_SHELL_JOB_ID, \
    MLFLOW_DATABRICKS_SHELL_JOB_RUN_ID, MLFLOW_DATABRICKS_WEBAPP_URL
from cral.tracking.utils.uri import get_db_profile_from_uri, is_databricks_uri, is_http_uri
from cral.version import VERSION
...
def before_run_validations(tracking_uri, backend_config):
    ...
    if backend_config is None:
        ...
        raise MlflowException(
            message=(
                ...
                " information, see https://cral.tracking.org/docs/latest/projects.html"
    ...
    if not is_databricks_uri(tracking_uri) and \
        ...
        raise ExecutionException(
            ...
            "Please specify a valid tracking URI via cral.tracking.set_tracking_uri or by setting the "
