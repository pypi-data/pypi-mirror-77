"""
The ``cral.tracking.h2o`` module provides an API for logging and loading H2O models. This module exports
...
def save_model(h2o_model, path, conda_env=None, mlflow_model=Model(), settings=None):
    ...
    pyfunc.add_to_model(mlflow_model, loader_module="cral.tracking.h2o",
...
def log_model(h2o_model, artifact_path, conda_env=None, registered_model_name=None, **kwargs):
    ...
    """
    Model.log(artifact_path=artifact_path, flavor=cral.tracking.h2o,
