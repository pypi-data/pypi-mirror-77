"""
The `cral.tracking` module provides a high-level API for tracking and logging metadata and artifacts for DeepLearning Algorithms.
...
cral.tracking.log_param("my", "param")
cral.tracking.log_metric("score", 100)
```

"""

from .utils.logging_utils import _configure_mlflow_loggers
from .tracking import _model_registry
...
from cral.tracking import projects  # noqa
#import cral.tracking.tracking as tracking  # noqa
from cral.tracking import tracking  # noqa

_configure_mlflow_loggers(__name__)

#TO DO: @pk00095
#Enable only for Client
# ActiveRun = fluent.ActiveRun
# log_param = fluent.log_param
# log_params = fluent.log_params
# log_metric = fluent.log_metric
# log_metrics = fluent.log_metrics
# set_tag = fluent.set_tag
# set_tags = fluent.set_tags
# delete_tag = fluent.delete_tag
# active_run = fluent.active_run
# get_run = fluent.get_run
# start_run = fluent.start_run
# end_run = fluent.end_run
# search_runs = fluent.search_runs
# set_experiment = fluent.set_experiment
# set_runid = fluent.set_runid
# log_batch = fluent.log_batch
# log_params_decorator = autologging_utils.log_params_decorator
...
def log_metrics(metrics, step=None):
    ...
    Args:
        metrics: Dictionary of metric_name: String -> value: Float. Note that some special values
...
# def log_artifacts(local_dir, artifact_path):
#     """
...
#     return fluent.log_artifacts(local_dir, artifact_path)
