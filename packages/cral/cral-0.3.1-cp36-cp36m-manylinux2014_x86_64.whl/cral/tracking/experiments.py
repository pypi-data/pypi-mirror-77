...
from cral.tracking.data import is_uri
from cral.tracking.entities import ViewType
from cral.tracking.tracking import _get_store, fluent
...
@click.option("--artifact-location", "-l",
              help="Base location for runs to store artifact results. Artifacts will be stored "
                   ...
                   "https://cral.tracking.org/docs/latest/tracking.html#where-runs-are-recorded for "
