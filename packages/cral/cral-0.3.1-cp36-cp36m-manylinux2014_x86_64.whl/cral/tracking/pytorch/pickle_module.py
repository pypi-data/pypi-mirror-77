...
serialization.py#L192). It is included as a distinct module from :mod:`cral.tracking.pytorch` to avoid
polluting the namespace with wildcard imports.

Calling ``torch.save(..., pickle_module=cral.tracking.pytorch.pickle_module)`` will persist PyTorch model
