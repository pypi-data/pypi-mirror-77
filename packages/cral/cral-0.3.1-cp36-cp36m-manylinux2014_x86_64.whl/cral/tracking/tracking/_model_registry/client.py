...
from cral.tracking.entities.model_registry import ModelVersion, RegisteredModel
from cral.tracking.exceptions import MlflowException
from cral.tracking.tracking._model_registry import utils
...
class ModelRegistryClient(object):
    ...
    def list_registered_models(self):
        ...
        :return: List of :py:class:`cral.tracking.entities.registry.RegisteredModel` objects.
        """
