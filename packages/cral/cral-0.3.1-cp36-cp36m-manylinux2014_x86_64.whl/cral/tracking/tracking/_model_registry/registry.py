from cral.tracking.tracking.registry import StoreRegistry
...
class ModelRegistryStoreRegistry(StoreRegistry):
    ...
    `cral.tracking.registry_store` group can be automatically registered through the
    ...
    def __init__(self):
        super(ModelRegistryStoreRegistry, self).__init__("cral.tracking.model_registry_store")
    ...
    def get_store(self, store_uri=None):
        ...
        :return: An instance of `cral.tracking.store.model_registry.AbstractStore` that fulfills the
