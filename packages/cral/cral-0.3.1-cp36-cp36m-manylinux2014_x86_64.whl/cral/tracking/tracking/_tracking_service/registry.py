...
class TrackingStoreRegistry(StoreRegistry):
    ...
    `cral.tracking.tracking_store` group can be automatically registered through the
    ...
    def __init__(self):
        super(TrackingStoreRegistry, self).__init__("cral.tracking.tracking_store")
    ...
    def get_store(self, store_uri=None, artifact_uri=None):
        ...
        :return: An instance of `cral.tracking.store.tracking.AbstractStore` that fulfills the store URI
                 requirements.
        """
