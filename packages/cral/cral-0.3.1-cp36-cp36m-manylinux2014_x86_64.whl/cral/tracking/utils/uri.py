...
from cral.tracking.utils.validation import _validate_db_type_string

_INVALID_DB_URI_MSG = "Please refer to https://cral.tracking.org/docs/latest/tracking.html#storage for " \
