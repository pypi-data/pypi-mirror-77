...
LEGACY_MLFLOW_GIT_BRANCH_NAME = "cral.tracking.gitBranchName"  # Replaced with cral.tracking.source.git.branch
LEGACY_MLFLOW_GIT_REPO_URL = "cral.tracking.gitRepoURL"  # Replaced with cral.tracking.source.git.repoURL
