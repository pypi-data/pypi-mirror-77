...
from cral.tracking.protos.service_lite_pb2 import RunData as ProtoRunData, Param as ProtoParam,\
...
class RunData(_MLflowObject):
    ...
    def __init__(self, metrics=None, params=None, tags=None):
        """
        Construct a new :py:class:`cral.tracking.entities.RunData` instance.
        :param metrics: List of :py:class:`cral.tracking.entities.Metric`.
        :param params: List of :py:class:`cral.tracking.entities.Param`.
        :param tags: List of :py:class:`cral.tracking.entities.RunTag`.
        """
