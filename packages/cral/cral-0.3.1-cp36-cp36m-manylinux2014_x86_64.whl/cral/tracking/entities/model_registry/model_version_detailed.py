...
from cral.tracking.entities.model_registry.model_version import ModelVersion
from cral.tracking.entities.model_registry.model_version_status import ModelVersionStatus
from cral.tracking.protos.model_registry_pb2 import ModelVersionDetailed as ProtoModelVersionDetailed
...
class ModelVersionDetailed(ModelVersion):
    ...
    :py:class:`cral.tracking.entities.model_registry.ModelVersion`.
    """
    ...
    def from_proto(cls, proto):
        # input: cral.tracking.protos.model_registry_pb2.ModelVersionDetailed
    ...
    def to_proto(self):
        ...
        # returns cral.tracking.protos.model_registry_pb2.ModelVersionDetailed
