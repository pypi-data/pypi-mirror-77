from cral.tracking.entities.model_registry.model_version_detailed import ModelVersionDetailed
from cral.tracking.entities.model_registry.registered_model import RegisteredModel
from cral.tracking.protos.model_registry_pb2 import RegisteredModelDetailed as ProtoRegisteredModelDetailed
...
class RegisteredModelDetailed(RegisteredModel):
    ...
    def latest_versions(self):
        """List of the latest :py:class:`cral.tracking.entities.model_registry.ModelVersion` instances
        for each stage"""
    ...
    def from_proto(cls, proto):
        # input: cral.tracking.protos.model_registry_pb2.RegisteredModelDetailed
    ...
    def to_proto(self):
        # returns cral.tracking.protos.model_registry_pb2.RegisteredModelDetailed
