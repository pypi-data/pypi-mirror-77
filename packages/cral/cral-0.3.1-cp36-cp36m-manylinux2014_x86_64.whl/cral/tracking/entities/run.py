...
from cral.tracking.protos.service_lite_pb2 import Run as ProtoRun
...
class Run(_MLflowObject):
    ...
    def info(self):
        ...
        :rtype: :py:class:`cral.tracking.entities.RunInfo`
        """
        return self._info
    ...
    def data(self):
        ...
        :rtype: :py:class:`cral.tracking.entities.RunData`
        """
        return self._data
