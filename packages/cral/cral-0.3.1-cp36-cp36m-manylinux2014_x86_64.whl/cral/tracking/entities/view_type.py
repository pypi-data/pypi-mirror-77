from cral.tracking.protos import service_lite_pb2
...
class ViewType(object):
    ...
    def to_proto(cls, view_type):
        if view_type == cls.ACTIVE_ONLY:
            return service_lite_pb2.ACTIVE_ONLY
        elif view_type == cls.DELETED_ONLY:
            return service_lite_pb2.DELETED_ONLY
        elif view_type == cls.ALL:
            return service_lite_pb2.ALL
        raise ValueError('Unexpected view_type: {}'.format(view_type))

    @classmethod
    def from_proto(cls, proto_view_type):
        if proto_view_type == service_lite_pb2.ACTIVE_ONLY:
            return cls.ACTIVE_ONLY
        elif proto_view_type == service_lite_pb2.DELETED_ONLY:
            return cls.DELETED_ONLY
        elif proto_view_type == service_lite_pb2.ALL:
            return cls.ALL
