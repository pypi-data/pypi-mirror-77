...
def main():
    ...
    input_parser.add_argument(
        'input_handle', metavar='INPUT', type=FileType('rb'),
        help='input file')

    input2_parser = ArgumentParser(add_help=False)
    input2_parser.add_argument(
        'input_handles', metavar='INPUT', type=FileType('rb'), nargs=2,
        help='input files')

    output_parser = ArgumentParser(add_help=False)
    output_parser.add_argument(
        'output_handle', metavar='OUTPUT', type=FileType('wb'),
        help='output file')

    output2_parser = ArgumentParser(add_help=False)
    output2_parser.add_argument(
        'output_handles', metavar='OUTPUT', type=FileType('wb'), nargs=2,
        help='output files')
    ...
    subparser.add_argument(
        'edits_handle', metavar='EDITS', type=FileType('rb'),
