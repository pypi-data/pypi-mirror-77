...
class BinaryModel(object):
    ...
    def __init__(self, sha1=None, md5=None, sha256=None, sha512=None, unpacked_sha1=None, object_class=None, file_type=None, upload_timestamp=None, first_seen=None, num_matches=None, num_sim_pack_sim_pay=None, num_sim_pack_diff_pay=None, num_diff_pack_sim_pay=None, investigations=None, tokens=None, avlabels=None, packed_campaign_size=None, payload_campaign_size=None, yara_id=None, yara_id_unpacked=None, color=None):  # noqa: E501
    ...
    def md5(self, md5):
        ...
        :type: str
        """
        if md5 is not None and not re.search(r'[a-fA-F\\d]{32}', md5):  # noqa: E501
            raise ValueError(r"Invalid value for `md5`, must be a follow pattern or equal to `/[a-fA-F\\d]{32}/`")  # noqa: E501
    ...
    def sha256(self, sha256):
        ...
        :type: str
        """
        if sha256 is not None and not re.search(r'[a-fA-F\\d]{64}', sha256):  # noqa: E501
            raise ValueError(r"Invalid value for `sha256`, must be a follow pattern or equal to `/[a-fA-F\\d]{64}/`")  # noqa: E501
    ...
    def sha512(self, sha512):
        ...
        :type: str
        """
        if sha512 is not None and not re.search(r'[a-fA-F\\d]{128}', sha512):  # noqa: E501
            raise ValueError(r"Invalid value for `sha512`, must be a follow pattern or equal to `/[a-fA-F\\d]{128}/`")  # noqa: E501
