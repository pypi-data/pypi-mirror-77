...
class AlertModel(object):
    ...
    def __init__(self, alert_id=None, severity_level=None, status=None, creation_date=None, title=None, description=None, investigation=None, campaign=None, binary=None):  # noqa: E501
    ...
    def alert_id(self, alert_id):
        ...
        :type: str
        """
        if alert_id is not None and not re.search(r'Alert-[\\d]{6}', alert_id):  # noqa: E501
            raise ValueError(r"Invalid value for `alert_id`, must be a follow pattern or equal to `/Alert-[\\d]{6}/`")  # noqa: E501
    ...
    def creation_date(self, creation_date):
        ...
        :type: str
        """
        if creation_date is not None and not re.search(r'202[\\d]-[\\d]{2}-[\\d]{2}T[0-2][\\d]:[0-5][\\d]:[0-5][\\d].[\\d]{6}Z', creation_date):  # noqa: E501
            raise ValueError(r"Invalid value for `creation_date`, must be a follow pattern or equal to `/202[\\d]-[\\d]{2}-[\\d]{2}T[0-2][\\d]:[0-5][\\d]:[0-5][\\d].[\\d]{6}Z/`")  # noqa: E501
    ...
    def investigation(self):
        """Gets the investigation of this AlertModel.  # noqa: E501

        The name of the investigation that the alert is linked to. Can be null  # noqa: E501

        :return: The investigation of this AlertModel.  # noqa: E501
        :rtype: str
        """
    ...
    def investigation(self, investigation):
        """Sets the investigation of this AlertModel.

        The name of the investigation that the alert is linked to. Can be null  # noqa: E501

        :param investigation: The investigation of this AlertModel.  # noqa: E501
        :type: str
        """
