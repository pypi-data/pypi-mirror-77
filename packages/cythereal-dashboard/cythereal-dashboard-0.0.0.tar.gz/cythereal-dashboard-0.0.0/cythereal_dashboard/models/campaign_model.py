...
class CampaignModel(object):
    ...
    def id(self, id):
        ...
        :type: str
        """
        if id is not None and not re.search(r'[a-fA-F\\d]{40}', id):  # noqa: E501
            raise ValueError(r"Invalid value for `id`, must be a follow pattern or equal to `/[a-fA-F\\d]{40}/`")  # noqa: E501
