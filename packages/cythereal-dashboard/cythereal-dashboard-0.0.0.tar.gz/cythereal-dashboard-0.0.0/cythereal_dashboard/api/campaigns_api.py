...
class CampaignsApi(object):
    ...
    def get_campaign_with_http_info(self, campaign_id, **kwargs):  # noqa: E501
        ...
        if 'campaign_id' in params and not re.search(r'^([a-fA-F\\d]{32}|[a-fA-F\\d]{40}|[a-fA-F\\d]{64}|[a-fA-F\\d]{128})$', params['campaign_id']):  # noqa: E501
            raise ValueError("Invalid value for parameter `campaign_id` when calling `get_campaign`, must conform to the pattern `/^([a-fA-F\\d]{32}|[a-fA-F\\d]{40}|[a-fA-F\\d]{64}|[a-fA-F\\d]{128})$/`")  # noqa: E501
        collection_formats = {}
    ...
    def reprocess_campaign_with_http_info(self, campaign_id, **kwargs):  # noqa: E501
        ...
        if 'campaign_id' in params and not re.search(r'^([a-fA-F\\d]{32}|[a-fA-F\\d]{40}|[a-fA-F\\d]{64}|[a-fA-F\\d]{128})$', params['campaign_id']):  # noqa: E501
            raise ValueError("Invalid value for parameter `campaign_id` when calling `reprocess_campaign`, must conform to the pattern `/^([a-fA-F\\d]{32}|[a-fA-F\\d]{40}|[a-fA-F\\d]{64}|[a-fA-F\\d]{128})$/`")  # noqa: E501
        collection_formats = {}
