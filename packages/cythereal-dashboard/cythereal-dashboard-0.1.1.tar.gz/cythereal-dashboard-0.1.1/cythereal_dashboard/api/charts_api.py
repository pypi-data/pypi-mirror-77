...
class ChartsApi(object):
    ...
    def get_investigation_timeline_binaries(self, investigation_name, **kwargs):  # noqa: E501
        """Gets all the binaries in an investigation in timeline format  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_investigation_timeline_binaries(investigation_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_investigation_timeline_binaries_with_http_info(investigation_name, **kwargs)  # noqa: E501
        else:
            (data) = self.get_investigation_timeline_binaries_with_http_info(investigation_name, **kwargs)  # noqa: E501
            return data

    def get_investigation_timeline_binaries_with_http_info(self, investigation_name, **kwargs):  # noqa: E501
        """Gets all the binaries in an investigation in timeline format  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_investigation_timeline_binaries_with_http_info(investigation_name, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_investigation_timeline_binaries" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('investigation_name' not in params or
            ...
            raise ValueError("Missing the required parameter `investigation_name` when calling `get_investigation_timeline_binaries`")  # noqa: E501
