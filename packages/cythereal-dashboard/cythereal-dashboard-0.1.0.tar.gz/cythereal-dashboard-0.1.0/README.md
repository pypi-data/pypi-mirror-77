...
*ChartsApi* | [**get_campaigns_timeline_binaries**](docs/ChartsApi.md#get_campaigns_timeline_binaries) | **GET** /charts/timeline/{campaign_id}/campaign/ | Gets all the binaries in a specific campaign for the user
*ChartsApi* | [**get_heatmap_data**](docs/ChartsApi.md#get_heatmap_data) | **GET** /charts/maps/ | Gets all the user&#39;s collection info in heat map format
*ChartsApi* | [**get_investigations_timeline_binaries**](docs/ChartsApi.md#get_investigations_timeline_binaries) | **GET** /charts/timeline/{investigation_name}/investigation/ | Gets all the binaries in an investigation in timeline format
...
*UpdateApi* | [**udpate_account**](docs/UpdateApi.md#udpate_account) | **GET** /update/account/ | Update&#39;s a users account to reflect their mongodb data
