...
class ErrorResponse(object):
    ...
    def __init__(self, success=None, code=None, message=None):  # noqa: E501
    ...
    def code(self):
        ...
        Error code. Typically corresponds to HTTP status code. If there are multiple errors, `code` will be for the first error.   # noqa: E501
